import{o as X,a7 as J,G as R,s as C,q as T,$ as D,A as u,_ as W,a8 as Z,a0 as I}from"./index-gYO_fZOl.js";import{g as ee,i as te,r as se,M as le,f as re,b as ae,a as ce,c as ne}from"./mcqDifficulty-DtvnjTcC.js";import{G as _,a as B,b as ie}from"./grammarMcq-CW5ncdO8.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";import"./practiceExpansion-67d_LqFm.js";let c=null,G=null,h=[],b=0,E=0,x=!1,q={level:null,category:null,label:"All Skills",difficulty:"normal"},m="normal",f=0,$=0,k=[],M=!1,L={},w={},j=0;const K=3;function P(e){return`gmcq:${e}`}function oe(e){return!!(C.get("lessonsSeen")||{})[P(e)]}function ue(e){const t={...C.get("lessonsSeen")||{}};t[P(e)]||(t[P(e)]=new Date().toISOString(),C.set("lessonsSeen",t))}function _e(e,t){c=e,G=t}function xe(){c&&(c.innerHTML="")}function de(e=_){return B.flatMap(t=>e[t]||[])}function Y({level:e=null,category:t=null}={},s=_){const l=e?s[e]||[]:de(s);return t?l.filter(a=>a.category===t):l}function U(e={},t=_){return Y(e,t).length}function me(e=_,t=X){return t.map(s=>{const l={};let a=0;for(const i of B){const n=U({level:i,category:s},e);l[i]=n,a+=n}return{category:s,total:a,levels:l}})}function pe(e=_,t=B){return t.map(s=>({level:s,total:U({level:s},e)}))}function F(e){var t;return((t=R[e])==null?void 0:t.label)||e}function he(e){const t=e.level||null,s=e.category?F(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function N(){if(!c)return;const e=pe(),t=me();let s=q.level||ee(),l=q.difficulty||m||"normal";const a=()=>{var i,n;c.innerHTML=`
  ...
  `}function be(e){return/___/.test(e.q||"")?"Read the whole sentence first, then choose the word that fits the blank.":"Read the question carefully, then choose the best answer."}function A(){if(!c)return;const e=h[b];if(!e)return ye();if(!oe(e.category)&&j<K)return V(e.category,()=>A());x=!1;const t=Math.round(b/h.length*100),s=M?`Recovery · ${q.label}`:q.label,l=[...e.choices].sort(()=>Math.random()-.5);c.innerHTML=`
    <div class="mcq-game" role="region" aria-label="Grammar question ${b+1} of ${h.length}">
      ...
      <div class="vmcq-next-wrap" id="gmcq-next-wrap" style="display:none">
        ...
        </tr>`}).join("")}</tbody></table>`}function V(e,t){var a,i;j+=1,ue(e);const s=I(e),l=R[e]||{icon:"🧠",label:e};c.innerHTML=`
    ...
    </div>`,l&&((o=c.querySelector("#gmcq-recovery"))==null||o.addEventListener("click",()=>qe())),(v=c.querySelector("#gmcq-replay"))==null||v.addEventListener("click",()=>H(q)),(p=c.querySelector("#gmcq-menu"))==null||p.addEventListener("click",()=>N())}export{xe as cleanupGrammarMcq,U as countItemsForScope,de as getAllItems,me as getCategoryCounts,Y as getItemsForScope,pe as getLevelCounts,_e as initGrammarMcq,N as showGrammarMcqBrowser,Ce as startGrammarMcqLevel};
