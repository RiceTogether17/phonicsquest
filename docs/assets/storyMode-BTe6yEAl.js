import{s as P,W as me,L as Pt,M as be,C as tt,N as jt,O as M,Q as T,R as Y,T as j,U as Ut}from"./index-Lhp2_XXZ.js";import{P as Dt,g as zt,e as nt,i as st}from"./sightStoryWeave-BcZBtgpM.js";import"./gsap-C8pce-KX.js";function Yt(e,t,s){var g;if(!((g=t.comprehension)!=null&&g.length)){s==null||s();return}const n={phase:"intro",qIndex:0,vocabIndex:0,correct:0,total:t.comprehension.length,flipped:!1};function o(){switch(n.phase){case"intro":return a();case"comprehension":return r();case"vocab":return c();case"openEnded":return d();case"grammar":return m();case"done":return p()}}function a(){var i,u,h,b;e.innerHTML=`
