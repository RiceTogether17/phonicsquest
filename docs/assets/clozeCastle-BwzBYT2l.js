import{p as q,C as N,a as be}from"./passages-CrCp32Wn.js";import{s as v,p as fe,q as ye,G as B,A as y,$ as Ae,a0 as ke,Y as Be,U as G,Z as ve,_ as Ne,a1 as Oe,a2 as Ge}from"./index-se4Lprrc.js";import{g as Ie,a as Ue,b as Me,c as Y,s as Ze,d as Je,e as U,f as Ve,h as Ye,p as Qe,i as Xe,j as Ke,k as et,l as Te,r as tt,m as lt,n as nt,o as Re,q as Pe,t as at,u as st,v as ct,w as ot,x as rt,y as ie,z as it,A as We,B as dt,C as ut,D as ge,E as xe,F as mt,G as He,H as pt,I as bt,J as Fe,K as kt}from"./masteryMap-CGSkgGlE.js";import"./practiceExpansion-67d_LqFm.js";import"./gsap-C8pce-KX.js";let k=null,A=null,z="P1",p="",M=0,ne=[],L=[],_=[],ae=0,se=0,ze=0,I=null,E=-1,R={},J=0,P=!1,de=0,he=0,$="practice",O=0,Ee=0,V=[],W=0,j=0,we=!1,ee=!1,ue=0,le=0,F={};function At(e,l){k=e,A=l}function Bt(){_e()}function Ce(){k&&(k.innerHTML=""),L=[],_=[],I&&(document.removeEventListener("keydown",I),I=null)}function _e(){if(!k)return;const e=v.get("ccqCompleted")||{},l=Object.keys(q);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const a=Object.keys(q[n]),s=a.reduce((m,c)=>m+q[n][c].length,0),d=a.reduce((m,c)=>m+q[n][c].reduce((o,w)=>{var b;return o+(((b=w.answers)==null?void 0:b.length)||0)},0),0),h=Ie({level:n,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:e}),u=h>=s,i=be[n];t+=`
    ...
    <h3 class="cloze-cat-title">${n} ${N[e]}</h3>
      ...
      <button class="cloze-cat-btn ${f?"cloze-cat-btn--done":""} ${C?"cloze-cat-btn--recommended":""}"
        ...
        <span class="cloze-cat-count">${oe} questions · ${Math.min(X,S)} / ${S} passages${C?" · Recommended":""}</span>
  ...
  </div>`;const h=l.reduce((r,x)=>r+q[e][x].length,0),u=Ue({mode:"clozeCastle",level:e,masteryMap:v.get("masteryMap")||{}}),i=u.length?u:Me({level:e,weakSkillsMap:v.get("ccqWeakSkills")||{}}).map(r=>({skill:r.skill,skillLabel:Y(r.skill),attempts:r.attempts,wrong:r.wrong,accuracy:Math.round((r.attempts-r.wrong)/Math.max(1,r.attempts)*100),lastExample:null})),m=i.map(r=>{const x=r.accuracy!=null?Ze(r):Je({weakSkills:[r.skill],accuracy:r.accuracy,hintsUsed:0}),S=r.lastExample?` · Last slip: "${y(r.lastExample.chosen||"—")}" → "${y(r.lastExample.correct||"?")}"`:"";return`<li>${y(r.skillLabel||Y(r.skill))}: ${r.wrong}/${r.attempts} · ${y(x)}${S}</li>`}).join("");a+=`<div class="cloze-cat-actions">
  ...
  </div>`,a+="</div>",k.innerHTML=a,(c=document.getElementById("cloze-back-levels"))==null||c.addEventListener("click",()=>_e()),(o=document.getElementById("cloze-mode-practice"))==null||o.addEventListener("click",()=>{$="practice",me(e)}),(w=document.getElementById("cloze-mode-exam"))==null||w.addEventListener("click",()=>{$="exam",me(e)}),k.querySelectorAll(".cloze-cat-btn").forEach(r=>{r.addEventListener("click",()=>{p=r.dataset.cat,$e(z,p)})}),(b=document.getElementById("cloze-play-all"))==null||b.addEventListener("click",()=>{p="__all__",je(z)}),(g=document.getElementById("cloze-mastery-review"))==null||g.addEventListener("click",()=>{p=fe.getRecommendedGrammarCategory(e,l)||l[0],$e(z,p)})}function $e(e,l){var n;ne=[...((n=q[e])==null?void 0:n[l])||[]].sort(()=>Math.random()-.5),M=0,ae=0,se=0,he=0,O=0,Ee=Date.now(),V=[],W=0,j=0,ue=0,le=0,F={},$!=="exam"?Ct(l,()=>D()):D()}function je(e){ne=[...Object.keys(q[e]||{}).flatMap(n=>q[e][n])].sort(()=>Math.random()-.5),M=0,ae=0,se=0,he=0,O=0,Ee=Date.now(),V=[],W=0,j=0,ue=0,le=0,F={},D()}function D(){if(M>=ne.length){Et();return}ht(ne[M])}function ht(e){const l=Ke(e);if(L=l.bankWords,_=l.blankFills,R={},J=0,de=0,ze=0,e.clues&&e.clues.length>0){const t=[...e.clues].sort((n,a)=>n.blankIndex-a.blankIndex)[0];E=(t==null?void 0:t.blankIndex)??-1,P=!0}else E=-1,P=!1;we=!1,ee=!1,gt(e)}function te(e){var i,m,c,o,w;if(!k)return;const l=be[z],t=`${M+1} / ${ne.length}`,n=p!=="__all__"&&B[p]?`${B[p].icon} ${B[p].label}`:"All Topics",a=e.clues&&e.clues.length>0,s=a&&P,d=U($),h=a?s?'<span class="cloze-badge cloze-badge--phase cloze-badge--phase-clue">🔍 Step 1 · Clue Hunt</span>':'<span class="cloze-badge cloze-badge--phase cloze-badge--phase-fill">🏰 Step 2 · Fill the Blanks</span>':"",u=a?s?"🔍 Step 1 of 2 — Tap the clue word in the passage that hints at the answer.":"🏰 Step 2 of 2 — Now tap a word from the bank to fill the next blank.":"🏰 Read the whole passage first, then tap a word from the bank to fill each blank.";k.innerHTML=`
    ...
    </div>`,(s=k.querySelector(".cloze-game"))==null||s.appendChild(a),(d=document.getElementById("clue-explanation-next"))==null||d.addEventListener("click",()=>{a.remove(),l()})}function H(e,l){const t=document.getElementById("cloze-feedback");t&&(t.textContent=e,t.className=`cloze-feedback cloze-feedback--${l?"success":"error"}`,t.hidden=!1,l&&setTimeout(()=>{t.hidden=!0},1600))}function Et(){var r,x,S,oe,X;if(!k)return;const e=be[z];Be(),G.playSfx("levelUp"),ve.celebrate(!0);const l=p!=="__all__"&&B[p]?`${B[p].icon} ${B[p].label}`:"All Topics",t=W>0?Math.round(j/W*100):100,n=t>=90?3:t>=70?2:1,a=U($),s=Math.max(1,Math.round((Date.now()-(Ee||Date.now()))/1e3)),d=et({accuracy:t,skillLabel:l,hintsUsed:O}),h=Me({level:z,weakSkillsMap:v.get("ccqWeakSkills")||{}}),u=h.length?`<p class="cloze-complete-score">Mastery focus: ${h.map(f=>`${Y(f.skill)} (${f.wrong}/${f.attempts})`).join(" · ")}</p>`:"",i=$==="exam"&&V.length?Ve(V):V.map(f=>`- ${f.passageTitle} ${f.blank}: ${f.studentAnswer||"(blank)"} → ${f.correctAnswer}`),m=Object.keys(R).length,c=m>0?Math.round(he/m*100):null,o=c!==null?`<p class="cloze-complete-clue">🔍 Clue accuracy: ${c}%</p>`:"",w=le>0?Math.round(ue/le*100):null,b=w!==null?`<p class="cloze-complete-clue">🔎 Scan accuracy: ${w}% (${ue}/${le})</p>`:"";let g="";if(t<70){let f=p!=="__all__"?p:null;if(!f){const C=Object.entries(F).filter(([,T])=>T.total>0);C.length>0&&(f=C.sort(([,T],[,Z])=>T.correct/T.total-Z.correct/Z.total)[0][0])}if(f){const C=ke(f),T=B[f]||{icon:"🏰",label:f};g=`
    ...
    </div>`,(r=document.getElementById("cloze-back-cat"))==null||r.addEventListener("click",()=>me(z)),(x=document.getElementById("cloze-replay"))==null||x.addEventListener("click",()=>{p==="__all__"?je(z):$e(z,p)}),(S=document.getElementById("cloze-copy-summary"))==null||S.addEventListener("click",async()=>{var C;const f=Ye({modeLabel:a.label,title:`${N[z]} · ${l}`,category:l,level:N[z],scoreLine:Te({mode:$,blankCorrect:j,blankTotal:W,passageCorrect:ae,passageTotal:se}),accuracy:t,timeTaken:`${s}s`,hintsUsed:O,clueScore:c??0,wrongLines:i,nextStep:d});try{await((C=navigator.clipboard)==null?void 0:C.writeText(f)),H("Summary copied!",!0)}catch{H("Unable to copy summary on this device.",!1)}}),(oe=document.getElementById("cloze-copy-parent-report"))==null||oe.addEventListener("click",async()=>{var K,Le;const{strongest:f,weakest:C}=Qe(F),T=Te({mode:$,blankCorrect:j,blankTotal:W,passageCorrect:ae,passageTotal:se}),Z=Xe({questLabel:"Cloze Castle",modeLabel:a.label,scoreLine:T,accuracy:t,strongest:f,weakest:C,weakExamples:C?((K=F[C.skill])==null?void 0:K.lastWrongExamples)||[]:[],recommendation:d});try{await((Le=navigator.clipboard)==null?void 0:Le.writeText(Z)),H("Parent report copied!",!0)}catch{H("Unable to copy parent report on this device.",!1)}}),(X=document.getElementById("cloze-back-levels"))==null||X.addEventListener("click",()=>_e()),I&&(document.removeEventListener("keydown",I),I=null),setTimeout(()=>{var f;return(f=document.getElementById("cloze-back-cat"))==null?void 0:f.focus()},200)}export{Ce as cleanupClozeCastle,At as initClozeCastle,Bt as showClozeBrowser};
