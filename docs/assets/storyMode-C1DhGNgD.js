import{P as jt,S as M,B as T,g as Pt,e as tt,i as nt}from"./sightStoryWeave-C4aqRhrq.js";import{s as j,W as me,I as be,C as st,K as Ut,L as Y,M as P,N as Dt}from"./index-Dud0PMWa.js";import"./gsap-C8pce-KX.js";function zt(e,t,s){var g;if(!((g=t.comprehension)!=null&&g.length)){s==null||s();return}const n={phase:"intro",qIndex:0,vocabIndex:0,correct:0,total:t.comprehension.length,flipped:!1};function o(){switch(n.phase){case"intro":return a();case"comprehension":return r();case"vocab":return c();case"openEnded":return d();case"grammar":return m();case"done":return p()}}function a(){var i,u,h,b;e.innerHTML=`
    ...
    `,document.querySelectorAll(".sq-option").forEach(b=>{b.addEventListener("click",()=>l(b,i))})}function l(i,u){const h=parseInt(i.dataset.idx,10),b=h===u.answer;b&&n.correct++,document.querySelectorAll(".sq-option").forEach((E,w)=>{E.disabled=!0,w===u.answer&&E.classList.add("sq-option--correct"),w===h&&!b&&E.classList.add("sq-option--wrong")});const f=document.getElementById("sq-feedback");f&&(f.hidden=!1,f.className=`sq-feedback ${b?"sq-feedback--correct":"sq-feedback--wrong"}`,f.textContent=b?"✅ Great thinking!":`✨ The answer is: ${u.options[u.answer]}`);const S=document.getElementById("sq-next");S&&(S.hidden=!1,S.addEventListener("click",()=>{var E,w,k;n.qIndex++,n.qIndex<n.total||(n.phase=(E=t.openEnded)!=null&&E.length?"openEnded":(w=t.vocab)!=null&&w.length?"vocab":(k=t.grammarSpotlight)!=null&&k.length?"grammar":"done",n.vocabIndex=0),o()}))}function d(){var u,h,b;const i=t.openEnded||[];if(!i.length){n.phase=(u=t.vocab)!=null&&u.length?"vocab":(h=t.grammarSpotlight)!=null&&h.length?"grammar":"done",o();return}e.innerHTML=`
      <div class="sq-screen sq-comprehension">
      ...
      </div>`,(b=document.getElementById("sq-open-next"))==null||b.addEventListener("click",()=>{var f,S;n.phase=(f=t.vocab)!=null&&f.length?"vocab":(S=t.grammarSpotlight)!=null&&S.length?"grammar":"done",o()})}function c(){var S,E,w;const i=t.vocab[n.vocabIndex],u=t.vocab.length,h=n.vocabIndex+1;e.innerHTML=`
    ...
    `;const b=document.getElementById("sq-flip-card"),f=()=>{n.flipped=!0,o()};b==null||b.addEventListener("click",f),b==null||b.addEventListener("keydown",k=>{(k.key==="Enter"||k.key===" ")&&f()}),(S=document.getElementById("sq-flip-btn"))==null||S.addEventListener("click",f),(E=document.getElementById("sq-vocab-next"))==null||E.addEventListener("click",()=>{var k;n.vocabIndex++,n.flipped=!1,n.vocabIndex<u||(n.phase=(k=t.grammarSpotlight)!=null&&k.length?"grammar":"done"),o()}),(w=document.getElementById("sq-vocab-skip"))==null||w.addEventListener("click",()=>{var k;n.phase=(k=t.grammarSpotlight)!=null&&k.length?"grammar":"done",o()})}function m(){var h;const u=(t.grammarSpotlight??[]).map((b,f)=>`
    ...
    `,(h=document.getElementById("sq-grammar-done"))==null||h.addEventListener("click",()=>{n.phase="done",o()})}function p(){var E;const i=n.total>0?Math.round(n.correct/n.total*100):100,u=i>=80?3:i>=50?2:1,h="⭐".repeat(u)+"☆".repeat(3-u),b=n.correct*15+(i===100?25:0),f=["Great job — keep it up!","Nice work! Read the story again to practise.","Super reader! You aced this Story Quest!"],S=u===3?f[2]:u===2?f[1]:f[0];e.innerHTML=`
    ...
    `,(E=document.getElementById("sq-back"))==null||E.addEventListener("click",()=>s==null?void 0:s())}o()}function Yt(e,t){if(typeof e!="string"||e.length===0||typeof t!="number"||!Number.isFinite(t)||t<0)return-1;const s=Math.min(t,e.length-1);let n=-1,o=!1;for(let a=0;a<=s;a++){const r=/\s/.test(e.charAt(a));!r&&!o?(n++,o=!0):r&&(o=!1)}return n<0?-1:n}function Vt(e,t){if(!e||typeof e.top!="number"||typeof e.bottom!="number"||typeof t!="number"||t<=0)return!1;const s=80;return e.bottom<s||e.top>t-s}function Kt(e){return typeof e!="string"?"":e.toLowerCase().replace(/^[^a-z0-9]+/,"").replace(/[^a-z0-9]+$/,"").trim()}let z=null;function at(){if(z)return z;z=new Map;for(const e of me)e!=null&&e.word&&z.set(e.word.toLowerCase(),e);return z}function Jt(e){const t=Kt(e),s=at(),n=t?s.get(t):null;if(n){const o=j.get("wordStats")||{},a=!!o[n.id]&&(o[n.id].attempts||0)>0;return{text:n.word,word:n,foundInBank:!0,graphemes:Array.isArray(n.graphemes)?n.graphemes:[t],types:Array.isArray(n.types)?n.types:[],alreadyTracked:a}}return{text:t,word:null,foundInBank:!1,graphemes:t?t.split(""):[],types:[],alreadyTracked:!1}}function ot(e){return!e||typeof e!="string"||!(at().has(e)||me.some(n=>(n==null?void 0:n.id)===e))?!1:(j.recordWordAttempt(e,!0),!0)}const Qt=.62,Xt=.4,Fe=2;function je(e){return String(e||"").toLowerCase().replace(/[’']/g,"'").split(/[^a-z0-9']+/).map(t=>t.replace(/^'+|'+$/g,"")).filter(Boolean)}function Zt(e,t,s=(n,o)=>be.phoneticSimilarity(n,o)){const n=e.length,o=t.length;if(n===0)return[];if(o===0)return e.map(p=>({word:p,status:"miss",heard:null}));const a=-.4,r=Array.from({length:n+1},()=>new Array(o+1).fill(0));for(let p=1;p<=n;p++)r[p][0]=p*a;for(let p=1;p<=o;p++)r[0][p]=p*a;const l=Array.from({length:n},(p,g)=>Array.from({length:o},(i,u)=>s(e[g],t[u])));for(let p=1;p<=n;p++)for(let g=1;g<=o;g++){const i=l[p-1][g-1]-.5;r[p][g]=Math.max(r[p-1][g-1]+i,r[p-1][g]+a,r[p][g-1]+a)}const d=new Array(n);let c=n,m=o;for(;c>0;){const p=m>0?l[c-1][m-1]-.5:-1/0;if(m>0&&r[c][m]===r[c-1][m-1]+p){const g=l[c-1][m-1],i=e[c-1];let u;g>=Qt?u="match":g>=Xt||i.length<=Fe?u="unsure":u="miss",d[c-1]={word:i,status:u,heard:t[m-1]},c--,m--}else if(m>0&&r[c][m]===r[c][m-1]+a)m--;else{const g=e[c-1];d[c-1]={word:g,status:g.length<=Fe?"unsure":"miss",heard:null},c--}}return d}function en(e,t,s){const n=je(e);let o=null;for(const a of t||[]){const r=Zt(n,je(a.text),s),l=r.filter(d=>d.status==="match").length;(!o||l>o.matchCount)&&(o={words:r,matchCount:l,total:n.length})}return o||{words:n.map(a=>({word:a,status:"miss",heard:null})),matchCount:0,total:n.length}}function tn(){return be.supported}async function nn(e){const t=await be.listenTranscript({timeoutMs:12e3});return t?en(e,t.transcripts):null}function sn(){be.stop()}function Pe(e){const t=j.get("groupMastery")||{},s=st.filter(o=>e.includes(o.phase));return s.length?s.filter(o=>(t[o.group]??0)>=.8).length/s.length:0}function Le(e){const t=j.get("groupMastery")||{};return st.some(s=>e.includes(s.phase)&&typeof t[s.group]=="number"&&t[s.group]>0)}function rt(){const e=Pe([1,2,3,4,5]),t=Le([6]),s=Pe([6])>=.5,n=Le([8]),o=Le([7]),a=e>=.6||t,r=a&&(s||n),l=r&&o;return{A:{ready:!0,hint:""},B:{ready:a,hint:a?"":"Best after starting Phase 6 — Long Vowels"},C:{ready:r,hint:r?"":"Best after Phase 6 and Bossy-R practice"},D:{ready:l,hint:l?"":"Best after starting Phase 7 — Diphthongs"}}}function an(e,t){const s=rt();for(const n of["A","B","C","D"]){if(!s[n].ready)break;const o=(t==null?void 0:t[n])||[];if(o.some(r=>!(e!=null&&e.includes(r.id)))||!o.length)return n}return"A"}const se=Object.freeze({short:{label:"short vowel",color:"#d62828",mark:"ă"},long:{label:"long vowel",color:"#1a7f37",mark:"ā"},schwa:{label:"schwa · lazy “uh”",color:"#6b7280",mark:"ə"},rcontrolled:{label:"bossy-r vowel",color:"#7c3aed",mark:"ûr"},diphthong:{label:"sliding vowel",color:"#ea580c",mark:"oi"},silent:{label:"silent letter",color:"#9aa3af",mark:"∅"},consonant:{label:"consonant",color:"#2563eb",mark:""},digraph:{label:"digraph",color:"#0891b2",mark:""},blend:{label:"blend",color:"#d97706",mark:""},affix:{label:"word part",color:"#db2777",mark:""}}),on=Object.freeze(["short","long","schwa","rcontrolled","diphthong","silent"].map(e=>({key:e,...se[e]}))),Re=new Set(["short","long","schwa","rcontrolled","diphthong"]),rn=new Set(["about","above","again","ago","along","alone","around","away","aside","awake","aboard","aloud","ashore","alike","asleep","amaze","alarm","across","aware","another","awhile","ahead","afraid","apart","alive","awoke","ajar","aloft","amount","account","asleep","aglow"]),fe="bcdfghjklmnpqrstvwxyz",ln=new RegExp(`[${fe}]a$`),cn=new RegExp("[bcdfghjkmnprstvz]al$"),it=/[ts]ion$/;function lt(e){const t=new Set;return e==="a"?t.add(0):e==="the"?t.add(2):(rn.has(e)&&e[0]==="a"&&t.add(0),e.length>=3&&ln.test(e)&&t.add(e.length-1),e.length>=4&&cn.test(e)&&t.add(e.length-2),e.length>=5&&it.test(e)&&t.add(e.length-3)),t.size?t:null}const dn=new Set(["maybe","recipe","karate","sesame","ukulele","finale"]),un=new RegExp(`[${fe}]e$`);function ct(e){const t=new Set,s=e.length;if(s>=5&&it.test(e)&&t.add(s-2),s>=4&&un.test(e)&&!dn.has(e)&&/[aeiou]/.test(e.slice(0,-2))&&t.add(s-1),s>=4&&e.endsWith("ed")){const n=e[s-3];fe.includes(n)&&n!=="t"&&n!=="d"&&/[aeiou]/.test(e.slice(0,-2))&&t.add(s-2)}return t.size?t:null}const pn=new Set(["head","bread","dead","ready","heavy","instead","meant","health","wealth","weather","feather","leather","thread","spread","breath","death","sweat","meadow","steady","already","breakfast","dread","heaven","peasant","pleasant","treasure","measure"]),hn=new Set(["been"]),gn=new Set(["friend","friends"]),mn=new Set(["snow","show","shown","low","below","grow","grown","blow","blown","glow","flow","slow","throw","thrown","own","owned","know","known","yellow","follow","window","arrow","narrow","elbow","rainbow","bowl","sparrow","pillow","shadow","meadow","borrow","tomorrow","below","row","mow","sow","bow","crow","flown","growth"]),bn=["ing","ed","ly","es","s","n"];function de(e,t){if(e.has(t))return!0;for(const s of bn)if(t.endsWith(s)&&t.length-s.length>=2&&e.has(t.slice(0,-s.length)))return!0;return!1}function Q(e,t,s,n,o,a){return Re.has(n)?a!=null&&a.has(s)?"silent":o!=null&&o.has(s)?"schwa":t==="ea"&&de(pn,e)||t==="ee"&&de(hn,e)||t==="ie"&&de(gn,e)?"short":t==="ow"&&de(mn,e)?"long":n:n}const v=null,dt=new Map([["have",[v,"short",v,"silent"]],["love",[v,"short",v,"silent"]],["come",[v,"short",v,"silent"]],["some",[v,"short",v,"silent"]],["done",[v,"short",v,"silent"]],["gone",[v,"short",v,"silent"]],["none",[v,"short",v,"silent"]],["give",[v,"short",v,"silent"]],["live",[v,"short",v,"silent"]],["one",["short",v,"silent"]],["were",[v,"rcontrolled","rcontrolled","silent"]],["here",[v,"rcontrolled","rcontrolled","silent"]],["where",[v,v,"rcontrolled","rcontrolled","silent"]],["there",[v,v,"rcontrolled","rcontrolled","silent"]],["above",["schwa",v,"short",v,"silent"]],["become",[v,"short",v,"short",v,"silent"]],["people",[v,"long","silent",v,v,"silent"]],["again",["schwa",v,"long","long",v]],["said",[v,"short","short",v]],["says",[v,"short","short",v]]]),fn=new Map(me.map(e=>[e.word.toLowerCase(),e])),ut=Object.freeze({sv:"short",lv:"long",rc:"rcontrolled",dp:"diphthong",se:"silent",c:"consonant",bl:"blend",d:"digraph",soft_c:"consonant",soft_g:"consonant",p:"affix",sf:"affix"});function yn(e){return ut[e]??"consonant"}function pt(e,t,s){const n=String(e).toLowerCase().replace(/[^a-z]/g,""),o=lt(n),a=ct(n),r=dt.get(n),l=[];let d=0;for(let c=0;c<t.length;c++){const m=t[c]||"",p=m.length||1;let g=yn(s[c]);Re.has(g)&&(g=(r==null?void 0:r[d])??Q(n,m,d,g,o,a)),l.push(g),d+=p}return l}const vn="aeiou",wn="bcdfghjklmnpqrstvwxyz",Ue=e=>vn.includes(e),Sn=e=>wn.includes(e),ht=Object.freeze({igh:"long",ar:"rcontrolled",or:"rcontrolled",er:"rcontrolled",ir:"rcontrolled",ur:"rcontrolled",ai:"long",ay:"long",ee:"long",ea:"long",ie:"long",oa:"long",oe:"long",ue:"long",ew:"long",oo:"long",ey:"long",oi:"diphthong",oy:"diphthong",ou:"diphthong",au:"diphthong",aw:"diphthong",ow:"diphthong"}),kn=Object.keys(ht).sort((e,t)=>t.length-e.length);function En(e,t,s){const n=[],o=e.length;let a=0;for(;a<o;){if(a===o-3&&Ue(e[a])&&Sn(e[a+1])&&e[a+2]==="e"){n.push({len:1,sound:Q(e,e[a],a,"long",t,s)}),n.push({len:1,sound:null}),n.push({len:1,sound:"silent"});break}let r=!1;for(const l of kn)if(e.startsWith(l,a)){n.push({len:l.length,sound:Q(e,l,a,ht[l],t,s)}),a+=l.length,r=!0;break}if(!r){if(Ue(e[a])||e[a]==="y"&&a>0){const l=a===o-1?"long":"short";n.push({len:1,sound:Q(e,e[a],a,l,t,s)}),a+=1;continue}n.push({len:1,sound:null}),a+=1}}return n}function $n(e,t,s,n){const o=[];let a=0;for(let r=0;r<e.graphemes.length;r++){const l=e.graphemes[r],d=l.length;if(d===2&&l[1]==="e"&&fe.includes(l[0])&&a+2===t.length&&(n!=null&&n.has(a+1))){o.push({len:1,sound:null}),o.push({len:1,sound:"silent"}),a+=2;continue}let c=ut[e.types[r]]??null;!Re.has(c)&&c!=="silent"&&(c=null),c=Q(t,l,a,c,s,n),o.push({len:d,sound:c}),a+=d}return o}function Ln(e){var r;const t=e.toLowerCase().replace(/[^a-z]/g,"");if(!t||jt.has(t))return null;const s=dt.get(t);if(s){const l=[];for(const d of s){const c=l[l.length-1];c&&c.sound===d?c.len+=1:l.push({len:1,sound:d})}return l}const n=lt(t),o=ct(t),a=fn.get(t);return(r=a==null?void 0:a.graphemes)!=null&&r.length?$n(a,t,n,o):En(t,n,o)}function xn(e){return e&&e.replace(/[A-Za-z]+/g,t=>{const s=Ln(t);if(!s)return t;let n="",o=0;for(const{len:a,sound:r}of s){const l=t.slice(o,o+a);o+=a,n+=r?`<span class="vs vs--${r}">${l}</span>`:l}return o<t.length&&(n+=t.slice(o)),n})}const qn="giri_friends_unlocked";function gt(){return Ut(qn)}const In=Object.freeze({"core-a-14":"Wet Boots","core-a-16":"Fast Feet","core-b-04":"Sun Day","core-a-06":"Shovel","core-a-04":"Pillow"});function _n(e){return typeof e!="string"||!e.trim()?"":e.replace(/^Giri's\s+/i,"").replace(/^Giri\s+and\s+the\s+/i,"").replace(/^Giri\s+and\s+/i,"").replace(/^Giri\s+/i,"").trim()||e}function Tn(e){if(!e||!e.id)return null;const t=In[e.id]||_n(e.title||"")||"Friend";return{id:e.id,storyId:e.id,name:t,emoji:e.emoji||"✨",band:e.band||"A",phase:e.phase||"",storyTitle:e.title||""}}function mt(){try{const e=localStorage.getItem(gt()),t=e?JSON.parse(e):[];return new Set(Array.isArray(t)?t:[])}catch{return new Set}}function Bn(e){try{localStorage.setItem(gt(),JSON.stringify(Array.from(e)))}catch{}}function An(e){if(!e||typeof e!="string")return!1;const t=mt();return t.has(e)?!1:(t.add(e),Bn(t),!0)}function Rn(e){const t=mt();if(!Array.isArray(e))return[];const s=[];for(const n of e){const o=Tn(n);o&&s.push({...o,unlocked:t.has(n.id)})}return s}function bt(e){const t=Rn(e);return{unlocked:t.filter(n=>n.unlocked).length,total:t.length,roster:t}}const ft="giri_fluency_history",De=5,H=new Map,Cn=10;function Mn(e,t){for(H.set(e,t);H.size>Cn;){const s=H.keys().next().value;H.delete(s)}}let G=null,q=null,xe=[],F=null,X=null,ye="idle",I=null;async function yt({storyId:e,lineIdx:t,onStateChange:s}={}){if(ye==="recording")return!1;X=s??null,xe=[];try{G=await navigator.mediaDevices.getUserMedia({audio:!0})}catch{return B("error"),!1}const n=Wn();try{q=new MediaRecorder(G,n?{mimeType:n}:{})}catch{q=new MediaRecorder(G)}return q.ondataavailable=o=>{o.data.size>0&&xe.push(o.data)},q.onstop=()=>{const o=new Blob(xe,{type:q.mimeType||"audio/webm"}),a=`rec_${e}_${t??"full"}_${Date.now()}`;F=a,Mn(a,o),Te(),B("recorded")},q.onerror=()=>{Te(),B("error")},q.start(),B("recording"),!0}function pe(){q&&q.state==="recording"?q.stop():Te()}function vt(e){const t=F,s=t?H.get(t):null;return s?new Promise(n=>{ve();const o=URL.createObjectURL(s);I=new Audio(o),B("playing"),I.onended=()=>{URL.revokeObjectURL(o),I=null,B("recorded"),n()},I.onerror=()=>{URL.revokeObjectURL(o),I=null,B("recorded"),n()},I.play().catch(()=>{URL.revokeObjectURL(o),I=null,B("recorded"),n()})}):Promise.resolve()}function ve(){I&&(I.pause(),I=null)}function _e(e){const t=F;t&&H.delete(t),t===F&&(F=null),ve(),B("idle")}function wt(){return ye}function St(){pe(),ve(),H.clear(),F=null,ye="idle",X=null}function Hn(e){const t=Et(),s=t[e.storyId]??[];s.push({date:new Date().toISOString(),wcpm:e.wcpm,durationSec:Math.round(e.durationSec),wordCount:e.wordCount,hasRecording:!!e.recordingId}),s.length>De&&s.splice(0,s.length-De),t[e.storyId]=s,On(t)}function kt(e){return Et()[e]??[]}function Nn(e){const t=kt(e);return t.length===0?null:Math.max(...t.map(s=>s.wcpm))}function B(e){ye=e,X==null||X(e)}function Te(){G&&(G.getTracks().forEach(e=>e.stop()),G=null)}function Wn(){const e=["audio/webm;codecs=opus","audio/webm","audio/ogg;codecs=opus","audio/mp4"];for(const t of e)try{if(MediaRecorder.isTypeSupported(t))return t}catch{}return""}function Et(){try{return JSON.parse(localStorage.getItem(ft)??"{}")}catch{return{}}}let ze=!1;function On(e){try{localStorage.setItem(ft,JSON.stringify(e))}catch{if(ze)return;ze=!0;const t=document.getElementById("toast-container");if(!t)return;const s=document.createElement("div");s.className="toast toast--warning",s.setAttribute("role","alert"),s.textContent="Device storage full — reading history may not be saved.",t.appendChild(s),setTimeout(()=>s.remove(),8e3)}}const $t="/phonicsquest/";function Gn(e){const t=e.toLowerCase().replace(/[^a-z]/g,"");return me.find(s=>s.word===t)??null}function Lt(e){return e.split(/(\s+|["""'',.!?;:()-]+)/).filter(s=>s.length>0).map(s=>({text:s,type:/^\s+$/.test(s)?"space":/^[^a-zA-Z0-9]+$/.test(s)?"punct":"word"}))}let y=null,_="A",Ye=!1,W="band",V="aloud",ae=!1,O=null,he=[],K=null,L="word",oe=!1,U=-1,ce=[],Z=0,we=[],Se=0,re=0;const xt="giri_stories_read";function J(){try{return JSON.parse(localStorage.getItem(xt)??"[]")}catch{return[]}}function ke(e){const t=J();t.includes(e)||(t.push(e),localStorage.setItem(xt,JSON.stringify(t))),An(e)}let ue=null,ee=null,ge=!1;const Ce="giri_show_graphemes",qt="giri_show_ruler",Me="giri_follow_mode",It="giri_meet_words",Ve="giri_comp_log";let x=He(Ce,!0),C=He(qt,!1);L=He(Me,"word");function He(e,t){try{const s=localStorage.getItem(e);return s===null?t:JSON.parse(s)}catch{return t}}function te(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}const _t=new Set;function Tt(){return new Date().toISOString().slice(0,10)}function Bt(){try{const e=localStorage.getItem(It);return e?JSON.parse(e):{}}catch{return{}}}function Fn(e){try{localStorage.setItem(It,JSON.stringify(e))}catch{}}function jn(e){return _t.has(e)?!0:Bt()[e]===Tt()}function Ke(e){_t.add(e);const t=Bt();t[e]=Tt();const s=Date.now()-30*24*60*60*1e3;for(const[n,o]of Object.entries(t))(!o||Date.parse(o)<s)&&delete t[n];Fn(t)}const Je=new Set,Pn=100;function Qe(e){try{const t=localStorage.getItem(Ve),s=t?JSON.parse(t):[];for(s.push({ts:Date.now(),...e});s.length>Pn;)s.shift();localStorage.setItem(Ve,JSON.stringify(s))}catch{}}function gs(e,t){y=e}function ms(){$(),ie()}function bs(){$(),Ae(),St(),Ne(),Ee()}function Ee(){O==null||O.remove(),O=null}function ie(){var s,n,o;Ee();const e=`
    <div class="sb-category-tabs" role="tablist" aria-label="Story categories">
      ...
      <button class="sb-cat-tab sb-cat-tab--friends" id="btn-open-friends" type="button" aria-label="Open Giri's Friends">🐾 Friends ${rs()}</button>
    </div>
  `;let t;if(W==="band"){if(!Ye){Ye=!0;try{const i={};for(const u of M)(i[s=u.band]??(i[s]=[])).push(u);_=an(J(),i)||_}catch{}}const a=T.find(i=>i.band===_)??T[0],r=M.filter(i=>i.band===_&&i.category!=="chapter"&&i.category!=="nonfiction-sg"),l=J(),d=r.filter(i=>l.includes(i.id)).length,c=rt(),m=T.map(i=>{var u,h,b;return`
      <button
  ...
  `}function At(e){const t=M.find(s=>s.id===e);t&&($(),Un(t))}function Un(e){var s,n,o;const t=T.find(a=>a.band===e.band)??T[(e.level??1)-1];y.innerHTML=`
  ...
  `,(s=document.getElementById("btn-reader-back"))==null||s.addEventListener("click",()=>{$(),ie()}),(n=document.getElementById("btn-mode-aloud"))==null||n.addEventListener("click",()=>{V="aloud",$(),Xe("aloud"),ne(e)}),(o=document.getElementById("btn-mode-decode"))==null||o.addEventListener("click",()=>{V="decode",$(),Xe("decode"),ne(e)}),ne(e)}function ne(e){jn(e.id)?V==="aloud"?le(e):Nt(e):Dn(e)}function Xe(e){document.querySelectorAll(".smode-btn").forEach(t=>{t.classList.toggle("active",t.dataset.mode===e)})}function Dn(e){var i,u;const t=document.getElementById("story-dynamic");if(!t)return;he=e.vocab??[];const s=tt(e),n=e.lines.map(h=>h.text??"").join(" ").toLowerCase(),o=he.filter(h=>{const b=h.word.toLowerCase().split(/\s+/)[0];return n.includes(b)});if(!s.length&&!o.length){Ke(e.id),ne(e);return}const a=s.length+o.length,l=Math.min(3,a),d=new Set,c=s.map(h=>`
  ...
  `;function p(h){const b=h.dataset.tapId;if(d.has(b))return;d.add(b),h.setAttribute("data-tapped","true");const f=document.getElementById("gate-progress");if(f&&(f.textContent=d.size>=l?`✓ Warmed up (${d.size} tapped) — keep going or start the story`:`${d.size} of ${l} tapped`),d.size>=l){const S=document.getElementById("gate-continue");S&&(S.disabled=!1)}}t.querySelectorAll(".hfw-chip, .vocab-chip").forEach(h=>{h.addEventListener("click",async()=>{Be(h);try{await P.speakWord(h.dataset.word)}catch{}p(h)})});const g=()=>{Ke(e.id),ne(e)};(i=document.getElementById("gate-skip"))==null||i.addEventListener("click",g),(u=document.getElementById("gate-continue"))==null||u.addEventListener("click",g)}function zn(e){return e.lines.filter(t=>t.type!=="label"&&t.type!=="chapter"&&t.text).reduce((t,s)=>t+s.text.trim().split(/\s+/).length,0)}function le(e){var p,g,i,u,h,b,f,S,E;const t=document.getElementById("story-dynamic");if(!t)return;Ee();const s=L==="word",n=e.lines.map((w,k)=>Qn(w,k,s,e)).join(""),o=!!((p=e.comprehension)!=null&&p.length),r=!!((g=e.talkAboutIt)!=null&&g.length)?`
  ...
  `:"",l=kt(e.id),d=Nn(e.id),c=l.length>0?`
    <div class="fluency-history" id="fluency-history">
      ...
      <div class="fluency-history-list">
        ${l.slice().reverse().map(w=>{const k=new Date(w.date);return`<span class="fluency-history-item">${`${k.getDate()}/${k.getMonth()+1}`}: <strong>${w.wcpm}</strong> wpm</span>`}).join("")}
      </div>
    </div>
  `:"";t.innerHTML=`
    <!-- Story text column -->
  ...
  `,t.querySelectorAll(".follow-mode-btn[data-follow]").forEach(w=>{w.addEventListener("click",()=>{L=w.dataset.follow,te(Me,L),le(e)})}),t.querySelectorAll(".wf-word").forEach(w=>{w.setAttribute("role","button"),w.setAttribute("tabindex","0");const k=N=>{const Ge=(w.textContent||"").trim();Ge&&(N.preventDefault(),ns(Ge))};w.addEventListener("click",k),w.addEventListener("keydown",N=>{(N.key==="Enter"||N.key===" ")&&k(N)})}),(i=document.getElementById("btn-toggle-graphemes"))==null||i.addEventListener("click",()=>{x=!x,te(Ce,x),le(e)}),(u=document.getElementById("btn-toggle-ruler"))==null||u.addEventListener("click",()=>{C=!C,te(qt,C);const w=document.getElementById("btn-toggle-ruler"),k=document.getElementById("story-body");w==null||w.setAttribute("aria-pressed",String(C)),k==null||k.classList.toggle("story-ruler-on",C)}),(h=document.getElementById("btn-story-play"))==null||h.addEventListener("click",()=>Ot(e)),(b=document.getElementById("btn-story-stop"))==null||b.addEventListener("click",()=>$());const m=zn(e);(f=document.getElementById("btn-fluency-start"))==null||f.addEventListener("click",()=>ds()),(S=document.getElementById("btn-fluency-done"))==null||S.addEventListener("click",()=>Ae(m,e)),ls(e),Ne(),Yn(e),cs(e),(E=document.getElementById("btn-launch-quest"))==null||E.addEventListener("click",()=>{$(),Ae(),St(),ke(e.id),zt(y,e,()=>{ie()})})}function Yn(e){var t,s,n,o;(t=document.getElementById("btn-rtg-start"))==null||t.addEventListener("click",()=>Vn(e)),(s=document.getElementById("btn-rtg-listen"))==null||s.addEventListener("click",()=>Kn(e)),(n=document.getElementById("btn-rtg-next"))==null||n.addEventListener("click",()=>Mt(e)),(o=document.getElementById("btn-rtg-exit"))==null||o.addEventListener("click",()=>{Ne(),le(e)})}function A(e){const t=document.getElementById("rtg-status");t&&(t.innerHTML=e)}function Rt(){const e=ce[U];return document.querySelector(`#story-body .sline[data-line="${e}"]`)||null}function Vn(e){var s,n,o;if(L!=="word"){L="word",te(Me,L),le(e);const a=document.getElementById("practice-drawer");a&&(a.open=!0);const r=document.getElementById("rtg-bar");r&&(r.open=!0)}$();const t=Array.from(document.querySelectorAll("#story-body .sline")).filter(a=>a.querySelector(".wf-word")).map(a=>Number(a.dataset.line));t.length!==0&&(oe=!0,ce=t,U=0,Z=0,we=[],Se=0,re=0,(s=document.getElementById("btn-rtg-start"))==null||s.setAttribute("hidden",""),(n=document.getElementById("btn-rtg-listen"))==null||n.removeAttribute("hidden"),(o=document.getElementById("btn-rtg-exit"))==null||o.removeAttribute("hidden"),Ct(),A("Read the glowing line out loud, then tap <strong>🎙 Read this line</strong>."))}function Ct(){document.querySelectorAll("#story-body .sline--rtg-current").forEach(t=>t.classList.remove("sline--rtg-current"));const e=Rt();e&&(e.classList.add("sline--rtg-current"),e.scrollIntoView({block:"center",behavior:D()}))}async function Kn(e){var m;const t=Rt(),s=document.getElementById("btn-rtg-listen");if(!t||!s||s.disabled)return;const n=Array.from(t.querySelectorAll(".wf-word")),o=n.map(p=>(p.textContent||"").trim()).filter(Boolean).join(" ");if(!o){Mt(e);return}s.disabled=!0,s.textContent="🦉 Giri is listening…",A("Go ahead — read the glowing line now.");const a=await nn(o);if(s.disabled=!1,s.textContent="🎙 Read this line",!oe)return;if(!a){Z++,Z>=2?A("Giri is having trouble hearing today. You can keep trying, or use <strong>🎙 Record Reading</strong> below and listen back together."):A("Giri couldn't hear that — move a little closer to the microphone and try again!");return}Z=0;const r=[];a.words.forEach((p,g)=>{const i=n[g];if(i)if(i.classList.remove("rtg-word--match","rtg-word--check"),p.status==="miss"){i.classList.add("rtg-word--check");const u=p.word.replace(/[^a-z]/g,"");u.length>2&&(r.push(u),ot(u))}else i.classList.add("rtg-word--match")});const l=a.words.filter(p=>p.status!=="miss").length;Se+=l,re+=a.words.length,we.push(...r);const d=U>=ce.length-1;r.length>0?A(`Nice reading! Let's check the orange ${r.length===1?"word":"words"} together — tap ${r.length===1?"it":"each one"} to hear it. Then ${d?"finish up":"go on"}!`):A("⭐ Great — Giri heard every word!"),(m=document.getElementById("btn-rtg-listen"))==null||m.setAttribute("hidden","");const c=document.getElementById("btn-rtg-next");c&&(c.textContent=d?"🌟 Finish":"Next line →",c.removeAttribute("hidden"),c.focus())}function Mt(e){var t,s;if(U>=ce.length-1){Jn(e);return}U++,(t=document.getElementById("btn-rtg-next"))==null||t.setAttribute("hidden",""),(s=document.getElementById("btn-rtg-listen"))==null||s.removeAttribute("hidden"),Ct(),A("Read the glowing line out loud, then tap <strong>🎙 Read this line</strong>.")}function Jn(e){var l,d;const t=re>0?Math.round(Se/re*100):0,s=[...new Set(we)],n={...j.get("readAloudStats")||{}},o=n[e.id]||{attempts:0};n[e.id]={attempts:(o.attempts||0)+1,lastMatchPct:t,lastMissedWords:s.slice(0,12),updatedAt:new Date().toISOString()},j.set("readAloudStats",n),document.querySelectorAll("#story-body .sline--rtg-current").forEach(c=>c.classList.remove("sline--rtg-current")),(l=document.getElementById("btn-rtg-next"))==null||l.setAttribute("hidden",""),(d=document.getElementById("btn-rtg-exit"))==null||d.setAttribute("hidden","");const a=document.getElementById("btn-rtg-start");a&&(a.removeAttribute("hidden"),a.textContent="Read it again");const r=s.length?` Words to practise: <strong>${s.slice(0,6).join(", ")}</strong> — they've been added to your review pile.`:" Every word was loud and clear!";A(`🌟 You read the whole story to Giri — ${t}% heard clearly.${r}`),ke(e.id),oe=!1}function Ne(){oe&&sn(),oe=!1,U=-1,ce=[],Z=0,we=[],Se=0,re=0}function We(e){return!x||!e?e:xn(e)}function Ht(){return`<div class="sound-legend" aria-label="What the vowel colours mean">${on.map(t=>`
    <span class="sl-item">
      <span class="sl-chip vs--${t.key}">${t.mark||"•"}</span>${t.label}
    </span>`).join("")}</div>`}function Qn(e,t,s=!1,n=null){const o=e.text??"",a=n?We(o,n.targetGraphemes,n.band):o,r=s?Xn(o,n):a;switch(e.type){case"chapter":return`<div class="sline sline--chapter"   data-line="${t}">📚 ${r}</div>`;case"label":return`<div class="sline sline--label"     data-line="${t}">${r}</div>`;case"beat":return`<p class="sline sline--beat"        data-line="${t}">${r}</p>`;case"intro":return`<p class="sline sline--intro"       data-line="${t}">${r}</p>`;case"end":return`<p class="sline sline--end"         data-line="${t}">${r}</p>`;case"text":return`<p class="sline sline--text"        data-line="${t}">${r}</p>`;case"paragraph":return`<p class="sline sline--paragraph"   data-line="${t}">${r}</p>`;default:return`<p class="sline"                    data-line="${t}">${r}</p>`}}function Xn(e,t=null){if(!e)return"";const s=Lt(e);let n=0;return s.map(o=>{if(o.type==="word"){const a=t?We(o.text,t.targetGraphemes,t.band):o.text;return`<span class="wf-word" data-word-idx="${n++}">${a}</span>`}return o.text}).join("")}function Nt(e){var c,m,p,g;const t=document.getElementById("story-dynamic");if(!t)return;Ee(),he=e.vocab??[];const n=tt(e).map(i=>`
  ...
  `).join(""),l=e.lines.map((i,u)=>{if(i.type==="label")return`<div class="sline sline--label" data-line="${u}">${i.text}</div>`;const b=Lt(i.text).map(S=>{if(S.type==="word"){const E=S.text.toLowerCase().replace(/[^a-z]/g,""),w=nt(E),k=We(S.text,e.targetGraphemes,e.band);return`<button class="decode-word${w?" decode-hfw":""}"
                         data-word="${S.text}"
                         aria-label="${w?"Sight word: ":"Decode: "}${S.text}"
                >${k}</button>`}return`<span class="decode-punct">${S.text}</span>`}).join("");return`<p class="sline ${{intro:"sline--intro",beat:"sline--beat",end:"sline--end",text:"sline--text",paragraph:"sline--paragraph"}[i.type]??""} decode-line" data-line="${u}">${b}</p>`}).join("");t.innerHTML=`
    <!-- Story text column -->
    <div class="story-content-wrap">
  ...
  `,(c=document.getElementById("btn-toggle-graphemes-decode"))==null||c.addEventListener("click",()=>{x=!x,te(Ce,x),Nt(e)}),(m=document.getElementById("btn-hfw-toggle"))==null||m.addEventListener("click",()=>{const i=document.getElementById("hfw-chip-list"),u=document.getElementById("btn-hfw-toggle"),h=u.getAttribute("aria-expanded")==="true";i.hidden=h,u.setAttribute("aria-expanded",String(!h)),u.textContent=h?"Show ▼":"Hide ▲"}),(p=document.getElementById("btn-vocab-toggle"))==null||p.addEventListener("click",()=>{const i=document.getElementById("vocab-chip-list"),u=document.getElementById("btn-vocab-toggle"),h=u.getAttribute("aria-expanded")==="true";i.hidden=h,u.setAttribute("aria-expanded",String(!h)),u.textContent=h?"Show ▼":"Hide ▲"}),t.querySelectorAll(".hfw-chip").forEach(i=>{i.addEventListener("click",()=>{var b,f;const u=i.dataset.word;Be(i);const h=new SpeechSynthesisUtterance(u);h.rate=.85,R(h),(b=window.speechSynthesis)==null||b.cancel(),(f=window.speechSynthesis)==null||f.speak(h)})}),t.querySelectorAll(".vocab-chip").forEach(i=>{i.addEventListener("click",()=>{var b,f;const u=i.dataset.word;Be(i),i.classList.toggle("vocab-chip--expanded");const h=new SpeechSynthesisUtterance(u);h.rate=.85,R(h),(b=window.speechSynthesis)==null||b.cancel(),(f=window.speechSynthesis)==null||f.speak(h)})}),(g=document.getElementById("btn-mark-read"))==null||g.addEventListener("click",i=>{ke(e.id);const u=i.currentTarget;u.textContent="✓ Read!",u.disabled=!0,u.classList.add("btn--success"),Ft(e)});const d=document.getElementById("decode-panel");d&&(d.remove(),document.body.appendChild(d)),O=d,t.querySelectorAll(".decode-word").forEach(i=>{i.addEventListener("click",()=>Zn(i))})}async function Zn(e){var r,l,d,c;document.querySelectorAll(".decode-word.decoding").forEach(m=>m.classList.remove("decoding")),e.classList.add("decoding");const t=e.dataset.word,s=t.toLowerCase().replace(/[^a-z]/g,""),n=Gn(t),o=!n&&nt(s),a=O;if(a)if(a.removeAttribute("hidden"),o){Ie({type:"hfw",word:s});const m=new SpeechSynthesisUtterance(s);m.rate=.85,R(m),(r=window.speechSynthesis)==null||r.cancel(),(l=window.speechSynthesis)==null||l.speak(m)}else if(n)Ie({type:"decode",word:n.word,wordObj:n}),await Wt(n);else{Ie({type:"tts",word:s});const m=new SpeechSynthesisUtterance(s);m.rate=.85,R(m),(d=window.speechSynthesis)==null||d.cancel(),(c=window.speechSynthesis)==null||c.speak(m)}}function Ie({type:e,word:t,wordObj:s}){var r,l,d;const n=document.getElementById("decode-panel-inner");if(!n)return;if(e==="hfw"){n.innerHTML=`
      <div class="dp-hfw">
        <span class="dp-sight-badge">⭐ Sight Word</span>
        <span class="dp-word">${t}</span>
        <button class="dp-hear-btn" id="dp-hear">🔊 Hear again</button>
      </div>
    `,(r=document.getElementById("dp-hear"))==null||r.addEventListener("click",()=>{var m,p;const c=new SpeechSynthesisUtterance(t);c.rate=.85,R(c),(m=window.speechSynthesis)==null||m.cancel(),(p=window.speechSynthesis)==null||p.speak(c)});return}if(e==="tts"){n.innerHTML=`
      <div class="dp-tts">
        <span class="dp-word">${t}</span>
        <button class="dp-hear-btn" id="dp-hear">🔊 Hear again</button>
      </div>
    `,(l=document.getElementById("dp-hear"))==null||l.addEventListener("click",()=>{var m,p;const c=new SpeechSynthesisUtterance(t);c.rate=.85,R(c),(m=window.speechSynthesis)==null||m.cancel(),(p=window.speechSynthesis)==null||p.speak(c)});return}const o=pt(s.word,s.graphemes,s.types),a=s.graphemes.map((c,m)=>{const p=se[o[m]]??se.consonant;return`<span class="dp-tile" data-idx="${m}" style="--tile-color:${p.color}" title="${p.label}">${c}</span>`}).join("");n.innerHTML=`
    <div class="dp-decode">
      <div class="dp-tiles" id="dp-tiles">${a}</div>
      <span class="dp-word" id="dp-word-label">${s.word}</span>
      <button class="dp-hear-btn" id="dp-hear">🔊 Hear again</button>
    </div>
  `,(d=document.getElementById("dp-hear"))==null||d.addEventListener("click",async()=>{await Wt(s)})}async function Wt(e){const t=document.querySelectorAll(".dp-tile");for(let n=0;n<e.graphemes.length;n++){t.forEach((a,r)=>a.classList.toggle("dp-tile--active",r===n));const o=n>0?e.graphemes[n-1]:null;await P.speakPhoneme(e.graphemes[n],e.types[n],{word:e.word,prevGrapheme:o}),await et(200)}t.forEach(n=>n.classList.remove("dp-tile--active")),await et(250);const s=document.getElementById("dp-word-label");s&&s.classList.add("dp-word--blend");try{await P.speakWord(e.word)}finally{s&&s.classList.remove("dp-word--blend")}}function Be(e){e.classList.add("hfw-chip--flash"),setTimeout(()=>e.classList.remove("hfw-chip--flash"),500)}function es(e){const t=[],s=e.lines;let n=0;for(;n<s.length;){const o=s[n];if(o.type==="label"){const a=s[n+1];if(a&&a.type==="beat"){t.push({text:`${o.text} ${a.text}`,highlightIdx:n+1}),n+=2;continue}n++;continue}t.push({text:o.text,highlightIdx:n}),n++}return t}function Ot(e){if(!window.speechSynthesis)return;$(),K=e,Oe(!0),ae=!0;const t=es(e);Gt(t,0)}function Gt(e,t){if(!ae||t>=e.length){Ze();return}const s=e[t];os(s.highlightIdx);const n=new SpeechSynthesisUtterance(s.text);n.rate=.82,R(n);const o=s.text.startsWith("Puff")?600:380;L==="word"&&ts(n,s.highlightIdx),n.onend=()=>{$e(),ae&&setTimeout(()=>Gt(e,t+1),o)},n.onerror=()=>Ze(),window.speechSynthesis.speak(n)}function ts(e,t){const s=y==null?void 0:y.querySelector(`[data-line="${t}"]`);if(!s)return;const n=s.querySelectorAll(".wf-word");if(n.length===0)return;const o=e.text||"";let a=!1,r=-1,l=[],d=!1;function c(i){if(i<0||i>=n.length||i===r)return;r=i,n.forEach(h=>h.classList.remove("wf-word--active"));const u=n[i];u.classList.add("wf-word--active"),as(u)}function m(){for(const i of l)clearTimeout(i);l=[]}function p(){var b;if(d)return;d=!0;const i=typeof e.rate=="number"&&e.rate>0?e.rate:.82,u=Array.from(n,f=>(f.textContent||"").trim());let h=0;for(let f=0;f<n.length;f++){const S=f,E=((b=u[f])==null?void 0:b.length)||3,w=Math.max(160,Math.round((90+E*60)/i)),k=setTimeout(()=>{a||c(S)},h);l.push(k),h+=w}}e.addEventListener("boundary",i=>{i.name&&i.name!=="word"||(a=!0,m(),c(Yt(o,i.charIndex??-1)))}),e.addEventListener("end",()=>{m()}),e.addEventListener("start",()=>{if(a)return;const i=setTimeout(()=>{a||(c(0),p())},180);l.push(i)});const g=setTimeout(()=>{a||d||(c(0),p())},800);l.push(g)}function ns(e){var o;const t=document.getElementById("word-detective-content");if(!t)return;$();const s=Jt(e);t.innerHTML=ss(s),Y.open("modal-word-detective");try{P.speakWord(s.text)}catch{}(o=t.querySelector('[data-action="hear"]'))==null||o.addEventListener("click",()=>{try{P.speakWord(s.text)}catch{}});const n=t.querySelector('[data-action="add-review"]');n==null||n.addEventListener("click",()=>{if(!s.word)return;ot(s.word.id)&&(n.disabled=!0,n.textContent="✓ In your Review Lane")})}function ss(e){const t=a=>String(a??"").replace(/[<>&]/g,r=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[r]),s=pt(e.text,e.graphemes,e.types),n=e.graphemes.map((a,r)=>{const l=se[s[r]]??se.consonant;return`<span class="wd-tile vs--${s[r]}" style="--tile-color:${l.color}" aria-label="${t(a)}, ${t(l.label)}">${t(a)}</span>`}).join(""),o=e.foundInBank?`<button class="btn btn--primary" type="button" data-action="add-review" ${e.alreadyTracked?"disabled":""}>
  ...
  `,t.appendChild(n),n.scrollIntoView({behavior:D(),block:"nearest"});const o=n.querySelector("#comp-feedback");n.querySelectorAll(".comp-choice").forEach(l=>{l.addEventListener("click",()=>{const d=l.dataset.resp;if(Qe({storyId:e.id,question:s,response:d}),n.querySelectorAll(".comp-choice").forEach(c=>c.disabled=!0),l.classList.add("correct"),d==="confident")o.textContent="👍 Great! You understood the story.";else if(d==="reread")o.textContent="📖 Good plan — listening again helps build fluency.",setTimeout(()=>Ot(e),300);else{o.textContent="💡 Look at the end of the story for clues.";const c=y==null?void 0:y.querySelector(".sline.sline--end, .sline:last-of-type");c==null||c.scrollIntoView({behavior:D(),block:"center"})}o.hidden=!1})}),(r=n.querySelector("#comp-skip"))==null||r.addEventListener("click",()=>{Qe({storyId:e.id,question:s,response:"skipped"}),n.remove()})}function rs(){try{const e=bt(M);return`<span class="sb-friends-count">${e.unlocked}/${e.total}</span>`}catch{return""}}function is(){var r,l;(r=document.getElementById("modal-story-friends"))==null||r.remove();const e=bt(M),t=document.createElement("div");t.id="modal-story-friends",t.className="modal-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Giri's Friends gallery");const s=d=>String(d??"").replace(/[<>&]/g,c=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[c]),n=new Map;for(const d of e.roster)n.has(d.band)||n.set(d.band,[]),n.get(d.band).push(d);const o=Array.from(n.entries()).sort((d,c)=>String(d[0]).localeCompare(String(c[0]))).map(([d,c])=>{const m=c.filter(g=>g.unlocked).length,p=c.map(g=>`
    ...
    `;const d=document.getElementById("story-quest-cta");d&&(d.hidden=!1)}}export{We as _highlightGraphemes,jn as _isMeetWordsCompletedToday,Qe as _logComprehensionAttempt,Ke as _setMeetWordsCompleted,bs as cleanupStoryMode,gs as initStoryMode,ms as showBrowser};
