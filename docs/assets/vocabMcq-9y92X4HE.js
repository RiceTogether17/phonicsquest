import{m as Y,a as M,s as E,q as V,K as j,x as d,I as F,T as z}from"./index-DeDXNYVD.js";import{V as C,a as I,b as X}from"./vocabMcq-ByAyNdFg.js";import{r as J,M as Z,f as ee,b as te,a as se,c as le}from"./mcqDifficulty-C1LCCWmn.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";function B(e){const t=M[e]||{};return{rule:t.rule||`${t.label||e} vocabulary questions test word meaning and usage in context.`,example:t.example||"Choose the word that best fits the sentence.",tip:t.tip||"Read the whole sentence carefully and test each option to find which sounds natural."}}let a=null,T=null,m=[],v=0,A=0,x=!1,q={level:null,category:null,label:"All Skills",difficulty:"normal"},b="normal",f=0,y=0,S=[],w=!1,L={},k={},O=0;const G=3;function D(e){return`vmcq:${e}`}function ce(e){return!!(E.get("lessonsSeen")||{})[D(e)]}function ae(e){const t={...E.get("lessonsSeen")||{}};t[D(e)]||(t[D(e)]=new Date().toISOString(),E.set("lessonsSeen",t))}function ge(e,t){a=e,T=t}function ye(){a&&(a.innerHTML="")}function re(e=C){return I.flatMap(t=>e[t]||[])}function K({level:e=null,category:t=null}={},s=C){const l=e?s[e]||[]:re(s);return t?l.filter(i=>i.category===t):l}function N(e={},t=C){return K(e,t).length}function ie(e=C,t=Y){return t.map(s=>{const l={};let i=0;for(const n of I){const r=N({level:n,category:s},e);l[n]=r,i+=r}return{category:s,total:i,levels:l}})}function ne(e=C,t=I){return t.map(s=>({level:s,total:N({level:s},e)}))}function Q(e){var t;return((t=M[e])==null?void 0:t.label)||e}function oe(e){const t=e.level||null,s=e.category?Q(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function P(){if(!a)return;const e=ne(),t=ie();let s=q.level||"P1",l=q.difficulty||b||"normal";const i=()=>{var n,r;a.innerHTML=`
    ...
    <div class="mcq-game" role="region" aria-label="Vocabulary question ${v+1} of ${m.length}">
      ...
      <div class="vmcq-next-wrap" id="vmcq-next-wrap" style="display:none">
        ...
        </tr>`}).join("")}</tbody></table>`}function U(e,t){var i,n;O+=1,ae(e);const s=B(e),l=M[e]||{icon:"📖",label:e};a.innerHTML=`
    ...
    </div>`,l&&((r=a.querySelector("#vmcq-recovery"))==null||r.addEventListener("click",()=>ue())),(c=a.querySelector("#vmcq-replay"))==null||c.addEventListener("click",()=>H(q)),(o=a.querySelector("#vmcq-menu"))==null||o.addEventListener("click",()=>P())}export{ye as cleanupVocabMcq,N as countItemsForScope,re as getAllItems,ie as getCategoryCounts,K as getItemsForScope,ne as getLevelCounts,ge as initVocabMcq,P as showVocabMcqBrowser,$e as startVocabMcqLevel};
