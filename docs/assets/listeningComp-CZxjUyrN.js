import{O as A}from"./openComprehensionPassages-ptKvqu40.js";import{x as d,s as S}from"./index-dTE5fncO.js";import"./gsap-C8pce-KX.js";let i=null,r=null,k="P3",o=null,m=!1,f=0,y=[],b=null;function I(t){window.speechSynthesis.cancel(),b=new SpeechSynthesisUtterance(t),b.rate=S.get("voiceSpeed")||.9,b.lang="en-SG",window.speechSynthesis.speak(b)}function v(){window.speechSynthesis.cancel(),b=null}function z(t,a){t&&(i=t,r=typeof a=="function"?a:()=>{},k="P3",o=null,m=!1,f=0,y=[],b=null)}function x(){v(),o=null,m=!1,f=0,y=[],$()}function R(){v(),i&&(i.innerHTML=""),i=null,r=null,o=null,m=!1,b=null}const P=["P1","P2","P3","P4","P5","P6"];function M(t){return A.filter(a=>a.level===t)}function $(){var a;if(!i)return;const t=P.map(e=>`
