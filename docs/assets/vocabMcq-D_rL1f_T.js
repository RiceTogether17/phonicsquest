import{m as X,a as x,s as E,q as V,K as j,x as u,I as F,T as J}from"./index-DH_tauIV.js";import{V as C,a as H,b as Z}from"./vocabMcq-xyyqSdUy.js";import{r as ee,M as te,f as se,b as le,a as ce,c as ae}from"./mcqDifficulty-qNlOzz6M.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";function I(e){const t=x[e]||{};return{rule:t.rule||`${t.label||e} vocabulary questions test word meaning and usage in context.`,example:t.example||"Choose the word that best fits the sentence.",tip:t.tip||"Read the whole sentence carefully and test each option to find which sounds natural."}}let r=null,T=null,h=[],b=0,A=0,M=!1,f={level:null,category:null,label:"All Skills",difficulty:"normal"},m="normal",q=0,$=0,k=[],_=!1,L={},w={},O=0;const N=3;function P(e){return`vmcq:${e}`}function re(e){return!!(E.get("lessonsSeen")||{})[P(e)]}function ne(e){const t={...E.get("lessonsSeen")||{}};t[P(e)]||(t[P(e)]=new Date().toISOString(),E.set("lessonsSeen",t))}function Se(e,t){r=e,T=t}function we(){r&&(r.innerHTML="")}function oe(e=C){return H.flatMap(t=>e[t]||[])}function K({level:e=null,category:t=null}={},s=C){const l=e?s[e]||[]:oe(s);return t?l.filter(a=>a.category===t):l}function Y(e={},t=C){return K(e,t).length}function ie(e=C,t=X){return t.map(s=>{const l={};let a=0;for(const o of H){const n=Y({level:o,category:s},e);l[o]=n,a+=n}return{category:s,total:a,levels:l}})}function ue(e=C,t=H){return t.map(s=>({level:s,total:Y({level:s},e)}))}function D(e){var t;return((t=x[e])==null?void 0:t.label)||e}function de(e){const t=e.level||null,s=e.category?D(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function G(){if(!r)return;const e=ue(),t=ie();let s=f.level||"P1",l=f.difficulty||m||"normal";const a=()=>{var o,n;r.innerHTML=`
