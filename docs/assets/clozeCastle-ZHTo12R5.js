import{p as M,C as j,a as pe}from"./passages-DNXaSraU.js";import{s as v,p as fe,q as ge,G as q,x as y,K as Ae,L as be,F as Be,E as G,H as ye,I as je,M as Oe,N as Ge}from"./index-qkED234S.js";import{g as Ie,a as Ue,b as Me,c as Z,s as Je,d as Ve,e as U,f as Ze,h as Ke,p as Qe,i as Xe,j as Ye,k as et,l as Te,r as tt,m as lt,n as nt,o as Re,q as Pe,t as at,u as st,v as ct,w as ot,x as rt,y as re,z as it,A as We,B as dt,C as ut,D as he,E as $e,F as mt,G as He,H as pt,I as bt,J as Fe,K as kt}from"./masteryMap-DKy1whG5.js";import"./gsap-C8pce-KX.js";let b=null,T=null,z="P1",m="",I=0,le=[],L=[],E=[],ne=0,ae=0,ve=0,A=null,x=-1,R={},J=0,P=!1,ie=0,ke=0,C="practice",O=0,xe=0,V=[],W=0,N=0,ze=!1,Y=!1,de=0,te=0,F={};function qt(e,l){b=e,T=l}function At(){Ee()}function we(){b&&(b.innerHTML=""),L=[],E=[],A&&(document.removeEventListener("keydown",A),A=null)}function Ee(){if(!b)return;const e=v.get("ccqCompleted")||{},l=Object.keys(M);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const a=Object.keys(M[n]),s=a.reduce((d,p)=>d+M[n][p].length,0),i=Ie({level:n,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:e}),k=i>=s,u=pe[n];t+=`
