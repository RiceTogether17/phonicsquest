import{B as U,c as w,s as L,ak as X,z as C,$ as H,M as o,a6 as F,al as Z}from"./index-BRmpb3iy.js";import{g as J,r as ee,i as P,a as te,M as se,f as ce,b as le,c as ae,d as re}from"./mcqBrowserShell-Bwe2Jbwc.js";import{V as _,a as I,b as ne,g as oe}from"./vocabMcq-_-1p6cgL.js";import{a as ie,b as ue}from"./mcqFeedback-su1eahmi.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";import"./mcqOptionExplanations-Atx8bQId.js";import"./practiceExpansion-D0CCBel5.js";function A(e){const t=w[e]||{};return{rule:t.rule||`${t.label||e} vocabulary questions test word meaning and usage in context.`,example:t.example||"Choose the word that best fits the sentence.",tip:t.tip||"Read the whole sentence carefully and test each option to find which sounds natural."}}let a=null,R=null,m=[],g=0,E=0,v={level:null,category:null,label:"All Skills",difficulty:"normal"},h="normal",f=0,y=0,$=[],k=!1,S={},B=0;const W=3;function G(e){return`vmcq:${e}`}const de=14,pe=.6;function me(e){const t=(L.get("lessonsSeen")||{})[G(e)];return t?(Date.now()-Date.parse(t))/864e5<de?!0:C.getSkillScore("vocabMcq",e)>=pe:!1}function qe(e){const t={...L.get("lessonsSeen")||{}};t[G(e)]=new Date().toISOString(),L.set("lessonsSeen",t)}function Te(e,t){a=e,R=t}function Ie(){a&&(a.innerHTML="")}function he(e=_){return I.flatMap(t=>e[t]||[])}function N({level:e=null,category:t=null}={},s=_){const l=e?s[e]||[]:he(s);return t?l.filter(r=>r.category===t):l}function Y(e={},t=_){return N(e,t).length}function ve(e=_,t=U){return t.map(s=>{const l={};let r=0;for(const n of I){const u=Y({level:n,category:s},e);l[n]=u,r+=u}return{category:s,total:r,levels:l}})}function fe(e=_,t=I){return t.map(s=>({level:s,total:Y({level:s},e)}))}function T(e){var t;return((t=w[e])==null?void 0:t.label)||e}function be(e){const t=e.level||null,s=e.category?T(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function Q(){if(!a)return;const e=fe(),t=ve();let s=v.level||J(),l=v.difficulty||h||"normal";const r=()=>{var n,u,p;a.innerHTML=`
  ...
  `}function ke(e){return/___/.test(e.q||"")?"Read the whole sentence first, then choose the word that fits the blank.":"Read the question carefully, then choose the best answer."}function x(){if(!a)return;const e=m[g];if(!e)return we();if(!me(e.category)&&B<W)return K(e.category,()=>x());const t=Math.round(g/m.length*100),s=k?`Recovery · ${v.label}`:v.label,l=[...e.choices].sort(()=>Math.random()-.5);a.innerHTML=`
    <div class="mcq-game" role="region" aria-label="Vocabulary question ${g+1} of ${m.length}">
      ...
      <div class="vmcq-next-wrap" id="vmcq-next-wrap" style="display:none">
        ...
        </tr>`}).join("")}</tbody></table>`}function K(e,t){var r,n;B+=1,qe(e);const s=A(e),l=w[e]||{icon:"📖",label:e};a.innerHTML=`
    ...
    </div>`,l&&((c=a.querySelector("#vmcq-recovery"))==null||c.addEventListener("click",()=>ge())),(i=a.querySelector("#vmcq-replay"))==null||i.addEventListener("click",()=>M(v)),(d=a.querySelector("#vmcq-menu"))==null||d.addEventListener("click",()=>Q())}export{Ie as cleanupVocabMcq,Y as countItemsForScope,he as getAllItems,ve as getCategoryCounts,N as getItemsForScope,fe as getLevelCounts,Te as initVocabMcq,Q as showVocabMcqBrowser,Be as startVocabMcqLevel};
