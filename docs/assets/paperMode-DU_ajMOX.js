import{s as b}from"./index-Vsj4XzcA.js";import{m as h,P as E,a as f,b as v,c as S,d as _,e as $,f as C,g as y,h as A,i as g,j as M,k as R}from"./primaryPracticeTest-BKVvyRYm.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";import"./shortAnswerGrader-BbVaplnA.js";const k=["P1","P2","P3","P4","P5","P6"],I={P1:"45 min",P2:"50 min",P3:"1 h",P4:"1 h 10 min",P5:"1 h 30 min",P6:"1 h 50 min"};let a=null,m=null,P=null,p=null,r=null;const u={practice:{icon:"🎯",label:"Practice Mode",desc:"Hints + per-section feedback. No timer."},test:{icon:"⏱️",label:"Test Mode",desc:"Timed. No hints. Mirrors the real paper."},review:{icon:"🔄",label:"Review Mistakes",desc:"Replay only the questions you got wrong last time."}},x=Object.freeze({P1:M.map(e=>R[e]).filter(Boolean),P2:A.map(e=>g[e]).filter(Boolean),P3:C.map(e=>y[e]).filter(Boolean),P4:_.map(e=>$[e]).filter(Boolean),P5:v.map(e=>S[e]).filter(Boolean),P6:E.map(e=>f[e]).filter(Boolean)});function O(e,{onLaunchSection:l,onGoHome:o}){a=e,m=l,P=o}function N(){r==null||r(),r=null,a&&(a.innerHTML="")}function q(){var o;if(!a)return;r==null||r(),r=null,a.innerHTML=`
    ...
    </div>`,o.querySelectorAll("[data-start-paper]").forEach(i=>{i.addEventListener("click",()=>{const d=t.find(n=>n.id===i.dataset.startPaper);!d||!a||(b.set("paperMode",l),r=h(a,d,{mode:l,onClose:()=>{r=null,q()},onPractiseSkill:n=>m==null?void 0:m(n,e)}))})})}export{N as cleanupPaperMode,O as initPaperMode,q as showPaperModeBrowser};
