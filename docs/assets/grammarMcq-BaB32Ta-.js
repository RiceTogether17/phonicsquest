import{l as X,R as J,G as R,s as C,q as T,K as P,x as u,I as F,T as Z,L as I}from"./index-DH_tauIV.js";import{G as _,a as B,b as ee}from"./grammarMcq-c8TFk-iF.js";import{r as te,M as se,f as le,b as re,a as ae,c as ce}from"./mcqDifficulty-qNlOzz6M.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";let c=null,G=null,h=[],b=0,E=0,x=!1,q={level:null,category:null,label:"All Skills",difficulty:"normal"},m="normal",f=0,$=0,k=[],M=!1,L={},w={},j=0;const K=3;function D(e){return`gmcq:${e}`}function ne(e){return!!(C.get("lessonsSeen")||{})[D(e)]}function ie(e){const t={...C.get("lessonsSeen")||{}};t[D(e)]||(t[D(e)]=new Date().toISOString(),C.set("lessonsSeen",t))}function we(e,t){c=e,G=t}function Me(){c&&(c.innerHTML="")}function oe(e=_){return B.flatMap(t=>e[t]||[])}function Y({level:e=null,category:t=null}={},s=_){const l=e?s[e]||[]:oe(s);return t?l.filter(a=>a.category===t):l}function U(e={},t=_){return Y(e,t).length}function ue(e=_,t=X){return t.map(s=>{const l={};let a=0;for(const i of B){const n=U({level:i,category:s},e);l[i]=n,a+=n}return{category:s,total:a,levels:l}})}function de(e=_,t=B){return t.map(s=>({level:s,total:U({level:s},e)}))}function O(e){var t;return((t=R[e])==null?void 0:t.label)||e}function me(e){const t=e.level||null,s=e.category?O(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function N(){if(!c)return;const e=de(),t=ue();let s=q.level||"P1",l=q.difficulty||m||"normal";const a=()=>{var i,n;c.innerHTML=`
  ...
  `}function fe(e){return/___/.test(e.q||"")?"Read the whole sentence first, then choose the word that fits the blank.":"Read the question carefully, then choose the best answer."}function A(){if(!c)return;const e=h[b];if(!e)return be();if(!ne(e.category)&&j<K)return V(e.category,()=>A());x=!1;const t=Math.round(b/h.length*100),s=M?`Recovery · ${q.label}`:q.label,l=[...e.choices].sort(()=>Math.random()-.5);c.innerHTML=`
    <div class="mcq-game" role="region" aria-label="Grammar question ${b+1} of ${h.length}">
      ...
      <div class="vmcq-next-wrap" id="gmcq-next-wrap" style="display:none">
        ...
        </tr>`}).join("")}</tbody></table>`}function V(e,t){var a,i;j+=1,ie(e);const s=I(e),l=R[e]||{icon:"🧠",label:e};c.innerHTML=`
    ...
    </div>`,l&&((o=c.querySelector("#gmcq-recovery"))==null||o.addEventListener("click",()=>pe())),(v=c.querySelector("#gmcq-replay"))==null||v.addEventListener("click",()=>H(q)),(p=c.querySelector("#gmcq-menu"))==null||p.addEventListener("click",()=>N())}export{Me as cleanupGrammarMcq,U as countItemsForScope,oe as getAllItems,ue as getCategoryCounts,Y as getItemsForScope,de as getLevelCounts,we as initGrammarMcq,N as showGrammarMcqBrowser,Le as startGrammarMcqLevel};
