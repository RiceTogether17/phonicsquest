import{p as T,C as G,a as ke}from"./passages-Du4BUcGK.js";import{s as z,p as ve,z as ye,G as A,M as y,$ as Ae,a9 as he,a4 as Ie,a0 as Q,a5 as ze,aa as Qe,a6 as Ve,ab as Ze,ac as Je,ad as Xe}from"./index-cg20xDXF.js";import{g as Ye,a as Y,s as Ke,b as et,c as V,d as tt,e as lt,p as nt,f as st,h as at,i as ct,j as qe,r as ot,k as rt,l as it,m as Me,n as Re,o as dt,q as ut,t as mt,u as pt,v as bt,w as de,x as Pe,y as kt,z as ge,A as xe,B as ht,C as We,D as ft,E as gt,F as He,G as vt}from"./masteryMap-DuHDCo86.js";import{s as re,g as Fe,a as Oe,b as je,p as De,r as yt,c as zt}from"./clozeCompletionTracker-CWPOmOJP.js";import"./practiceExpansion-D0CCBel5.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";let b=null,B=null,w="P1",p="",R=0,ne=[],q=[],S=[],se=0,ae=0,ie=0,I=null,_=-1,P={},J=0,W=!1,ue=0,fe=0,E="practice",U=0,Ee=0,X=[],F=0,D=0,we=!1,ee=!1,me=0,le=0,j={};function Ft(e,l){b=e,B=l}function Ot(){_e()}function Ce(){b&&(b.innerHTML=""),q=[],S=[],I&&(document.removeEventListener("keydown",I),I=null)}function _e(){if(!b)return;const e=z.get("ccqCompleted")||{},l=Object.keys(T);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const s=Object.keys(T[n]),a=s.map(c=>re(T[n][c])),r=a.reduce((c,f)=>c+f.seeds,0),h=a.reduce((c,f)=>c+f.seedQuestions,0),m=a.reduce((c,f)=>c+f.variants,0),d=Fe({level:n,ccqCompletedByPassage:z.get("ccqCompletedByPassage")||{},ccqCompleted:e,seedIndex:Oe(s.flatMap(c=>T[n][c]))}),u=d>=r,o=ke[n];t+=`
