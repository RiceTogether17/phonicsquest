import{G as C}from"./grammarMcq-Bw5v4S7U.js";import{V as M}from"./vocabMcq-BVDX5YqQ.js";import{z as v}from"./index-Cn4PbYeT.js";import"./mcqOptionExplanations-Atx8bQId.js";import"./practiceExpansion-D0CCBel5.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";const b=3;function P(t){const c=w(t),i=k(C[c]||[],b,"grammarMcq"),n=k(M[c]||[],b,"vocabMcq");return{grade:c,items:[...i,...n]}}const g=["P1","P2","P3","P4","P5","P6"];function E(t,c,i=0){const n=g.indexOf(String(t||"").toUpperCase()),r=n===-1?2:n;return i<4?{level:g[r],direction:"same"}:c<=.35&&r>0?{level:g[r-1],direction:"down"}:c>=.9&&r<g.length-1?{level:g[r+1],direction:"up"}:{level:g[r],direction:"same"}}function L(t){if(!Array.isArray(t)||t.length===0)return{total:0,correct:0,accuracy:0,weakSkills:[],strongSkills:[]};const c=[],i=[];let n=0;for(const r of t){if(!r||!r.source||!r.category)continue;const e=!!r.correct;e&&n++,v.updateSkill(r.source,r.category,e,{alpha:.45}),v.recordAttempt({quest:r.source,skill:r.category,correct:e,level:r.level||null}),(e?i:c).push({quest:r.source,skill:r.category})}return{total:t.length,correct:n,accuracy:t.length>0?n/t.length:0,weakSkills:c,strongSkills:i}}function w(t){const c=String(t||"").toUpperCase();return/^P[1-6]$/.test(c)?c:"P3"}function k(t,c,i){const n=[],r=new Set;for(const e of t)if(!(!e||!e.category)&&!r.has(e.category)&&(r.add(e.category),n.push({source:i,category:e.category,subskill:e.subskill||e.category,q:e.q,choices:Array.isArray(e.choices)?[...e.choices]:[],answer:e.answer,explain:e.explain||"",level:e.level||null}),n.length>=c))break;return n}const N={_normaliseGrade:w,_pickPerCategory:k},a=t=>String(t??"").replace(/[<>&]/g,c=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[c]),T=t=>String(t??"").replace(/"/g,"&quot;").replace(/</g,"&lt;");function O({container:t,profile:c,onComplete:i}){if(!t||typeof i!="function")return;const n=(c==null?void 0:c.primaryGrade)||"P3",r=(c==null?void 0:c.name)||"Friend",{items:e}=P(n),f=[];let h="intro",d=0,q=!1;function y(){return h==="intro"?S():h==="summary"?A():$()}function S(){var s,l;t.innerHTML=`
      ...
      </div>`,(p=t.querySelector('[data-action="continue"]'))==null||p.addEventListener("click",()=>{i({skipped:!1,results:s})})}y()}export{b as QUICK_CHECK_PER_DOMAIN,N as __TEST__,L as applyPrimaryQuickCheckResults,P as buildPrimaryQuickCheck,E as recommendPrimaryLevel,O as showPrimaryQuickCheck};
