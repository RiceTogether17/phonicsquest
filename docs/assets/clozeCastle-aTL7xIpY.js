import{p as M,C as j,a as pe}from"./passages-DNXaSraU.js";import{s as y,p as fe,q as ge,G as B,x as v,K as qe,L as be,F as Ae,E as G,H as ve,I as je,M as Oe,N as Ge}from"./index-DrgttqLD.js";import{g as Ie,a as Ue,b as Me,c as J,s as Ve,d as Ze,e as U,f as Je,h as Ke,p as Qe,i as Xe,j as Ye,k as et,l as Te,r as tt,m as lt,n as nt,o as Re,q as Pe,t as ct,u as at,v as st,w as ot,x as rt,y as re,z as it,A as We,B as dt,C as ut,D as he,E as $e,F as mt,G as He,H as pt,I as bt,J as Fe,K as kt}from"./masteryMap-CqCoxdga.js";import"./gsap-C8pce-KX.js";let b=null,T=null,z="P1",m="",I=0,le=[],L=[],E=[],ne=0,ce=0,ye=0,q=null,x=-1,R={},V=0,P=!1,ie=0,ke=0,C="practice",O=0,xe=0,Z=[],W=0,N=0,ze=!1,Y=!1,de=0,te=0,F={};function Bt(e,l){b=e,T=l}function qt(){Ee()}function we(){b&&(b.innerHTML=""),L=[],E=[],q&&(document.removeEventListener("keydown",q),q=null)}function Ee(){if(!b)return;const e=y.get("ccqCompleted")||{},l=Object.keys(M);let t='<div class="cloze-browser">';t+='<div class="cloze-browser-grid">';for(const n of l){const c=Object.keys(M[n]),a=c.reduce((d,p)=>d+M[n][p].length,0),i=Ie({level:n,ccqCompletedByPassage:y.get("ccqCompletedByPassage")||{},ccqCompleted:e}),k=i>=a,u=pe[n];t+=`
