import{p as q,C as D,a as be}from"./passages-CrCp32Wn.js";import{s as v,p as fe,q as ye,G as B,A as y,T as Ae,U as ke,O as Be,M as G,Q as ve,R as De,X as Ne,Y as Ge}from"./index-CRqGm-mG.js";import{g as Ie,a as Ue,b as Me,c as X,s as Je,d as Qe,e as U,f as Ve,h as Xe,p as Ye,i as Ze,j as Ke,k as et,l as Te,r as tt,m as lt,n as nt,o as Re,q as Pe,t as at,u as st,v as ct,w as ot,x as rt,y as ie,z as it,A as We,B as dt,C as ut,D as ge,E as xe,F as mt,G as He,H as pt,I as bt,J as Fe,K as kt}from"./masteryMap-CTCWoukC.js";import"./practiceExpansion-67d_LqFm.js";import"./gsap-C8pce-KX.js";let k=null,A=null,z="P1",p="",M=0,ne=[],L=[],_=[],ae=0,se=0,ze=0,I=null,E=-1,R={},Q=0,P=!1,de=0,he=0,$="practice",N=0,Ee=0,V=[],W=0,O=0,we=!1,ee=!1,ue=0,le=0,F={};function At(e,l){k=e,A=l}function Bt(){_e()}function Ce(){k&&(k.innerHTML=""),L=[],_=[],I&&(document.removeEventListener("keydown",I),I=null)}function _e(){if(!k)return;const e=v.get("ccqCompleted")||{},l=Object.keys(q);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const a=Object.keys(q[n]),s=a.reduce((m,c)=>m+q[n][c].length,0),d=a.reduce((m,c)=>m+q[n][c].reduce((o,w)=>{var b;return o+(((b=w.answers)==null?void 0:b.length)||0)},0),0),h=Ie({level:n,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:e}),u=h>=s,i=be[n];t+=`
