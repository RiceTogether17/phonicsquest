import{p as q,C as N,a as ke}from"./passages-C58v9gBd.js";import{s as v,p as ye,z as ve,G as A,M as y,$ as Be,a9 as he,a4 as Ae,a0 as G,a5 as ze,aa as Ne,a6 as Oe,ab as Ge,ac as Ue,ad as Ve}from"./index-Cn4PbYeT.js";import{g as Ze,a as Q,s as Je,b as Qe,c as U,d as Xe,e as Ye,p as Ke,f as et,h as tt,i as lt,j as Te,r as nt,k as at,l as st,m as Ie,n as Me,o as ct,q as ot,t as rt,u as it,v as dt,w as de,x as Re,y as ut,z as ge,A as xe,B as mt,C as Pe,D as pt,E as bt,F as We,G as kt}from"./masteryMap-CmZt-vCm.js";import{g as He,a as Fe,r as ht,b as ft}from"./clozeCompletionTracker-BNrgTcI4.js";import"./practiceExpansion-D0CCBel5.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";let k=null,B=null,z="P1",p="",M=0,ne=[],L=[],_=[],ae=0,se=0,ie=0,I=null,E=-1,R={},Z=0,P=!1,ue=0,fe=0,$="practice",O=0,Ee=0,J=[],W=0,j=0,we=!1,ee=!1,me=0,le=0,F={};function Rt(e,l){k=e,B=l}function Pt(){_e()}function Ce(){k&&(k.innerHTML=""),L=[],_=[],I&&(document.removeEventListener("keydown",I),I=null)}function _e(){if(!k)return;const e=v.get("ccqCompleted")||{},l=Object.keys(q);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const a=Object.keys(q[n]),s=a.reduce((u,c)=>u+q[n][c].length,0),d=a.reduce((u,c)=>u+q[n][c].reduce((o,w)=>{var b;return o+(((b=w.answers)==null?void 0:b.length)||0)},0),0),h=He({level:n,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:e}),m=h>=s,i=ke[n];t+=`
  ...
  </div>`;const h=l.reduce((r,x)=>r+q[e][x].length,0),m=Ze({mode:"clozeCastle",level:e,masteryMap:v.get("masteryMap")||{}}),i=m.length?m:Fe({level:e,weakSkillsMap:v.get("ccqWeakSkills")||{}}).map(r=>({skill:r.skill,skillLabel:Q(r.skill),attempts:r.attempts,wrong:r.wrong,accuracy:Math.round((r.attempts-r.wrong)/Math.max(1,r.attempts)*100),lastExample:null})),u=i.map(r=>{const x=r.accuracy!=null?Je(r):Qe({weakSkills:[r.skill],accuracy:r.accuracy,hintsUsed:0}),S=r.lastExample?` · Last slip: "${y(r.lastExample.chosen||"—")}" → "${y(r.lastExample.correct||"?")}"`:"";return`<li>${y(r.skillLabel||Q(r.skill))}: ${r.wrong}/${r.attempts} · ${y(x)}${S}</li>`}).join("");a+=`<div class="cloze-cat-actions">
    ...
    </div>`}function wt(e){var t,n;U($).allowHints&&((t=document.getElementById("clue-hint-btn"))==null||t.addEventListener("click",()=>{const a=Se(e);if(!a)return;Z=Math.min(Z+1,4),O=rt(O);const{message:s}=it(Z,a),d=document.getElementById("clue-hint-msg");d&&(d.textContent=s,d.className="clue-hint-msg clue-hint-msg--visible"),Z>=4&&(R[E]="weak",be(e,"weak"))}),(n=document.getElementById("clue-skip-btn"))==null||n.addEventListener("click",()=>{E<0||(R[E]="weak",be(e,"weak"))}))}function De(e,l){var m;const t=Se(l);if(!t)return;const n=mt(e,t),a=We(n),s=de(((m=l.blankSkills)==null?void 0:m[E])||(p!=="__all__"?p:"sentenceLogic")),d=document.getElementById("clue-hunt-feedback");if(d){const i=Pe(t.clueType),u=Q(s),c=t.explanation||"Use the clue to choose the best-fitting word.";d.textContent=`${i} · ${u}. ${a.message} ${c}`,d.className=`clue-hunt-feedback ${a.cssClass}`}const h=document.getElementById("cloze-passage");h&&Me({container:h,text:l.text,activeBlankIndex:E,selectedWord:e,selectedResult:n,filledAnswers:_.map((i,u)=>{var c;return i!==null&&((c=L.find(o=>o.id===i))==null?void 0:c.word)||""}),onTapWord:i=>De(i,l)}),v.recordClueAttempt({quest:"clozeCastle",result:n,clueType:t.clueType}),n==="strong"||n==="partial"?(R[E]=n,G.playSfx(n==="strong"?"correct":"pop"),setTimeout(()=>be(l,n),800)):(ue++,G.playSfx("wrong"),ue>=2&&(R[E]="weak",setTimeout(()=>be(l,"weak"),1e3)))}function be(e,l){if(!P)return;P=!1,E=-1,fe+=xe(l);const t=document.getElementById("cloze-instruction");t&&(t.textContent="🏰 Clue found! Now tap the word from the bank that fits the blank.");const n=document.getElementById("cloze-bank-wrapper");n&&(n.className="cloze-bank-wrapper");const a=document.getElementById("cloze-check");a&&(a.disabled=!1),X(e)}function ce(e){const l=document.getElementById("cloze-passage");if(l)if(P){const t=_.map(n=>{var a;return n!==null&&((a=L.find(s=>s.id===n))==null?void 0:a.word)||""});Me({container:l,text:e.text,activeBlankIndex:E,filledAnswers:t,onTapWord:n=>De(n,e)})}else ct({container:l,text:e.text,blankFills:_,bankWords:L,blankClass:"cloze-blank",filledClass:"cloze-blank--filled",emptyBlankAria:t=>`Empty blank ${t+1}`,removeBlankAria:t=>`Remove ${t} from blank`,onRemoveWord:()=>{ce(e),X(e)},onTapEmpty:t=>{t.classList.add("cloze-blank--selected"),setTimeout(()=>t.classList.remove("cloze-blank--selected"),800)}})}function X(e){const l=document.getElementById("cloze-bank");if(l){if(P){l.innerHTML=L.map(t=>`
      <button class="cloze-word-chip cloze-word-chip--locked"
              disabled aria-disabled="true"
              aria-label="${Be(t.word)}">${y(t.word)}</button>
    `).join("");return}ot({container:l,bankWords:L,chipClass:"cloze-word-chip",usedClass:"cloze-word-chip--used",onChooseWord:t=>{if(!kt(L,_,t))return;G.playSfx("pop");const n=(e.clues||[]).slice().sort((a,s)=>a.blankIndex-s.blankIndex).find(a=>_[a.blankIndex]===null&&!Object.hasOwn(R,a.blankIndex));n?(E=n.blankIndex,P=!0,Z=0,ue=0,console.info("[ClozeCastle] Activating next clue target",{blankIndex:E,passageId:e.id}),te(e)):(ce(e),X(e))}})}}function Se(e){return e.clues&&e.clues.find(l=>l.blankIndex===E)||null}function Ct(e,l){return e.clues&&e.clues.find(t=>t.blankIndex===l)||null}function re(e,l){const t=p!=="__all__"?de(p):"sentenceLogic";return e.answers.map((n,a)=>{var c,o;const s=Ct(e,a),d=l[a]||"",h=Re(e,a),m=de(h.primarySkill||t),i=d!==n,u=i?pt({meta:h,chosen:d,correct:n,stem:Ge(e.text,a,e.answers),domain:"grammar"}):null;return{blank:`#${a+1}`,passageTitle:e.title,studentAnswer:d,correctAnswer:n,status:i?"Try again":"Correct",skillTag:m,skillLabel:Q(m),clueTypeLabel:Pe(h.clueType||(s==null?void 0:s.clueType)),clue:((c=s==null?void 0:s.acceptableSpans)==null?void 0:c[0])||"—",explanation:((o=e.grammarNotes)==null?void 0:o[a])||h.correctReason||(s==null?void 0:s.explanation)||"Read the words before and after the blank.",nextStepPrompt:bt(m),whyWrong:u==null?void 0:u.whyWrong,whyRight:u==null?void 0:u.whyRight,missedClue:u==null?void 0:u.missedClue,examTip:h.examTip||(u?u.examTip:""),misconceptionId:(u==null?void 0:u.misconceptionId)||null}})}function $t(e){if(_.some(c=>c===null)){H("Fill in all the blanks first! 🏰",!1);return}const l=dt(_,L);[...l];const t=l.every((c,o)=>c===e.answers[o]),n=l.filter((c,o)=>c===e.answers[o]).length,a=U($),s=p==="__all__"?"mixed":p,d=e.answers.map((c,o)=>{var w;return de(((w=e.blankSkills)==null?void 0:w[o])||(p!=="__all__"?p:"sentenceLogic"))}),h=new Set(d.filter((c,o)=>l[o]!==e.answers[o]));ve.recordAttempt({quest:"clozeCastle",skill:s,correct:t,responseMs:2e3,level:z}),ve.updateSkill("clozeCastle",s,t),ye.recordGrammarCategoryAttempt(z,s,t),se++,W+=e.answers.length,j+=n;const m=ht({storageKey:"ccqWeakSkills",level:z,skills:d,wrongSkillSet:h,current:v.get("ccqWeakSkills")||{}});v.set("ccqWeakSkills",m);let i=v.get("masteryMap")||{};const u=re(e,l);if(ie===0&&Ne(u,{mode:"clozeCastle"}),u.forEach((c,o)=>{const w=Re(e,o),b=c.status!=="Correct",f=w.primarySkill;F[f]||(F[f]={correct:0,total:0,label:c.skillLabel||Q(f),lastWrongExamples:[]});const r=F[f];r.total+=1,b?c.correctAnswer&&r.lastWrongExamples.length<3&&r.lastWrongExamples.push(c.correctAnswer):r.correct+=1,i=ut({mode:"clozeCastle",level:z,category:s,skill:f,clueType:w.clueType,wasWrong:b,example:b?{passageId:e.id,blankIndex:o,chosen:c.studentAnswer,correct:c.correctAnswer,clueType:w.clueType}:null,current:i})}),v.set("masteryMap",i),a.showFinalReviewOnly){J.push(...u.filter(o=>o.status!=="Correct").map(o=>({passageTitle:o.passageTitle,blank:o.blank,studentAnswer:o.studentAnswer,correctAnswer:o.correctAnswer,explanation:o.explanation,skillLabel:o.skillLabel})));const c=v.get("ccqExamAttempts")||[];c.push({level:z,category:s,passageId:e.id,blankCorrect:n,blankTotal:e.answers.length,submittedAt:Date.now()}),v.set("ccqExamAttempts",c.slice(-150)),M++,D();return}if(t){ae++,Oe.recordCorrect(2e3,!1),U($).confettiPerPassage&&Ae(),G.playSfx("correct"),ze.celebrate(!1);const c=Math.round(n/Math.max(1,e.answers.length)*100);if(p!=="__all__"&&e.id){const o=ft({level:z,category:p,passageId:e.id,accuracy:c,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:v.get("ccqCompleted")||{},ccqCatCompleted:v.get("ccqCatCompleted")||{}});v.set("ccqCompletedByPassage",o.nextByPassage),v.set("ccqCompleted",o.nextCompleted),v.set("ccqCatCompleted",o.nextCatCompleted)}document.querySelectorAll(".cloze-blank--filled").forEach(o=>o.classList.add("cloze-blank--correct")),ge({host:k.querySelector(".cloze-game"),title:"Answer Review",rows:re(e,l),onContinue:()=>{e.clues&&e.clues.length>0?_t(e,()=>setTimeout(()=>{M++,D()},600)):(H("✅ Excellent! All correct!",!0),setTimeout(()=>{M++,D()},1200))}})}else{if(G.playSfx("wrong"),ie++,document.querySelectorAll(".cloze-blank--filled").forEach((c,o)=>{var b;const w=((b=L.find(f=>f.id===_[o]))==null?void 0:b.word)||"";c.classList.toggle("cloze-blank--wrong",w!==e.answers[o])}),ze.encourage(),$==="exam"){ge({host:k.querySelector(".cloze-game"),title:"Exam Submission Review",rows:re(e,l),onContinue:()=>{M++,D()}});return}ie>=2?(H("❌ Let's review your answers first.",!1),setTimeout(()=>{document.querySelectorAll(".cloze-blank--wrong").forEach(o=>o.classList.remove("cloze-blank--wrong"));const c=document.getElementById("cloze-feedback");c&&(c.hidden=!0),ge({host:k.querySelector(".cloze-game"),title:"Review Mistakes",rows:re(e,l),onContinue:()=>Et(e,l)})},800)):(H("❌ Not quite — the red blanks need another look. Reread those sentences before you try again.",!1),setTimeout(()=>{document.querySelectorAll(".cloze-blank--wrong").forEach(o=>o.classList.remove("cloze-blank--wrong"));const c=document.getElementById("cloze-feedback");c&&(c.hidden=!0)},1800))}}function xt(e,l){var s,d;if(!k)return;const t={...v.get("lessonsSeen")||{}};t[`cloze:${e}`]||(t[`cloze:${e}`]=new Date().toISOString(),v.set("lessonsSeen",t));const n=he(e),a=A[e]||{icon:"🏰",label:e};k.innerHTML=`
    ...
    </div>`,k.appendChild(s);const d=e.answers.map((m,i)=>({n:i+1,correctAnswer:m,studentAnswer:l[i]||"(left blank)"})).filter(m=>m.studentAnswer!==m.correctAnswer);d.length>0&&Ue(s.querySelector(".ctb-panel"),()=>{var m;return Ve({skillLabel:n?((m=A[n])==null?void 0:m.label)||n:"grammar cloze",exercise:`Fill in the blanks: "${e.text}"`,studentAnswer:d.map(i=>`blank ${i.n}: ${i.studentAnswer}`).join(", "),correctAnswer:d.map(i=>`blank ${i.n}: ${i.correctAnswer}`).join(", "),level:z})}),(h=s.querySelector("#ctb-try-again"))==null||h.addEventListener("click",()=>{s.remove(),Ie(L,_),_=_.map(()=>null),X(e),ce(e)}),setTimeout(()=>{var m;return(m=s.querySelector("#ctb-try-again"))==null?void 0:m.focus()},100)}function _t(e,l){var s,d;if(!k)return;const t=document.getElementById("cloze-explanation-overlay");t&&t.remove();const n=e.answers.map((h,m)=>{var f,r;const i=(e.clues||[]).find(x=>x.blankIndex===m),u=R[m]||"weak",c=We(u),o=xe(u),w=((f=i==null?void 0:i.acceptableSpans)==null?void 0:f[0])||"Skipped / no clue",b=((r=e.grammarNotes)==null?void 0:r[m])||(i==null?void 0:i.explanation)||`"${h}" is the best fit for the sentence meaning and grammar.`;return`
