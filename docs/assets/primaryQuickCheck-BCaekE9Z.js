import{G as A}from"./grammarMcq-B62X-ojl.js";import{V as M}from"./vocabMcq-C6piviqh.js";import{q as f}from"./index-BjQGCboo.js";import"./mcqOptionExplanations-Bix-y16L.js";import"./gsap-C8pce-KX.js";const b=3;function C(t){const c=v(t),n=m(A[c]||[],b,"grammarMcq"),a=m(M[c]||[],b,"vocabMcq");return{grade:c,items:[...n,...a]}}function E(t){if(!Array.isArray(t)||t.length===0)return{total:0,correct:0,accuracy:0,weakSkills:[],strongSkills:[]};const c=[],n=[];let a=0;for(const r of t){if(!r||!r.source||!r.category)continue;const e=!!r.correct;e&&a++,f.updateSkill(r.source,r.category,e,{alpha:.45}),f.recordAttempt({quest:r.source,skill:r.category,correct:e,level:r.level||null}),(e?n:c).push({quest:r.source,skill:r.category})}return{total:t.length,correct:a,accuracy:t.length>0?a/t.length:0,weakSkills:c,strongSkills:n}}function v(t){const c=String(t||"").toUpperCase();return/^P[1-6]$/.test(c)?c:"P3"}function m(t,c,n){const a=[],r=new Set;for(const e of t)if(!(!e||!e.category)&&!r.has(e.category)&&(r.add(e.category),a.push({source:n,category:e.category,subskill:e.subskill||e.category,q:e.q,choices:Array.isArray(e.choices)?[...e.choices]:[],answer:e.answer,explain:e.explain||"",level:e.level||null}),a.length>=c))break;return a}const Q={_normaliseGrade:v,_pickPerCategory:m},u=t=>String(t??"").replace(/[<>&]/g,c=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[c]),T=t=>String(t??"").replace(/"/g,"&quot;").replace(/</g,"&lt;");function H({container:t,profile:c,onComplete:n}){if(!t||typeof n!="function")return;const a=(c==null?void 0:c.primaryGrade)||"P3",r=(c==null?void 0:c.name)||"Friend",{items:e}=C(a),y=[];let d="intro",l=0,q=!1;function h(){return d==="intro"?S():d==="summary"?$():w()}function S(){var o,i;t.innerHTML=`
      <div class="pqc-card">
