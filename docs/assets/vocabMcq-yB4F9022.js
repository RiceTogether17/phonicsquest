import{m as Y,a as M,s as E,q as V,y as D,x as d,w as F,D as z}from"./index-dTE5fncO.js";import{V as C,a as I,b as X}from"./vocabMcq-BvOsIjwT.js";import{r as J,M as Z,f as ee,b as te,a as se,c as le}from"./mcqDifficulty-Cv9PIDsc.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";import"./aiService-Bhw2Co5T.js";import"./askGiriButton-BFgnYhI1.js";import"./aiGuardrails-C831OhIJ.js";function B(e){const t=M[e]||{};return{rule:t.rule||`${t.label||e} vocabulary questions test word meaning and usage in context.`,example:t.example||"Choose the word that best fits the sentence.",tip:t.tip||"Read the whole sentence carefully and test each option to find which sounds natural."}}let a=null,T=null,m=[],v=0,A=0,x=!1,q={level:null,category:null,label:"All Skills",difficulty:"normal"},b="normal",f=0,y=0,S=[],w=!1,L={},k={},O=0;const G=3;function j(e){return`vmcq:${e}`}function ce(e){return!!(E.get("lessonsSeen")||{})[j(e)]}function ae(e){const t={...E.get("lessonsSeen")||{}};t[j(e)]||(t[j(e)]=new Date().toISOString(),E.set("lessonsSeen",t))}function ke(e,t){a=e,T=t}function Se(){a&&(a.innerHTML="")}function re(e=C){return I.flatMap(t=>e[t]||[])}function N({level:e=null,category:t=null}={},s=C){const l=e?s[e]||[]:re(s);return t?l.filter(i=>i.category===t):l}function W(e={},t=C){return N(e,t).length}function ie(e=C,t=Y){return t.map(s=>{const l={};let i=0;for(const n of I){const r=W({level:n,category:s},e);l[n]=r,i+=r}return{category:s,total:i,levels:l}})}function ne(e=C,t=I){return t.map(s=>({level:s,total:W({level:s},e)}))}function Q(e){var t;return((t=M[e])==null?void 0:t.label)||e}function oe(e){const t=e.level||null,s=e.category?Q(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function P(){if(!a)return;const e=ne(),t=ie();let s=q.level||"P1",l=q.difficulty||b||"normal";const i=()=>{var n,r;a.innerHTML=`
    ...
    <div class="mcq-game" role="region" aria-label="Vocabulary question ${v+1} of ${m.length}">
      ...
      <div class="pt-choices" role="group" aria-label="Answer choices">
        ${l.map(r=>`<button class="pt-choice-btn" data-choice="${D(r)}" aria-label="Choose ${D(r)}">${d(r)}</button>`).join("")}
      </div>
