import{A as X,aj as Z,G as x,s as _,ak as J,z as L,$ as H,M as d,a9 as C,a6 as O,al as ee}from"./index-BwJLQiTu.js";import{g as te,r as se,i as P,a as le,M as re,f as ae,b as ce,c as ne,d as ie}from"./mcqBrowserShell-DgEocBrN.js";import{G as S,a as G,b as oe,g as W}from"./grammarMcq-B5R5Mhaj.js";import{a as ue,b as de}from"./mcqFeedback-CHP0opst.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";import"./mcqOptionExplanations-Atx8bQId.js";import"./practiceExpansion-D0CCBel5.js";let a=null,A=null,q=[],b=0,R=0,g={level:null,category:null,label:"All Skills",difficulty:"normal"},h="normal",f=0,v=0,y=[],$=!1,k={},I=0;const N=3;function Y(e,t=null){return(t?W(e,t):null)?`gmcq:${e}:${t}`:`gmcq:${e}`}const me=14,pe=.6;function qe(e,t=null){const s=(_.get("lessonsSeen")||{})[Y(e,t)];return s?(Date.now()-Date.parse(s))/864e5<me?!0:L.getSkillScore("grammarMcq",e)>=pe:!1}function he(e,t=null){const s={..._.get("lessonsSeen")||{}};s[Y(e,t)]=new Date().toISOString(),_.set("lessonsSeen",s)}function Ge(e,t){a=e,A=t}function Ie(){a&&(a.innerHTML="")}function ge(e=S){return G.flatMap(t=>e[t]||[])}function z({level:e=null,category:t=null}={},s=S){const r=e?s[e]||[]:ge(s);return t?r.filter(n=>n.category===t):r}function K(e={},t=S){return z(e,t).length}function fe(e=S,t=X){return t.map(s=>{const r={};let n=0;for(const c of G){const o=K({level:c,category:s},e);r[c]=o,n+=o}return{category:s,total:n,levels:r}})}function be(e=S,t=G){return t.map(s=>({level:s,total:K({level:s},e)}))}function T(e){var t;return((t=x[e])==null?void 0:t.label)||e}function ve(e){const t=e.level||null,s=e.category?T(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function Q(){if(!a)return;const e=be(),t=fe();let s=g.level||te(),r=g.difficulty||h||"normal";const n=()=>{var c,o,m;a.innerHTML=`
  ...
  `}function Se(e){return/___/.test(e.q||"")?"Read the whole sentence first, then choose the word that fits the blank.":"Read the question carefully, then choose the best answer."}function E(){if(!a)return;const e=q[b];if(!e)return Me();if(!qe(e.category,e.level)&&I<N)return V(e.category,()=>E(),e.level);const t=Math.round(b/q.length*100),s=$?`Recovery · ${g.label}`:g.label,r=[...e.choices].sort(()=>Math.random()-.5);a.innerHTML=`
    <div class="mcq-game" role="region" aria-label="Grammar question ${b+1} of ${q.length}">
      ...
      <div class="vmcq-next-wrap" id="gmcq-next-wrap" style="display:none">
        ...
        </tr>`}).join("")}</tbody></table>`}function V(e,t,s=null){var i,u,p;I+=1,he(e,s);const r=C(e),n=x[e]||{icon:"🧠",label:e},c=s?W(e,s):null,o=c?c.label:n.label,m=(c==null?void 0:c.focus)||r.rule,l=(i=c==null?void 0:c.keyForms)!=null&&i.length?`Forms to watch this year: ${c.keyForms.join(", ")}`:r.example;a.innerHTML=`
    ...
    </div>`,r&&((l=a.querySelector("#gmcq-recovery"))==null||l.addEventListener("click",()=>ye())),(i=a.querySelector("#gmcq-replay"))==null||i.addEventListener("click",()=>M(g)),(u=a.querySelector("#gmcq-menu"))==null||u.addEventListener("click",()=>Q())}export{Ie as cleanupGrammarMcq,K as countItemsForScope,ge as getAllItems,fe as getCategoryCounts,z as getItemsForScope,be as getLevelCounts,Ge as initGrammarMcq,Q as showGrammarMcqBrowser,De as startGrammarMcqLevel};
