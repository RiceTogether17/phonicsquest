import{p as q,C as N,a as ke}from"./passages-C58v9gBd.js";import{s as v,p as ye,z as ve,G as A,M as y,$ as Be,a9 as he,a4 as Ae,a0 as G,a5 as ze,aa as Ne,a6 as Oe,ab as Ge,ac as Ue,ad as Je}from"./index-CkuCUw9a.js";import{g as Ie,a as Ve,b as Me,c as Q,s as Ze,d as Qe,e as U,f as Xe,h as Ye,p as Ke,i as et,j as tt,k as lt,l as Te,r as nt,m as at,n as st,o as Re,q as Pe,t as ct,u as ot,v as rt,w as it,x as dt,y as de,z as ut,A as We,B as mt,C as pt,D as ge,E as xe,F as bt,G as He,H as kt,I as ht,J as Fe,K as ft}from"./masteryMap-DomfST4B.js";import"./practiceExpansion-D0CCBel5.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";let k=null,B=null,z="P1",p="",M=0,ne=[],L=[],_=[],ae=0,se=0,ie=0,I=null,E=-1,R={},V=0,P=!1,ue=0,fe=0,$="practice",O=0,Ee=0,Z=[],W=0,j=0,we=!1,ee=!1,me=0,le=0,F={};function Mt(e,l){k=e,B=l}function Rt(){_e()}function Ce(){k&&(k.innerHTML=""),L=[],_=[],I&&(document.removeEventListener("keydown",I),I=null)}function _e(){if(!k)return;const e=v.get("ccqCompleted")||{},l=Object.keys(q);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const a=Object.keys(q[n]),s=a.reduce((u,c)=>u+q[n][c].length,0),d=a.reduce((u,c)=>u+q[n][c].reduce((o,w)=>{var b;return o+(((b=w.answers)==null?void 0:b.length)||0)},0),0),h=Ie({level:n,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:e}),m=h>=s,i=ke[n];t+=`
  ...
  </div>`;const h=l.reduce((r,x)=>r+q[e][x].length,0),m=Ve({mode:"clozeCastle",level:e,masteryMap:v.get("masteryMap")||{}}),i=m.length?m:Me({level:e,weakSkillsMap:v.get("ccqWeakSkills")||{}}).map(r=>({skill:r.skill,skillLabel:Q(r.skill),attempts:r.attempts,wrong:r.wrong,accuracy:Math.round((r.attempts-r.wrong)/Math.max(1,r.attempts)*100),lastExample:null})),u=i.map(r=>{const x=r.accuracy!=null?Ze(r):Qe({weakSkills:[r.skill],accuracy:r.accuracy,hintsUsed:0}),S=r.lastExample?` · Last slip: "${y(r.lastExample.chosen||"—")}" → "${y(r.lastExample.correct||"?")}"`:"";return`<li>${y(r.skillLabel||Q(r.skill))}: ${r.wrong}/${r.attempts} · ${y(x)}${S}</li>`}).join("");a+=`<div class="cloze-cat-actions">
