import{p as M,C as j,a as pe}from"./passages-DNXaSraU.js";import{s as y,p as fe,q as ge,G as B,y as v,z as qe,A as be,v as Ae,u as G,w as ve,x as je}from"./index-BjQGCboo.js";import{g as Ie,a as Oe,b as Me,c as J,s as Ge,d as Ue,e as U,f as Ve,h as Ze,p as Je,i as Qe,j as Xe,k as Ke,l as Te,r as Ye,m as et,n as tt,o as Re,q as Pe,t as lt,u as nt,v as ct,w as at,x as st,y as re,z as ot,A as We,B as rt,C as it,D as he,E as $e,F as dt,G as He,H as ut,I as mt,J as Fe,K as pt}from"./masteryMap-CYWvcNgc.js";import{a as bt}from"./askGiriButton-dz_jCY38.js";import{e as kt}from"./aiService-CYVHoJXN.js";import"./gsap-C8pce-KX.js";import"./aiGuardrails-BL8OKwhk.js";let b=null,T=null,z="P1",m="",I=0,le=[],L=[],E=[],ne=0,ce=0,ye=0,q=null,x=-1,R={},V=0,P=!1,ie=0,ke=0,C="practice",O=0,xe=0,Z=[],W=0,D=0,ze=!1,Y=!1,de=0,te=0,F={};function It(e,l){b=e,T=l}function Mt(){Ee()}function we(){b&&(b.innerHTML=""),L=[],E=[],q&&(document.removeEventListener("keydown",q),q=null)}function Ee(){if(!b)return;const e=y.get("ccqCompleted")||{},l=Object.keys(M);let t='<div class="cloze-browser">';t+='<div class="cloze-browser-grid">';for(const n of l){const c=Object.keys(M[n]),a=c.reduce((d,p)=>d+M[n][p].length,0),i=Ie({level:n,ccqCompletedByPassage:y.get("ccqCompletedByPassage")||{},ccqCompleted:e}),k=i>=a,u=pe[n];t+=`
  ...
  </div>`;const k=l.reduce((o,$)=>o+M[e][$].length,0),u=Oe({mode:"clozeCastle",level:e,masteryMap:y.get("masteryMap")||{}}),d=u.length?u:Me({level:e,weakSkillsMap:y.get("ccqWeakSkills")||{}}).map(o=>({skill:o.skill,skillLabel:J(o.skill),attempts:o.attempts,wrong:o.wrong,accuracy:Math.round((o.attempts-o.wrong)/Math.max(1,o.attempts)*100),lastExample:null})),p=d.map(o=>{const $=o.accuracy!=null?Ge(o):Ue({weakSkills:[o.skill],accuracy:o.accuracy,hintsUsed:0}),S=o.lastExample?` · Last slip: "${v(o.lastExample.chosen||"—")}" → "${v(o.lastExample.correct||"?")}"`:"";return`<li>${v(o.skillLabel||J(o.skill))}: ${o.wrong}/${o.attempts} · ${v($)}${S}</li>`}).join("");c+=`<div class="cloze-cat-actions">
  ...
  </div>`,c+="</div>",b.innerHTML=c,(r=document.getElementById("cloze-back-levels"))==null||r.addEventListener("click",()=>Ee()),(s=document.getElementById("cloze-mode-practice"))==null||s.addEventListener("click",()=>{C="practice",ue(e)}),(w=document.getElementById("cloze-mode-exam"))==null||w.addEventListener("click",()=>{C="exam",ue(e)}),b.querySelectorAll(".cloze-cat-btn").forEach(o=>{o.addEventListener("click",()=>{m=o.dataset.cat,Ce(z,m)})}),(g=document.getElementById("cloze-play-all"))==null||g.addEventListener("click",()=>{m="__all__",De(z)}),(h=document.getElementById("cloze-mastery-review"))==null||h.addEventListener("click",()=>{m=fe.getRecommendedGrammarCategory(e,l)||l[0],Ce(z,m)})}function Ce(e,l){var n;le=[...((n=M[e])==null?void 0:n[l])||[]].sort(()=>Math.random()-.5),I=0,ne=0,ce=0,ke=0,O=0,xe=Date.now(),Z=[],W=0,D=0,de=0,te=0,F={},C!=="exam"?Ct(l,()=>N()):N()}function De(e){le=[...Object.keys(M[e]||{}).flatMap(n=>M[e][n])].sort(()=>Math.random()-.5),I=0,ne=0,ce=0,ke=0,O=0,xe=Date.now(),Z=[],W=0,D=0,de=0,te=0,F={},N()}function N(){if(I>=le.length){Et();return}ht(le[I])}function ht(e){const l=Xe(e);if(L=l.bankWords,E=l.blankFills,R={},V=0,ie=0,ye=0,e.clues&&e.clues.length>0){const t=[...e.clues].sort((n,c)=>n.blankIndex-c.blankIndex)[0];x=(t==null?void 0:t.blankIndex)??-1,P=!0}else x=-1,P=!1;ze=!1,Y=!1,ft(e)}function ee(e){var d,p,r,s,w;if(!b)return;const l=pe[z],t=`${I+1} / ${le.length}`,n=m!=="__all__"&&B[m]?`${B[m].icon} ${B[m].label}`:"All Topics",c=e.clues&&e.clues.length>0,a=c&&P,i=U(C),k=c?a?'<span class="cloze-badge cloze-badge--phase cloze-badge--phase-clue">🔍 Step 1 · Clue Hunt</span>':'<span class="cloze-badge cloze-badge--phase cloze-badge--phase-fill">🏰 Step 2 · Fill the Blanks</span>':"",u=c?a?"🔍 Step 1 of 2 — Tap the clue word in the passage that hints at the answer.":"🏰 Step 2 of 2 — Now tap a word from the bank to fill the next blank.":"🏰 Tap a word from the bank to fill the next blank.";b.innerHTML=`
    ...
    </div>`;const t=document.getElementById("cloze-scan-host");tt({host:t,attention:l,onContinue:()=>{Y=!0,ee(e)},onSkip:()=>{Y=!0,ee(e)}})}function gt(){const e=Object.values(R||{}).map($e);if(!e.length)return"☆ ☆ ☆";const l=e.reduce((n,c)=>n+c,0)/e.length,t=l>=.85?3:l>=.45?2:1;return`${"★".repeat(t)}${"☆".repeat(3-t)}`}function vt(e){const l=_e(e);if(!l)return"";const t=U(C);return`
    ...
    </div>`}function yt(e){var t,n;U(C).allowHints&&((t=document.getElementById("clue-hint-btn"))==null||t.addEventListener("click",()=>{const c=_e(e);if(!c)return;V=Math.min(V+1,4),O=ct(O);const{message:a}=at(V,c),i=document.getElementById("clue-hint-msg");i&&(i.textContent=a,i.className="clue-hint-msg clue-hint-msg--visible"),V>=4&&(R[x]="weak",me(e,"weak"))}),(n=document.getElementById("clue-skip-btn"))==null||n.addEventListener("click",()=>{x<0||(R[x]="weak",me(e,"weak"))}))}function Ne(e,l){var u;const t=_e(l);if(!t)return;const n=dt(e,t),c=Fe(n),a=re(((u=l.blankSkills)==null?void 0:u[x])||(m!=="__all__"?m:"sentenceLogic")),i=document.getElementById("clue-hunt-feedback");if(i){const d=He(t.clueType),p=J(a),r=t.explanation||"Use the clue to choose the best-fitting word.";i.textContent=`${d} · ${p}. ${c.message} ${r}`,i.className=`clue-hunt-feedback ${c.cssClass}`}const k=document.getElementById("cloze-passage");k&&Pe({container:k,text:l.text,activeBlankIndex:x,selectedWord:e,selectedResult:n,filledAnswers:E.map((d,p)=>{var r;return d!==null&&((r=L.find(s=>s.id===d))==null?void 0:r.word)||""}),onTapWord:d=>Ne(d,l)}),y.recordClueAttempt({quest:"clozeCastle",result:n,clueType:t.clueType}),n==="strong"||n==="partial"?(R[x]=n,G.playSfx(n==="strong"?"correct":"pop"),setTimeout(()=>me(l,n),800)):(ie++,G.playSfx("wrong"),ie>=2&&(R[x]="weak",setTimeout(()=>me(l,"weak"),1e3)))}function me(e,l){if(!P)return;P=!1,x=-1,ke+=$e(l);const t=document.getElementById("cloze-instruction");t&&(t.textContent="🏰 Now tap a word to fill the blank!");const n=document.getElementById("cloze-bank-wrapper");n&&(n.className="cloze-bank-wrapper");const c=document.getElementById("cloze-check");c&&(c.disabled=!1),Q(e)}function ae(e){const l=document.getElementById("cloze-passage");if(l)if(P){const t=E.map(n=>{var c;return n!==null&&((c=L.find(a=>a.id===n))==null?void 0:c.word)||""});Pe({container:l,text:e.text,activeBlankIndex:x,filledAnswers:t,onTapWord:n=>Ne(n,e)})}else lt({container:l,text:e.text,blankFills:E,bankWords:L,blankClass:"cloze-blank",filledClass:"cloze-blank--filled",emptyBlankAria:t=>`Empty blank ${t+1}`,removeBlankAria:t=>`Remove ${t} from blank`,onRemoveWord:()=>{ae(e),Q(e)},onTapEmpty:t=>{t.classList.add("cloze-blank--selected"),setTimeout(()=>t.classList.remove("cloze-blank--selected"),800)}})}function Q(e){const l=document.getElementById("cloze-bank");if(l){if(P){l.innerHTML=L.map(t=>`
      <button class="cloze-word-chip cloze-word-chip--locked"
              disabled aria-disabled="true"
              aria-label="${qe(t.word)}">${v(t.word)}</button>
    `).join("");return}nt({container:l,bankWords:L,chipClass:"cloze-word-chip",usedClass:"cloze-word-chip--used",onChooseWord:t=>{if(!pt(L,E,t))return;G.playSfx("pop");const n=(e.clues||[]).slice().sort((c,a)=>c.blankIndex-a.blankIndex).find(c=>E[c.blankIndex]===null&&!R.hasOwnProperty(c.blankIndex));n?(x=n.blankIndex,P=!0,V=0,ie=0,console.info("[ClozeCastle] Activating next clue target",{blankIndex:x,passageId:e.id}),ee(e)):(ae(e),Q(e))}})}}function _e(e){return e.clues&&e.clues.find(l=>l.blankIndex===x)||null}function zt(e,l){return e.clues&&e.clues.find(t=>t.blankIndex===l)||null}function oe(e,l){const t=m!=="__all__"?re(m):"sentenceLogic";return e.answers.map((n,c)=>{var r,s;const a=zt(e,c),i=l[c]||"",k=We(e,c),u=re(k.primarySkill||t),d=i!==n,p=d?ut({meta:k,chosen:i,correct:n}):null;return{blank:`#${c+1}`,passageTitle:e.title,studentAnswer:i,correctAnswer:n,status:d?"Try again":"Correct",skillLabel:J(u),clueTypeLabel:He(k.clueType||(a==null?void 0:a.clueType)),clue:((r=a==null?void 0:a.acceptableSpans)==null?void 0:r[0])||"—",explanation:((s=e.grammarNotes)==null?void 0:s[c])||k.correctReason||(a==null?void 0:a.explanation)||"Read the words before and after the blank.",nextStepPrompt:mt(u),whyWrong:p==null?void 0:p.whyWrong,whyRight:p==null?void 0:p.whyRight,missedClue:p==null?void 0:p.missedClue,examTip:k.examTip||(p?p.examTip:"")}})}function wt(e){if(E.some(r=>r===null)){H("Fill in all the blanks first! 🏰",!1);return}const l=st(E,L);[...l];const t=l.every((r,s)=>r===e.answers[s]),n=l.filter((r,s)=>r===e.answers[s]).length,c=U(C),a=m==="__all__"?"mixed":m,i=e.answers.map((r,s)=>{var w;return re(((w=e.blankSkills)==null?void 0:w[s])||(m!=="__all__"?m:"sentenceLogic"))}),k=new Set(i.filter((r,s)=>l[s]!==e.answers[s]));ge.recordAttempt({quest:"clozeCastle",skill:a,correct:t,responseMs:2e3,level:z}),ge.updateSkill("clozeCastle",a,t),fe.recordGrammarCategoryAttempt(z,a,t),ce++,W+=e.answers.length,D+=n;const u=ot({storageKey:"ccqWeakSkills",level:z,skills:i,wrongSkillSet:k,current:y.get("ccqWeakSkills")||{}});y.set("ccqWeakSkills",u);let d=y.get("masteryMap")||{};const p=oe(e,l);if(p.forEach((r,s)=>{const w=We(e,s),g=r.status!=="Correct",h=w.primarySkill;F[h]||(F[h]={correct:0,total:0,label:r.skillLabel||J(h),lastWrongExamples:[]});const o=F[h];o.total+=1,g?r.correctAnswer&&o.lastWrongExamples.length<3&&o.lastWrongExamples.push(r.correctAnswer):o.correct+=1,d=rt({mode:"clozeCastle",level:z,category:a,skill:h,clueType:w.clueType,wasWrong:g,example:g?{passageId:e.id,blankIndex:s,chosen:r.studentAnswer,correct:r.correctAnswer,clueType:w.clueType}:null,current:d})}),y.set("masteryMap",d),c.showFinalReviewOnly){Z.push(...p.filter(s=>s.status!=="Correct").map(s=>({passageTitle:s.passageTitle,blank:s.blank,studentAnswer:s.studentAnswer,correctAnswer:s.correctAnswer,explanation:s.explanation,skillLabel:s.skillLabel})));const r=y.get("ccqExamAttempts")||[];r.push({level:z,category:a,passageId:e.id,blankCorrect:n,blankTotal:e.answers.length,submittedAt:Date.now()}),y.set("ccqExamAttempts",r.slice(-150)),I++,N();return}if(t){ne++,je.recordCorrect(2e3,!1),U(C).confettiPerPassage&&Ae(),G.playSfx("correct"),ve.celebrate(!1);const r=Math.round(n/Math.max(1,e.answers.length)*100);if(m!=="__all__"&&e.id){const s=it({level:z,category:m,passageId:e.id,accuracy:r,ccqCompletedByPassage:y.get("ccqCompletedByPassage")||{},ccqCompleted:y.get("ccqCompleted")||{},ccqCatCompleted:y.get("ccqCatCompleted")||{}});y.set("ccqCompletedByPassage",s.nextByPassage),y.set("ccqCompleted",s.nextCompleted),y.set("ccqCatCompleted",s.nextCatCompleted)}document.querySelectorAll(".cloze-blank--filled").forEach(s=>s.classList.add("cloze-blank--correct")),he({host:b.querySelector(".cloze-game"),title:"Answer Review",rows:oe(e,l),onContinue:()=>{e.clues&&e.clues.length>0?xt(e,()=>setTimeout(()=>{I++,N()},600)):(H("✅ Excellent! All correct!",!0),setTimeout(()=>{I++,N()},1200))}})}else{if(G.playSfx("wrong"),ye++,document.querySelectorAll(".cloze-blank--filled").forEach((r,s)=>{var g;const w=((g=L.find(h=>h.id===E[s]))==null?void 0:g.word)||"";r.classList.toggle("cloze-blank--wrong",w!==e.answers[s])}),ve.encourage(),C==="exam"){he({host:b.querySelector(".cloze-game"),title:"Exam Submission Review",rows:oe(e,l),onContinue:()=>{I++,N()}});return}ye>=2?(H("❌ Let's review your answers first.",!1),setTimeout(()=>{document.querySelectorAll(".cloze-blank--wrong").forEach(s=>s.classList.remove("cloze-blank--wrong"));const r=document.getElementById("cloze-feedback");r&&(r.hidden=!0),he({host:b.querySelector(".cloze-game"),title:"Review Mistakes",rows:oe(e,l),onContinue:()=>$t(e,l)})},800)):(H("❌ Some blanks are wrong – try again!",!1),setTimeout(()=>{document.querySelectorAll(".cloze-blank--wrong").forEach(s=>s.classList.remove("cloze-blank--wrong"));const r=document.getElementById("cloze-feedback");r&&(r.hidden=!0)},1800))}}function Ct(e,l){var a,i;if(!b)return;const t={...y.get("lessonsSeen")||{}};t[`cloze:${e}`]||(t[`cloze:${e}`]=new Date().toISOString(),y.set("lessonsSeen",t));const n=be(e),c=B[e]||{icon:"🏰",label:e};b.innerHTML=`
    ...
    <div class="cloze-complete">
      ...
      <p class="cloze-complete-score">Blanks: ${D} / ${W} correct · ${t}%</p>
    ...
    </div>`,(o=document.getElementById("cloze-back-cat"))==null||o.addEventListener("click",()=>ue(z)),($=document.getElementById("cloze-replay"))==null||$.addEventListener("click",()=>{m==="__all__"?De(z):Ce(z,m)}),(S=document.getElementById("cloze-copy-summary"))==null||S.addEventListener("click",async()=>{var _;const f=Ze({modeLabel:c.label,title:`${j[z]} · ${l}`,category:l,level:j[z],scoreLine:Te({mode:C,blankCorrect:D,blankTotal:W,passageCorrect:ne,passageTotal:ce}),accuracy:t,timeTaken:`${a}s`,hintsUsed:O,clueScore:r??0,wrongLines:d,nextStep:i});try{await((_=navigator.clipboard)==null?void 0:_.writeText(f)),H("Summary copied!",!0)}catch{H("Unable to copy summary on this device.",!1)}}),(X=document.getElementById("cloze-copy-parent-report"))==null||X.addEventListener("click",async()=>{var Se,Le;const{strongest:f,weakest:_}=Je(F),A=Te({mode:C,blankCorrect:D,blankTotal:W,passageCorrect:ne,passageTotal:ce}),se=Qe({questLabel:"Cloze Castle",modeLabel:c.label,scoreLine:A,accuracy:t,strongest:f,weakest:_,weakExamples:_?((Se=F[_.skill])==null?void 0:Se.lastWrongExamples)||[]:[],recommendation:i});try{await((Le=navigator.clipboard)==null?void 0:Le.writeText(se)),H("Parent report copied!",!0)}catch{H("Unable to copy parent report on this device.",!1)}}),(K=document.getElementById("cloze-back-levels"))==null||K.addEventListener("click",()=>Ee()),q&&(document.removeEventListener("keydown",q),q=null),setTimeout(()=>{var f;return(f=document.getElementById("cloze-back-cat"))==null?void 0:f.focus()},200)}export{we as cleanupClozeCastle,It as initClozeCastle,Mt as showClozeBrowser};
