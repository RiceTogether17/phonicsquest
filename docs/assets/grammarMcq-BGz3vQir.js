import{o as X,a1 as J,G as A,s as C,q as T,T as D,A as u,R as W,a2 as Z,U as I}from"./index-CkYopHYb.js";import{g as ee,i as te,r as se,M as le,f as re,b as ae,a as ce,c as ne}from"./mcqDifficulty-BB0Bxq4L.js";import{G as _,a as B,b as ie}from"./grammarMcq-DImI3FMz.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";import"./practiceExpansion-67d_LqFm.js";let c=null,G=null,h=[],b=0,E=0,x=!1,q={level:null,category:null,label:"All Skills",difficulty:"normal"},m="normal",f=0,$=0,k=[],M=!1,L={},w={},j=0;const K=3;function P(e){return`gmcq:${e}`}function oe(e){return!!(C.get("lessonsSeen")||{})[P(e)]}function ue(e){const t={...C.get("lessonsSeen")||{}};t[P(e)]||(t[P(e)]=new Date().toISOString(),C.set("lessonsSeen",t))}function _e(e,t){c=e,G=t}function xe(){c&&(c.innerHTML="")}function de(e=_){return B.flatMap(t=>e[t]||[])}function U({level:e=null,category:t=null}={},s=_){const l=e?s[e]||[]:de(s);return t?l.filter(a=>a.category===t):l}function Y(e={},t=_){return U(e,t).length}function me(e=_,t=X){return t.map(s=>{const l={};let a=0;for(const i of B){const n=Y({level:i,category:s},e);l[i]=n,a+=n}return{category:s,total:a,levels:l}})}function pe(e=_,t=B){return t.map(s=>({level:s,total:Y({level:s},e)}))}function F(e){var t;return((t=A[e])==null?void 0:t.label)||e}function he(e){const t=e.level||null,s=e.category?F(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function N(){if(!c)return;const e=pe(),t=me();let s=q.level||ee(),l=q.difficulty||m||"normal";const a=()=>{var i,n;c.innerHTML=`
