import{C as re,r as Me}from"./chartjs-BR_H7_9u.js";import{g as Re,s as v,a as Oe,r as Pe,b as W,n as H,S as z,V as N,h as R,W as j,c as G,G as D,d as oe,e as je,f as ce,i as Ne,j as ie,P as Ie,C as q,p as I,k as Te,l as Ge,m as De,o as Ve,q as Be,t as V,u as le,v as We,w as He,x as F,y as ze,z as U,A as qe,B as Fe}from"./index-CYQu5mDr.js";import{r as Ue}from"./curriculumMap-DK4JpjdN.js";import"./vocabPassages-C6X4T5EP.js";import"./passages-C58v9gBd.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";import"./practiceExpansion-D0CCBel5.js";function A(e){const t=(v.get("questMastery")||{})[e]||{},s=Object.values(t).filter(a=>typeof a=="number");return s.length?s.reduce((a,n)=>a+n,0)/s.length:null}function P(e){const s=(v.get("clueStats")||{})[e];if(!s)return null;if(e==="sentenceForge"){const n=(s.correct||0)+(s.incorrect||0);return n>0?{accuracy:s.correct/n,attempted:n}:null}const a=s.attempted||0;return a?{accuracy:((s.strong||0)+(s.partial||0)*.5)/a,attempted:a,strong:s.strong||0,partial:s.partial||0,weak:s.weak||0}:null}function Z(e){const t=(v.get("questMastery")||{})[e]||{};if(!Object.keys(t).length)return null;let s=null,a=1/0;for(const[n,r]of Object.entries(t))r<a&&(a=r,s=n);return s?{skill:s,score:a}:null}function de(){const e=H(v.get("groupMastery")||{});let t=null,s=1/0;for(const a of z){const n=e[a];typeof n=="number"&&n<s&&(s=n,t=a)}return t}function Qe(e,t=10){const s=(v.get("questAttempts")||[]).filter(a=>a.quest===e).slice(0,t);return s.length<3?null:s.filter(a=>a.correct).length/s.length}function Ye(e,t){return e===null?null:e>=.7&&t!==null&&t>=.7?"Finding clues and answering correctly":e>=.7&&t!==null&&t<.55?"Finds clue but chooses wrong answer":e<.5&&t!==null&&t<.5?"Misses clue and answer — needs focused practice":e<.5&&t!==null&&t>=.65?"Answering correctly but clue work still weak":e>=.5&&e<.7?"Developing clue detection skills":"Building understanding"}function pe(){var i,p;const e=W(),t=H(v.get("groupMastery")||{}),s=(e==null?void 0:e.schoolLevel)==="primary"?"Primary":"Preschool",a=z.map(l=>({label:N[l],score:t[l]??null})).filter(l=>l.score!==null),n=[...a].sort((l,y)=>y.score-l.score),r=n[0],o=n[n.length-1],c=[{name:"Grammar Cloze",score:A("clozeCastle")},{name:"Sentence Skills",score:A("sentenceForge")},{name:"Vocabulary Cloze",score:A("wordVault")}].filter(l=>l.score!==null).sort((l,y)=>y.score-l.score),d=((i=c[0])==null?void 0:i.name)||(r?`Phonics (${r.label})`:"Not enough data yet"),u=((p=c[c.length-1])==null?void 0:p.name)||(o?`Phonics (${o.label})`:"Not enough data yet");let h;if((e==null?void 0:e.schoolLevel)==="primary"){const l=A("sentenceForge"),y=A("clozeCastle"),b=A("wordVault");l!==null&&l<.6?h="Sentence structure skills":y!==null&&y<.6?h="Grammar cloze passages":b!==null&&b<.6?h="Vocabulary in context":h="Advanced sentence and grammar skills"}else{const l=de();l&&(t[l]??0)<.6?h=`Short vowel sounds (${N[l]||l})`:a.length?h="Phonics blending and awareness":h="Starting phonics journey"}return{learnerType:s,profileName:(e==null?void 0:e.name)||"Learner",profileAvatar:(e==null?void 0:e.avatar)||"🦉",strongest:d,weakest:u,currentFocus:h}}function ue(){const e=H(v.get("groupMastery")||{}),t=z.map(d=>e[d]).filter(d=>typeof d=="number"),s=t.length?t.reduce((d,u)=>d+u,0)/t.length:null,a=[],n=P("clozeCastle");n&&a.push(n.accuracy);const r=P("sentenceForge");r&&a.push(r.accuracy);const o=P("wordVault");o&&a.push(o.accuracy);const c=a.length?a.reduce((d,u)=>d+u,0)/a.length:null;return[{id:"phonics",label:"Phonics / Decoding",icon:"🔤",score:s,color:"#3b82f6"},{id:"sentenceSkills",label:"Sentence Skills",icon:"🔨",score:A("sentenceForge"),color:"#f97316"},{id:"grammarCloze",label:"Grammar Cloze",icon:"🏰",score:A("clozeCastle"),color:"#a855f7"},{id:"vocabCloze",label:"Vocabulary Cloze",icon:"🔑",score:A("wordVault"),color:"#0d9488"},{id:"editingQuest",label:"Editing Quest",icon:"✏️",score:A("editingQuest"),color:"#0ea5e9"},{id:"writingQuest",label:"Writing Quest",icon:"📝",score:A("writingQuest"),color:"#7c3aed"},{id:"clueDetection",label:"Clue Detection",icon:"🔍",score:c,color:"#f59e0b"}]}function he(){const e=v.get("clueStats")||{},t=v.get("questAttempts")||[],s=[],a=[{key:"clozeCastle",label:"Cloze Castle",icon:"🏰"},{key:"wordVault",label:"Word Vault",icon:"🔑"},{key:"sentenceForge",label:"Sentence Forge",icon:"🔨"},{key:"editingQuest",label:"Editing Quest",icon:"✏️"},{key:"writingQuest",label:"Writing Quest",icon:"📝"}];for(const{key:r,label:o,icon:c}of a){const d=P(r);if(!d)continue;const u=t.filter(i=>i.quest===r),h=u.length>=3?u.filter(i=>i.correct).length/u.length:null;s.push({quest:o,icon:c,clueAttempted:d.attempted,clueAccuracy:d.accuracy,answerAccuracy:h,interpretation:Ye(d.accuracy,h)})}const n=Object.entries(e.byType||{}).filter(([,r])=>r.attempted>=3).map(([r,o])=>({type:R(r),accuracy:((o.strong||0)+(o.partial||0)*.5)/o.attempted,attempted:o.attempted})).sort((r,o)=>r.accuracy-o.accuracy);return{questInsights:s,byType:n}}function Ke(){return[{code:"LO 3.1",focus:"Decode and blend multi-syllabic words",target:"blend"},{code:"LO 4.2",focus:"Use grammar in context and editing",target:"cloze-castle"},{code:"LO 5.2",focus:"Synthesis and sentence transformation",target:"sentence-forge"}]}function me(){const e=W(),t=(e==null?void 0:e.schoolLevel)==="primary",s=v.get("groupMastery")||{},a=[];if(t){const n=P("clozeCastle");if(n&&n.accuracy<.6){const d=Z("clozeCastle"),u=Math.round(n.accuracy*100);a.push({why:`Grammar clue accuracy is ${u}%.${d?` Weakest area: ${R(d.skill)}.`:""}`,target:`Cloze Castle${d?` – ${R(d.skill)}`:""}`,ctaLabel:"Practise Cloze Castle",ctaTarget:"cloze-castle"})}const r=Z("sentenceForge"),o=Qe("sentenceForge");(o!==null&&o<.65||r&&r.score<.55)&&a.push({why:r?`Sentence skill "${R(r.skill)}" scores ${Math.round(r.score*100)}% — needs practice.`:"Recent sentence building accuracy is below target.",target:`Sentence Forge${r?` – ${R(r.skill)}`:""}`,ctaLabel:"Try Sentence Forge",ctaTarget:"sentence-forge"});const c=P("wordVault");c&&c.accuracy<.6&&a.push({why:`Vocabulary context clue accuracy is ${Math.round(c.accuracy*100)}%.`,target:"Word Vault – Context Clues",ctaLabel:"Practise Word Vault",ctaTarget:"word-vault"}),a.length||a.push({why:"Keep grammar skills sharp with regular practice.",target:"Cloze Castle",ctaLabel:"Open Cloze Castle",ctaTarget:"cloze-castle"},{why:"Consistent sentence structure practice builds academic writing.",target:"Sentence Forge",ctaLabel:"Open Sentence Forge",ctaTarget:"sentence-forge"})}else{const n=de(),r=n?s[n]??0:null;if(n&&r<.65){const d=Math.round(r*100);a.push({why:`${N[n]} decoding accuracy is ${d}% — below the 65% target.`,target:`Phonics – ${N[n]}`,ctaLabel:"Practise Blend It!",ctaTarget:"blend",ctaGroup:n})}const o=z.map(d=>s[d]??0);o.reduce((d,u)=>d+u,0)/o.length>=.6&&a.push({why:"Phonics foundation is building well. Sight words extend reading fluency.",target:"Sight Words",ctaLabel:"Try Sight Words",ctaTarget:"sight-words"}),a.push({why:"Reading decodable stories reinforces all phonics skills in context.",target:"Giri Stories",ctaLabel:"Read a Story",ctaTarget:"stories"})}return a.slice(0,3)}function ge(){const e=[],t=v.get("wordHistory")||[],s=v.get("questAttempts")||[],a=v.get("clueStats")||{},n=Date.now(),r=7*24*60*60*1e3,o=t.filter(i=>i.timestamp&&n-new Date(i.timestamp).getTime()<r),c=t.filter(i=>{if(!i.timestamp)return!1;const p=n-new Date(i.timestamp).getTime();return p>=r&&p<2*r});if(o.length>=5&&c.length>=5){const i=o.filter(l=>l.correct).length/o.length,p=c.filter(l=>l.correct).length/c.length;i>p+.1?e.push("Accuracy has improved over the last 7 days"):i<p-.1&&e.push("Accuracy has dipped recently — more practice will help")}const d=a.byType||{},u=Object.entries(d).filter(([,i])=>i.attempted>=3).filter(([,i])=>((i.strong||0)+(i.partial||0)*.5)/i.attempted<.45).map(([i])=>R(i));u.length>0&&e.push(`Struggled with ${u[0]} clues recently`),s.filter(i=>i.quest==="sentenceForge").length<3&&e.push("Not enough data yet in Sentence Forge");const h=Object.entries(d).filter(([,i])=>i.attempted>=3).filter(([,i])=>((i.strong||0)+(i.partial||0)*.5)/i.attempted>=.75).map(([i])=>R(i));return h.length>0&&e.push(`Strong in ${h[0]} passages`),!e.length&&t.length<10&&e.push("Keep playing to see learning pattern insights here"),e.slice(0,4)}function ye(){const e=Re(),t=v.get("wordHistory")||[],s=v.get("streak")||0,a=Date.now(),n=7*24*3600*1e3,r=a-n,o=new Date(r).toISOString().slice(0,10),d=(v.get("weeklyXpLog")||[]).filter(w=>w.date>=o).reduce((w,Ee)=>w+(Ee.xp||0),0),u=t.filter(w=>w.timestamp&&new Date(w.timestamp).getTime()>=r),h=new Set(u.map(w=>w.word).filter(Boolean)).size,i=v.get("questAttempts")||[],p=new Set(i.filter(w=>w.timestamp&&new Date(w.timestamp).getTime()>=r).map(w=>new Date(w.timestamp).toDateString()));v.get("lastPlayDate")===new Date().toDateString()&&p.add(new Date().toDateString());const l=p.size,y=Oe(),b={"on-track":{label:"On track",emoji:"✅"},"needs-practice":{label:"Needs practice",emoji:"⚠️"},"at-risk":{label:"Needs attention",emoji:"🔴"},"no-data":{label:"Getting started",emoji:"📊"}},g=b[e.overallSignal]||b["no-data"],S=e.strongDomains[0]||e.masteredDomains[0]||null,C=S?`${S.icon} ${S.label} (${Pe(S.state)})`:"Still building foundations — every session counts!",$=e.domainsAtRisk[0]||e.needsPractice[0]||null,_=$?`${$.icon} ${$.label} needs attention`:null,L=e.progressionDecision,m=L&&L.decision!=="no-data"?L.label:null;let k,x;$?(k=`Practise ${$.icon} ${$.label} this week`,x=(L==null?void 0:L.decision)==="consolidate"?"Securing this area before moving on will build lasting confidence.":"Regular short practice sessions will close the gap quickly."):e.reviewsDue>0?(k=`Complete ${e.reviewsDue} spaced review word${e.reviewsDue>1?"s":""}`,x="Reviewing words at the right time is how long-term memory forms."):(k="Keep the daily habit going — all areas are in good shape",x="Consistency is the most powerful factor in language learning.");const M=e.reviewsDue>0?`${e.reviewsDue} word${e.reviewsDue>1?"s":""} due for review`:"No review words due today";return{weekDays:l,weekWords:h,weekXp:d,streak:s,domainCounts:y,overallSignal:e.overallSignal,signalLabel:g.label,signalEmoji:g.emoji,domainsAtRisk:e.domainsAtRisk,needsPractice:e.needsPractice,mainStrength:C,mainConcern:_,advancementNote:m,weeklyPriority:k,whyPriority:x,reviewsDue:e.reviewsDue,reviewNote:M}}function Xe(){const e=v.get("wordStats")||{},t=[];for(const s of j){const a=e[s.id];if(!a||a.attempts<6)continue;const n=a.correct/a.attempts;n<.4&&t.push({word:s.word,group:s.group,attempts:a.attempts,accuracy:Math.round(n*100)})}return t.sort((s,a)=>s.accuracy-a.accuracy),t.slice(0,6)}const ve={connectorClue:"LO-ENG-GR-03",contextInference:"LO-ENG-VOC-02",synonymContrast:"LO-ENG-VOC-03",definitionMatch:"LO-ENG-VOC-01",idiomaticExpressions:"LO-ENG-VOC-05",proverbsSayings:"LO-ENG-VOC-06",scienceTechTerms:"LO-ENG-VOC-07",socialStudiesVocab:"LO-ENG-VOC-08",pronouns:"LO-ENG-GR-04",svAgreement:"LO-ENG-GR-05",conditionals:"LO-ENG-GR-08",passiveVoice:"LO-ENG-GR-09",reportedSpeech:"LO-ENG-GR-10",relativeClauses:"LO-ENG-GR-11",tenses:"LO-ENG-GR-06",modals:"LO-ENG-GR-07",morphologicalAffix:"LO-ENG-VOC-04",collocationCloze:"LO-ENG-VOC-09",grammaticalRole:"LO-ENG-VOC-10"},Ze={pronouns:1.25,connectorClue:1.2,conditionals:1.2,passiveVoice:1.15,reportedSpeech:1.15,tenses:1.2,modals:1.2,morphologicalAffix:1.15,synonymContrast:1.1,collocationCloze:1.15,scienceTechTerms:1.1,socialStudiesVocab:1.1};function J(e){const t=Ze[e.key]||1,s=e.attempts===0?.1:0;return(1-(e.accuracy||0))*t+s}const fe="https://www.moe.gov.sg/primary/curriculum/syllabus";function be(e,t){return t>0?e/t:0}function we(e,t){const s=v.get("questAttempts")||[];return t.map(a=>{const n=s.filter(c=>c.quest===e&&c.skill===a),r=n.length,o=n.filter(c=>c.correct).length;return{key:a,attempts:r,correct:o,accuracy:be(o,r)}})}function $e(){var n;const e=Object.keys(G),t=we("wordVault",e),s=((n=v.get("clueStats"))==null?void 0:n.wordVault)||{attempted:0,strong:0,partial:0},a=s.attempted>0?((s.strong||0)+(s.partial||0))/s.attempted:0;return t.map(r=>{var o,c;return{...r,label:((o=G[r.key])==null?void 0:o.label)||r.key,tooltip:((c=G[r.key])==null?void 0:c.desc)||"Vocabulary development category",loCode:ve[r.key]||"LO-ENG-VOC",clueSuccess:a,syllabusLink:fe}})}function ke(){var n;const e=Object.keys(D),t=we("clozeCastle",e),s=((n=v.get("clueStats"))==null?void 0:n.clozeCastle)||{attempted:0,strong:0,partial:0},a=s.attempted>0?((s.strong||0)+(s.partial||0))/s.attempted:0;return t.map(r=>{var o,c;return{...r,label:((o=D[r.key])==null?void 0:o.label)||r.key,tooltip:`${((c=D[r.key])==null?void 0:c.label)||r.key} mastery`,loCode:ve[r.key]||"LO-ENG-GR",clueSuccess:a,syllabusLink:fe}})}function Se(){const e=$e().map(s=>({...s,priorityScore:J(s)})).sort((s,a)=>a.priorityScore-s.priorityScore).slice(0,3),t=ke().map(s=>({...s,priorityScore:J(s)})).sort((s,a)=>a.priorityScore-s.priorityScore).slice(0,3);return{vocab:e,grammar:t}}function Ce({days:e=7}={}){const t=v.get("learningEvents")||[],s=Date.now()-e*24*60*60*1e3,n=t.filter(u=>{const h=Date.parse(u.timestamp||"");return Number.isFinite(h)&&h>=s}).filter(u=>u.eventType==="quest_attempt"),r=n.filter(u=>typeof u.responseMs=="number"),o=n.filter(u=>u.correct===!0).length,c=r.length?Math.round(r.reduce((u,h)=>u+h.responseMs,0)/r.length):null,d=["sentenceForge","clozeCastle","wordVault"].map(u=>{const h=n.filter(l=>l.quest===u),i=h.length,p=h.filter(l=>l.correct===!0).length;return{quest:u,attempts:i,accuracy:i>0?p/i:0}});return{days:e,attempts:n.length,correct:o,accuracy:n.length?o/n.length:0,avgResponseMs:c,byQuest:d}}function Je({limit:e=6}={}){const{vocab:t,grammar:s}=Se(),a=Ce({days:7}),n=[];for(const c of t)n.push({quest:"wordVault",skill:c.key,label:c.label,loCode:c.loCode,reason:`Low mastery (${Math.round(c.accuracy*100)}%) in ${c.label}`,targetAccuracy:.85});for(const c of s)n.push({quest:"clozeCastle",skill:c.key,label:c.label,loCode:c.loCode,reason:`MOE-priority grammar focus: ${c.label}`,targetAccuracy:.85});a.avgResponseMs!==null&&a.avgResponseMs>3500&&n.unshift({quest:"sentenceForge",skill:"fluency",label:"Sentence fluency sprint",loCode:"LO-ENG-FLUENCY",reason:`Average response time is ${a.avgResponseMs}ms (target < 3000ms).`,targetAccuracy:.8});const r=new Set,o=[];for(const c of n){const d=`${c.quest}:${c.skill}`;if(!r.has(d)&&(r.add(d),o.push(c),o.length>=e))break}return o}function et(){const e=v.get("questAttempts")||[];return["sentenceForge","clozeCastle","wordVault"].map(s=>{const a=e.filter(c=>c.quest===s).slice(0,12),n=a.length,r=a.filter(c=>c.correct).length,o=be(r,n);return{quest:s,total:n,correct:r,accuracy:o}})}const ee={grammar:{target:"grammar-mcq",label:"🧠 Grammar MCQ"},vocabulary:{target:"vocab-mcq",label:"📖 Vocabulary MCQ"},vocab:{target:"vocab-mcq",label:"📖 Vocabulary MCQ"}},B=Object.freeze({red:55,amber:75}),te=Object.freeze({unknown:"⚪ Not enough evidence",green:"🟢 Secure",amber:"🟡 Developing",red:"🔴 Needs support"});function Le(e){return e==null||Number.isNaN(e)?"unknown":e<B.red?"red":e<B.amber?"amber":"green"}function tt(e=[]){if(!Array.isArray(e)||e.length===0)return{band:"unknown",label:te.unknown,summary:"No weak skills detected yet — keep practising to build a clearer picture.",skills:[]};const t=e.map(r=>({label:r.label,pct:r.pct,band:Le(r.pct),attempts:r.attempts??0,independentAttempts:r.independentAttempts??0,lastPractised:r.lastPractised??null,confidence:r.confidence??oe(r.independentAttempts??0)})),s={red:4,unknown:3,amber:2,green:1},a=t.reduce((r,o)=>s[o.band]>s[r]?o.band:r,"green");let n;if(a==="red"){const r=t.filter(o=>o.band==="red").map(o=>o.label);n=`${Q(r)} below ${B.red}% — focused practice this week will lift exam scores.`}else if(a==="unknown"){const r=t.filter(o=>o.band==="unknown").map(o=>o.label);n=`Not enough practice yet to judge ${Q(r)} — a few short sessions will show where things stand.`}else if(a==="amber"){const r=t.filter(o=>o.band==="amber").map(o=>o.label);n=`${Q(r)} under ${B.amber}% — solid practice will close the gap before the next paper.`}else n="Skills look solid for the next paper — keep the rhythm going.";return{band:a,label:te[a],summary:n,skills:t}}function Q(e){return e.length===0?"":e.length===1?e[0]:e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")} and ${e[e.length-1]}`}function st(e){const t=(e==null?void 0:e.profile)||null,s=Array.isArray(e==null?void 0:e.weakSkills)?e.weakSkills:[],a=Array.isArray(e==null?void 0:e.strengths)?e.strengths:[],n=Array.isArray(e==null?void 0:e.recentMistakes)?e.recentMistakes:[],r=(e==null?void 0:e.weekly)||{days:0,words:0,accuracy:0},o=s.slice(0,3).map(g=>({label:g.label,pct:(g.attempts??0)>0?Math.round((g.score||0)*100):null,domain:g.domain||"grammar",attempts:g.attempts??0,independentAttempts:g.independentAttempts??0,lastPractised:g.lastPractised??null,confidence:g.confidence??oe(g.independentAttempts??0)})),c=a.slice(0,3).map(g=>({label:g.label,pct:Math.round((g.score||0)*100)})),d=tt(o),u=at(o[0],t),h=nt({topWeak:o,topStrong:c,weekly:r,profile:t}),i=n.slice(0,5).map(g=>({word:String(g.word||"").slice(0,40),mode:g.mode||"",when:g.when||""})),p=o.map(g=>({...g,band:Le(g.pct)})),l=Array.isArray(e==null?void 0:e.graduatingSoon)?e.graduatingSoon.slice(0,5).map(g=>({word:String(g.word||"").slice(0,40)})).filter(g=>g.word):[],y=Array.isArray(e==null?void 0:e.slippingRecently)?e.slippingRecently.slice(0,5).map(g=>({word:String(g.word||"").slice(0,40)})).filter(g=>g.word):[],b=je(3).map(g=>({id:g.id,label:g.childName,teacherLabel:g.label,count:g.count,tip:g.selfCheck}));return{learnerName:(t==null?void 0:t.name)||"Your child",grade:(t==null?void 0:t.primaryGrade)||null,avatar:(t==null?void 0:t.avatar)||"🧒",weekly:r,strengths:c.length?c:[{label:"Steady effort",pct:null}],needsPractice:p,habits:b,recentMistakes:i,recommendation:u,examRisk:d,teacherComment:h,graduatingSoon:l,slippingRecently:y}}function at(e,t){if(!e)return{title:"10-minute warm-up: Grammar MCQ",detail:"No weak skills detected yet. A short Grammar MCQ session will help us learn what to focus on.",target:"grammar-mcq",targetLabel:"🧠 Grammar MCQ"};const s=ee[e.domain]||ee.grammar,a=t!=null&&t.primaryGrade?` (${t.primaryGrade})`:"",n=e.pct==null?"not enough practice yet to give a score":`currently ${e.pct}%${K(e)}`;return{title:`10 minutes: ${e.label}${a}`,detail:`Practise ${e.label} — ${n}. Aim for 8 of 10 correct before bed.`,target:s.target,targetLabel:s.label}}function K(e){const t=(e==null?void 0:e.attempts)??0;return t<=0||t>=12?"":` from just ${t} answer${t===1?"":"s"}`}function nt({topWeak:e,topStrong:t,weekly:s,profile:a}){const n=(a==null?void 0:a.name)||"Your child",r=s.days>=5?`${n} has been wonderfully consistent this week (${s.days} active days).`:s.days>=2?`${n} practised on ${s.days} days this week — a solid rhythm.`:`${n} hasn't practised much this week. Two short sessions will keep skills warm.`,o=t[0]?` They are strongest in ${t[0].label}${t[0].pct?` (${t[0].pct}%)`:""}.`:"",c=e[0]?e[0].pct==null?` ${e[0].label} is the area to look at next — there isn't enough practice yet to put a number on it.`:` ${e[0].label} is the area to focus on next — currently ${e[0].pct}%${K(e[0])}.`:" No weak spots have shown up yet — there may simply not be enough practice recorded to tell.";return`${r}${o}${c} Encourage them to read aloud short passages every day to keep building fluency.`}function rt(e){var s,a,n,r,o,c;if(!e)return"";const t=[];if(t.push(`📚 ${e.learnerName}'s English update${e.grade?` (${e.grade})`:""}`),t.push(`This week: ${e.weekly.days} active days · ${e.weekly.words} questions · ${Math.round(e.weekly.accuracy*100)}% accuracy`),(a=(s=e.strengths)==null?void 0:s[0])!=null&&a.pct?t.push(`✅ Strength: ${e.strengths[0].label} (${e.strengths[0].pct}%)`):t.push("✅ Strength: Steady effort"),(n=e.needsPractice)!=null&&n[0]){const d=e.needsPractice[0],u=d.pct==null?"not enough practice yet to score":`${d.pct}%${K(d)}`;t.push(`🎯 Needs practice: ${d.label} (${u})`)}return e.examRisk&&t.push(`🚦 Exam focus: ${e.examRisk.label} — ${e.examRisk.summary}`),(r=e.recentMistakes)!=null&&r.length&&t.push(`📝 Recent slips: ${e.recentMistakes.slice(0,3).map(d=>d.word).join(", ")}`),(o=e.graduatingSoon)!=null&&o.length&&t.push(`🌱 Graduating soon: ${e.graduatingSoon.slice(0,3).map(d=>d.word).join(", ")}`),(c=e.slippingRecently)!=null&&c.length&&t.push(`🍂 Slipping: ${e.slippingRecently.slice(0,3).map(d=>d.word).join(", ")} — a 2-min review tonight will help.`),t.push(`👉 Today's 10 min: ${e.recommendation.title}`),t.push(`💬 Automated learning summary: ${e.teacherComment}`),t.join(`
`)}const _e=2,xe=.6,ot=2,ct=e=>`phonicsquest_profile_${e}`;function it(e){if(!e)return{};try{const t=localStorage.getItem(ct(e)),s=t?JSON.parse(t):null;return s&&typeof s=="object"?s:{}}catch{return{}}}function lt(e){const t=Date.parse(e||"");return Number.isNaN(t)?1/0:(Date.now()-t)/864e5}function dt(e){const t=e==null?void 0:e.misconceptionLog;return!t||typeof t!="object"?[]:Object.entries(t).filter(([s,a])=>!a||typeof a!="object"||Ne(s)||!ie(s)||(a.count||0)<ot?!1:lt(a.lastSeen)<=Ie).map(([s,a])=>({id:s,count:a.count||0})).sort((s,a)=>a.count-s.count)}function pt(e){const t=e==null?void 0:e.groupMastery;if(!t||typeof t!="object")return[];const s=H(t);return Object.entries(s).filter(([a,n])=>typeof n=="number"&&n>0&&n<=xe).filter(([a])=>q.some(n=>n.group===a||n.id===a)).map(([a,n])=>({group:a,mastery:n})).sort((a,n)=>a.mastery-n.mastery)}function ut(e){const t=q.find(s=>s.group===e||s.id===e);return(t==null?void 0:t.name)||N[e]||e}function ht(e){var s;const t=q.find(a=>a.group===e||a.id===e);return{target:((s=t==null?void 0:t.recommendedModes)==null?void 0:s[0])||"blend",group:(t==null?void 0:t.group)||e}}function mt(){const e=ce(),t=new Map;for(const a of e){if(!(a!=null&&a.id))continue;const n=it(a.id),r={id:a.id,name:a.name,avatar:a.avatar};for(const{id:o,count:c}of dt(n)){const d=`misconception:${o}`;t.has(d)||t.set(d,{kind:"misconception",key:o,children:[],total:0});const u=t.get(d);u.children.push({...r,count:c}),u.total+=c}for(const{group:o,mastery:c}of pt(n)){const d=`phonics:${o}`;t.has(d)||t.set(d,{kind:"phonics",key:o,children:[],total:0});const u=t.get(d);u.children.push({...r,mastery:c}),u.total+=1}}return{groups:[...t.values()].filter(a=>a.children.length>=_e).map(a=>a.kind==="misconception"?gt(a):yt(a)).sort((a,n)=>n.children.length-a.children.length||n.total-a.total),childCount:e.length,generatedAt:new Date().toISOString()}}function gt(e){const t=ie(e.key);return{kind:"misconception",key:e.key,title:t.label,childName:t.childName,detail:t.rule,example:t.example,teach:t.cue,children:e.children,total:e.total,action:null}}function yt(e){const t=ut(e.key);return{kind:"phonics",key:e.key,title:t,childName:t,detail:`Practised but not secure — all ${e.children.length} are under ${Math.round(xe*100)}%.`,example:"",teach:`Teach ${t} once to the group, then let each child practise it.`,children:e.children,total:e.total,action:ht(e.key)}}function vt(){return ce().length>=_e}re.register(...Me);let O=null,E=null;function Jt(e,t={}){E=t.onNavigate||null;const s=I.getOverallStats();e.innerHTML=`
    <!-- ── At a glance ────────────────────────────────────────────────────
  ...
  `,$t(),Ct(),xt(),Mt(),Ot(),Rt(),At(),Et(),Pt(),jt(),Lt(),_t(),wt(),Nt(s),It(s),Tt(s),Gt(s),Dt(),Wt(),Vt(),bt()}function T(e,t){e&&(t?e.setAttribute("data-dash-empty","true"):e.removeAttribute("data-dash-empty"))}function ft(e){return e.getAttribute("data-dash-empty")==="true"?!0:e.children.length===0&&!e.textContent.trim()}function bt(){for(const e of document.querySelectorAll(".dash-group")){const t=e.querySelectorAll(".dash-group__body > div[id]");if(!t.length)continue;const s=Array.from(t).every(ft);e.hidden=s}}function wt(){const e=document.getElementById("dash-curriculum-map");if(!e)return;e.innerHTML='<h3 class="dash-section-title">Learning journey</h3><div id="dash-cm-inner"></div>';const t=document.getElementById("dash-cm-inner");t&&Ue(t)}function $t(){var S,C,$,_,L;const e=document.getElementById("dash-parent-report-card");if(!e)return;const t=W(),s=I.getOverallStats(),a=ye(),n=Te(),r=v.get("questMastery")||{},o=[];for(const[,m]of Object.entries(r))if(!(!m||typeof m!="object"))for(const[k,x]of Object.entries(m)){if(typeof x!="number")continue;const M=o.find(w=>w.skill===k);M?x>M.score&&(M.score=x):o.push({skill:k,score:x})}const c=o.filter(m=>m.score>=.75).sort((m,k)=>k.score-m.score).map(m=>({skill:m.skill,label:St(m.skill),score:m.score})),d=(s.recentHistory||[]).filter(m=>m&&m.correct===!1).slice(0,5).map(m=>({word:m.wordId,mode:m.mode,when:X(m.timestamp),correct:!1})),u={days:(a==null?void 0:a.weekDays)??0,words:(a==null?void 0:a.weekWords)??(s.totalAttempts||0),accuracy:s.overallAccuracy||0},h=v.get("wordStats")||{},i=Ge(h,j).map(m=>({word:m.item.word||m.id})),p=De(h,j).map(m=>({word:m.item.word||m.id})),l=st({profile:t,weakSkills:n,strengths:c,recentMistakes:d,weekly:u,graduatingSoon:i,slippingRecently:p});e.innerHTML=`
    <section class="parent-report-card" aria-label="Parent report card" role="region">
      ...
      <div class="parent-report-card__grid">
        ...
        <div class="parent-report-card__cell parent-report-card__cell--review-lane">
          ...
          ${(_=l.graduatingSoon)!=null&&_.length?`
          ...
          `:""}
          ${(L=l.slippingRecently)!=null&&L.length?`
    ...
    <div class="coaching-card ${s}" aria-label="Parent coaching summary">
      ...
      ${c}
      ${u}
    </div>`}function Lt(){const e=document.getElementById("dash-reporting-section");if(!e)return;const t=$e().sort((h,i)=>h.accuracy-i.accuracy).slice(0,8),s=ke().sort((h,i)=>h.accuracy-i.accuracy).slice(0,8),a=et(),n=Se(),r=Ce({days:7}),o=Je({limit:6});T(e,!t.length&&!s.length&&!a.length);const c=h=>h.map(i=>{const p=Math.round((i.accuracy||0)*100),l=Math.round((i.clueSuccess||0)*100);return`<div class="dash-category-row" title="${i.tooltip}">
  ...
  `}function _t(){const e=document.getElementById("dash-moe-section");if(!e)return;const t=Ke();T(e,!t.length),e.innerHTML=`
    ...
    </ul>`}function xt(){const e=document.getElementById("dash-learner-summary");if(!e)return;const t=pe(),s=v.get("speechLocale")||"en-SG";e.innerHTML=`
    ...
    </div>`}function At(){const e=document.getElementById("dash-domains-section");if(!e)return;const t=ue(),s=t.some(a=>a.score!==null);T(e,!s),e.innerHTML=`
    ...
    </div>`}function Et(){const e=document.getElementById("dash-clue-section");if(!e)return;const{questInsights:t,byType:s}=he();if(T(e,!1),!t.length&&!s.length){T(e,!0),e.innerHTML=`
    ...
    ${n}`}function Mt(){const e=document.getElementById("dash-actions-section");if(!e)return;const t=me();e.innerHTML=`
  ...
  `,e.querySelectorAll(".cs-action").forEach(n=>{n.addEventListener("click",()=>E==null?void 0:E({target:n.dataset.target,group:n.dataset.group}))})}function Ot(){const e=document.getElementById("dash-stuck-words");if(!e)return;const t=Xe();if(!t.length)return;const s=t.map(a=>`
    ...
    </div>`}function Pt(){const e=document.getElementById("dash-patterns-section");if(!e)return;const t=ge();t.length&&(e.innerHTML=`
    ...
    ${i}`}function Nt(e){const t=document.getElementById("chart-mastery");if(!t)return;O&&(O.destroy(),O=null);const s=le.filter(o=>V[o]),a=s.map(o=>V[o].label),n=s.map(o=>Math.round((e.groupMastery[o]??0)*100)),r=s.map(o=>V[o].color);O=new re(t,{type:"bar",data:{labels:a,datasets:[{label:"Mastery %",data:n,backgroundColor:r.map(o=>o+"80"),borderColor:r,borderWidth:2,borderRadius:6,barPercentage:.7}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,max:100,ticks:{callback:o=>o+"%",font:{size:11}},grid:{display:!1}},x:{ticks:{font:{size:10},maxRotation:45},grid:{display:!1}}}}})}function It(e){const t=document.getElementById("mastery-bars");t&&(t.innerHTML=le.map(s=>{const a=V[s];if(!a)return"";const n=Math.round((e.groupMastery[s]??0)*100);return`
      ...
      </div>`}).join(""))}function Tt(e){const t=document.getElementById("learning-path");if(!t)return;const s=We(He());t.innerHTML=q.map(a=>{const n=s.includes(a.id),r=a.groups??(a.group?[a.group]:[]),o=r.map(d=>e.groupMastery[d]??0),c=r.length?Math.round(o.reduce((d,u)=>d+u,0)/r.length*100):0;return`
      ...
      </div>`}).join("")}function Gt(e){const t=document.getElementById("word-history-body");if(!t)return;const s=e.recentHistory.slice(0,30).map(a=>{const n=j.find(d=>d.id===a.wordId),r=(n==null?void 0:n.emoji)||"",o=X(a.timestamp),c=a.correct?'<span style="color:var(--color-success)">✓</span>':'<span style="color:var(--color-error)">✗</span>';return`<tr>
      <td>${r} ${a.wordId}</td>
      <td>${a.mode}</td>
      <td>${c}</td>
      <td>${o}</td>
...
`),p=new Blob([i],{type:"text/csv"}),l=URL.createObjectURL(p),y=document.createElement("a");y.href=l,y.download="phonicsquest-progress-anonymised.csv",y.click(),URL.revokeObjectURL(l)}),(o=document.getElementById("btn-export-report"))==null||o.addEventListener("click",()=>{const i=Ht(),p=new Blob([JSON.stringify(i,null,2)],{type:"application/json"}),l=URL.createObjectURL(p),y=document.createElement("a");y.href=l,y.download=`phonicsquest-parent-report-${new Date().toISOString().slice(0,10)}.json`,y.click(),URL.revokeObjectURL(l)}),(c=document.getElementById("btn-import-csv"))==null||c.addEventListener("click",()=>{const i=document.getElementById("csv-import-panel");i&&(i.hidden=!i.hidden)}),(d=document.getElementById("csv-browse-btn"))==null||d.addEventListener("click",()=>{var i;(i=document.getElementById("csv-file-input"))==null||i.click()}),(u=document.getElementById("csv-file-input"))==null||u.addEventListener("change",i=>{var l;const p=(l=i.target.files)==null?void 0:l[0];p&&ne(p)});const e=document.getElementById("csv-drop-zone");e&&(e.addEventListener("dragover",i=>{i.preventDefault(),e.classList.add("dash-import-drop--active")}),e.addEventListener("dragleave",()=>e.classList.remove("dash-import-drop--active")),e.addEventListener("drop",i=>{var l,y;i.preventDefault(),e.classList.remove("dash-import-drop--active");const p=(y=(l=i.dataTransfer)==null?void 0:l.files)==null?void 0:y[0];p&&ne(p)}));const t=document.getElementById("adaptive-weak-weight"),s=document.getElementById("adaptive-unseen-weight"),a=v.get("adaptiveConfig")||{};t&&(t.value=String(a.weakWeight??5),t.addEventListener("input",()=>{v.set("adaptiveConfig",{...v.get("adaptiveConfig")||{},weakWeight:Number(t.value)})})),s&&(s.value=String(a.unseenWeight??3),s.addEventListener("input",()=>{v.set("adaptiveConfig",{...v.get("adaptiveConfig")||{},unseenWeight:Number(s.value)})})),(h=document.getElementById("btn-print-report"))==null||h.addEventListener("click",()=>{document.body.classList.add("print-mode"),window.print(),setTimeout(()=>document.body.classList.remove("print-mode"),2e3)})}function Bt(e,t=Date.now()){if(!Array.isArray(e))return 0;const s=864e5,a=new Set;for(let r=0;r<7;r++)a.add(new Date(t-r*s).toISOString().slice(0,10));const n=new Set;for(const r of e)a.has(r==null?void 0:r.date)&&(r.xp||0)>0&&n.add(r.date);return n.size}function Wt(){const e=document.getElementById("print-report-content");if(!e)return;const t=new Date().toLocaleDateString("en-SG",{day:"numeric",month:"long",year:"numeric"});function s(d){const u=d*100;return u>=70?"#22c55e":u>=40?"#f59e0b":"#ef4444"}function a(d,u,h){var p;const i=[];for(const l of u){const y=U.getSkillScore(d,l);if(y===.5)continue;const b=Math.round(y*100),g=s(y),S=((p=h[l])==null?void 0:p.label)||l,C=Math.max(b,4),$=U.getSkillSample(d,l),L=U.isEarlyIndication(d,l)?`<span class="print-report-early">early indication — ${$.attempts} independent ${$.attempts===1?"attempt":"attempts"}</span>`:"";i.push(`
    ...
    </div>`}function Ht(){const e=I.getOverallStats(),t=W();return{generatedAt:new Date().toISOString(),learnerSummary:pe(),literacyDomains:ue(),clueInsights:he(),recommendedActions:me(),recentPatternInsights:ge(),progress:{wordsAttempted:e.wordsAttempted,wordsMastered:e.wordsMastered,overallAccuracy:e.overallAccuracy,bestStreak:e.bestStreak,totalAttempts:e.totalAttempts,totalCorrect:e.totalCorrect,groupMastery:e.groupMastery,recentHistory:e.recentHistory.slice(0,50),profile:t}}}const Ae=new Set(["a","e","i","o","u"]),zt=new Set("bcdfghjklmnpqrstvwxyz".split(""));function Y(e){const s=e.toLowerCase().split(""),a=s.map(n=>Ae.has(n)?"sv":(zt.has(n),"c"));return{graphemes:s,types:a}}function se(e){const t=e.toLowerCase().split("").find(s=>Ae.has(s));return t?`short-${t}`:"short-a"}function ae(e,t){const s=[],a=[];let n=!1;for(const c of t){if(c==="sv"||c==="lv"){n=!0;continue}n?a.push(c):s.push(c)}const r=s.length,o=a.length;return r<=1&&o<=1?"CVC":r>=2&&o<=1?"blend":r<=1&&o>=2?"CVCC":"CCVCC"}async function ne(e){var u,h;const t=document.getElementById("csv-import-preview"),s=document.getElementById("csv-import-status");if(!t||!s)return;const n=(await e.text()).trim().split(`
`).filter(i=>i.trim());if(!n.length){s.hidden=!1,s.textContent="File is empty.",s.className="dash-import-status dash-import-status--error";return}const r=n[0].trim(),o=r.includes(","),c=[],d=new Set(j.map(i=>i.id));if(o){const i=r.toLowerCase().split(",").map(C=>C.trim()),p=i.indexOf("word");if(p<0){s.hidden=!1,s.textContent='CSV must have a "word" column.',s.className="dash-import-status dash-import-status--error";return}const l=i.indexOf("graphemes"),y=i.indexOf("types"),b=i.indexOf("group"),g=i.indexOf("level"),S=i.indexOf("emoji");for(let C=1;C<n.length;C++){const $=n[C].split(",").map(k=>k.trim()),_=$[p];if(!_||d.has(_.toLowerCase()))continue;const L=l>=0&&$[l]?$[l].split(/[|;]/):Y(_).graphemes,m=y>=0&&$[y]?$[y].split(/[|;]/):Y(_).types;c.push({id:_.toLowerCase(),word:_.toLowerCase(),graphemes:L,types:m,pattern:ae(L,m),group:b>=0&&$[b]||se(_),level:g>=0&&parseInt($[g])||1,emoji:S>=0&&$[S]||""})}}else for(const i of n){const p=i.trim().toLowerCase();if(!p||d.has(p))continue;const{graphemes:l,types:y}=Y(p);c.push({id:p,word:p,graphemes:l,types:y,pattern:ae(l,y),group:se(p),level:1,emoji:""})}if(!c.length){s.hidden=!1,s.textContent="No new words found (all may already exist).",s.className="dash-import-status dash-import-status--error";return}t.hidden=!1,t.innerHTML=`
