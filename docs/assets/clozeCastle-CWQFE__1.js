import{p as M,C as j,a as pe}from"./passages-DNXaSraU.js";import{s as y,p as fe,q as ge,G as B,y as v,z as qe,A as be,v as Ae,u as G,w as ve,x as je,B as Oe,D as Ge}from"./index-8n3AK7vy.js";import{g as Ie,a as Ue,b as Me,c as J,s as Ve,d as Ze,e as U,f as Je,h as Qe,p as Xe,i as Ke,j as Ye,k as et,l as Te,r as tt,m as lt,n as nt,o as Re,q as Pe,t as ct,u as at,v as st,w as ot,x as rt,y as re,z as it,A as We,B as dt,C as ut,D as he,E as $e,F as mt,G as He,H as pt,I as bt,J as De,K as kt}from"./masteryMap-C4uRYMLd.js";import"./gsap-C8pce-KX.js";let b=null,T=null,z="P1",m="",I=0,le=[],L=[],E=[],ne=0,ce=0,ye=0,q=null,x=-1,R={},V=0,P=!1,ie=0,ke=0,C="practice",O=0,xe=0,Z=[],W=0,F=0,ze=!1,Y=!1,de=0,te=0,D={};function Bt(e,l){b=e,T=l}function qt(){Ee()}function we(){b&&(b.innerHTML=""),L=[],E=[],q&&(document.removeEventListener("keydown",q),q=null)}function Ee(){if(!b)return;const e=y.get("ccqCompleted")||{},l=Object.keys(M);let t='<div class="cloze-browser">';t+='<div class="cloze-browser-grid">';for(const n of l){const c=Object.keys(M[n]),a=c.reduce((d,p)=>d+M[n][p].length,0),i=Ie({level:n,ccqCompletedByPassage:y.get("ccqCompletedByPassage")||{},ccqCompleted:e}),k=i>=a,u=pe[n];t+=`
  ...
  </div>`,c+="</div>",b.innerHTML=c,(r=document.getElementById("cloze-back-levels"))==null||r.addEventListener("click",()=>Ee()),(s=document.getElementById("cloze-mode-practice"))==null||s.addEventListener("click",()=>{C="practice",ue(e)}),(w=document.getElementById("cloze-mode-exam"))==null||w.addEventListener("click",()=>{C="exam",ue(e)}),b.querySelectorAll(".cloze-cat-btn").forEach(o=>{o.addEventListener("click",()=>{m=o.dataset.cat,Ce(z,m)})}),(g=document.getElementById("cloze-play-all"))==null||g.addEventListener("click",()=>{m="__all__",Fe(z)}),(h=document.getElementById("cloze-mastery-review"))==null||h.addEventListener("click",()=>{m=fe.getRecommendedGrammarCategory(e,l)||l[0],Ce(z,m)})}function Ce(e,l){var n;le=[...((n=M[e])==null?void 0:n[l])||[]].sort(()=>Math.random()-.5),I=0,ne=0,ce=0,ke=0,O=0,xe=Date.now(),Z=[],W=0,F=0,de=0,te=0,D={},C!=="exam"?Ct(l,()=>N()):N()}function Fe(e){le=[...Object.keys(M[e]||{}).flatMap(n=>M[e][n])].sort(()=>Math.random()-.5),I=0,ne=0,ce=0,ke=0,O=0,xe=Date.now(),Z=[],W=0,F=0,de=0,te=0,D={},N()}function N(){if(I>=le.length){Et();return}ht(le[I])}function ht(e){const l=Ye(e);if(L=l.bankWords,E=l.blankFills,R={},V=0,ie=0,ye=0,e.clues&&e.clues.length>0){const t=[...e.clues].sort((n,c)=>n.blankIndex-c.blankIndex)[0];x=(t==null?void 0:t.blankIndex)??-1,P=!0}else x=-1,P=!1;ze=!1,Y=!1,ft(e)}function ee(e){var d,p,r,s,w;if(!b)return;const l=pe[z],t=`${I+1} / ${le.length}`,n=m!=="__all__"&&B[m]?`${B[m].icon} ${B[m].label}`:"All Topics",c=e.clues&&e.clues.length>0,a=c&&P,i=U(C),k=c?a?'<span class="cloze-badge cloze-badge--phase cloze-badge--phase-clue">🔍 Step 1 · Clue Hunt</span>':'<span class="cloze-badge cloze-badge--phase cloze-badge--phase-fill">🏰 Step 2 · Fill the Blanks</span>':"",u=c?a?"🔍 Step 1 of 2 — Tap the clue word in the passage that hints at the answer.":"🏰 Step 2 of 2 — Now tap a word from the bank to fill the next blank.":"🏰 Tap a word from the bank to fill the next blank.";b.innerHTML=`
    ...
    </div>`,(o=document.getElementById("cloze-back-cat"))==null||o.addEventListener("click",()=>ue(z)),($=document.getElementById("cloze-replay"))==null||$.addEventListener("click",()=>{m==="__all__"?Fe(z):Ce(z,m)}),(S=document.getElementById("cloze-copy-summary"))==null||S.addEventListener("click",async()=>{var _;const f=Qe({modeLabel:c.label,title:`${j[z]} · ${l}`,category:l,level:j[z],scoreLine:Te({mode:C,blankCorrect:F,blankTotal:W,passageCorrect:ne,passageTotal:ce}),accuracy:t,timeTaken:`${a}s`,hintsUsed:O,clueScore:r??0,wrongLines:d,nextStep:i});try{await((_=navigator.clipboard)==null?void 0:_.writeText(f)),H("Summary copied!",!0)}catch{H("Unable to copy summary on this device.",!1)}}),(X=document.getElementById("cloze-copy-parent-report"))==null||X.addEventListener("click",async()=>{var Se,Le;const{strongest:f,weakest:_}=Xe(D),A=Te({mode:C,blankCorrect:F,blankTotal:W,passageCorrect:ne,passageTotal:ce}),se=Ke({questLabel:"Cloze Castle",modeLabel:c.label,scoreLine:A,accuracy:t,strongest:f,weakest:_,weakExamples:_?((Se=D[_.skill])==null?void 0:Se.lastWrongExamples)||[]:[],recommendation:i});try{await((Le=navigator.clipboard)==null?void 0:Le.writeText(se)),H("Parent report copied!",!0)}catch{H("Unable to copy parent report on this device.",!1)}}),(K=document.getElementById("cloze-back-levels"))==null||K.addEventListener("click",()=>Ee()),q&&(document.removeEventListener("keydown",q),q=null),setTimeout(()=>{var f;return(f=document.getElementById("cloze-back-cat"))==null?void 0:f.focus()},200)}export{we as cleanupClozeCastle,Bt as initClozeCastle,qt as showClozeBrowser};
