import{p as q,C as N,a as ke}from"./passages-C58v9gBd.js";import{s as v,p as ye,z as ve,G as A,M as y,$ as Be,a9 as he,a4 as Ae,a0 as G,a5 as ze,aa as Ne,a6 as Oe,ab as Ge,ac as Ue,ad as Ve}from"./index-CYQu5mDr.js";import{g as Ze,a as Q,s as Je,b as Qe,c as U,d as Xe,e as Ye,p as Ke,f as et,h as tt,i as lt,j as Te,r as nt,k as at,l as st,m as Ie,n as Me,o as ct,q as ot,t as rt,u as it,v as dt,w as de,x as Re,y as ut,z as ge,A as xe,B as mt,C as Pe,D as pt,E as bt,F as We,G as kt}from"./masteryMap-CFcaOxbb.js";import{g as He,a as Fe,r as ht,b as ft}from"./clozeCompletionTracker-BNrgTcI4.js";import"./practiceExpansion-D0CCBel5.js";import"./gsap-C8pce-KX.js";import"./stories-BYImWThp.js";let k=null,B=null,z="P1",p="",M=0,ne=[],L=[],_=[],ae=0,se=0,ie=0,I=null,E=-1,R={},Z=0,P=!1,ue=0,fe=0,$="practice",O=0,Ee=0,J=[],W=0,j=0,we=!1,ee=!1,me=0,le=0,F={};function Rt(e,l){k=e,B=l}function Pt(){_e()}function Ce(){k&&(k.innerHTML=""),L=[],_=[],I&&(document.removeEventListener("keydown",I),I=null)}function _e(){if(!k)return;const e=v.get("ccqCompleted")||{},l=Object.keys(q);let t='<div class="cloze-browser">';t+='<h3 class="cloze-cat-title">🏰 Cloze Castle</h3>',t+='<p class="cloze-cat-subtitle">Each passage is a short story with missing words. Read it through first, then fill every blank. Pick your level to begin.</p>',t+='<div class="cloze-browser-grid">';for(const n of l){const a=Object.keys(q[n]),s=a.reduce((u,c)=>u+q[n][c].length,0),d=a.reduce((u,c)=>u+q[n][c].reduce((o,w)=>{var b;return o+(((b=w.answers)==null?void 0:b.length)||0)},0),0),h=He({level:n,ccqCompletedByPassage:v.get("ccqCompletedByPassage")||{},ccqCompleted:e}),m=h>=s,i=ke[n];t+=`
