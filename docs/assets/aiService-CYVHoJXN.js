const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/aiGuardrails-BL8OKwhk.js","assets/index-BjQGCboo.js","assets/gsap-C8pce-KX.js","assets/index--g6Qmn4e.css"])))=>i.map(i=>d[i]);
import{_ as m,s as y}from"./index-BjQGCboo.js";const w="https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent";function p(){return y.get("geminiApiKey")||""}function k(){return!!p()}async function g(t,{maxTokens:n=1024,temperature:i=.3}={}){var a,r,o,s,c;const e=p();if(!e)return null;try{const h=await fetch(`${w}?key=${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:t}]}],generationConfig:{maxOutputTokens:n,temperature:i}})});if(!h.ok)return null;const u=await h.json();return((c=(s=(o=(r=(a=u==null?void 0:u.candidates)==null?void 0:a[0])==null?void 0:r.content)==null?void 0:o.parts)==null?void 0:s[0])==null?void 0:c.text)??null}catch{return null}}async function f({question:t,options:n,chosen:i,correct:e,authoredExplanation:a="",level:r=""}){const{askGiriConstrained:o}=await m(async()=>{const{askGiriConstrained:h}=await import("./aiGuardrails-BL8OKwhk.js");return{askGiriConstrained:h}},__vite__mapDeps([0,1,2,3])),s=i===e,c=`A ${r?`${r} `:""}student answered a multiple-choice English question.
