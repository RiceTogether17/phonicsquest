import{l as z,R as V,G as R,s as E,q as T,K as D,x as d,I as F,T as X,L as H}from"./index-CEXKm1qS.js";import{G as L,a as B,b as J}from"./grammarMcq-DYSd3A7S.js";import{r as Z,M as ee,f as te,b as se,a as le,c as ae}from"./mcqDifficulty-Dv-OEtEw.js";import"./gsap-C8pce-KX.js";import"./mcqOptionExplanations-Bix-y16L.js";let r=null,G=null,p=[],g=0,x=0,C=!1,q={level:null,category:null,label:"All Skills",difficulty:"normal"},h="normal",f=0,y=0,S=[],M=!1,w={},k={},j=0;const K=3;function O(e){return`gmcq:${e}`}function re(e){return!!(E.get("lessonsSeen")||{})[O(e)]}function ce(e){const t={...E.get("lessonsSeen")||{}};t[O(e)]||(t[O(e)]=new Date().toISOString(),E.set("lessonsSeen",t))}function ye(e,t){r=e,G=t}function $e(){r&&(r.innerHTML="")}function ie(e=L){return B.flatMap(t=>e[t]||[])}function N({level:e=null,category:t=null}={},s=L){const l=e?s[e]||[]:ie(s);return t?l.filter(i=>i.category===t):l}function W(e={},t=L){return N(e,t).length}function ne(e=L,t=z){return t.map(s=>{const l={};let i=0;for(const n of B){const c=W({level:n,category:s},e);l[n]=c,i+=c}return{category:s,total:i,levels:l}})}function oe(e=L,t=B){return t.map(s=>({level:s,total:W({level:s},e)}))}function Q(e){var t;return((t=R[e])==null?void 0:t.label)||e}function ue(e){const t=e.level||null,s=e.category?Q(e.category):null;return[t,s].filter(Boolean).join(" · ")||"All Skills"}function P(){if(!r)return;const e=oe(),t=ne();let s=q.level||"P1",l=q.difficulty||h||"normal";const i=()=>{var n,c;r.innerHTML=`
    ...
    <div class="mcq-game" role="region" aria-label="Grammar question ${g+1} of ${p.length}">
      ...
      <div class="vmcq-next-wrap" id="gmcq-next-wrap" style="display:none">
        ...
        </tr>`}).join("")}</tbody></table>`}function Y(e,t){var i,n;j+=1,ce(e);const s=H(e),l=R[e]||{icon:"🧠",label:e};r.innerHTML=`
    ...
    </div>`,l&&((c=r.querySelector("#gmcq-recovery"))==null||c.addEventListener("click",()=>de())),(a=r.querySelector("#gmcq-replay"))==null||a.addEventListener("click",()=>I(q)),(o=r.querySelector("#gmcq-menu"))==null||o.addEventListener("click",()=>P())}export{$e as cleanupGrammarMcq,W as countItemsForScope,ie as getAllItems,ne as getCategoryCounts,N as getItemsForScope,oe as getLevelCounts,ye as initGrammarMcq,P as showGrammarMcqBrowser,ke as startGrammarMcqLevel};
