import{s as P,W as me,N as Pt,O as be,C as tt,Q as jt,R as M,T,U as Y,X as j,Y as Ut}from"./index-DrZ2R3gf.js";import{P as Dt,g as zt,e as nt,i as st}from"./sightStoryWeave-CH7jng1s.js";import"./gsap-C8pce-KX.js";function Yt(e,t,s){var g;if(!((g=t.comprehension)!=null&&g.length)){s==null||s();return}const n={phase:"intro",qIndex:0,vocabIndex:0,correct:0,total:t.comprehension.length,flipped:!1};function o(){switch(n.phase){case"intro":return a();case"comprehension":return r();case"vocab":return c();case"openEnded":return d();case"grammar":return m();case"done":return p()}}function a(){var i,u,h,b;e.innerHTML=`
