...
import { buildCopySummaryText, getModeConfig, getNextStepRecommendation, buildWrongAnswerLines } from './clozeSessionSummary.js';
import { incrementHintUsage } from './hintUsage.js';
import { resetWordVaultSessionState } from './wordVaultSessionState.js';
...
function _startPassage(catKey, level) {
  ...
  _sessionCorrect = reset.sessionCorrect;
  _sessionTotal = reset.sessionTotal;
  _sessionClueScore = reset.sessionClueScore;
  _sessionHintsUsed = reset.sessionHintsUsed;
  _sessionBlankCorrect = reset.sessionBlankCorrect;
  _sessionBlankTotal = reset.sessionBlankTotal;
  _sessionReviewRows = reset.sessionReviewRows;
...
function _showComplete(summary = {}) {
  ...
  const wrongLines = buildWrongAnswerLines(_sessionReviewRows);
