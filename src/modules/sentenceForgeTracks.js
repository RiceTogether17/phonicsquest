export function classifySentenceTrack(entry) {
  ...
  if (hasAny(['synthesis_transformation', 'inversion', 'relative_clauses', 'concession', 'reported_speech'])) return 'synthesis-transformation';
  if (hasAny(['connector_clue', 'comparison_structure', 'time_order_clue', 'clause_boundary', 'punctuation_clue'])) return 'sentence-combining';
