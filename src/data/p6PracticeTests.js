      ...
      items: [
        {
          ...
          explain: '"A stride in the right direction" (a significant, purposeful advance) is the natural collocation.',
        },
        {
...
Alex Tan`,
    ...
    sectionI: {
      ...
      errors: [
        ...
        { wrong: 'warn',       correction: 'warned',       kind: 'grammar'  },
  ...
  T2: {
    ...
    sectionA: {
      ...
      items: [
        ...
        {
          q: 'No sooner ___ the video posted than it had received a million views.',
          choices: [
            'had the video been / was',
            'was the video / had',
            'the video had been / was',
            'had the video been / had',
          ],
          answer: 'had the video been / was',
          skill: 'inversion',
          practiseTarget: 'grammar-mcq',
          explain: '"No sooner had X been done than Y was done" — inversion after "No sooner"; past perfect then simple past.',
        },
        {
    ...
    sectionF: {
      ...
      items: [
        ...
        },
        {
          ...
          alternates: ['the community acted sooner, the ancient temple would not have been demolished'],
          skill: 'conditionals',
