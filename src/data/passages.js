...
export const passages = {
  P1: {
    ...
    simplePast: [
      {
        id: 'g-p1-sp-01', title: 'Yesterday at School',
        text: 'Yesterday, I ___ to school early. I ___ with my friends at recess. We ___ lunch together.',
        answers: ['went', 'played', 'ate'],
      ...
      {
        id: 'g-p1-sp-02', title: 'My Birthday',
        text: 'Last week, Mum ___ a cake. Dad ___ me a present. I ___ very happy.',
        answers: ['baked', 'gave', 'was'],
        wordBank: ['baked', 'gave', 'was', 'bake', 'give', 'is', 'made', 'had'],
        xp: 20,
      },
      {
    ...
    connectors: [
      {
        id: 'g-p1-con-01', title: 'My Pets',
        text: 'I have a cat ___ a dog. The cat is small ___ the dog is big. I love them ___ they are cute.',
        answers: ['and', 'but', 'because'],
      ...
      {
        id: 'g-p1-con-02', title: 'Playtime',
        text: 'I like to run ___ jump. I want to play ___ it is raining. We stay inside ___ read books.',
        answers: ['and', 'but', 'and'],
        wordBank: ['and', 'but', 'and', 'or', 'so', 'because'],
        xp: 20,
      },
      {
        id: 'g-p1-con-03', title: 'At the Canteen',
        text: 'I was hungry ___ I bought some food. I wanted noodles ___ they were sold out. I chose rice ___ chicken instead.',
        answers: ['so', 'but', 'and'],
        wordBank: ['so', 'but', 'and', 'because', 'or', 'then'],
        xp: 20,
      },
    ],
    tenseAwareness: [
      {
        id: 'g-p1-ta-01', title: 'Now and Before',
        text: 'Right now, I ___ reading a book. Yesterday, I ___ to the library. Every day, I ___ breakfast at home.',
        answers: ['am', 'went', 'eat'],
        wordBank: ['am', 'went', 'eat', 'is', 'go', 'ate', 'was', 'eats'],
        xp: 20,
        clues: [
          { blankIndex: 0, prompt: 'Tap the time phrase for blank 1.', acceptableSpans: ['Right now'], partialSpans: ['reading'], clueType: 'time-marker', explanation: '"Right now" means present tense: I am reading.' },
          { blankIndex: 1, prompt: 'Tap the time word for blank 2.', acceptableSpans: ['Yesterday'], partialSpans: ['library'], clueType: 'time-marker', explanation: '"Yesterday" means past tense: I went.' },
        ],
      },
      {
      ...
      {
        id: 'g-p1-ta-03', title: 'Weekend Fun',
        text: 'Every Saturday, I ___ swimming. Last Saturday, I ___ to the beach. Now I ___ tired but happy.',
        answers: ['go', 'went', 'am'],
        wordBank: ['go', 'went', 'am', 'goes', 'going', 'was', 'is', 'come'],
        xp: 20,
      },
    ],
    modals: [
      {
        id: 'g-p1-mod-01', title: 'What I Can Do',
        text: 'I ___ ride a bicycle. My baby sister ___ walk yet. We ___ swim in the deep pool.',
        answers: ['can', 'cannot', 'cannot'],
        wordBank: ['can', 'cannot', 'cannot', 'can', 'must', 'may'],
        xp: 20,
      },
      {
        id: 'g-p1-mod-02', title: 'School Rules',
        text: 'We ___ run in the hallway. We ___ be polite to teachers. I ___ read many books in the library.',
        answers: ['cannot', 'must', 'can'],
        wordBank: ['cannot', 'must', 'can', 'can', 'may', 'should'],
        xp: 20,
      },
      {
        id: 'g-p1-mod-03', title: 'Helping at Home',
        text: 'I ___ help Mum wash the dishes. My brother ___ cook yet. We ___ be careful with hot water.',
        answers: ['can', 'cannot', 'must'],
        wordBank: ['can', 'cannot', 'must', 'may', 'should', 'can'],
        xp: 20,
      },
    ],
...
function _mergeUniqueById(targetArr, incomingArr) {
...
function mergeExtraPassages() {
  for (const [level, cats] of Object.entries(EXTRA_GRAMMAR_PASSAGES || {})) {
    ...
    for (const [catKey, arr] of Object.entries(cats || {})) {
      ...
      _mergeUniqueById(passages[level][catKey], arr);
    }
  }
}
