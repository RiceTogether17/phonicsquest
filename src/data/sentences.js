...
// ── Sight-word exposure sentences ────────────────────────────────────────
// One purpose-built sentence for each sight-word-quest word that appears in
// no story (see the sightStoryWeave coverage floors). The card game
// introduces the word; these give it a real sentence-level outing.
const SIGHT_EXPOSURE_SENTENCES = [
  { id: 'ssw000', sentence: 'A spider has eight thin legs.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Number before the noun', grammarNote: 'The number word \u201ceight\u201d comes before the describing word and the noun.' },
  { id: 'ssw001', sentence: 'I love the pretty yellow flowers in our garden.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adjectives before the noun', grammarNote: 'Describing words like “pretty” and “yellow” come before the noun they describe.' },
  { id: 'ssw002', sentence: 'We will eat fruit and bread today.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Future with “will”', grammarNote: '“Will” + base verb tells us the eating has not happened yet.' },
  { id: 'ssw003', sentence: 'The funny clown made everyone laugh.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Make + someone + verb', grammarNote: 'After “made everyone”, the verb “laugh” stays in its base form.' },
  { id: 'ssw004', sentence: 'We watch the kite as it flies over the field.', level: 2, sentenceSkills: ['time_order_clue', 'sight_word_exposure'], focusLabel: '“As” joins two actions', grammarNote: '“As” shows the watching and the flying happen at the same time.' },
  { id: 'ssw005', sentence: 'Close one eye to see the picture better.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command sentence', grammarNote: 'Commands start with the verb — no subject is needed.' },
  { id: 'ssw006', sentence: 'Pull your hat down over your head.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command sentence', grammarNote: 'Commands begin with the action word, like “pull”.' },
  { id: 'ssw007', sentence: 'Please put these books on the shelf.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Polite command', grammarNote: '“Please” softens a command; “these” points to books near the speaker.' },
  { id: 'ssw008', sentence: 'Listen well and you will hear the birds sing.', level: 2, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: '“And” links a command to a result', grammarNote: 'The command comes first; “and” introduces what will happen next.' },
  { id: 'ssw009', sentence: 'We talk about our day, and I tell Mum my news.', level: 2, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: '“And” joins two ideas', grammarNote: '“Talk about” a topic, but “tell” a person the news.' },
  { id: 'ssw010', sentence: 'Add a little salt to the soup.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command sentence', grammarNote: '“A little” is used with things we cannot count, like salt.' },
  { id: 'ssw011', sentence: 'Once upon a time, a wolf lived in the deep wood.', level: 2, sentenceSkills: ['time_order_clue', 'sight_word_exposure'], focusLabel: 'Story opening phrase', grammarNote: '“Once upon a time” is a fixed phrase that starts a story in the past.' },
  { id: 'ssw012', sentence: 'The young bird cannot fly far yet.', level: 1, sentenceSkills: ['modal_order', 'sight_word_exposure'], focusLabel: '“Cannot” + base verb', grammarNote: 'After “cannot”, the verb “fly” stays in its base form.' },
  { id: 'ssw013', sentence: 'One sock is here, but the other sock is lost.', level: 2, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: '“But” shows contrast', grammarNote: '“But” joins two ideas that pull in different directions.' },
  { id: 'ssw014', sentence: 'Maybe we can go to the park after lunch.', level: 1, sentenceSkills: ['modal_order', 'sight_word_exposure'], focusLabel: 'Sentence starting with “maybe”', grammarNote: '“Maybe” shows we are not sure; “can” is followed by the base verb “go”.' },
  { id: 'ssw015', sentence: 'A plant needs water and light to live a healthy life.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“To” + verb shows purpose', grammarNote: '“To live” explains why the plant needs water and light.' },
  { id: 'ssw016', sentence: 'Ben wrote his name on the first page.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Simple past sentence', grammarNote: '“Wrote” is the past form of “write” — irregular verbs change their spelling.' },
  { id: 'ssw017', sentence: 'Long ago, people knew how to read the stars.', level: 3, sentenceSkills: ['time_order_clue', 'sight_word_exposure'], focusLabel: 'Fronted time phrase', grammarNote: '“Long ago” at the start sets the whole sentence in the distant past.' },
  { id: 'ssw018', sentence: 'We played on, though the rain had started.', level: 4, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: '“Though” shows contrast', grammarNote: '“Though” tells us the playing continued despite the rain.' },
  { id: 'ssw019', sentence: 'This bus goes to the city every hour.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Present habit with “every”', grammarNote: '“Goes” ends in -es because the subject “this bus” is singular.' },
  { id: 'ssw020', sentence: 'Don\'t run on the wet floor.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Negative command', grammarNote: '“Don\'t” + base verb tells someone NOT to do something.' },
  { id: 'ssw021', sentence: 'We begin to learn a new song today.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Verb + to + verb', grammarNote: '“Begin” is followed by “to” + the base verb “learn”.' },
  { id: 'ssw022', sentence: 'Only a few seats are left on the bus.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“A few” with countable nouns', grammarNote: '“A few” is used with things we can count, like seats.' },
  { id: 'ssw023', sentence: 'The magic show was really good.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adverb before adjective', grammarNote: '“Really” makes the describing word “good” stronger.' },
  { id: 'ssw024', sentence: 'Help me move this desk to the front.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Help + someone + verb', grammarNote: 'After “help me”, the verb “move” stays in its base form.' },
  { id: 'ssw025', sentence: 'My aunty makes the best noodles.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Superlative “the best”', grammarNote: '“The best” compares the noodles with all other noodles.' },
  { id: 'ssw026', sentence: 'Exercise keeps your body strong.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Keep + noun + adjective', grammarNote: '“Keeps your body strong” tells the result of exercising.' },
  { id: 'ssw027', sentence: 'Write your name below the line.', level: 1, sentenceSkills: ['preposition_clue', 'sight_word_exposure'], focusLabel: 'Preposition “below”', grammarNote: '“Below” tells us the position — under the line, not on it.' },
  { id: 'ssw028', sentence: 'This puzzle is easy for my sister.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“For” shows who', grammarNote: '“For my sister” tells us who finds the puzzle easy.' },
  { id: 'ssw029', sentence: 'We often read together before bed.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adverb of frequency', grammarNote: '“Often” sits before the main verb to show how regularly we read.' },
  { id: 'ssw030', sentence: 'I can\'t reach the top shelf.', level: 1, sentenceSkills: ['modal_order', 'sight_word_exposure'], focusLabel: '“Can\'t” + base verb', grammarNote: '“Can\'t” is short for “cannot”; the verb “reach” stays in base form.' },
  { id: 'ssw031', sentence: 'We couldn\'t find the cat anywhere.', level: 2, sentenceSkills: ['modal_order', 'sight_word_exposure'], focusLabel: '“Couldn\'t” + base verb', grammarNote: '“Couldn\'t” is the past of “can\'t” — the search failed.' },
  { id: 'ssw032', sentence: 'Each parent came to watch the school play.', level: 3, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“Each” + singular noun', grammarNote: '“Each” goes with one parent at a time, so the noun stays singular.' },
  { id: 'ssw033', sentence: 'This is the best cake I have ever tasted.', level: 3, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Present perfect + “ever”', grammarNote: '“Have ever tasted” covers the speaker\'s whole life up to now.' },
  { id: 'ssw034', sentence: 'Circle the biggest number on the page.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Superlative command', grammarNote: '“Biggest” compares all the numbers on the page.' },
  { id: 'ssw035', sentence: 'We looked everywhere for the lost key.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adverb “everywhere”', grammarNote: '“Everywhere” tells us where the looking happened — all places.' },
  { id: 'ssw036', sentence: 'Wash the cut so it does not hurt later.', level: 2, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: '“So” shows purpose', grammarNote: '“So” introduces the reason for washing the cut.' },
  { id: 'ssw037', sentence: 'The glass was almost full.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adverb “almost”', grammarNote: '“Almost” means very close to, but not quite.' },
  { id: 'ssw038', sentence: 'May I have another slice of melon?', level: 1, sentenceSkills: ['modal_order', 'sight_word_exposure'], focusLabel: 'Polite request with “may”', grammarNote: '“May I” is the polite way to ask permission.' },
  { id: 'ssw039', sentence: 'Lean the ladder against the wall.', level: 2, sentenceSkills: ['preposition_clue', 'sight_word_exposure'], focusLabel: 'Preposition “against”', grammarNote: '“Against” means touching and pushing on the wall.' },
  { id: 'ssw040', sentence: 'Soon you will be able to swim across the pool.', level: 2, sentenceSkills: ['modal_order', 'sight_word_exposure'], focusLabel: '“Be able to” + verb', grammarNote: '“Will be able to” talks about a skill you will have in the future.' },
  { id: 'ssw041', sentence: 'Never play with fire.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command with “never”', grammarNote: '“Never” at the start makes the rule as strong as possible.' },
  { id: 'ssw042', sentence: 'Zara had a bright idea for the project.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Article “a” with adjective', grammarNote: '“A bright idea” — the article comes before the describing word.' },
  { id: 'ssw043', sentence: 'Spell each word, then read the whole sentence.', level: 2, sentenceSkills: ['time_order_clue', 'sight_word_exposure'], focusLabel: '“Then” orders two steps', grammarNote: '“Then” tells us the reading comes after the spelling.' },
  { id: 'ssw044', sentence: 'The zoo keeper fed every animal before noon.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“Every” + singular noun', grammarNote: '“Every animal” means all of them, one by one — the noun stays singular.' },
  { id: 'ssw045', sentence: 'We study spelling every Friday.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Present habit', grammarNote: '“Every Friday” signals a routine, so the verb stays in simple present.' },
  { id: 'ssw046', sentence: 'Singapore is a small island with many parks.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Describing a place', grammarNote: '“With many parks” adds extra information about the island.' },
  { id: 'ssw047', sentence: 'A map shows the whole world on one page.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Subject–verb–object', grammarNote: 'The subject “a map” does the showing; “the whole world” is what is shown.' },
  { id: 'ssw048', sentence: 'The teacher showed an example on the board.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Article “an” before vowel sound', grammarNote: '“An example” — use “an” because “example” starts with a vowel sound.' },
  { id: 'ssw049', sentence: 'The rope is one metre long.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Measurement phrase', grammarNote: 'We say “one metre long” — the measurement comes before “long”.' },
  { id: 'ssw050', sentence: 'Water can change from one state to another.', level: 4, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“From … to” pattern', grammarNote: '“From one state to another” shows a complete change.' },
  { id: 'ssw051', sentence: 'We tried Indian food at the hawker centre.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Simple past “tried”', grammarNote: 'Verbs ending in consonant + y change to -ied in the past: try → tried.' },
  { id: 'ssw052', sentence: 'Sometimes we walk home instead of taking the bus.', level: 3, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“Instead of” + -ing', grammarNote: 'After “instead of”, the verb takes its -ing form: “taking”.' },
  { id: 'ssw053', sentence: 'Snow covers the mountains in winter.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Present-tense fact', grammarNote: 'Facts about seasons use the simple present: “covers”.' },
  { id: 'ssw054', sentence: 'Blue is my favourite colour.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Subject + be + noun', grammarNote: 'The colour word “blue” acts as the subject of the sentence.' },
  { id: 'ssw055', sentence: 'Mark the correct answer with a tick.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command with “with”', grammarNote: '“With a tick” tells us HOW to mark the answer.' },
  { id: 'ssw056', sentence: 'We usually have recess at ten.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adverb of frequency', grammarNote: '“Usually” sits before the main verb “have”.' },
  { id: 'ssw057', sentence: 'The alarm didn\'t ring this morning.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“Didn\'t” + base verb', grammarNote: 'After “didn\'t”, the verb “ring” goes back to its base form.' },
  { id: 'ssw058', sentence: 'Put the pictures in the correct order.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command sentence', grammarNote: '“In the correct order” tells us how the pictures should end up.' },
  { id: 'ssw059', sentence: 'It rained heavily; however, the match went on.', level: 5, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: 'Formal connector “however”', grammarNote: '“However” joins two contrasting sentences, with a semicolon before it.' },
  { id: 'ssw060', sentence: 'The shop sells many products made from rice.', level: 4, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Shortened relative clause', grammarNote: '“Made from rice” is short for “which are made from rice”.' },
  { id: 'ssw061', sentence: 'Tell me what happened at practice.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Indirect question', grammarNote: 'Inside “what happened”, the words keep statement order — no “did”.' },
  { id: 'ssw062', sentence: 'Measure the table with a ruler.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command with a tool', grammarNote: '“With a ruler” names the tool used for measuring.' },
  { id: 'ssw063', sentence: 'Big waves rolled onto the beach.', level: 1, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Subject–verb–place', grammarNote: 'The describing word “big” comes before the noun “waves”.' },
  { id: 'ssw064', sentence: 'Leave a space between the two words.', level: 2, sentenceSkills: ['preposition_clue', 'sight_word_exposure'], focusLabel: 'Preposition “between”', grammarNote: '“Between” is used for exactly two things — the two words.' },
  { id: 'ssw065', sentence: 'Every word needs at least one vowel.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“Every” + singular verb', grammarNote: '“Every word” is singular, so the verb takes -s: “needs”.' },
  { id: 'ssw066', sentence: 'The shells made a pretty pattern in the sand.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Article + adjective + noun', grammarNote: '“A pretty pattern” — article, describing word, then noun.' },
  { id: 'ssw067', sentence: 'Write the numeral seven next to the word.', level: 3, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command with position', grammarNote: '“Next to” tells us exactly where to write the numeral.' },
  { id: 'ssw068', sentence: 'Birds fly south in winter and north in spring.', level: 3, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: '“And” joins two patterns', grammarNote: 'The sentence repeats the same pattern for winter and spring.' },
  { id: 'ssw069', sentence: 'Did you notice the new sign on the door?', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Question with “did”', grammarNote: 'Questions about the past start with “did” + base verb “notice”.' },
  { id: 'ssw070', sentence: 'The kind king shared his bread with the poor.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Adjective + noun', grammarNote: '“Kind” describes the king; “the poor” means poor people as a group.' },
  { id: 'ssw071', sentence: 'I\'ll carry the bag if you hold the door.', level: 3, sentenceSkills: ['connector_clue', 'sight_word_exposure'], focusLabel: 'First conditional with “if”', grammarNote: '“I\'ll” is short for “I will”; “if” sets the condition.' },
  { id: 'ssw072', sentence: 'A centimetre is a unit of length.', level: 3, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Definition sentence', grammarNote: 'Definitions use “is a” to say what group something belongs to.' },
  { id: 'ssw073', sentence: 'Count the sides of each figure.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Command with “each”', grammarNote: '“Each figure” means every shape, one at a time.' },
  { id: 'ssw074', sentence: 'Are you certain the door is locked?', level: 3, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: 'Question with “be”', grammarNote: 'Questions with “are” swap the subject and the verb: “Are you…?”' },
  { id: 'ssw075', sentence: 'Some birds travel a very long way.', level: 2, sentenceSkills: ['word_order', 'sight_word_exposure'], focusLabel: '“Very” before adjective', grammarNote: '“Very” makes “long” stronger; the phrase describes the journey.' },
