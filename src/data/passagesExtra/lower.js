...
const P3_SPECS = [
  ...
  { category: 'simplePast', title: 'Field Trip Day', text: 'Last Friday, our class ___ to the Botanic Gardens. We ___ many different plants and ___ notes in our books. After lunch, the guide ___ us through the orchid section.', answers: ['went', 'saw', 'wrote', 'led'], wordBank: ['went', 'saw', 'wrote', 'led', 'goes', 'see'] },
  { category: 'simplePast', title: 'Sports Day Recount', text: 'Yesterday, our school ___ Sports Day at the field. The Year 4 pupils ___ in three races. Mei ___ the relay for our class. Everyone ___ together loudly.', answers: ['held', 'competed', 'ran', 'cheered'], wordBank: ['held', 'competed', 'ran', 'cheered', 'compete', 'cheer'] },
  { category: 'simplePast', title: 'Birthday Surprise', text: 'Last Saturday, my mother ___ a small party at home. My friends ___ early and ___ presents on the table. We ___ cake together in the afternoon.', answers: ['planned', 'arrived', 'left', 'ate'], wordBank: ['planned', 'arrived', 'left', 'ate', 'plan', 'arrive'] },
  { category: 'simplePast', title: 'Class Photo Mishap', text: 'Last Monday, we ___ outside the hall for the class photo. The photographer ___ us to smile widely. Suddenly, Adam ___ his cap on the floor. We all ___ at the surprise.', answers: ['waited', 'asked', 'dropped', 'laughed'], wordBank: ['waited', 'asked', 'dropped', 'laughed', 'wait', 'ask'] },
  { category: 'simplePast', title: 'Library Adventure', text: 'Last Wednesday, the librarian ___ us a new section. We ___ many fun books on the shelves. I ___ a mystery story home. My brother ___ a comic instead.', answers: ['showed', 'found', 'took', 'borrowed'], wordBank: ['showed', 'found', 'took', 'borrowed', 'find', 'show'] },
  { category: 'simplePast', title: 'Class Party Recount', text: "Last Friday, our class ___ a party for our teacher. Mei ___ a card with everyone's signatures. Tim ___ a song on the guitar. We all ___ the cake at the end.", answers: ['held', 'made', 'played', 'shared'], wordBank: ['held', 'made', 'played', 'shared', 'hold', 'make'] },
