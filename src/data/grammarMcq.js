...
const _SUBJECTS = ['The pupil', 'My brother', 'Our teacher', 'The class monitor', 'The twins', 'The players', 'Her cousin', 'The science team'];
const _PLACES = ['in the canteen', 'at the void deck', 'near the school gate', 'in the library', 'at East Coast Park', 'beside the hall', 'on the field', 'at the community club'];
  ...
  reflexivePronouns(level, i) {
    const rows = [
      ['We can do this ___. We do not need your help.', 'ourselves', ['himself', 'yourselves', 'themselves'], {
        'ourselves': '"Ourselves" is correct because the subject is "we", so the reflexive pronoun must be "ourselves".',
        'himself': '"Himself" matches "he", not "we".',
        'yourselves': '"Yourselves" matches "you (plural)", not "we".',
        'themselves': '"Themselves" matches "they", not "we".',
      }],
      ['"You only have ___ to blame," Mother scolded my sister and me.', 'yourselves', ['yourself', 'ourselves', 'themselves'], {
        'yourselves': '"Yourselves" is correct because "you" here refers to two people (my sister and me), so the plural reflexive is needed.',
        'yourself': '"Yourself" is for a single person being addressed, but two people are being scolded here.',
        'ourselves': '"Ourselves" matches "we", not "you (plural)".',
        'themselves': '"Themselves" matches "they", not "you (plural)".',
      }],
      ['Lin Lin made the cake all by ___ — she is very proud.', 'herself', ['himself', 'themselves', 'yourselves'], {
        'herself': '"Herself" is correct because the subject is "she" (Lin Lin), so the reflexive pronoun is "herself".',
        'himself': '"Himself" matches "he", not "she".',
        'themselves': '"Themselves" matches "they", not "she".',
        'yourselves': '"Yourselves" matches "you (plural)", not "she".',
      }],
      ['The boys built the tree house ___ over the weekend.', 'themselves', ['ourselves', 'himself', 'herself'], {
        'themselves': '"Themselves" is correct because the subject is "the boys" (plural, they), so the reflexive is "themselves".',
        'ourselves': '"Ourselves" matches "we", not "they".',
        'himself': '"Himself" is singular for one male, but "the boys" is plural.',
        'herself': '"Herself" matches "she", not a group of boys.',
      }],
      ['I taught ___ how to ride a bicycle last year.', 'myself', ['himself', 'ourselves', 'themselves'], {
        'myself': '"Myself" is correct because the subject is "I", so the reflexive pronoun is "myself".',
        'himself': '"Himself" matches "he", not "I".',
        'ourselves': '"Ourselves" matches "we", not "I".',
        'themselves': '"Themselves" matches "they", not "I".',
      }],
      ['The cat groomed ___ patiently in the sunshine.', 'itself', ['himself', 'themselves', 'herself'], {
        'itself': '"Itself" is correct because the subject is "the cat" (a thing), so the reflexive pronoun is "itself".',
        'himself': '"Himself" is used for a male person, not an animal referred to as "it".',
        'themselves': '"Themselves" matches "they", not "it".',
        'herself': '"Herself" is used for a female person, not an animal referred to as "it".',
      }],
      ['Mr Lim, please help ___ to the snacks on the table.', 'yourself', ['himself', 'themselves', 'ourselves'], {
        'yourself': '"Yourself" is correct because Mr Lim is being addressed as "you" (singular), so the reflexive is "yourself".',
        'himself': '"Himself" would be used if the sentence said "Mr Lim helped himself", not when speaking directly to him.',
        'themselves': '"Themselves" matches "they", not "you (singular)".',
        'ourselves': '"Ourselves" matches "we", not "you (singular)".',
      }],
      ['Tim could not lift the heavy box by ___, so he asked his brother for help.', 'himself', ['themselves', 'yourself', 'itself'], {
        'himself': '"Himself" is correct because the subject is "Tim" (he), so the reflexive pronoun is "himself".',
        'themselves': '"Themselves" matches "they", not "he".',
        'yourself': '"Yourself" matches "you", not "he".',
        'itself': '"Itself" matches "it" (a thing), not "he".',
      }],
      ['The girls poured ___ a glass of juice each before assembly.', 'themselves', ['herself', 'ourselves', 'yourselves'], {
        'themselves': '"Themselves" is correct because the subject is "the girls" (they), so the reflexive is "themselves".',
        'herself': '"Herself" is singular for one female, but "the girls" is plural.',
        'ourselves': '"Ourselves" matches "we", not "they".',
        'yourselves': '"Yourselves" matches "you (plural)", not "they".',
      }],
      ['"Do not blame ___, Ali — it was not your fault," said Mother.', 'yourself', ['himself', 'yourselves', 'itself'], {
        'yourself': '"Yourself" is correct because Ali is being addressed as "you" (singular), so the reflexive is "yourself".',
        'himself': '"Himself" would be used if the sentence talked about Ali in the third person, not when speaking to him.',
        'yourselves': '"Yourselves" is for "you" referring to more than one person, but only Ali is being addressed.',
        'itself': '"Itself" matches "it" (a thing), not "you".',
      }],
      ['The new boy introduced ___ to the whole class with a calm, confident voice.', 'himself', ['herself', 'themselves', 'myself'], {
        'himself': '"Himself" is correct because the subject is "the new boy" (he), so the reflexive pronoun is "himself".',
        'herself': '"Herself" matches "she", not "he".',
        'themselves': '"Themselves" matches "they", not "he".',
        'myself': '"Myself" matches "I", not "he".',
      }],
      ['After the long walk, we treated ___ to ice cream at the void deck.', 'ourselves', ['themselves', 'yourselves', 'myself'], {
        'ourselves': '"Ourselves" is correct because the subject is "we", so the reflexive pronoun is "ourselves".',
        'themselves': '"Themselves" matches "they", not "we".',
        'yourselves': '"Yourselves" matches "you (plural)", not "we".',
        'myself': '"Myself" matches "I", not "we".',
      }],
      ['The robot can repair ___ when one of its parts is damaged.', 'itself', ['himself', 'themselves', 'herself'], {
        'itself': '"Itself" is correct because the subject is "the robot" (a thing, referred to as "it"), so the reflexive is "itself".',
        'himself': '"Himself" is for a male person, not a robot referred to as "it".',
        'themselves': '"Themselves" matches "they", not "it".',
        'herself': '"Herself" is for a female person, not a robot referred to as "it".',
      }],
      ['Hannah baked the loaf of bread ___ for the school bake sale.', 'herself', ['themselves', 'yourself', 'ourselves'], {
        'herself': '"Herself" is correct because the subject is "Hannah" (she), so the reflexive pronoun is "herself".',
        'themselves': '"Themselves" matches "they", not "she".',
        'yourself': '"Yourself" matches "you", not "she".',
        'ourselves': '"Ourselves" matches "we", not "she".',
      }],
      ['Sarah and Mia found ___ a quiet corner of the library to study.', 'themselves', ['herself', 'yourself', 'ourselves'], {
        'themselves': '"Themselves" is correct because the subject is "Sarah and Mia" (they), so the reflexive is "themselves".',
        'herself': '"Herself" is singular for one female, but "Sarah and Mia" is plural.',
        'yourself': '"Yourself" matches "you", not "they".',
        'ourselves': '"Ourselves" matches "we", not "they".',
      }],
      ['Have you ever asked ___ why the sky looks blue, Daniel?', 'yourself', ['himself', 'yourselves', 'themselves'], {
        'yourself': '"Yourself" is correct because Daniel is addressed as "you" (singular), so the reflexive is "yourself".',
        'himself': '"Himself" would be used if referring to Daniel in the third person, not when speaking to him.',
        'yourselves': '"Yourselves" is for "you" referring to more than one person, but only Daniel is addressed.',
        'themselves': '"Themselves" matches "they", not "you (singular)".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
  ...
  tagQuestions(level, i) {
    const rows = [
      ['Andy is joining us for recess, ___ he?', 'isn\'t', ['is', 'does', 'doesn\'t'], {
        'isn\'t': '"Isn\'t" is correct because the statement is positive ("is joining"), so the tag must be negative.',
        'is': '"Is" would make a positive tag after a positive statement — tags must reverse polarity.',
        'does': '"Does" is the wrong auxiliary — the main verb uses "is", so the tag must also use "is".',
        'doesn\'t': '"Doesn\'t" is the wrong auxiliary — the main verb uses "is", so the tag must also use "is".',
      }],
      ['You have watched this movie before, ___ you?', 'haven\'t', ['did', 'have', 'didn\'t'], {
        'haven\'t': '"Haven\'t" is correct because the statement is positive ("have watched"), so the tag must be negative using the same auxiliary "have".',
        'did': '"Did" is the wrong auxiliary — the main verb uses "have watched" (present perfect), not simple past.',
        'have': '"Have" would make a positive tag after a positive statement — tags must reverse polarity.',
        'didn\'t': '"Didn\'t" is the wrong auxiliary — the main verb uses "have" (present perfect), not "did" (simple past).',
      }],
      ['They will join the swim team, ___ they?', 'won\'t', ['will', 'do', 'don\'t'], {
        'won\'t': '"Won\'t" is correct because the statement is positive ("will join"), so the tag must be negative using "will".',
        'will': '"Will" would make a positive tag after a positive statement — tags must reverse polarity.',
        'do': '"Do" is the wrong auxiliary — the main verb uses "will", so the tag must also use "will".',
        'don\'t': '"Don\'t" is the wrong auxiliary — the main verb uses "will", so the tag must also use "will".',
      }],
      ['She does not eat seafood, ___ she?', 'does', ['doesn\'t', 'is', 'isn\'t'], {
        'does': '"Does" is correct because the statement is negative ("does not eat"), so the tag must be positive.',
        'doesn\'t': '"Doesn\'t" would make a negative tag after a negative statement — tags must reverse polarity.',
        'is': '"Is" is the wrong auxiliary — the main verb uses "does", so the tag must also use "does".',
        'isn\'t': '"Isn\'t" is the wrong auxiliary — the main verb uses "does", so the tag must also use "does".',
      }],
      ['We must finish this by Friday, ___ we?', 'mustn\'t', ['must', 'do', 'don\'t'], {
        'mustn\'t': '"Mustn\'t" is correct because the statement is positive ("must finish"), so the tag must be negative using the same auxiliary "must".',
        'must': '"Must" would make a positive tag after a positive statement — tags must reverse polarity.',
        'do': '"Do" is the wrong auxiliary — the main verb uses "must", so the tag must also use "must".',
        'don\'t': '"Don\'t" is the wrong auxiliary — the main verb uses "must", so the tag must also use "must".',
      }],
      ['The twins are not in the team, ___ they?', 'are', ['aren\'t', 'is', 'isn\'t'], {
        'are': '"Are" is correct because the statement is negative ("are not"), so the tag must be positive using "are".',
        'aren\'t': '"Aren\'t" would make a negative tag after a negative statement — tags must reverse polarity.',
        'is': '"Is" is wrong — "the twins" is plural, so the auxiliary must be "are", not "is".',
        'isn\'t': '"Isn\'t" is wrong — "the twins" is plural, so the auxiliary must be "are", not "is".',
      }],
      ['Your sister can swim very well, ___ she?', 'can\'t', ['can', 'does', 'doesn\'t'], {
        'can\'t': '"Can\'t" is correct because the statement is positive ("can swim"), so the tag must be negative using "can".',
        'can': '"Can" would make a positive tag after a positive statement — tags must reverse polarity.',
        'does': '"Does" is the wrong auxiliary — the main verb uses "can", so the tag must also use "can".',
        'doesn\'t': '"Doesn\'t" is the wrong auxiliary — the main verb uses "can", so the tag must also use "can".',
      }],
      ['He should bring his calculator tomorrow, ___ he?', 'shouldn\'t', ['should', 'does', 'doesn\'t'], {
        'shouldn\'t': '"Shouldn\'t" is correct because the statement is positive ("should bring"), so the tag must be negative using "should".',
        'should': '"Should" would make a positive tag after a positive statement — tags must reverse polarity.',
        'does': '"Does" is the wrong auxiliary — the main verb uses "should", so the tag must also use "should".',
        'doesn\'t': '"Doesn\'t" is the wrong auxiliary — the main verb uses "should", so the tag must also use "should".',
      }],
      ['They were practising in the hall after school, ___ they?', 'weren\'t', ['were', 'are', 'aren\'t'], {
        'weren\'t': '"Weren\'t" is correct because the statement is positive ("were practising"), so the tag must be negative using "were".',
        'were': '"Were" would make a positive tag after a positive statement — tags must reverse polarity.',
        'are': '"Are" is the wrong tense — the statement uses past "were", so the tag must also use "were".',
        'aren\'t': '"Aren\'t" is the wrong tense — the statement uses past "were", so the tag must also use "were".',
      }],
      ['It was a tiring P.E. lesson, ___ it?', 'wasn\'t', ['was', 'is', 'isn\'t'], {
        'wasn\'t': '"Wasn\'t" is correct because the statement is positive ("was"), so the tag must be negative using "was".',
        'was': '"Was" would make a positive tag after a positive statement — tags must reverse polarity.',
      ...
      ['We had finished the test before the bell rang, ___ we?', 'hadn\'t', ['had', 'did', 'didn\'t'], {
        ...
        'had': '"Had" would make a positive tag after a positive statement — tags must reverse polarity.',
        'did': '"Did" is the wrong auxiliary — the main verb uses "had" (past perfect), so the tag must also use "had".',
        'didn\'t': '"Didn\'t" is the wrong auxiliary — the main verb uses "had" (past perfect), so the tag must also use "had".',
      }],
      ['The kittens are playing in the garden, ___ they?', 'aren\'t', ['are', 'is', 'isn\'t'], {
        'aren\'t': '"Aren\'t" is correct because the statement is positive ("are playing"), so the tag must be negative using "are".',
        'are': '"Are" would make a positive tag after a positive statement — tags must reverse polarity.',
        'is': '"Is" is wrong — "the kittens" is plural, so the auxiliary must be "are", not "is".',
        'isn\'t': '"Isn\'t" is wrong — "the kittens" is plural, so the auxiliary must be "are", not "is".',
      }],
      ['Father has fixed the broken chair, ___ he?', 'hasn\'t', ['has', 'does', 'doesn\'t'], {
        'hasn\'t': '"Hasn\'t" is correct because the statement is positive ("has fixed"), so the tag must be negative using "has".',
        'has': '"Has" would make a positive tag after a positive statement — tags must reverse polarity.',
        'does': '"Does" is the wrong auxiliary — the main verb uses "has" (present perfect), so the tag must also use "has".',
        'doesn\'t': '"Doesn\'t" is the wrong auxiliary — the main verb uses "has" (present perfect), so the tag must also use "has".',
      }],
      ['Aunty Lin would prefer chicken rice, ___ she?', 'wouldn\'t', ['would', 'does', 'doesn\'t'], {
        'wouldn\'t': '"Wouldn\'t" is correct because the statement is positive ("would prefer"), so the tag must be negative using "would".',
        'would': '"Would" would make a positive tag after a positive statement — tags must reverse polarity.',
        'does': '"Does" is the wrong auxiliary — the main verb uses "would", so the tag must also use "would".',
        'doesn\'t': '"Doesn\'t" is the wrong auxiliary — the main verb uses "would", so the tag must also use "would".',
      }],
      ['Your brother could not find his keys, ___ he?', 'could', ['couldn\'t', 'can', 'can\'t'], {
        'could': '"Could" is correct because the statement is negative ("could not find"), so the tag must be positive using "could".',
        'couldn\'t': '"Couldn\'t" would make a negative tag after a negative statement — tags must reverse polarity.',
        'can': '"Can" is the wrong tense — the statement uses past "could", so the tag must also use "could".',
        'can\'t': '"Can\'t" is the wrong tense — the statement uses past "could", so the tag must also use "could".',
      }],
      ['The bus will arrive at eight, ___ it?', 'won\'t', ['will', 'does', 'doesn\'t'], {
        'won\'t': '"Won\'t" is correct because the statement is positive ("will arrive"), so the tag must be negative using "will".',
        'will': '"Will" would make a positive tag after a positive statement — tags must reverse polarity.',
        'does': '"Does" is the wrong auxiliary — the main verb uses "will", so the tag must also use "will".',
        'doesn\'t': '"Doesn\'t" is the wrong auxiliary — the main verb uses "will", so the tag must also use "will".',
      }],
      ['You have been to the science centre before, ___ you?', 'haven\'t', ['have', 'did', 'didn\'t'], {
        'haven\'t': '"Haven\'t" is correct because the statement is positive ("have been"), so the tag must be negative using "have".',
        'have': '"Have" would make a positive tag after a positive statement — tags must reverse polarity.',
        'did': '"Did" is the wrong auxiliary — the main verb uses "have" (present perfect), so the tag must also use "have".',
        'didn\'t': '"Didn\'t" is the wrong auxiliary — the main verb uses "have" (present perfect), so the tag must also use "have".',
      }],
      ['It was raining when you left school, ___ it?', 'wasn\'t', ['was', 'is', 'isn\'t'], {
        'wasn\'t': '"Wasn\'t" is correct because the statement is positive ("was raining"), so the tag must be negative using "was".',
        'was': '"Was" would make a positive tag after a positive statement — tags must reverse polarity.',
        'is': '"Is" is the wrong tense — the statement uses past "was", so the tag must also use "was".',
        'isn\'t': '"Isn\'t" is the wrong tense — the statement uses past "was", so the tag must also use "was".',
      }],
      ['We need not bring our art files today, ___ we?', 'need', ['needn\'t', 'do', 'don\'t'], {
        'need': '"Need" is correct because the statement is negative ("need not"), so the tag must be positive using "need".',
        'needn\'t': '"Needn\'t" would make a negative tag after a negative statement — tags must reverse polarity.',
        'do': '"Do" is the wrong auxiliary — the main verb uses "need", so the tag must also use "need".',
        'don\'t': '"Don\'t" is the wrong auxiliary — the main verb uses "need", so the tag must also use "need".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return {
  ...
  compoundIndefinite(level, i) {
    const rows = [
      ['I must have dropped my key ___. I cannot seem to find it.', 'somewhere', ['nowhere', 'anywhere', 'everywhere'], {
        'somewhere': '"Somewhere" is correct because the key was dropped in an unknown but specific place that exists.',
        'nowhere': '"Nowhere" means no place at all, but the key was dropped somewhere — the speaker just does not know where.',
        'anywhere': '"Anywhere" is used in questions or negative sentences to mean any place; this is a positive statement.',
        'everywhere': '"Everywhere" means in all places, which does not fit — the key was lost in one particular spot.',
      }],
      ['Is there ___ at home? The lights are off.', 'anyone', ['no one', 'someone', 'everyone'], {
        'anyone': '"Anyone" is correct because this is a question asking if any person (unspecified) is present.',
        'no one': '"No one" makes a negative statement, but the sentence is a question — use "anyone" in questions.',
        'someone': '"Someone" suggests a specific unknown person, but in a question we use "anyone" to leave the answer open.',
        'everyone': '"Everyone" means all people, which is too broad for a question about whether any person is home.',
      }],
      ['There is ___ to do — the room is spotless.', 'nothing', ['anything', 'something', 'everything'], {
        'nothing': '"Nothing" is correct because the room is spotless, meaning there is no task at all to do.',
        'anything': '"Anything" is used in questions or negatives (e.g. "there is not anything"), not in a positive statement.',
        'something': '"Something" implies a task exists, but the room is described as spotless — there is no task.',
        'everything': '"Everything" means all things need to be done, which contradicts the room being spotless.',
      }],
      ['I want to go ___ quiet for the holidays.', 'somewhere', ['nowhere', 'anywhere', 'everywhere'], {
        'somewhere': '"Somewhere" is correct because the speaker wants a real but unspecified quiet place.',
        'nowhere': '"Nowhere" means no place at all, but the speaker wants to go to a place — just not a specific one.',
        'anywhere': '"Anywhere" is used in questions or negatives; here the speaker has a positive desire to go to a place.',
        'everywhere': '"Everywhere" means all places, which contradicts wanting a single quiet destination.',
      }],
      ['___ in the class enjoys art lessons — even the shy ones.', 'Everyone', ['No one', 'Anyone', 'Someone'], {
        'Everyone': '"Everyone" is correct because the sentence says all pupils in the class enjoy art, with no exceptions.',
        'No one': '"No one" means not a single person enjoys art, which contradicts the meaning.',
        'Anyone': '"Anyone" is used in questions or conditionals, not to make a positive statement about all members.',
        'Someone': '"Someone" means an unknown individual, but the sentence talks about the whole class without exception.',
      }],
      ['I looked ___ for my glasses but they were on my head.', 'everywhere', ['nowhere', 'somewhere', 'anywhere'], {
        'everywhere': '"Everywhere" is correct because the speaker searched in all possible places.',
        'nowhere': '"Nowhere" means the speaker did not look anywhere, but the sentence says they searched.',
        'somewhere': '"Somewhere" means a single unknown place, but the speaker looked in all places.',
        'anywhere': '"Anywhere" is used in questions or negative sentences, not positive statements about a thorough search.',
      }],
      ['Did you see ___ suspicious near the school gate just now?', 'anything', ['something', 'nothing', 'everything'], {
        'anything': '"Anything" is correct because this is a question asking whether something (unspecified) was seen.',
        'something': '"Something" implies the speaker is fairly sure something suspicious was there; "anything" is more neutral in questions.',
        'nothing': '"Nothing" is negative and turns the question into a statement rather than a genuine question.',
        'everything': '"Everything" means all things, which is too broad for asking about one suspicious object or person.',
      }],
      ['___ knocked at the door, but I could not see who it was through the peephole.', 'Someone', ['No one', 'Anyone', 'Everyone'], {
        'Someone': '"Someone" is correct because a real but unknown person knocked — the speaker heard it.',
        'No one': '"No one" means nobody knocked, which contradicts the sound at the door.',
        'Anyone': '"Anyone" is used in questions or conditionals, not to introduce a real unknown person in a statement.',
        'Everyone': '"Everyone" means all people knocked, which is not possible — only one unknown person knocked.',
      }],
      ['There is ___ in the snack jar — I finished it yesterday.', 'nothing', ['anything', 'something', 'everywhere'], {
        'nothing': '"Nothing" is correct because the speaker confirms the jar is empty.',
        'anything': '"Anything" is used in questions or negatives (e.g. "there is not anything"); this is a positive statement.',
        'something': '"Something" would mean food remains, but the speaker says it was all finished.',
        'everywhere': '"Everywhere" is a place word and cannot describe the contents of a jar.',
      }],
      ['We searched ___ for the missing hamster and finally found it under the sofa.', 'everywhere', ['somewhere', 'anywhere', 'nowhere'], {
        'everywhere': '"Everywhere" is correct because the team searched in all possible places until they found it.',
        'somewhere': '"Somewhere" means one unknown place, but the sentence shows they searched all around.',
        'anywhere': '"Anywhere" is used in questions or negatives, not positive statements about a thorough search.',
        'nowhere': '"Nowhere" would mean they did not search at all, which contradicts finding the hamster.',
      }],
      ['___ in the room felt the sudden chill when Mum opened the window.', 'Everyone', ['Anyone', 'Someone', 'No one'], {
        'Everyone': '"Everyone" is correct because all people in the room felt the chill without exception.',
        'Anyone': '"Anyone" is used in questions or conditionals, not to make a positive statement about all people.',
        'Someone': '"Someone" means only one unknown person felt it, but the sentence implies all people did.',
        'No one': '"No one" would mean nobody felt the chill, which contradicts the meaning of the sentence.',
      }],
      ['Has ___ told you about the change in the timetable yet?', 'anyone', ['someone', 'everyone', 'no one'], {
        'anyone': '"Anyone" is correct because this is a question asking whether any person (unspecified) has told you.',
        'someone': '"Someone" suggests the speaker is fairly sure a specific person told you; "anyone" is more neutral in questions.',
        'everyone': '"Everyone" means all people told you, which is too broad for a simple question.',
        'no one': '"No one" turns the question into a negative statement rather than a genuine question.',
      }],
      ['I do not know ___ in this new class — please introduce me to your friends.', 'anyone', ['someone', 'everyone', 'no one'], {
        'anyone': '"Anyone" is correct because the negative "do not know" pairs with "anyone" — not knowing any person.',
        'someone': '"Someone" is used in positive statements; after a negative verb, "anyone" is needed.',
        'everyone': '"Everyone" means all people, which is too specific for a general "I know nobody" situation.',
        'no one': '"No one" would create a double negative with "do not know", making it grammatically incorrect.',
      }],
      ['___ has been moved on my desk — my pencil case is in the wrong spot!', 'Something', ['Nothing', 'Anything', 'Everything'], {
        'Something': '"Something" is correct because the speaker notices a real but unspecified object has been moved.',
        'Nothing': '"Nothing" means no item was moved, but the pencil case is clearly in the wrong spot.',
        'Anything': '"Anything" is used in questions or negatives, not positive statements about a specific observation.',
        'Everything': '"Everything" means all items were moved, but the speaker only mentions the pencil case.',
      }],
      ['The shop was so quiet that there was ___ inside except the cashier.', 'no one', ['someone', 'anyone', 'everyone'], {
        'no one': '"No one" is correct because the shop was empty of customers — only the cashier was there.',
        'someone': '"Someone" implies a specific unknown person was present, but the shop was described as nearly empty.',
        'anyone': '"Anyone" is used in questions or after negatives (e.g. "there was not anyone"), not in a positive statement.',
        'everyone': '"Everyone" means all people were there, which contradicts the description of a quiet, empty shop.',
      }],
      ['Let us go ___ peaceful and read a book together this afternoon.', 'somewhere', ['anywhere', 'nowhere', 'everywhere'], {
        'somewhere': '"Somewhere" is correct because the speaker wants to find a real but unspecified peaceful place.',
        'anywhere': '"Anywhere" suggests any place will do; "somewhere" fits better because the speaker has a specific quality in mind.',
        'nowhere': '"Nowhere" means no place at all, but the speaker wants to go to a place.',
        'everywhere': '"Everywhere" means all places, which contradicts looking for a single peaceful spot.',
      }],
      ['The playground was empty — there was ___ in sight on such a hot afternoon.', 'no one', ['anyone', 'someone', 'everyone'], {
        'no one': '"No one" is correct because the playground was empty — not a single person was visible.',
        'anyone': '"Anyone" is used in questions or after negatives; this is a positive statement confirming emptiness.',
        'someone': '"Someone" implies a specific unknown person was there, but the playground was described as empty.',
        'everyone': '"Everyone" means all people were visible, which contradicts the playground being empty.',
      }],
      ['After the storm, the debris had blown ___ — the field, the carpark, even the rooftop.', 'everywhere', ['somewhere', 'anywhere', 'nowhere'], {
        'everywhere': '"Everywhere" is correct because the examples (field, carpark, rooftop) show debris was in all places.',
        'somewhere': '"Somewhere" means one unknown place, but the examples show debris spread to many places.',
        'anywhere': '"Anywhere" is used in questions or negatives, not positive statements about wide distribution.',
        'nowhere': '"Nowhere" would mean the debris did not spread, which contradicts the examples given.',
      }],
      ['The librarian checked all the shelves but could not find the book ___.', 'anywhere', ['somewhere', 'nowhere', 'everywhere'], {
        'anywhere': '"Anywhere" is correct because "could not find" is a negative context, so "anywhere" fits — the book was not in any place.',
        'somewhere': '"Somewhere" implies the book is in one unknown place; the sentence says it was not found anywhere.',
        'nowhere': '"Nowhere" would create a double negative with "could not find", making it grammatically incorrect.',
        'everywhere': '"Everywhere" means all places, but the sentence is about failing to find the book, not confirming it is everywhere.',
      }],
      ['The park was so dark that Mum said there was ___ safe to sit.', 'nowhere', ['somewhere', 'anywhere', 'everywhere'], {
        'nowhere': '"Nowhere" is correct because there was no safe place at all — the park was too dark.',
        'somewhere': '"Somewhere" implies a safe place existed, but the sentence says there was none.',
        'anywhere': '"Anywhere" is used in questions or after negatives (e.g. "there was not anywhere safe"); the sentence uses a positive structure.',
        'everywhere': '"Everywhere" means all places, which contradicts the idea that no safe spot could be found.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return {
  ...
  demonstratives(level, i) {
    const rows = [
      ['I like this toy. I do not like ___ one over there.', 'that', ['this', 'these', 'those'], {
        'that': '"That" is correct because "over there" signals the toy is far away, and "that" is singular for one far thing.',
        'this': '"This" is for something near the speaker, but "over there" tells us the toy is far away.',
        'these': '"These" is plural for many near things, but the toy is one single thing far away.',
        'those': '"Those" is plural for many far things, but only one toy is described.',
      }],
      ['"___ is my pencil," said Mimi as she held it in her hand.', 'This', ['That', 'These', 'Those'], {
        'This': '"This" is correct because Mimi is holding the pencil — it is near (in her hand), and it is one item.',
        'That': '"That" is for something far from the speaker, but Mimi is holding the pencil.',
        'These': '"These" is plural for many near things, but there is only one pencil.',
        'Those': '"Those" is plural for many far things, but there is only one pencil and it is near.',
      }],
      ['Look at ___ apples on the table in front of us. They are red and shiny.', 'these', ['this', 'that', 'those'], {
        'these': '"These" is correct because the apples are on the table right in front of us (near), and they are more than one.',
        'this': '"This" is singular for one near thing, but there are multiple apples.',
        'that': '"That" is singular for one far thing, but the apples are near and there are more than one.',
        'those': '"Those" is for things far away, but the table is right in front of us.',
      }],
      ['Can you see ___ birds flying high in the sky?', 'those', ['this', 'that', 'these'], {
        'those': '"Those" is correct because the birds are high in the sky (far away), and they are more than one.',
        'this': '"This" is singular for one near thing, but the birds are far away and there are more than one.',
        'that': '"That" is singular for one far thing, but there are multiple birds.',
        'these': '"These" is for things near the speaker, but the birds are high in the sky, far away.',
      }],
      ['"Pass me ___ book on your desk, please," asked the teacher.', 'that', ['this', 'these', 'those'], {
        'that': '"That" is correct because the book is on the pupil\'s desk, away from the teacher who is asking.',
        'this': '"This" is for something near the speaker (the teacher), but the book is on the pupil\'s desk.',
        'these': '"These" is plural for many near things, but only one book is mentioned and it is far from the teacher.',
        'those': '"Those" is plural for many far things, but only one book is described.',
      }],
      ['"___ shoes here are mine. The ones over there are yours."', 'These', ['That', 'Those', 'This'], {
        'These': '"These" is correct because the shoes are near the speaker ("here") and there are more than one.',
        'That': '"That" is singular for one far thing, but the shoes are near ("here") and there are more than one.',
        'Those': '"Those" is for things far away, but "here" tells us the shoes are near the speaker.',
        'This': '"This" is singular for one near thing, but "shoes" is plural.',
      }],
      ['"___ is the way to the science lab — follow the corridor to the end and turn left," the prefect told us.', 'This', ['That', 'These', 'Those'], {
        'This': '"This" is correct because the prefect is pointing to a method or route being demonstrated right now.',
        'That': '"That" is for something distant or previously mentioned; the prefect is showing the route right now.',
        'These': '"These" is plural for many near things; "the way" is a single concept.',
        'Those': '"Those" is plural for many far things; "the way" is a single concept being described now.',
      }],
      ['Could you please hand me ___ scissors over there on the cupboard?', 'those', ['this', 'that', 'these'], {
        'those': '"Those" is correct because the scissors are on the cupboard (far from the speaker) and scissors is treated as plural.',
        'this': '"This" is singular for one near thing; the scissors are far away and treated as plural.',
        'that': '"That" is singular for one far thing; scissors is treated as plural.',
        'these': '"These" is for things near the speaker, but the scissors are over there on the cupboard.',
      }],
      ['"___ cookies that I am holding are still warm — try one!"', 'These', ['That', 'Those', 'This'], {
        'These': '"These" is correct because the cookies are in the speaker\'s hands (near) and there are more than one.',
        'That': '"That" is singular for one far thing, but the cookies are near and there are more than one.',
        'Those': '"Those" is for things far away, but the speaker is holding the cookies.',
        'This': '"This" is singular for one near thing, but "cookies" is plural.',
      }],
      ['Look! ___ butterfly near the window is much smaller than ours.', 'That', ['This', 'These', 'Those'], {
        'That': '"That" is correct because the butterfly is near the window (away from the speaker) and it is one butterfly.',
        'This': '"This" is for something near the speaker; the butterfly is by the window, away from the speaker.',
        'These': '"These" is plural for many near things; only one butterfly is described.',
        'Those': '"Those" is plural for many far things; only one butterfly is described.',
      }],
      ['"___ is how you fold the paper into a boat," Mrs Lee told the class.', 'This', ['That', 'These', 'Those'], {
        'This': '"This" is correct because Mrs Lee is demonstrating the method right now, in front of the class.',
        'That': '"That" is for something distant or already past; the demonstration is happening right now.',
        'These': '"These" is plural for many near things; the method being shown is a single concept.',
        'Those': '"Those" is plural for many far things; the method is being shown right now.',
      }],
      ['___ little boy beside me is my younger brother Tim.', 'This', ['That', 'These', 'Those'], {
        'This': '"This" is correct because the boy is beside the speaker (near) and it is one person.',
        'That': '"That" is for something far from the speaker; the boy is standing right beside the speaker.',
        'These': '"These" is plural for many near things; only one boy is described.',
        'Those': '"Those" is plural for many far things; only one boy is near.',
      }],
      ['"Please stack ___ chairs here against the wall before the parents arrive," said the teacher, pointing to the chairs beside her.', 'these', ['those', 'this', 'that'], {
        'these': '"These" is correct because the teacher is pointing to chairs beside her (near) and there are more than one.',
        'those': '"Those" is for things far from the speaker; the chairs are beside the teacher.',
        'this': '"This" is singular for one near thing, but "chairs" is plural.',
        'that': '"That" is singular for one far thing; the chairs are near and plural.',
      }],
      ['"___ pupil by the window — please sit up straight," the teacher said.', 'That', ['This', 'These', 'Those'], {
        'That': '"That" is correct because the pupil is at the window, away from the teacher, and it is one person.',
        'This': '"This" is for someone near the speaker; the pupil is away by the window.',
        'These': '"These" is plural for many near things; only one pupil is referred to.',
        'Those': '"Those" is plural for many far things; only one pupil is referred to.',
      }],
      ['Look at ___ clouds in the distance. I think it might rain later.', 'those', ['these', 'this', 'that'], {
        'those': '"Those" is correct because the clouds are in the distance (far away) and there are more than one.',
        'these': '"These" is for things near the speaker; the clouds are in the distance.',
        'this': '"This" is singular for one near thing; the clouds are far away and plural.',
        'that': '"That" is singular for one far thing; there are multiple clouds.',
      }],
      ['___ shoes near the door belong to my older brother.', 'Those', ['These', 'This', 'That'], {
        'Those': '"Those" is correct because the shoes are near the door (away from the speaker) and there are more than one.',
        'These': '"These" is for things near the speaker; the shoes are by the door, away from the speaker.',
        'This': '"This" is singular for one near thing; the shoes are far and plural.',
        'That': '"That" is singular for one far thing; there are multiple shoes.',
      }],
      ['Can you pass me ___ stapler on the table right in front of you?', 'that', ['this', 'these', 'those'], {
        'that': '"That" is correct because the stapler is in front of the person being addressed (away from the speaker asking) and it is one item.',
        'this': '"This" is for something near the speaker, but the stapler is on the table in front of the listener.',
        'these': '"These" is plural for many near things; only one stapler is mentioned.',
        'those': '"Those" is plural for many far things; only one stapler is mentioned.',
      }],
      ['___ two boys standing beside the flagpole are in my class.', 'Those', ['These', 'That', 'This'], {
        'Those': '"Those" is correct because the boys are beside the flagpole (far from the speaker) and there are two of them.',
        'These': '"These" is for things near the speaker; the boys are by the flagpole, away from the speaker.',
        'That': '"That" is singular for one far thing; there are two boys.',
        'This': '"This" is singular for one near thing; the boys are far away and there are two of them.',
      }],
      ['I bought ___ new eraser at the school bookshop just now.', 'this', ['that', 'these', 'those'], {
        'this': '"This" is correct because the speaker just bought the eraser and is likely holding or showing it (near), and it is one item.',
        'that': '"That" is for something far from the speaker; the eraser was just bought and is near.',
        'these': '"These" is plural for many near things; only one eraser is mentioned.',
        'those': '"Those" is plural for many far things; only one eraser is described.',
      }],
      ['___ worksheet that Teacher handed out yesterday was very challenging.', 'That', ['This', 'Those', 'These'], {
        'That': '"That" is correct because the worksheet was handed out yesterday (it is past, treated as distant) and it is one worksheet.',
        'This': '"This" is for something near or current; the worksheet is from yesterday, treated as a more distant reference.',
        'Those': '"Those" is plural for many far things; only one worksheet is mentioned.',
        'These': '"These" is plural for many near things; only one worksheet is described.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return {
  ...
  whQuestions(level, i) {
    const rows = [
      ['"___ did you perform this magic trick? Please show me," Fred asked.', 'How', ['When', 'What', 'Where'], {
        'How': '"How" is correct because Fred wants to know the method or manner in which the trick was done.',
        'When': '"When" asks about time, not the method of performing a trick.',
        'What': '"What" asks about a thing or action, not the manner or method.',
        'Where': '"Where" asks about a place, not the method of doing something.',
      }],
      ['"___ are you today? I hope you are feeling much better," my teacher said to me.', 'How', ['Why', 'What', 'Which'], {
        'How': '"How" is correct because the teacher is asking about the speaker\'s condition or state.',
        'Why': '"Why" asks for a reason; the teacher is asking about health, not why something happened.',
        'What': '"What" asks about a thing; "how are you" is a fixed greeting asking about one\'s wellbeing.',
        'Which': '"Which" asks for a choice from a set, not about a person\'s condition.',
      }],
      ['"___ is your birthday party? I want to know the date," Sara asked.', 'When', ['Where', 'How', 'Who'], {
        'When': '"When" is correct because Sara wants to know the date or time of the party.',
        'Where': '"Where" asks about a place, but Sara says she wants to know the date.',
        'How': '"How" asks about manner or condition, not the date of an event.',
        'Who': '"Who" asks about a person, not when an event takes place.',
      }],
      ['"___ do you keep your school bag at home?" asked Mum.', 'Where', ['When', 'How', 'Why'], {
        'Where': '"Where" is correct because Mum wants to know the location or place where the bag is kept.',
        'When': '"When" asks about time, not the location of the bag.',
        'How': '"How" asks about the manner of keeping, not the physical location.',
        'Why': '"Why" asks for a reason, not a location.',
      }],
      ['"___ are you wearing a raincoat? It is not raining," Tom asked.', 'Why', ['How', 'When', 'Where'], {
        'Why': '"Why" is correct because Tom wants to know the reason for wearing a raincoat when it is not raining.',
        'How': '"How" asks about the manner of wearing, not the reason.',
        'When': '"When" asks about time, not the reason for an action.',
        'Where': '"Where" asks about place, not the reason for wearing something.',
      }],
      ['"___ of these three animals is the largest — the blue whale, the elephant, or the giraffe?" the teacher asked.', 'Which', ['How', 'When', 'Whose'], {
        'Which': '"Which" is correct because the question asks for a selection from a specific set of three named animals.',
        'How': '"How" asks about manner or degree, not a choice between named options.',
        'When': '"When" asks about time, not a choice between animals.',
        'Whose': '"Whose" asks about ownership, not a selection from a list.',
      }],
      ['"___ did you go on your school holiday last December?" Aunt Mei asked.', 'Where', ['When', 'How', 'Why'], {
        'Where': '"Where" is correct because Aunt Mei wants to know the place visited during the holiday.',
        'When': '"When" asks about time, but the sentence already gives the time ("last December").',
        'How': '"How" asks about manner or condition, not the destination.',
        'Why': '"Why" asks for a reason, not a place.',
      }],
      ['"___ is the new student who joined our class today?" Daniel whispered.', 'Who', ['What', 'Which', 'Whose'], {
        'Who': '"Who" is correct because Daniel wants to know the identity of the new person.',
        'What': '"What" asks about a thing or action, not the identity of a person.',
        'Which': '"Which" asks for a choice from a specific set, not the identity of a new person.',
        'Whose': '"Whose" asks about ownership, not who a person is.',
      }],
      ['"___ pencil case is this on the floor near the door?" the teacher asked.', 'Whose', ['Who', 'Which', 'What'], {
        'Whose': '"Whose" is correct because the teacher wants to know who the pencil case belongs to.',
        'Who': '"Who" asks about a person, not ownership of an object.',
        'Which': '"Which" asks for a selection from a set, not who owns something.',
        'What': '"What" asks about a thing or action, not the owner of the pencil case.',
      }],
      ['"___ many books did you borrow from the school library yesterday?" the librarian asked politely.', 'How', ['What', 'When', 'Which'], {
        'How': '"How" is correct because "how many" is the fixed phrase for asking about quantity.',
        'What': '"What many" is not a grammatical phrase — the correct form is "how many".',
        'When': '"When" asks about time, not the number of books.',
        'Which': '"Which many" is not grammatical — only "how many" asks about quantity.',
      }],
      ['"___ do you spell \'necessary\'?" the teacher asked the class.', 'How', ['What', 'When', 'Where'], {
        'How': '"How" is correct because "how do you spell" is the fixed phrase for asking about spelling.',
        'What': '"What do you spell" is not the natural phrase — we say "how do you spell" a word.',
        'When': '"When" asks about time, not the spelling of a word.',
        'Where': '"Where" asks about place, not the spelling of a word.',
      }],
      ['"___ gave you permission to leave the classroom?" the prefect asked sternly.', 'Who', ['What', 'Which', 'Whose'], {
        'Who': '"Who" is correct because the prefect wants to know the identity of the person who gave permission.',
        'What': '"What" asks about a thing, not the identity of a person who gave permission.',
      ...
      ['"___ is the science lab? I cannot find it," the new student said.', 'Where', ['When', 'Why', 'How'], {
        ...
        'When': '"When" asks about time, not the location of a room.',
        'Why': '"Why" asks for a reason, not a location.',
        'How': '"How" asks about manner or condition, not the physical location of a place.',
      }],
      ['"___ did you arrive late today, Sam?" the teacher asked with concern.', 'Why', ['How', 'When', 'Where'], {
        'Why': '"Why" is correct because the teacher wants to know the reason for Sam\'s lateness.',
        'How': '"How" asks about the manner of arriving, not the reason for being late.',
        'When': '"When" asks about the time of arrival, not the reason for being late.',
        'Where': '"Where" asks about a place, not the reason for lateness.',
      }],
      ['"___ time does the school bus arrive at the bus stop?" Ali asked.', 'What', ['When', 'Where', 'Which'], {
        'What': '"What" is correct because "what time" is the fixed phrase for asking about a specific time.',
        'When': '"When" can ask about time but "what time" is the more precise and natural phrase here.',
        'Where': '"Where time" is not grammatical — "where" asks about a place, not a time.',
        'Which': '"Which time" could work with a specific list, but "what time" is the natural way to ask about bus arrival.',
      }],
      ['"___ long does it take you to walk from your home to school?" asked the teacher.', 'How', ['What', 'When', 'Why'], {
        'How': '"How" is correct because "how long" is the fixed phrase for asking about duration.',
        'What': '"What long" is not grammatical — "how long" is the correct phrase for asking about duration.',
        'When': '"When" asks about a point in time, not a duration or length of time.',
        'Why': '"Why long" is not grammatical — "why" asks for a reason, not a duration.',
      }],
      ['"___ book is this? It does not have a name written on it," said the teacher.', 'Whose', ['Who', 'Which', 'What'], {
        'Whose': '"Whose" is correct because the teacher wants to know who the book belongs to.',
        'Who': '"Who" asks about a person\'s identity, not who owns the book.',
        'Which': '"Which book" would ask for a selection from a set, not who owns an item.',
        'What': '"What book" asks about the type or title, not the owner.',
      }],
      ['"___ is your grandmother? I heard she was not feeling well," said Auntie.', 'How', ['What', 'Who', 'Where'], {
        'How': '"How" is correct because Auntie wants to know the grandmother\'s condition or state of health.',
        'What': '"What" asks about a thing, not a person\'s health condition.',
  ...
  presentCont(level, i) {
    const rows = [
      ['Look! The children ___ across the hall.', 'are running', ['run', 'ran', 'is running'], {
        'are running': '"Are running" is correct because "Look!" signals an action happening right now, and "the children" is plural.',
        'run': '"Run" is simple present for habits; "Look!" tells us the action is in progress at this very moment.',
        'ran': '"Ran" is simple past; "Look!" tells us the action is happening now, not in the past.',
        'is running': '"Is running" uses a singular auxiliary; "the children" is plural and needs "are".',
      }],
      ['Right now, my mother ___ dinner for everyone.', 'is cooking', ['cooks', 'cooked', 'are cooking'], {
        'is cooking': '"Is cooking" is correct because "right now" signals an action in progress, and "my mother" is singular.',
        'cooks': '"Cooks" is simple present for habits; "right now" tells us the action is ongoing at this moment.',
        'cooked': '"Cooked" is simple past; "right now" tells us the action is still happening.',
        'are cooking': '"Are cooking" uses a plural auxiliary; "my mother" is singular and needs "is".',
      }],
      ['At the moment, I ___ my spelling corrections.', 'am checking', ['check', 'checked', 'is checking'], {
        'am checking': '"Am checking" is correct because "at the moment" signals an action in progress, and "I" takes "am".',
        'check': '"Check" is simple present for habits; "at the moment" tells us the action is ongoing right now.',
        'checked': '"Checked" is simple past; "at the moment" tells us the action is still happening.',
        'is checking': '"Is checking" uses the auxiliary for he/she/it; "I" must use "am".',
      }],
      ['Listen! The choir ___ the final chorus.', 'is singing', ['sing', 'sang', 'are singing'], {
        'is singing': '"Is singing" is correct because "Listen!" signals an action in progress, and "the choir" is a singular collective noun.',
        'sing': '"Sing" is simple present for habits; "Listen!" tells us we can hear the singing right now.',
        'sang': '"Sang" is simple past; "Listen!" tells us the action is happening at this very moment.',
        'are singing': '"Are singing" uses a plural auxiliary; "the choir" is treated as a singular collective noun.',
      }],
      ['Sshh — the baby ___ in the pram.', 'is sleeping', ['sleep', 'sleeps', 'are sleeping'], {
        'is sleeping': '"Is sleeping" is correct because "Sshh" signals the action is ongoing right now, and "the baby" is singular.',
        'sleep': '"Sleep" is the base form; with a singular subject and an ongoing action, "is sleeping" is needed.',
        'sleeps': '"Sleeps" is simple present for a routine, not an action happening at this very moment.',
        'are sleeping': '"Are sleeping" uses a plural auxiliary; "the baby" is singular and needs "is".',
      }],
      ['The technicians ___ the new projector right now.', 'are installing', ['installs', 'install', 'is installing'], {
        'are installing': '"Are installing" is correct because "right now" signals an ongoing action, and "the technicians" is plural.',
        'installs': '"Installs" is simple present for he/she/it; "the technicians" is plural.',
        'install': '"Install" is simple present base form for habits; "right now" signals an action in progress.',
        'is installing': '"Is installing" uses a singular auxiliary; "the technicians" is plural and needs "are".',
      }],
      ['Look outside! It ___ heavily again.', 'is raining', ['rains', 'rained', 'are raining'], {
        'is raining': '"Is raining" is correct because "Look outside!" signals an action in progress, and "it" is singular.',
        'rains': '"Rains" is simple present for a regular pattern; "Look outside!" signals it is raining right now.',
        'rained': '"Rained" is simple past; "Look outside!" tells us the rain is happening at this moment.',
        'are raining': '"Are raining" uses a plural auxiliary; "it" is singular and needs "is".',
      }],
      ['The art teacher ___ a beautiful mural at this very moment.', 'is painting', ['paints', 'painted', 'are painting'], {
        'is painting': '"Is painting" is correct because "at this very moment" signals an ongoing action, and "the art teacher" is singular.',
        'paints': '"Paints" is simple present for a habit or routine, not an action in progress at this moment.',
        'painted': '"Painted" is simple past; "at this very moment" tells us the painting is still ongoing.',
        'are painting': '"Are painting" uses a plural auxiliary; "the art teacher" is singular and needs "is".',
      }],
      ['Right now, our librarian ___ the new books on the shelves.', 'is arranging', ['arranges', 'arrange', 'are arranging'], {
        'is arranging': '"Is arranging" is correct because "right now" signals an ongoing action, and "our librarian" is singular.',
        'arranges': '"Arranges" is simple present for a habit; "right now" signals the action is in progress.',
        'arrange': '"Arrange" is base form for plural/general subjects; "our librarian" is singular.',
        'are arranging': '"Are arranging" uses a plural auxiliary; "our librarian" is singular and needs "is".',
      }],
      ['Look — the puppies ___ in the playpen!', 'are tumbling', ['tumbles', 'tumble', 'is tumbling'], {
        'are tumbling': '"Are tumbling" is correct because "Look" signals an action in progress, and "the puppies" is plural.',
        'tumbles': '"Tumbles" is simple present for he/she/it; "the puppies" is plural.',
        'tumble': '"Tumble" is base form simple present for habits; "Look" signals the action is happening right now.',
        'is tumbling': '"Is tumbling" uses a singular auxiliary; "the puppies" is plural and needs "are".',
      }],
      ['Look! The cat ___ on top of the HDB letterbox.', 'is sitting', ['sit', 'sat', 'are sitting'], {
        'is sitting': '"Is sitting" is correct because "Look!" signals an action in progress, and "the cat" is singular.',
        'sit': '"Sit" is base form simple present for habits; "Look!" signals the action is happening right now.',
        'sat': '"Sat" is simple past; "Look!" tells us the action is happening at this moment.',
        'are sitting': '"Are sitting" uses a plural auxiliary; "the cat" is singular and needs "is".',
      }],
      ['Right now, Father ___ the dishes after dinner.', 'is washing', ['washes', 'washed', 'are washing'], {
        'is washing': '"Is washing" is correct because "right now" signals an ongoing action, and "Father" is singular.',
        'washes': '"Washes" is simple present for a habit; "right now" signals the action is in progress at this moment.',
        'washed': '"Washed" is simple past; "right now" tells us the washing is still happening.',
        'are washing': '"Are washing" uses a plural auxiliary; "Father" is singular and needs "is".',
      }],
      ['Listen! The teacher ___ the instructions for the game.', 'is reading', ['read', 'reads', 'are reading'], {
        'is reading': '"Is reading" is correct because "Listen!" signals an action in progress, and "the teacher" is singular.',
        'read': '"Read" is base form simple present for habits; "Listen!" signals the reading is happening right now.',
        'reads': '"Reads" is simple present for a routine, not an action in progress at this moment.',
        'are reading': '"Are reading" uses a plural auxiliary; "the teacher" is singular and needs "is".',
      }],
      ['At the moment, the boys ___ their shoes before PE.', 'are tying', ['ties', 'tie', 'is tying'], {
        'are tying': '"Are tying" is correct because "at the moment" signals an ongoing action, and "the boys" is plural.',
        'ties': '"Ties" is simple present for he/she/it; "the boys" is plural.',
        'tie': '"Tie" is base form for habits; "at the moment" signals the action is in progress.',
        'is tying': '"Is tying" uses a singular auxiliary; "the boys" is plural and needs "are".',
      }],
      ['Look! My little sister ___ the cat with a ribbon.', 'is chasing', ['chases', 'chased', 'are chasing'], {
        'is chasing': '"Is chasing" is correct because "Look!" signals an action in progress, and "my little sister" is singular.',
        'chases': '"Chases" is simple present for a habit; "Look!" signals the chasing is happening right now.',
        'chased': '"Chased" is simple past; "Look!" tells us the action is still happening.',
        'are chasing': '"Are chasing" uses a plural auxiliary; "my little sister" is singular and needs "is".',
      }],
      ['Right now, the canteen auntie ___ fresh noodles for us.', 'is frying', ['fries', 'fried', 'are frying'], {
        'is frying': '"Is frying" is correct because "right now" signals an ongoing action, and "the canteen auntie" is singular.',
        'fries': '"Fries" is simple present for a habit; "right now" signals the frying is in progress.',
        'fried': '"Fried" is simple past; "right now" tells us the frying is still happening.',
        'are frying': '"Are frying" uses a plural auxiliary; "the canteen auntie" is singular and needs "is".',
      }],
      ['Look! The twins ___ the void deck for the party.', 'are sweeping', ['sweep', 'swept', 'is sweeping'], {
        'are sweeping': '"Are sweeping" is correct because "Look!" signals an ongoing action, and "the twins" is plural.',
        'sweep': '"Sweep" is base form simple present for habits; "Look!" signals the action is happening right now.',
        'swept': '"Swept" is simple past; "Look!" tells us the action is still in progress.',
        'is sweeping': '"Is sweeping" uses a singular auxiliary; "the twins" is plural and needs "are".',
      }],
      ['At the moment, our class ___ a thank-you card for the teacher.', 'is making', ['make', 'made', 'are making'], {
        'is making': '"Is making" is correct because "at the moment" signals an ongoing action, and "our class" is a singular collective noun.',
        'make': '"Make" is base form for habits; "at the moment" signals the making is in progress.',
        'made': '"Made" is simple past; "at the moment" tells us the action is still happening.',
        'are making': '"Are making" uses a plural auxiliary; "our class" is treated as singular and needs "is".',
      }],
      ['Listen! The birds ___ outside the classroom window.', 'are chirping', ['chirp', 'chirped', 'is chirping'], {
        'are chirping': '"Are chirping" is correct because "Listen!" signals an ongoing action, and "the birds" is plural.',
        'chirp': '"Chirp" is base form simple present for habits; "Listen!" signals the chirping is happening right now.',
        'chirped': '"Chirped" is simple past; "Listen!" tells us the chirping is still going on.',
        'is chirping': '"Is chirping" uses a singular auxiliary; "the birds" is plural and needs "are".',
      }],
      ['Right now, Mum ___ the MRT to meet us at Jurong East.', 'is taking', ['take', 'took', 'are taking'], {
        'is taking': '"Is taking" is correct because "right now" signals an ongoing action, and "Mum" is singular.',
        'take': '"Take" is base form for habits; "right now" signals the journey is in progress.',
        'took': '"Took" is simple past; "right now" tells us the action is still happening.',
        'are taking': '"Are taking" uses a plural auxiliary; "Mum" is singular and needs "is".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'present_continuous', q, choices: buildChoices(answer, ds), answer, explain: 'Use present continuous for actions happening now. Form: am/is/are + verb-ing. "I" → am, he/she/it → is, we/they/plural → are.', optionExplanations };
  },
  prepositions(level, i) {
    const p1Rows = [
      ['Gavin fell asleep ___ the sofa.', 'on', ['in', 'into', 'onto'], {
        'on': '"On" is correct because Gavin is resting on the surface of the sofa.',
        'in': '"In" is for enclosed spaces; a sofa is a surface, not an enclosed space.',
        'into': '"Into" shows movement going inside something; Gavin is resting on a surface.',
        'onto': '"Onto" shows movement up onto a surface; Gavin has already settled and is now asleep.',
      }],
      ['The ball rolled away and fell ___ a drain.', 'into', ['to', 'on', 'over'], {
        'into': '"Into" is correct because the ball moved and ended up inside the enclosed drain.',
        'to': '"To" shows direction of movement but does not capture entering the drain.',
        'on': '"On" is for resting on a surface; the ball fell inside the drain, not on top of it.',
        'over': '"Over" means the ball passed above or across the drain, not that it fell inside.',
      }],
      ['Holly has to attend a lesson ___ 8 o\'clock in the morning.', 'at', ['in', 'on', 'by'], {
        ...
        'by': '"By" means not later than 8 o\'clock; the sentence states the lesson starts exactly at that time.',
      }],
      ['It was very hot, so we sat ___ the shade where it was cooler.', 'in', ['on', 'with', 'below'], {
        'in': '"In" is correct because shade is an area that surrounds or encloses you.',
        'on': '"On" is for surfaces; you sit inside the shade, not on top of it.',
      ...
      ['The children ran ___ the playground after the bell rang.', 'to', ['at', 'on', 'in'], {
        ...
        'at': '"At" shows a fixed location; the children are moving towards, not already at, the playground.',
        'on': '"On" is for a surface; the movement is towards the playground.',
        'in': '"In" is for being inside an area; the children are heading towards the playground.',
      }],
      ['She kept her storybook ___ her bag to read later.', 'in', ['on', 'at', 'under'], {
        'in': '"In" is correct because the storybook is placed inside the bag.',
        'on': '"On" is for surfaces; a bag is a container, and the book goes inside it.',
        'at': '"At" shows a point or location, not placement inside a container.',
        'under': '"Under" means below; the book is placed inside the bag, not beneath it.',
      }],
      ['The kite flew high ___ the trees in the park.', 'above', ['under', 'below', 'behind'], {
        'above': '"Above" is correct because the kite is at a higher position than the trees.',
        'under': '"Under" means lower than the trees; the kite is flying high.',
        'below': '"Below" also means lower than the trees; the kite is flying high.',
        'behind': '"Behind" means at the back of the trees; the kite is higher, not behind.',
      }],
      ['We live ___ the sixth floor of the apartment block.', 'on', ['at', 'in', 'above'], {
        'on': '"On" is correct because floor levels in a building always use "on" (e.g. on the third floor).',
        'at': '"At" is used for specific addresses or general locations, not specific floor levels.',
        'in': '"In" is for enclosed spaces; for floor levels, "on" is the correct preposition.',
        'above': '"Above" means higher than the sixth floor; the family lives on the sixth floor.',
      }],
      ['Dad parked the car ___ the shopping centre.', 'at', ['in', 'on', 'above'], {
        'at': '"At" is correct because it refers to a general location or point — the shopping centre is treated as a destination.',
        'in': '"In" could mean inside the building; "at" is more natural for the general location.',
        'on': '"On" is for surfaces or floor levels, not a general location like a shopping centre.',
        'above': '"Above" would mean the car floated over the shopping centre, which is impossible.',
      }],
      ['The bird perched ___ the branch and sang a sweet song.', 'on', ['at', 'in', 'under'], {
        'on': '"On" is correct because the bird rested on the surface of the branch.',
        'at': '"At" shows a general point or location, not contact with a surface like a branch.',
      ...
      ['We must line up ___ the classroom door before we go in.', 'at', ['on', 'in', 'over'], {
        'at': '"At" is correct because the door is a specific point or location.',
        'on': '"On" is for surfaces; a door is a location point, not a surface to stand on.',
        'in': '"In" is for enclosed spaces; the pupils are outside in front of the door.',
        'over': '"Over" means above the door; the pupils are standing at the door.',
      }],
      ['Grandma keeps her glasses ___ her purse.', 'in', ['on', 'at', 'under'], {
        'in': '"In" is correct because a purse is a container and the glasses are stored inside it.',
        'on': '"On" is for surfaces; a purse is a container, so "in" is needed.',
      ...
      ['My little brother sat ___ me on the MRT.', 'beside', ['above', 'into', 'behind'], {
        ...
        'behind': '"Behind" means at the back; he is seated next to the speaker, not behind.',
      }],
      ['School starts ___ seven thirty in the morning.', 'at', ['on', 'in', 'by'], {
        'at': '"At" is correct because it is always used with specific clock times.',
        'on': '"On" is used with days or dates, not clock times.',
        'in': '"In" is used with months or years, not specific clock times.',
        'by': '"By" means not later than 7.30 a.m.; the sentence states school starts exactly at that time.',
      }],
    ];
    const p2Rows = [
      ['The cyclist took shelter ___ the bridge as it was raining.', 'under', ['at', 'on', 'above'], {
        'under': '"Under" is correct because the cyclist moved to the space below the bridge for shelter.',
        'at': '"At" shows a general location; the cyclist went specifically below the bridge.',
        'on': '"On" would mean the cyclist went on top of the bridge; they went beneath it.',
        'above': '"Above" would mean above the bridge; shelter from rain is found below it.',
      }],
      ['Joe kicked the ball so hard that it flew ___ the fence.', 'over', ['above', 'across', 'through'], {
        'over': '"Over" is correct because the ball travelled up and past the top of the fence.',
        'above': '"Above" means higher than the fence without necessarily passing it; "over" shows the ball cleared it.',
        'across': '"Across" means from one side to the other of a flat surface; a fence is a vertical barrier.',
        'through': '"Through" means passing inside or between gaps; the ball went over the top of the fence.',
      }],
      ['It is dangerous to dash ___ the road without watching out for traffic.', 'across', ['along', 'over', 'through'], {
        'across': '"Across" is correct because you move from one side of the road to the other side.',
        'along': '"Along" means moving in the same direction as the road, not crossing it.',
      ...
      ['Tall buildings stood all ___ her.', 'around', ['beside', 'across', 'towards'], {
        'around': '"Around" is correct because the buildings were on all sides of Emily.',
        'beside': '"Beside" means next to one side only; "around" captures all sides.',
        'across': '"Across" means on the opposite side; the buildings were on all sides.',
        'towards': '"Towards" shows direction of movement; the buildings are in a fixed position surrounding her.',
      }],
      ['She decided to head ___ the park to find her way home.', 'towards', ['among', 'beside', 'off'], {
        'towards': '"Towards" is correct because she is moving in the direction of the park.',
        'among': '"Among" means being in the middle of a group; it does not describe movement in a direction.',
        'beside': '"Beside" means next to something; "towards" shows the direction of travel.',
        'off': '"Off" means away from something; here she is moving in the direction of the park.',
      }],
      ['The train went ___ a long tunnel before reaching the next station.', 'through', ['over', 'across', 'along'], {
        'through': '"Through" is correct because the train entered and passed all the way inside the tunnel.',
        'over': '"Over" means passing above the tunnel; the train went inside it.',
        'across': '"Across" means from one side to the other of a flat surface; a tunnel is enclosed.',
        'along': '"Along" means beside or parallel to something; the train went inside the tunnel.',
      }],
      ['The rabbit hopped ___ the fence and landed on the soft grass.', 'over', ['across', 'through', 'into'], {
        'over': '"Over" is correct because the rabbit jumped up and cleared the top of the fence.',
        'across': '"Across" means moving from one side of a flat surface to the other; a fence is a vertical barrier.',
        'through': '"Through" means passing inside or between gaps; the rabbit cleared the top of the fence.',
        'into': '"Into" means entering an enclosed space; the rabbit landed on grass after clearing the fence.',
      }],
      ['The cat jumped ___ the open box and sat down inside.', 'into', ['onto', 'over', 'through'], {
        'into': '"Into" is correct because the cat moved and ended up inside the box.',
        'onto': '"Onto" means moving on top of the surface; the cat went inside the box.',
      ...
      ['She slid ___ the chair to make room for the new pupil.', 'off', ['over', 'across', 'below'], {
        'off': '"Off" is correct because she moved away from and down from the chair.',
        'over': '"Over" means above or passing to the other side; she moved down from the chair.',
        'across': '"Across" means from one side to the other; she moved off the seat entirely.',
        'below': '"Below" means at a lower level; "off" captures the movement away from the chair.',
      }],
    ];
    const upperRows = [
      ['Please place the attendance file ___ the principal\'s desk.', 'on', ['in', 'under', 'between'], {
        'on': '"On" is correct because the file is placed on the surface of the desk.',
        'in': '"In" is for enclosed containers; a desk is a surface.',
      ...
      ['The football rolled ___ the bench.', 'under', ['above', 'across', 'toward'], {
        ...
        'toward': '"Toward" shows direction of movement; the ball went under the bench, not just towards it.',
      }],
      ['They walked ___ the bridge to the science centre.', 'across', ['behind', 'inside', 'with'], {
        'across': '"Across" is correct because they crossed from one end of the bridge to the other.',
        'behind': '"Behind" means at the back of the bridge; they walked over its length.',
      ...
      ['Pass the message ___ Mrs Lim before recess, please.', 'to', ['at', 'for', 'with'], {
        ...
        'at': '"At" shows location, not the recipient of a message.',
        'for': '"For" shows purpose or benefit; "pass to" indicates giving something to someone.',
        'with': '"With" shows accompaniment, not delivering a message to someone.',
      }],
      ['The new mural was painted ___ several talented seniors over the holidays.', 'by', ['for', 'with', 'from'], {
        'by': '"By" is correct because it shows the agent (the doers) in a passive sentence.',
        'for': '"For" shows purpose or benefit; "by" identifies who performed the action.',
        'with': '"With" shows using a tool; "by" identifies the people who did the painting.',
        'from': '"From" shows origin or source, not the doer of a passive action.',
      }],
      ['The library is open ___ 8 a.m. to 4 p.m. every weekday.', 'from', ['for', 'since', 'until'], {
        'from': '"From" is correct because "from…to" gives the start and end of a time range.',
        'for': '"For" is used with a duration (e.g. for two hours); here a specific start and end are given.',
        'since': '"Since" marks the starting point without an end; "from…to" gives both start and end.',
        'until': '"Until" marks an end point; "from" marks the start, so "from…to" is the correct pair.',
      }],
      ['We must hand in the project ___ Friday at the latest.', 'by', ['until', 'at', 'on'], {
        'by': '"By" is correct because it means the project must be submitted no later than Friday.',
        'until': '"Until" means up to a continuous point in time; "by" is used for deadlines.',
    ...
    const rows = level === 'P1' ? p1Rows : level === 'P2' ? p2Rows : upperRows;
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'preposition_use', q, choices: buildChoices(answer, ds), answer, explain: 'Place: on (surface), in (enclosed), at (point/location), between (two), among (many). Movement: into, onto, across, through, over, along. Time: at (clock time), on (date/day), in (month/year), by (deadline), from…to (range).', optionExplanations };
  },
  possessives(level, i) {
    const rows = [
      ['This is not my bottle. It is ___.', 'hers', ['her', 'she', 'herself'], {
        ...
        'her': '"Her" is a possessive adjective used before a noun (e.g. "her bottle"), but no noun follows here.',
        'she': '"She" is a subject pronoun, not used to show ownership.',
      ...
      ['The boys forgot ___ PE shirts in class.', 'their', ['there', 'they', 'theirs'], {
        'their': '"Their" is correct because it is a possessive adjective that comes before the noun "PE shirts".',
        'there': '"There" is a place word, not a possessive adjective.',
        'they': '"They" is a subject pronoun, not a possessive adjective.',
        'theirs': '"Theirs" is a possessive pronoun that stands alone; it cannot come before a noun like "PE shirts".',
      }],
      ['That laptop belongs to my parents. It is ___.', 'theirs', ['their', 'them', 'they'], {
        'theirs': '"Theirs" is correct because it is a possessive pronoun that stands alone to show ownership.',
        'their': '"Their" is a possessive adjective used before a noun; no noun follows here.',
        'them': '"Them" is an object pronoun, not a possessive pronoun.',
        'they': '"They" is a subject pronoun, not used to show ownership.',
      }],
      ['I borrowed ___ ruler because mine was missing.', 'his', ['he', 'him', 'himself'], {
        'his': '"His" is correct because it is a possessive adjective that comes before the noun "ruler".',
        'he': '"He" is a subject pronoun, not a possessive adjective.',
      ...
      ['The cat washed ___ paws after the long nap on the sofa.', 'its', ['it\'s', 'their', 'his'], {
        'its': '"Its" is correct because it is a possessive adjective showing the paws belong to the cat (singular, a thing).',
        'it\'s': '"It\'s" means "it is" — never use an apostrophe when showing ownership with "its".',
        'their': '"Their" is for plural owners; the cat is one animal.',
        'his': '"His" is for a male person; a cat is usually referred to as "it".',
      }],
      ['My sister and I take turns walking ___ dog every evening.', 'our', ['ours', 'us', 'we'], {
        'our': '"Our" is correct because it is a possessive adjective that comes before the noun "dog".',
        'ours': '"Ours" is a possessive pronoun that stands alone; it cannot come before a noun like "dog".',
        'us': '"Us" is an object pronoun, not a possessive adjective.',
        'we': '"We" is a subject pronoun, not a possessive adjective.',
      }],
      ['"Is this jacket ___, Aunt Mei?" I asked at the door.', 'yours', ['your', 'you', 'yourself'], {
        'yours': '"Yours" is correct because it is a possessive pronoun that stands alone — no noun follows.',
        'your': '"Your" is a possessive adjective used before a noun (e.g. "your jacket"), but no noun follows here.',
        'you': '"You" is a subject or object pronoun, not a possessive pronoun.',
        'yourself': '"Yourself" is a reflexive pronoun, not a possessive pronoun.',
      }],
      ['Dan said the spare key on the table is ___.', 'his', ['he', 'him', 'himself'], {
        'his': '"His" is correct because it is a possessive pronoun that stands alone to show the key belongs to Dan.',
        'he': '"He" is a subject pronoun, not used to show ownership.',
        'him': '"Him" is an object pronoun, not a possessive pronoun.',
        'himself': '"Himself" is a reflexive pronoun, not a possessive pronoun.',
      }],
      ['Daniel and Mei brought ___ projects to school in clear folders.', 'their', ['theirs', 'them', 'they'], {
        'their': '"Their" is correct because it is a possessive adjective coming before the noun "projects".',
        'theirs': '"Theirs" is a possessive pronoun that stands alone; it cannot come before a noun like "projects".',
        'them': '"Them" is an object pronoun, not a possessive adjective.',
        'they': '"They" is a subject pronoun, not a possessive adjective.',
      }],
      ['Each student must label ___ exercise book before the lesson begins.', 'his or her', ['theirs', 'them', 'their\'s'], {
        'his or her': '"His or her" is correct because "each student" is singular, so we use a singular possessive — "his or her" covers both genders.',
        'theirs': '"Theirs" is a possessive pronoun that stands alone; it cannot come before a noun like "exercise book".',
        'them': '"Them" is an object pronoun, not a possessive adjective.',
        'their\'s': '"Their\'s" is not a real word — possessive pronouns never take an apostrophe.',
      }],
      ['That blue water bottle is not mine. It is ___.', 'his', ['he', 'him', 'himself'], {
        'his': '"His" is correct because it is a possessive pronoun that stands alone — no noun follows.',
        'he': '"He" is a subject pronoun, not used to show ownership.',
        'him': '"Him" is an object pronoun, not a possessive pronoun.',
        'himself': '"Himself" is a reflexive pronoun, not a possessive pronoun.',
      }],
      ['Mei forgot her umbrella, so I lent her ___.', 'mine', ['my', 'me', 'myself'], {
        'mine': '"Mine" is correct because it is a possessive pronoun that stands alone — no noun follows.',
        'my': '"My" is a possessive adjective used before a noun (e.g. "my umbrella"), but no noun follows here.',
        'me': '"Me" is an object pronoun, not a possessive pronoun.',
        'myself': '"Myself" is a reflexive pronoun, not a possessive pronoun.',
      }],
      ['The girls packed ___ own snacks for the school trip.', 'their', ['theirs', 'them', 'they'], {
        'their': '"Their" is correct because it is a possessive adjective coming before "own snacks".',
        'theirs': '"Theirs" is a possessive pronoun that stands alone; it cannot come before "own snacks".',
        'them': '"Them" is an object pronoun, not a possessive adjective.',
        'they': '"They" is a subject pronoun, not a possessive adjective.',
      }],
      ['The dog wagged ___ tail when it heard the doorbell.', 'its', ["it's", 'their', 'his'], {
        'its': '"Its" is correct because it is a possessive adjective showing the tail belongs to the dog.',
        "it's": '"It\'s" means "it is" — never use an apostrophe when showing ownership with "its".',
        'their': '"Their" is for plural owners; the dog is one animal.',
        'his': '"His" is for a male person; a dog is usually referred to as "it".',
      }],
      ['"Is this storybook ___, or does it belong to the class?" the teacher asked Siti.', 'yours', ['your', 'you', 'yourself'], {
        'yours': '"Yours" is correct because it is a possessive pronoun that stands alone — no noun follows.',
        'your': '"Your" is a possessive adjective used before a noun (e.g. "your storybook"), but no noun follows here.',
        'you': '"You" is a subject or object pronoun, not a possessive pronoun.',
        'yourself': '"Yourself" is a reflexive pronoun, not a possessive pronoun.',
      }],
      ['My sister and I share ___ bedroom at home.', 'our', ['ours', 'us', 'we'], {
        'our': '"Our" is correct because it is a possessive adjective that comes before the noun "bedroom".',
        'ours': '"Ours" is a possessive pronoun that stands alone; it cannot come before a noun like "bedroom".',
        'us': '"Us" is an object pronoun, not a possessive adjective.',
        'we': '"We" is a subject pronoun, not a possessive adjective.',
      }],
      ['Tom left ___ lunchbox in the canteen by mistake.', 'his', ['he', 'him', 'himself'], {
        'his': '"His" is correct because it is a possessive adjective that comes before "lunchbox".',
        'he': '"He" is a subject pronoun, not a possessive adjective.',
        'him': '"Him" is an object pronoun, not a possessive adjective.',
        'himself': '"Himself" is a reflexive pronoun, not a possessive adjective.',
      }],
      ...
      ['My classmates finished ___ project before the deadline.', 'their', ['theirs', 'them', 'they'], {
        ...
        'theirs': '"Theirs" is a possessive pronoun that stands alone; it cannot come before a noun like "project".',
        'them': '"Them" is an object pronoun, not a possessive adjective.',
        'they': '"They" is a subject pronoun, not a possessive adjective.',
      }],
      ['Grandma made these kueh herself. They are all ___.', 'hers', ['her', 'she', 'herself'], {
        'hers': '"Hers" is correct because it is a possessive pronoun that stands alone — no noun follows.',
        'her': '"Her" is a possessive adjective used before a noun (e.g. "her kueh"), but no noun follows here.',
        'she': '"She" is a subject pronoun, not used to show ownership.',
        'herself': '"Herself" is a reflexive pronoun for emphasis or reflexive actions, not a possessive pronoun.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'possessive_forms', q, choices: buildChoices(answer, ds), answer, explain: 'Possessive adjectives (my, your, his, her, its, our, their) come before a noun. Possessive pronouns (mine, yours, his, hers, ours, theirs) stand alone. Never use an apostrophe in "its" when showing ownership.', optionExplanations };
  },
  quantifiers(level, i) {
    const p1Rows = [
      ['I looked into the refrigerator. There wasn\'t ___ juice left.', 'any', ['a few', 'many', 'a little'], {
        'any': '"Any" is correct because after a negative ("wasn\'t"), we use "any" with uncountable nouns like juice.',
        'a few': '"A few" is for countable nouns; juice is uncountable.',
        'many': '"Many" is for countable nouns in questions or negatives; juice is uncountable.',
        'a little': '"A little" means a small amount — it implies some juice remains, but the sentence says none is left.',
      }],
      ['There is no ___ soup left after Dan finished the whole pot.', 'more', ['any', 'much', 'many'], {
        'more': '"No more" is the correct fixed phrase meaning there is none left.',
        'any': '"No any" is not grammatical — "no more" is the correct phrase.',
      ...
      ['There wasn\'t ___ juice left. I only had half a glass of it.', 'much', ['some', 'little', 'few'], {
        'much': '"Much" is correct because after a negative ("wasn\'t"), we use "much" with uncountable nouns like juice.',
        'some': '"Some" is used in positive statements; "wasn\'t some" is not the natural negative form.',
        'little': '"Little" means almost none; it is used in positive sentences, not after "wasn\'t".',
        'few': '"Few" is for countable nouns; juice is uncountable.',
      }],
      ['I bought ___ apples at the market for our breakfast.', 'some', ['any', 'much', 'a little'], {
        'some': '"Some" is correct because it is a positive statement about an unspecified number of apples.',
        'any': '"Any" is used in questions or negatives; this is a positive statement.',
        'much': '"Much" is for uncountable nouns; apples are countable.',
        'a little': '"A little" is for uncountable nouns; apples are countable.',
      }],
      ['How ___ pencils do you have in your pencil case?', 'many', ['much', 'a little', 'less'], {
        'many': '"Many" is correct because pencils are countable and "how many" asks about a countable quantity.',
        'much': '"Much" is for uncountable nouns; pencils are countable — use "how many".',
        'a little': '"A little" is for uncountable nouns and does not fit with "how".',
        'less': '"Less" is for uncountable nouns in comparisons; the question asks about a countable quantity.',
      }],
      ['We only had ___ time left, so we hurried to the bus stop.', 'a little', ['a few', 'many', 'much'], {
        'a little': '"A little" is correct because time is uncountable and "a little" means a small but sufficient amount.',
      ...
      ['Only ___ seats are left in the hall — let us sit down quickly.', 'a few', ['a little', 'much', 'less'], {
        'a few': '"A few" is correct because seats are countable and "a few" means a small number still exists.',
        'a little': '"A little" is for uncountable nouns; seats are countable.',
        'much': '"Much" is for uncountable nouns; seats are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; seats are countable.',
      }],
      ['Can I have ___ more time to finish my drawing?', 'a little', ['a few', 'many', 'much'], {
        'a little': '"A little" is correct because time is uncountable and "a little more time" means a small extra amount.',
        'a few': '"A few" is for countable nouns; time is uncountable.',
        'many': '"Many" is for countable nouns; time is uncountable.',
        'much': '"A much more time" is not grammatical — "a little more time" is the natural phrase.',
      }],
      ['There were ___ clouds in the sky, so we stayed outside to play.', 'few', ['little', 'much', 'many'], {
        'few': '"Few" (without "a") is correct because it means almost no clouds — emphasising there were hardly any, justifying staying outside.',
        'little': '"Little" is for uncountable nouns; clouds are countable.',
        'much': '"Much" is for uncountable nouns; clouds are countable.',
        'many': '"Many" would mean a lot of clouds, but the sentence implies there were hardly any.',
      }],
      ['He ate ___ biscuits but saved the rest for his sister.', 'some', ['any', 'much', 'a little'], {
        'some': '"Some" is correct because it is a positive statement — he ate an unspecified number of biscuits.',
        'any': '"Any" is used in questions or negatives; this is a positive statement.',
      ...
      ['There are ___ pupils waiting at the bus stop after school.', 'a few', ['a little', 'much', 'any'], {
        'a few': '"A few" is correct because pupils are countable and "a few" means a small number are waiting.',
        'a little': '"A little" is for uncountable nouns; pupils are countable.',
      ...
      ['We do not have ___ time left before the bell rings.', 'much', ['many', 'a few', 'some'], {
        'much': '"Much" is correct because time is uncountable and "not much" is the standard negative phrase.',
        'many': '"Many" is for countable nouns; time is uncountable.',
        'a few': '"A few" is for countable nouns; time is uncountable.',
      ...
      ['___ of my friends live in HDB flats near the school.', 'Many', ['Much', 'A little', 'Any'], {
        'Many': '"Many" is correct because friends are countable and "many of my friends" means a large number.',
        'Much': '"Much" is for uncountable nouns; friends are countable.',
        'A little': '"A little" is for uncountable nouns; friends are countable.',
        'Any': '"Any" is used in questions or negatives; this is a positive statement.',
      }],
      ['I only have ___ coins left in my wallet for the canteen.', 'a few', ['a little', 'much', 'many'], {
        'a few': '"A few" is correct because coins are countable and "a few" means a small number remains.',
        'a little': '"A little" is for uncountable nouns; coins are countable.',
        'much': '"Much" is for uncountable nouns; coins are countable.',
        'many': '"Many" suggests a large number; "a few" indicates just a small number left.',
      }],
    ];
    const upperRows = [
      ['There are ___ marbles in this small pouch.', 'few', ['little', 'much', 'less'], {
        'few': '"Few" (without "a") is correct because marbles are countable and "few" stresses the very small number.',
        'little': '"Little" is for uncountable nouns; marbles are countable.',
        'much': '"Much" is for uncountable nouns; marbles are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; marbles are countable.',
      }],
      ['How ___ sugar should we add to this drink?', 'much', ['many', 'few', 'several'], {
        'much': '"Much" is correct because sugar is uncountable and "how much" asks about quantity.',
        'many': '"Many" is for countable nouns; sugar is uncountable — use "how much".',
        'few': '"Few" is for countable nouns; sugar is uncountable.',
        'several': '"Several" is for countable nouns; sugar is uncountable and does not fit with "how".',
      }],
      ['Only ___ pupils were absent during rehearsal.', 'a few', ['a little', 'much', 'less'], {
        'a few': '"A few" is correct because pupils are countable and "a few" means a small number were absent.',
        'a little': '"A little" is for uncountable nouns; pupils are countable.',
        'much': '"Much" is for uncountable nouns; pupils are countable.',
      ...
      ['We have ___ water left, so refill the bottle.', 'little', ['few', 'many', 'several'], {
        'little': '"Little" (without "a") is correct because water is uncountable and "little" stresses there is almost none — hence the need to refill.',
        'few': '"Few" is for countable nouns; water is uncountable.',
        'many': '"Many" is for countable nouns; water is uncountable.',
        'several': '"Several" is for countable nouns; water is uncountable.',
      }],
      ['The volunteers prepared ___ packets of dried noodles for the food drive.', 'several', ['much', 'a little', 'less'], {
        'several': '"Several" is correct because packets are countable and "several" means more than two but not a huge number.',
        'much': '"Much" is for uncountable nouns; packets are countable.',
        'a little': '"A little" is for uncountable nouns; packets are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; packets are countable.',
      }],
      ['The dietitian advised him to add ___ salt to his meals and rely on herbs for flavour instead.', 'less', ['fewer', 'many', 'several'], {
        'less': '"Less" is correct because salt is uncountable and "less" is used with uncountable nouns for comparisons.',
        'fewer': '"Fewer" is for countable nouns; salt is uncountable — use "less".',
        'many': '"Many" is for countable nouns; salt is uncountable.',
        'several': '"Several" is for countable nouns; salt is uncountable.',
      }],
      ['Take ___ time as you need to finish the paper.', 'as much', ['as many', 'how much', 'how many'], {
        'as much': '"As much" is correct because time is uncountable and "as much … as you need" expresses sufficient quantity.',
        'as many': '"As many" is for countable nouns; time is uncountable.',
        'how much': '"How much" forms a question; this sentence is not asking a question.',
        'how many': '"How many" forms a question about countable nouns; this sentence is a statement.',
      }],
      ['Mr Lee asked, "How ___ chairs do we still need for the parents?"', 'many', ['much', 'a little', 'less'], {
        'many': '"Many" is correct because chairs are countable and "how many" asks about quantity of countable things.',
        'much': '"Much" is for uncountable nouns; chairs are countable — use "how many".',
        'a little': '"A little" is for uncountable nouns; chairs are countable and this is a question.',
        'less': '"Less" is for uncountable nouns in comparisons; chairs are countable.',
      }],
      ['There has been ___ rainfall this month than last month.', 'less', ['fewer', 'many', 'several'], {
        'less': '"Less" is correct because rainfall is uncountable and "less" compares uncountable quantities.',
        'fewer': '"Fewer" is for countable nouns; rainfall is uncountable — use "less".',
        'many': '"Many" is for countable nouns; rainfall is uncountable.',
        'several': '"Several" is for countable nouns; rainfall is uncountable.',
      }],
      ['___ of the homework was done on the bus ride home.', 'Most', ['Many', 'Several', 'A few'], {
        'Most': '"Most" is correct because homework is uncountable and "most of the homework" means the largest part.',
        'Many': '"Many" is for countable nouns; homework is uncountable.',
    ...
    const rows = level === 'P1' ? p1Rows : upperRows;
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'quantifier_choice', q, choices: buildChoices(answer, ds), answer, explain: 'Countable nouns (chairs, pupils) → many/few/a few/several. Uncountable nouns (water, time, sugar) → much/little/a little/less. In positive statements use "some"; in questions/negatives use "any"/"much"/"many".', optionExplanations };
  },
  connectors(level, i) {
    const p2Rows = [
      ['Mandy and Ken can walk ___ take the bus to school.', 'or', ['nor', 'and', 'but'], {
        'or': '"Or" is correct because it presents two alternative choices.',
        'nor': '"Nor" is used in "neither…nor" for two negatives; the sentence presents two positive options.',
      ...
      ['The fire broke out ___ the store was just about to open.', 'when', ['so', 'but', 'because'], {
        ...
        'so': '"So" shows result; the fire breaking out was not caused by the store opening.',
        'but': '"But" contrasts two ideas; these are two simultaneous events, not a contrast.',
        'because': '"Because" gives a reason; the fire did not break out because the store was opening.',
      }],
      ['You can enter only ___ you have an entry pass.', 'if', ['as', 'while', 'until'], {
        'if': '"If" is correct because it introduces a condition — entry depends on having a pass.',
        'as': '"As" gives a reason or shows two things happening simultaneously; the pass is a condition, not a reason.',
        'while': '"While" shows two actions happening at the same time; the pass is a condition for entry.',
        'until': '"Until" means up to a point in time; the pass is a condition, not a time reference.',
      }],
      ['Shake the bottle well ___ you pour out the sauce.', 'before', ['as', 'when', 'after'], {
        'before': '"Before" is correct because shaking must happen first, then pouring.',
        'as': '"As" shows two actions happening at the same time; shaking must be done first.',
        'when': '"When" links simultaneous or triggered events; shaking should be completed before pouring.',
        'after': '"After" would reverse the order — shaking must happen before, not after, pouring.',
      }],
      ['I kept ringing the doorbell ___ someone finally opened the door.', 'until', ['since', 'unless', 'while'], {
        'until': '"Until" is correct because the ringing continued up to the point when the door opened.',
        'since': '"Since" marks a starting point; the ringing stopped when the door opened.',
        'unless': '"Unless" introduces a negative condition; the ringing was about duration, not a condition.',
        'while': '"While" shows two things happening at the same time; the ringing stopped when the door opened.',
      }],
      ['She wore a raincoat ___ she knew it might drizzle later.', 'because', ['but', 'or', 'when'], {
        'because': '"Because" is correct because knowing it might drizzle is the reason for wearing the raincoat.',
        'but': '"But" contrasts two ideas; the knowing is the cause, not a contrast.',
        'or': '"Or" presents alternatives; the sentence explains a cause and effect.',
        'when': '"When" links events in time; here the knowing is the reason for wearing the raincoat.',
      }],
      ['He was ill, ___ he still came to school for the important test.', 'but', ['and', 'so', 'because'], {
        'but': '"But" is correct because it shows contrast — being ill and still coming to school are unexpected opposites.',
        'and': '"And" adds both facts together without showing the surprising contrast.',
        'so': '"So" would mean his illness caused him to come — which reverses the logic.',
        'because': '"Because" would mean he came to school because he was ill — which is illogical.',
      }],
      ['The teacher waited ___ the whole class was quiet.', 'until', ['since', 'while', 'as'], {
        'until': '"Until" is correct because the waiting continued up to the point when the class became quiet.',
        'since': '"Since" marks a starting point; the waiting stopped when the class became quiet.',
        'while': '"While" shows simultaneous actions; the class became quiet after the waiting, not during it.',
        'as': '"As" shows simultaneous events or reason; the waiting lasted until the class was quiet.',
      }],
      ['Read the passage carefully ___ you try to answer the questions.', 'before', ['after', 'when', 'so'], {
        'before': '"Before" is correct because reading should be completed first, then questions answered.',
        'after': '"After" would reverse the order — reading the passage should come first.',
        'when': '"When" links simultaneous or triggered events; reading should be done first.',
        'so': '"So" shows result; this sentence is about the sequence of two actions.',
      }],
      ['The shop was closed, ___ we went home without buying anything.', 'so', ['but', 'and', 'because'], {
        'so': '"So" is correct because the shop being closed is the cause, and going home is the result.',
        'but': '"But" contrasts two ideas; here the closure directly caused the outcome.',
        'and': '"And" simply adds the two facts without showing the cause-and-effect link.',
        'because': '"Because" reverses the logic — going home is the result of the closure, not the reason for it.',
      }],
    ];
    const upperRows = [
      ['The sky darkened, ___ we packed our raincoats.', 'so', ['but', 'or', 'because'], {
        'so': '"So" is correct because the darkening sky is the cause and packing the raincoats is the result.',
        'but': '"But" contrasts two ideas; darkening caused the packing — it is cause and effect.',
        'or': '"Or" presents alternatives; the sentence shows a cause-and-effect relationship.',
        'because': '"Because" reverses the logic — packing is the result of the dark sky, not the reason for it.',
      }],
      ['She was tired, ___ she still completed her corrections.', 'but', ['and', 'so', 'because'], {
        'but': '"But" is correct because it shows contrast — being tired yet still completing the work.',
        'and': '"And" adds both facts without showing the surprising contrast between tiredness and completion.',
        'so': '"So" would mean she completed the corrections because she was tired — which is illogical.',
        'because': '"Because" would mean she was tired because she completed the corrections — reversing the logic.',
      }],
      ['Pack your bottle ___ your worksheet before camp.', 'and', ['but', 'or', 'because'], {
        'and': '"And" is correct because both the bottle and the worksheet need to be packed — two things added together.',
        'but': '"But" contrasts two ideas; packing both items is not a contrast.',
        'or': '"Or" presents alternatives; both items should be packed, not one or the other.',
        'because': '"Because" gives a reason; the sentence is simply listing two things to pack.',
      }],
      ['He revised carefully ___ he wanted to improve.', 'because', ['but', 'so', 'or'], {
        'because': '"Because" is correct because wanting to improve is the reason for revising carefully.',
        'but': '"But" contrasts two ideas; wanting to improve and revising carefully are connected by cause.',
        'so': '"So" reverses the logic — revising carefully is the result of wanting to improve.',
        'or': '"Or" presents alternatives; the sentence shows a cause-and-effect relationship.',
      }],
      ['We must hurry, ___ we will miss the last bus.', 'or', ['so', 'and', 'but'], {
        'or': '"Or" is correct because it introduces a negative consequence if the condition is not met.',
        'so': '"So" would mean hurrying causes missing the bus — which reverses the logic.',
        'and': '"And" would mean both hurrying and missing the bus happen together — not logical.',
        'but': '"But" contrasts two ideas; the sentence is about consequence, not contrast.',
      }],
      ['The teacher praised Mei ___ she had spotted the missing comma.', 'because', ['but', 'so', 'or'], {
        'because': '"Because" is correct because spotting the comma is the reason for the praise.',
        'but': '"But" contrasts two ideas; spotting the comma caused the praise — it is a reason.',
        'so': '"So" reverses the logic — the praise is the result of spotting the comma.',
        'or': '"Or" presents alternatives; the sentence shows a cause-and-effect relationship.',
      }],
      ['I love both salads ___ stir-fried vegetables for lunch.', 'and', ['or', 'but', 'so'], {
        'and': '"And" is correct because "both…and" is a fixed pair that adds two things together.',
        'or': '"Both…or" is not a grammatical pair — "both…and" is the correct construction.',
        'but': '"But" contrasts two ideas; "both…and" adds them together.',
        'so': '"So" shows result; the sentence is about liking two things equally.',
      }],
      ['Wear sunscreen, ___ you will get sunburnt at the beach.', 'or', ['so', 'because', 'and'], {
        'or': '"Or" is correct because it introduces a negative consequence if the instruction is not followed.',
        'so': '"So" would mean wearing sunscreen causes sunburn — which reverses the logic.',
        'because': '"Because" would give a reason; the sentence warns of a consequence if sunscreen is not worn.',
        'and': '"And" would mean wearing sunscreen and getting sunburnt happen together — illogical.',
      }],
      ['She studied for the test, ___ she still felt nervous on the day.', 'but', ['so', 'and', 'because'], {
        'but': '"But" is correct because it shows contrast — studying does not always prevent nervousness.',
        'so': '"So" would mean studying caused her nervousness — which reverses the logic.',
        'and': '"And" adds two facts without showing the surprising contrast.',
        'because': '"Because" would mean she was nervous because she studied — which is illogical.',
      }],
      ['The lift was broken, ___ we used the stairs to reach the fifth floor.', 'so', ['but', 'or', 'because'], {
        'so': '"So" is correct because the broken lift is the cause and using the stairs is the result.',
        'but': '"But" contrasts two ideas; the broken lift directly caused using the stairs.',
        'or': '"Or" presents alternatives; the sentence shows a cause-and-effect relationship.',
        'because': '"Because" reverses the logic — using the stairs is the result, not the reason.',
      }],
      ['Wei studied hard every night this week. ___, he felt confident when the test day arrived.', 'As a result', ['However', 'Nevertheless', 'Although'], {
        'As a result': '"As a result" is correct because hard studying is the cause and confidence is the outcome.',
        'However': '"However" introduces a contrast or unexpected turn; here the result logically follows the effort.',
        'Nevertheless': '"Nevertheless" means "despite that" — the sentence shows a logical positive result, not a contrast.',
        'Although': '"Although" introduces a concession within one sentence; this connector links two separate sentences as cause and result.',
      }],
      ['Rina practised her speech many times. ___, she still felt nervous standing in front of the audience.', 'However', ['Therefore', 'As a result', 'Furthermore'], {
        'However': '"However" is correct because it introduces a contrast — much practice did not prevent nervousness.',
        'Therefore': '"Therefore" shows a logical result; nervousness is the unexpected outcome, not a logical one.',
        'As a result': '"As a result" shows a logical consequence; nervousness is an unexpected contrast to all the practice.',
        'Furthermore': '"Furthermore" adds more supporting information; it does not introduce a contrast.',
      }],
      ['Ali finished his homework early. He spent the extra time reading ___ he wanted to improve his vocabulary.', 'because', ['but', 'or', 'so'], {
        'because': '"Because" is correct because wanting to improve vocabulary is the reason for reading.',
        'but': '"But" contrasts two ideas; the extra reading was done for a positive reason, not in contrast.',
        'or': '"Or" presents alternatives; the sentence gives the reason for reading.',
        'so': '"So" reverses the logic — reading is the result of wanting to improve, not the cause.',
      }],
    ];
    const rows = (level === 'P1' || level === 'P2') ? p2Rows : upperRows;
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'connector_logic', q, choices: buildChoices(answer, ds), answer, explain: 'Choose the connector that matches the relationship between the two ideas — choice (or), reason (because/as), time (before/when/until), condition (if), contrast (but).', optionExplanations };
  },
  countableUncountable(level, i) {
    const rows = [
      ['There is ___ rice left in the cooker.', 'some', ['many', 'few', 'an'], {
        'some': '"Some" is correct because rice is uncountable and "some" works in a positive statement about an unspecified amount.',
        'many': '"Many" is for countable nouns; rice is uncountable.',
        'few': '"Few" is for countable nouns; rice is uncountable.',
        'an': '"An" is for a single countable noun before a vowel sound; rice is uncountable.',
      }],
      ['How ___ oranges did Grandma buy?', 'many', ['much', 'little', 'less'], {
        'many': '"Many" is correct because oranges are countable and "how many" asks about countable quantity.',
        'much': '"Much" is for uncountable nouns; oranges are countable — use "how many".',
        'little': '"Little" is for uncountable nouns; oranges are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; oranges are countable.',
      }],
      ['Please add ___ flour to the bowl.', 'a little', ['a few', 'many', 'several'], {
        'a little': '"A little" is correct because flour is uncountable and "a little" means a small amount.',
        'a few': '"A few" is for countable nouns; flour is uncountable.',
        'many': '"Many" is for countable nouns; flour is uncountable.',
        'several': '"Several" is for countable nouns; flour is uncountable.',
      }],
      ['We need ___ chairs for the visitors.', 'a few', ['a little', 'much', 'less'], {
        'a few': '"A few" is correct because chairs are countable and "a few" means a small number is needed.',
        'a little': '"A little" is for uncountable nouns; chairs are countable.',
        'much': '"Much" is for uncountable nouns; chairs are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; chairs are countable.',
      }],
      ['There is too ___ noise in the corridor — please be quieter.', 'much', ['many', 'few', 'several'], {
        'much': '"Much" is correct because noise is uncountable and "too much" means an excessive amount.',
        'many': '"Many" is for countable nouns; noise is uncountable.',
        'few': '"Few" is for countable nouns; noise is uncountable.',
        'several': '"Several" is for countable nouns; noise is uncountable.',
      }],
      ['I have ___ friends who play the violin.', 'many', ['much', 'a little', 'less'], {
        'many': '"Many" is correct because friends are countable and "many" means a large number.',
        'much': '"Much" is for uncountable nouns; friends are countable.',
        'a little': '"A little" is for uncountable nouns; friends are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; friends are countable.',
      }],
      ['The recipe calls for ___ sugar, just enough to balance the lemon.', 'a little', ['a few', 'many', 'several'], {
        'a little': '"A little" is correct because sugar is uncountable and "a little" means a small but sufficient amount.',
        'a few': '"A few" is for countable nouns; sugar is uncountable.',
        'many': '"Many" is for countable nouns; sugar is uncountable.',
        'several': '"Several" is for countable nouns; sugar is uncountable.',
      }],
      ['We bought ___ bottles of water for the camp trip.', 'several', ['a little', 'much', 'less'], {
        'several': '"Several" is correct because bottles are countable and "several" means more than two.',
        'a little': '"A little" is for uncountable nouns; bottles are countable.',
        'much': '"Much" is for uncountable nouns; bottles are countable.',
        'less': '"Less" is for uncountable nouns in comparisons; bottles are countable.',
      }],
      ['There is ___ time before the bell rings — hurry up!', 'little', ['few', 'many', 'several'], {
        'little': '"Little" (without "a") is correct because time is uncountable and "little" stresses there is almost none — hence the need to hurry.',
        'few': '"Few" is for countable nouns; time is uncountable.',
        'many': '"Many" is for countable nouns; time is uncountable.',
        'several': '"Several" is for countable nouns; time is uncountable.',
      }],
  ...
  futureTense(level, i) {
    const rows = [
      ...
      ['I think it ___ later in the afternoon.', 'will rain', ['rains', 'rained', 'is raining'], {
        ...
        'rains': '"Rains" is simple present for a regular pattern; "I think" signals this is a future prediction.',
      ...
      ['Do not worry. I ___ you after CCA.', 'will call', ['call', 'called', 'am calling'], {
        ...
        'call': '"Call" is base form; for a promise made now, "will call" is needed.',
      ...
      ['"___ you help me carry these books, please?" asked Mrs Lim.', 'Will', ['Did', 'Are', 'Do'], {
        ...
        'Did': '"Did" forms a simple past question; Mrs Lim is asking for help now, not asking about the past.',
      ...
      ['Look at those clouds — it ___ heavily in a few minutes.', 'is going to rain', ['rains', 'rained', 'has rained'], {
        ...
        'rains': '"Rains" is simple present for regular patterns; the clouds are evidence the rain is about to happen.',
        'rained': '"Rained" is simple past; the rain has not happened yet.',
        'has rained': '"Has rained" is present perfect for a recently completed action; the rain has not started yet.',
      }],
      ['Hold on a second — I ___ the door for you.', 'will open', ['open', 'opened', 'am opening'], {
        'will open': '"Will open" is correct because this is a spontaneous offer or decision made at the moment of speaking.',
        'open': '"Open" is base form; for a spontaneous offer made at this moment, "will open" is needed.',
      ...
      ['Sam has bought all the ingredients — he ___ laksa for dinner tonight.', 'is going to cook', ['cooks', 'cooked', 'will cooking'], {
        'is going to cook': '"Is going to cook" is correct because buying the ingredients is evidence of a definite plan.',
        'cooks': '"Cooks" is simple present for habits; the bought ingredients show a definite future plan.',
      ...
      ['Look at that enormous wave — it ___ the sandcastle!', 'is going to knock over', ['knocks over', 'knocked over', 'has knocked over'], {
        ...
        'knocks over': '"Knocks over" is simple present for habitual actions; the wave is about to knock it over right now.',
        'knocked over': '"Knocked over" is simple past; the knocking has not happened yet.',
        'has knocked over': '"Has knocked over" is present perfect; the wave has not knocked the castle yet.',
      }],
      ['I promise I ___ your secret — not a word to anyone.', 'will keep', ['keep', 'kept', 'am keeping'], {
        'will keep': '"Will keep" is correct because "I promise…will" is the standard formula for making a promise.',
        'keep': '"Keep" is base form; when making a promise, "I will keep" is the natural phrasing.',
      ...
      ['"___ you be joining the astronomy club this term?" the teacher asked Daniel.', 'Will', ['Did', 'Do', 'Are'], {
        'Will': '"Will" is correct because the teacher is asking about a future plan or intention.',
        'Did': '"Did" forms a past question; the teacher is asking about joining this term (future).',
      ...
      ['I already told Mrs Tan — we ___ the performance for her birthday celebration next Friday.', 'are performing', ['perform', 'performed', 'will performing'], {
        ...
        'perform': '"Perform" is base form; for a fixed arrangement, "are performing" is the natural choice.',
        'performed': '"Performed" is simple past; the performance is scheduled for next Friday.',
        'will performing': '"Will performing" is not grammatical — "will" must be followed by the base form, not "performing".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'future_forms', q, choices: buildChoices(answer, ds), answer, explain: '"Will + verb" for predictions, promises, and spontaneous decisions. "Going to + verb" for plans with evidence. Present continuous for fixed arrangements. Simple present for timetabled events.', optionExplanations };
  },
  conjunctions(level, i) {
    const lowerRows = [
      ['Would you prefer noodles ___ rice for lunch?', 'or', ['and', 'but', 'because'], {
        'or': '"Or" is correct because it presents a choice between two options.',
        'and': '"And" would mean both noodles and rice together; "or" asks which one you prefer.',
        'but': '"But" contrasts two ideas; noodles and rice are simply two choices, not a contrast.',
        'because': '"Because" gives a reason; the sentence is asking for a preference, not a reason.',
      }],
      ['He stayed quiet ___ he was unsure of the answer.', 'because', ['or', 'but', 'so'], {
        'because': '"Because" is correct because being unsure is the reason for staying quiet.',
        'or': '"Or" presents alternatives; the sentence is about a cause and its effect.',
        'but': '"But" contrasts two ideas; being unsure and staying quiet are cause and effect, not a contrast.',
        'so': '"So" reverses the logic — staying quiet is the result of being unsure, not the cause.',
      }],
      ['Pack an extra jacket, ___ the mountain evenings can be surprisingly cold.', 'for', ['yet', 'or', 'and'], {
        'for': '"For" is correct because it gives the reason for packing a jacket (a more formal "because").',
        'yet': '"Yet" contrasts two ideas; the sentence gives a reason, not a contrast.',
        'or': '"Or" presents alternatives; the sentence gives the reason for an action.',
        'and': '"And" adds two facts together without capturing the cause-and-reason relationship.',
      }],
      ['She practised daily, ___ she improved steadily.', 'so', ['or', 'because', 'but'], {
        'so': '"So" is correct because daily practice is the cause, and steady improvement is the result.',
        'or': '"Or" presents alternatives; the sentence shows cause and effect.',
        'because': '"Because" reverses the logic — improvement is the result of practice, not the reason for it.',
        'but': '"But" contrasts; practising and improving are logically connected, not contrasting.',
      }],
      ['The kitten was hungry ___ tired after the long ride home.', 'and', ['or', 'but', 'so'], {
        'and': '"And" is correct because both hunger and tiredness describe the kitten — two qualities added together.',
        'or': '"Or" presents alternatives; the kitten was both hungry and tired.',
        'but': '"But" contrasts; hunger and tiredness after a long ride are not in contrast.',
        'so': '"So" would mean hunger caused tiredness; both are separate qualities.',
      }],
      ['Choose the blue file ___ the red one — they hold the same number of pages.', 'or', ['so', 'and', 'because'], {
        'or': '"Or" is correct because it presents a choice between the blue file and the red one.',
        'so': '"So" would show result; the sentence is offering a choice, not a consequence.',
        'and': '"And" would mean both files must be chosen; "or" offers one as an alternative.',
        'because': '"Because" gives a reason; the sentence is about choosing one option.',
      }],
      ['He woke up early, ___ he still missed the school bus.', 'yet', ['so', 'and', 'because'], {
        'yet': '"Yet" is correct because it shows a surprising contrast — waking early did not prevent missing the bus.',
        'so': '"So" would mean waking early caused him to miss the bus — which is illogical.',
        'and': '"And" adds both facts without capturing the unexpected contrast.',
        'because': '"Because" would mean he missed the bus because he woke early — illogical.',
      }],
      ['Wash your hands carefully ___ you finish playing outside.', 'after', ['so', 'or', 'yet'], {
        'after': '"After" is correct because it shows sequence — finishing playing comes first, then washing hands.',
        'so': '"So" shows result; the sentence is about time sequence, not cause and effect.',
        'or': '"Or" presents alternatives; the sentence shows a time sequence.',
        'yet': '"Yet" contrasts; the sentence is about the order of two actions.',
      }],
      ['I left early ___ I would not be caught in the storm.', 'so that', ['because', 'or', 'but'], {
        'so that': '"So that" is correct because it introduces the purpose — leaving early was done to achieve a goal.',
        'because': '"Because" gives a reason in the past; "so that" expresses future purpose or intention.',
        'or': '"Or" presents alternatives; the sentence explains the purpose of leaving early.',
        'but': '"But" contrasts; leaving early and avoiding the storm are purpose and outcome, not a contrast.',
      }],
      ['The volunteers were patient ___ kind to every visitor in the booth.', 'and', ['but', 'or', 'so'], {
        'and': '"And" is correct because both patience and kindness describe the volunteers — two qualities added together.',
        'but': '"But" contrasts; patience and kindness are both positive qualities of the volunteers.',
    ...
    const upperRows = [
      ['The proposal was well-researched; ___, it was approved without changes.', 'consequently', ['nevertheless', 'however', 'although'], {
        'consequently': '"Consequently" is correct because approval is the logical result of being well-researched.',
        'nevertheless': '"Nevertheless" means "despite that" and introduces a contrast; here the result follows logically.',
        'however': '"However" introduces a contrast or unexpected point; approval is the expected outcome.',
        'although': '"Although" introduces a concession; this sentence shows a direct cause-and-effect relationship.',
      }],
      ['She trained hard throughout the year. ___, she did not qualify for the finals.', 'Nevertheless', ['Therefore', 'Furthermore', 'Consequently'], {
        'Nevertheless': '"Nevertheless" is correct because it introduces an unexpected contrast — training hard did not lead to qualification.',
        'Therefore': '"Therefore" shows a logical result; not qualifying is an unexpected outcome, not a logical one.',
        'Furthermore': '"Furthermore" adds more supporting information; it does not introduce a contrast.',
        'Consequently': '"Consequently" shows a logical result; the unexpected failure calls for a contrast word.',
      }],
      ['The talk was long; ___, every pupil stayed attentive throughout.', 'nonetheless', ['otherwise', 'therefore', 'subsequently'], {
        'nonetheless': '"Nonetheless" is correct because it introduces a contrast — the length of the talk did not prevent attentiveness.',
        'otherwise': '"Otherwise" means "if not"; the sentence is about a contrast between length and attention.',
      ...
      ['The hall was packed; ___, latecomers had to stand at the back.', 'as a result', ['in contrast', 'on the other hand', 'nonetheless'], {
        ...
        'in contrast': '"In contrast" introduces a difference; the two clauses are cause and effect.',
      ...
      ['The campsite looked beautiful; ___, it was far too remote for young children.', 'however', ['therefore', 'furthermore', 'subsequently'], {
        ...
        'therefore': '"Therefore" shows a logical result; the remoteness is not a result of the beauty.',
        'furthermore': '"Furthermore" adds information on the same side; the sentence contrasts two opposing qualities.',
        'subsequently': '"Subsequently" means "afterwards in time"; the sentence is about a contrast, not a time sequence.',
      }],
      ['She prepared thoroughly ___ she still felt nervous before the speech.', 'although', ['consequently', 'furthermore', 'nonetheless'], {
        'although': '"Although" is correct because it introduces a concession within one sentence — despite preparation, nervousness remained.',
        'consequently': '"Consequently" shows a logical result; nervousness despite preparation is a contrast, not a result.',
        'furthermore': '"Furthermore" adds more supporting information; the sentence contrasts preparation with nervousness.',
        'nonetheless': '"Nonetheless" links two separate sentences; "although" works within a single clause.',
      }],
      ['The evidence was incomplete; ___, the committee deferred its decision.', 'therefore', ['however', 'furthermore', 'subsequently'], {
        'therefore': '"Therefore" is correct because incomplete evidence is the cause and deferring the decision is the logical result.',
        'however': '"However" introduces a contrast; deferring the decision is the expected consequence of incomplete evidence.',
        'furthermore': '"Furthermore" adds more information on the same side; the sentence shows a cause-and-effect relationship.',
        'subsequently': '"Subsequently" means "afterwards in time"; "therefore" better captures the logical cause-and-effect link.',
      }],
      ['The new system saves time. ___, it reduces the risk of human error.', 'Furthermore', ['Nevertheless', 'Consequently', 'However'], {
        'Furthermore': '"Furthermore" is correct because it adds another positive benefit to the first — both saving time and reducing errors.',
    ...
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'conjunction_function', q, choices: buildChoices(answer, ds), answer, explain: 'and = adds; but/yet = contrast; or = choice; so/so that = result/purpose; because/for = reason; after/before/when = time sequence. Check whether the two clauses agree or contrast, and what relationship connects them.', optionExplanations };
  },
  comparatives(level, i) {
    const rows = [
      ['This puzzle is ___ than yesterday\'s puzzle.', 'harder', ['hard', 'hardest', 'more hard'], {
        'harder': '"Harder" is correct because "hard" is a short adjective, so add -er to compare two things.',
        'hard': '"Hard" is the base form, not the comparative — add -er to compare two things.',
        'hardest': '"Hardest" is the superlative for three or more; only two puzzles are being compared.',
        'more hard': '"More hard" is incorrect — short adjectives like "hard" use -er, not "more".',
      }],
      ['The new route is ___ than the old one.', 'shorter', ['short', 'shortest', 'more short'], {
        'shorter': '"Shorter" is correct because "short" is a short adjective, so add -er to compare two routes.',
        'short': '"Short" is the base form, not the comparative — add -er to compare two things.',
        'shortest': '"Shortest" is the superlative for three or more; only two routes are being compared.',
        'more short': '"More short" is incorrect — short adjectives like "short" use -er, not "more".',
      }],
      ['A cheetah is ___ than a rabbit.', 'faster', ['fast', 'fastest', 'more fast'], {
        'faster': '"Faster" is correct because "fast" is a short adjective, so add -er to compare two animals.',
        'fast': '"Fast" is the base form, not the comparative — add -er when comparing.',
        'fastest': '"Fastest" is the superlative for three or more; only two animals are compared.',
        'more fast': '"More fast" is incorrect — short adjectives like "fast" use -er, not "more".',
      }],
      ['Today is ___ than Monday.', 'hotter', ['hot', 'hottest', 'more hot'], {
        'hotter': '"Hotter" is correct because "hot" is a short CVC adjective — double the final consonant and add -er.',
        'hot': '"Hot" is the base form, not the comparative — double the "t" and add -er.',
        'hottest': '"Hottest" is the superlative for three or more; only two days are compared.',
        'more hot': '"More hot" is incorrect — short adjectives like "hot" use -er (hotter), not "more".',
      }],
      ['Mei is ___ than Daniel at solving riddles.', 'better', ['gooder', 'best', 'more good'], {
        'better': '"Better" is correct because "good" is an irregular comparative — good → better.',
        'gooder': '"Gooder" is not a real word — "good" has an irregular comparative form: "better".',
        'best': '"Best" is the superlative of "good"; only two people are being compared.',
      ...
      ['The river near my grandmother\'s village is ___ than the canal beside our school.', 'wider', ['widest', 'wide', 'more wide'], {
        'wider': '"Wider" is correct because "wide" is a short adjective ending in -e, so just add -r.',
        'widest': '"Widest" is the superlative for three or more; only two bodies of water are compared.',
      ...
      ['My cousin is ___ than I am, even though he is two years younger.', 'taller', ['tall', 'tallest', 'more tall'], {
        ...
        'tall': '"Tall" is the base form, not the comparative — add -er when comparing.',
        'tallest': '"Tallest" is the superlative for three or more; only two people are compared.',
        'more tall': '"More tall" is incorrect — short adjectives like "tall" use -er, not "more".',
      }],
      ['Walking home is ___ than waiting for the late bus.', 'quicker', ['quick', 'quickest', 'more quick'], {
        'quicker': '"Quicker" is correct because "quick" is a short adjective, so add -er to compare two options.',
        'quick': '"Quick" is the base form, not the comparative — add -er when comparing.',
        'quickest': '"Quickest" is the superlative for three or more; only two options are compared.',
        'more quick': '"More quick" is incorrect — short adjectives like "quick" use -er, not "more".',
      }],
      ['My new schoolbag is ___ than my old one, so it is easier to carry.', 'lighter', ['light', 'lightest', 'more light'], {
        'lighter': '"Lighter" is correct because "light" is a short adjective, so add -er to compare two bags.',
        'light': '"Light" is the base form, not the comparative — add -er when comparing.',
      ...
      ['The library near Grandma\'s house is ___ from our school than the one in our estate.', 'farther', ['far', 'farthest', 'more far'], {
        ...
        'far': '"Far" is the base form, not the comparative — "far" has an irregular form: "farther".',
        'farthest': '"Farthest" is the superlative for three or more; only two libraries are being compared.',
        'more far': '"More far" is incorrect — "far" has an irregular form: "farther".',
      }],
      ['My school bag feels ___ on Fridays when I bring all my books home.', 'heavier', ['heavy', 'heaviest', 'more heavy'], {
        'heavier': '"Heavier" is correct because "heavy" ends in consonant + y — change y to i and add -er.',
        'heavy': '"Heavy" is the base form, not the comparative — change y to i and add -er.',
      ...
      ['The hawker stall near the bus stop is ___ than the café inside the shopping mall.', 'less expensive', ['expensive', 'least expensive', 'lesser expensive'], {
        ...
        'expensive': '"Expensive" is the base form, not the comparative — use "less expensive" to compare.',
      ...
      ['The canteen\'s replacement drinks machine is ___ than the one that broke down last term.', 'newer', ['new', 'newest', 'more new'], {
        ...
        'more new': '"More new" is incorrect — short adjectives like "new" use -er, not "more".',
      }],
      ['On clear nights, the moon looks ___ than usual from the rooftop garden.', 'brighter', ['bright', 'brightest', 'more bright'], {
        'brighter': '"Brighter" is correct because "bright" is a short adjective, so add -er to compare.',
        'bright': '"Bright" is the base form, not the comparative — add -er when comparing.',
        'brightest': '"Brightest" is the superlative for three or more comparisons.',
        'more bright': '"More bright" is incorrect — short adjectives like "bright" use -er, not "more".',
      }],
      ['Taking the MRT is ___ than taking the bus during the morning rush hour.', 'more convenient', ['convenient', 'most convenient', 'convenientest'], {
        'more convenient': '"More convenient" is correct because "convenient" is a long adjective — use "more" to compare.',
        'convenient': '"Convenient" is the base form, not the comparative — long adjectives need "more" before them.',
        'most convenient': '"Most convenient" is the superlative for three or more; only two transport options are compared.',
        'convenientest': '"Convenientest" is not a real word — long adjectives use "more convenient".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'comparative_forms', q, choices: buildChoices(answer, ds), answer, explain: 'Short adjectives (one syllable): add -er (harder, taller). Adjectives ending in -y: change y to i and add -er (easier). Long adjectives: use "more" (more confident). Irregular: good → better, bad → worse, far → farther.', optionExplanations };
  },
  superlatives(level, i) {
    const rows = [
      ['Mount Everest is the ___ mountain in the world.', 'highest', ['higher', 'high', 'more high'], {
        'highest': '"Highest" is correct because it is the superlative of "high" — comparing Everest to all mountains.',
        'higher': '"Higher" is a comparative for comparing two things; the world has more than two mountains.',
        'high': '"High" is the base form; a superlative is needed to compare among all mountains.',
        'more high': '"More high" is not correct — short adjectives use -est for superlatives, not "most".',
      }],
      ['Of all my classmates, Aisha runs the ___.', 'fastest', ['faster', 'fast', 'most fast'], {
        'fastest': '"Fastest" is correct because it is the superlative of "fast" — comparing Aisha to all classmates.',
        'faster': '"Faster" is a comparative for two things; "of all my classmates" means more than two.',
        'fast': '"Fast" is the base form; a superlative is needed to compare across all classmates.',
        'most fast': '"Most fast" is not correct — short adjectives use -est for superlatives.',
      }],
      ['That bakery sells the ___ pastries in our neighbourhood.', 'best', ['better', 'goodest', 'most good'], {
        'best': '"Best" is correct because it is the irregular superlative of "good" — comparing across all bakeries.',
        'better': '"Better" is the comparative of "good"; the neighbourhood has more than two bakeries.',
      ...
      ['The blue whale is the ___ animal that has ever lived.', 'largest', ['larger', 'large', 'more large'], {
        'largest': '"Largest" is correct because it is the superlative of "large" — comparing the whale to all animals.',
        'larger': '"Larger" is a comparative for two things; the sentence compares the whale to all animals ever.',
      ...
      ['Among the three brothers, Tom is the ___.', 'tallest', ['taller', 'tall', 'most tall'], {
        ...
        'taller': '"Taller" is a comparative for two people; three brothers are being compared.',
        'tall': '"Tall" is the base form; a superlative is needed when comparing among three.',
        'most tall': '"Most tall" is not correct — short adjectives use -est for superlatives.',
      }],
      ['This rollercoaster is the ___ ride in the entire amusement park.', 'most exciting', ['more exciting', 'exciting', 'excitingest'], {
        'most exciting': '"Most exciting" is correct because "exciting" is a long adjective — use "most" for superlatives.',
        'more exciting': '"More exciting" is a comparative for two things; all rides in the park are being compared.',
        'exciting': '"Exciting" is the base form; a superlative is needed to compare across all rides.',
        'excitingest': '"Excitingest" is not a real word — long adjectives use "most" for superlatives.',
      }],
      ['The Sahara is the ___ hot desert on Earth.', 'largest', ['larger', 'large', 'more large'], {
        'largest': '"Largest" is correct because it is the superlative of "large" — comparing the Sahara to all hot deserts.',
        'larger': '"Larger" is a comparative for two things; Earth has more than two hot deserts.',
        'large': '"Large" is the base form; a superlative is needed.',
        'more large': '"More large" is not correct — short adjectives use -est for superlatives.',
      }],
      ['Mei chose the ___ book on the shelf to read first because it looked short.', 'thinnest', ['thinner', 'thin', 'most thin'], {
        'thinnest': '"Thinnest" is correct because "thin" is a short CVC adjective — double the final consonant and add -est.',
        'thinner': '"Thinner" is a comparative for two things; all books on the shelf are being compared.',
        'thin': '"Thin" is the base form; a superlative is needed to compare across all books.',
        'most thin': '"Most thin" is not correct — short CVC adjectives like "thin" use -nest for superlatives.',
      }],
      ['Of all the cakes Mum has ever baked, this one is the ___.', 'most delicious', ['more delicious', 'delicious', 'deliciousest'], {
        'most delicious': '"Most delicious" is correct because "delicious" is a long adjective — use "most" for superlatives.',
        'more delicious': '"More delicious" is a comparative for two things; all cakes ever baked are being compared.',
        'delicious': '"Delicious" is the base form; a superlative is needed to compare across all cakes.',
        'deliciousest': '"Deliciousest" is not a real word — long adjectives use "most delicious".',
      }],
      ['Daniel is the ___ player on the team — he never gives up.', 'most determined', ['more determined', 'determined', 'determinedest'], {
        'most determined': '"Most determined" is correct because "determined" is a long adjective — use "most" for superlatives.',
        'more determined': '"More determined" is a comparative for two people; the whole team is being compared.',
        'determined': '"Determined" is the base form; a superlative is needed to compare across all players.',
        'determinedest': '"Determinedest" is not a real word — long adjectives use "most determined".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'superlative_forms', q, choices: buildChoices(answer, ds), answer, explain: 'Use the + superlative to compare three or more. Short adjectives: add -est (highest, tallest). Long adjectives: the most + adjective. Irregular: good → best, bad → worst.', optionExplanations };
  },
  modals(level, i) {
    const lowerRows = [
      ['You ___ submit the form by Friday.', 'must', ['might', 'could', 'would'], {
        ...
        'would': '"Would" is used for willingness or hypothetical situations, not obligation.',
      }],
      ['May I borrow your marker? Yes, you ___.', 'may', ['must', 'should', 'would'], {
        'may': '"May" is correct because it grants permission in a polite, formal way.',
        'must': '"Must" expresses obligation, not permission to do something.',
        'should': '"Should" gives advice; the response grants permission, not advice.',
        'would': '"Would" is for willingness or hypotheticals, not granting permission.',
      }],
      ['If you feel unwell, you ___ see the school nurse.', 'should', ['might', 'would', 'can\'t'], {
        'should': '"Should" is correct because it gives advice about what the right action is.',
        'might': '"Might" suggests possibility; "should" is needed to give a recommendation.',
        'would': '"Would" is for hypotheticals; the sentence is giving direct advice.',
        'can\'t': '"Can\'t" means not able to or not allowed; the sentence is giving a recommendation, not a prohibition.',
      }],
      ['The sign says we ___ run in the corridor.', 'must not', ['should', 'might', 'could'], {
        'must not': '"Must not" is correct because a sign creates a strict prohibition — running is not allowed.',
        'should': '"Should" gives advice; a sign with a rule is a prohibition, needing "must not".',
      ...
      ['You ___ bring your spelling book tomorrow because we have a test.', 'have to', ['could', 'might', 'would'], {
        ...
        'could': '"Could" suggests ability or possibility, not a requirement.',
      ...
      ['You ___ be tired after such a long walk. Sit down for a while.', 'must', ['can', 'might', 'will'], {
        'must': '"Must" is correct because it expresses a logical deduction — a long walk almost certainly causes tiredness.',
        'can': '"Can" is about ability; the sentence is making a logical deduction about how you feel.',
        'might': '"Might" expresses mere possibility; "must" shows the speaker is fairly certain.',
        'will': '"Will" is about a certain future action; "must" is needed for a present logical deduction.',
      }],
      ['I ___ swim across the entire pool by myself now!', 'can', ['must', 'should', 'may'], {
        'can': '"Can" is correct because it expresses ability — the speaker is able to swim across.',
        'must': '"Must" expresses obligation; the sentence is about ability.',
    ...
    const upperRows = [
      ['She ___ her calculator at home — she had to borrow one for the test.', 'must have left', ['should leave', 'must leave', 'could leave'], {
        'must have left': '"Must have left" is correct because "had to borrow" provides strong evidence for a past logical deduction.',
        'should leave': '"Should leave" is present or future advice; the situation calls for a past deduction.',
        'must leave': '"Must leave" is present or future obligation; the calculator was forgotten in the past.',
        'could leave': '"Could leave" suggests present ability or permission; a past deduction needs "must have + past participle".',
      }],
      ['You ___ told me earlier — I would have waited for you.', 'should have', ['should', 'must have', 'could'], {
        'should have': '"Should have" is correct because it expresses a past regret — the right action was not taken.',
        'should': '"Should" is present advice; the situation is about a past action that did not happen.',
        'must have': '"Must have" expresses a past logical deduction, not a regret about what should have been done.',
        'could': '"Could" is present possibility; the sentence needs past modal "should have".',
      }],
      ['He looks pale; he ___ been unwell since the start of the week.', 'must have', ['should have', 'could have', 'would have'], {
        'must have': '"Must have" is correct because looking pale is strong evidence for a past logical deduction.',
        'should have': '"Should have" expresses regret about a past action; the sentence is making a deduction based on evidence.',
        'could have': '"Could have" expresses past possibility; "must have" shows logical certainty based on evidence.',
        'would have': '"Would have" is for hypothetical past results; the sentence is making a present deduction.',
      }],
      ['We ___ finished the whole project by now if the printer had not broken down.', 'could have', ['could', 'must have', 'should'], {
        'could have': '"Could have" is correct because it expresses a hypothetical past ability — the project could have been done under different circumstances.',
        'could': '"Could" is present ability; the sentence is about a past hypothetical situation.',
        'must have': '"Must have" expresses past logical certainty; the sentence is about an unfulfilled possibility.',
        'should': '"Should" is present advice; the sentence is about a past hypothetical.',
      }],
      ['She ___ left without saying goodbye — that is so unlike her.', 'cannot have', ['could not', 'must not have', 'should not'], {
        'cannot have': '"Cannot have" is correct because it expresses strong past disbelief — it seems impossible she left without saying goodbye.',
        'could not': '"Could not" expresses past inability; the sentence is about disbelief, not inability.',
        'must not have': '"Must not have" expresses a prohibition in the past; the sentence is about logical disbelief.',
        'should not': '"Should not" is present advice; the sentence is making a past deduction.',
      }],
      ['If only I ___ studied harder, I might have scored better.', 'had', ['have', 'would have', 'could'], {
        'had': '"Had" is correct because "if only I had studied" is the third conditional — a regret about a past action that did not happen.',
        'have': '"Have" is present perfect; the third conditional if-clause needs "had + past participle".',
        'would have': '"Would have" belongs in the result clause, not the if-clause.',
        'could': '"Could" is present ability; the if-clause of the third conditional needs "had".',
      }],
      ['You ___ not have borrowed the book without asking — it is not yours.', 'should', ['must', 'could', 'might'], {
        'should': '"Should not have" is correct because it expresses that a past action was wrong — a moral reproach.',
        'must': '"Must not have" expresses prohibition; "should not have" is more appropriate for moral reproach.',
      ...
      ['I ___ have imagined it — the lights really did flicker on their own.', 'could not', ['must not', 'should not', 'would not'], {
        ...
        'must not': '"Must not have" expresses a past prohibition; the sentence is about impossibility.',
    ...
    const rows = (level === 'P5' || level === 'P6') ? upperRows : lowerRows;
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'modal_meaning', q, choices: buildChoices(answer, ds), answer, explain: 'must = strong obligation or logical certainty; should = advice; may/can = permission; might/could = possibility; must not = prohibition; have to = external obligation. Read the context to decide the strength and type of meaning needed.', optionExplanations };
  },
  ...
  pastCont(level, i) {
    const rows = [
      ['At 8 p.m., we ___ for the oral exam.', 'were revising', ['revised', 'have revised', 'are revising'], {
        'were revising': '"Were revising" is correct because "at 8 p.m." shows a specific past time when the action was in progress.',
        'revised': '"Revised" is simple past for a completed action; "at 8 p.m." shows the action was ongoing at that time.',
      ...
      ['They ___ when the principal entered.', 'were talking', ['talked', 'have talked', 'are talking'], {
        'were talking': '"Were talking" is correct because the talking was already in progress when the principal entered (a single completed action).',
        'talked': '"Talked" is simple past, but it does not show the action was ongoing when interrupted.',
        'have talked': '"Have talked" is present perfect; the sentence describes a past scene that was interrupted.',
        'are talking': '"Are talking" is present continuous; the sentence is set in the past.',
      }],
      ['At that moment, the class ___ a video.', 'was watching', ['watched', 'has watched', 'is watching'], {
        'was watching': '"Was watching" is correct because "at that moment" shows a specific past time when the action was in progress.',
        'watched': '"Watched" is simple past; "at that moment" shows the action was ongoing at that instant.',
        'has watched': '"Has watched" is present perfect; the sentence describes what was happening at a past moment.',
        'is watching': '"Is watching" is present continuous; "at that moment" signals a past time.',
      }],
      ['I ___ to my favourite song when the doorbell rang.', 'was listening', ['listened', 'have listened', 'am listening'], {
        'was listening': '"Was listening" is correct because it shows an ongoing action that was interrupted by the doorbell.',
        'listened': '"Listened" is simple past; it does not show the action was in progress when the doorbell rang.',
        'have listened': '"Have listened" is present perfect; the sentence describes a past scene.',
        'am listening': '"Am listening" is present continuous; "when the doorbell rang" sets the scene in the past.',
      }],
      ['The students ___ quietly in the library when the alarm sounded.', 'were reading', ['read', 'have read', 'are reading'], {
        'were reading': '"Were reading" is correct because it shows an ongoing action that was interrupted by the alarm.',
        'read': '"Read" is simple past; it does not show the reading was in progress when the alarm interrupted.',
        'have read': '"Have read" is present perfect; the sentence describes a past scene.',
        'are reading': '"Are reading" is present continuous; "when the alarm sounded" sets the scene in the past.',
      }],
      ['At 3 p.m. yesterday, my parents ___ groceries at the supermarket.', 'were buying', ['bought', 'have bought', 'are buying'], {
        'were buying': '"Were buying" is correct because "at 3 p.m. yesterday" shows a specific past time when the action was in progress.',
        'bought': '"Bought" is simple past; "at 3 p.m." shows the action was ongoing at that specific time.',
      ...
      ['It ___ heavily when we boarded the bus this morning.', 'was raining', ['rained', 'has rained', 'is raining'], {
        'was raining': '"Was raining" is correct because the rain was already in progress when we boarded (a completed action).',
        'rained': '"Rained" is simple past; it does not show the rain was ongoing at the moment of boarding.',
        'has rained': '"Has rained" is present perfect; the sentence describes a past scene this morning.',
        'is raining': '"Is raining" is present continuous; "when we boarded" sets the scene in the past.',
      }],
      ['Sarah ___ a postcard to her cousin when the phone rang.', 'was writing', ['wrote', 'has written', 'is writing'], {
        'was writing': '"Was writing" is correct because the writing was in progress when the phone interrupted.',
        'wrote': '"Wrote" is simple past; it does not show the writing was ongoing when interrupted.',
        'has written': '"Has written" is present perfect; the sentence describes a past interruption.',
        'is writing': '"Is writing" is present continuous; "when the phone rang" sets the scene in the past.',
      }],
      ['The little kittens ___ in the warm sunshine when I found them.', 'were sleeping', ['slept', 'have slept', 'are sleeping'], {
        'were sleeping': '"Were sleeping" is correct because the kittens were already asleep when the speaker found them.',
        'slept': '"Slept" is simple past; it does not show the sleeping was in progress at the time of discovery.',
      ...
      ['The boys ___ a ball in the courtyard when the teacher called them in.', 'were kicking', ['kicked', 'have kicked', 'are kicking'], {
        'were kicking': '"Were kicking" is correct because the kicking was in progress when the teacher interrupted.',
        'kicked': '"Kicked" is simple past; it does not show the action was ongoing when interrupted.',
        'have kicked': '"Have kicked" is present perfect; the sentence describes a past interruption.',
        'are kicking': '"Are kicking" is present continuous; "when the teacher called" sets the scene in the past.',
      }],
      ['My mother ___ laksa when the guests arrived early.', 'was preparing', ['prepared', 'has prepared', 'is preparing'], {
        'was preparing': '"Was preparing" is correct because the preparation was in progress when the guests arrived.',
        'prepared': '"Prepared" is simple past; it does not show the cooking was ongoing when the guests arrived.',
      ...
      ['It ___ lightly when we arrived at Bishan Park.', 'was drizzling', ['drizzled', 'has drizzled', 'is drizzling'], {
        'was drizzling': '"Was drizzling" is correct because the drizzle was already in progress when we arrived.',
        'drizzled': '"Drizzled" is simple past; it does not show the drizzle was ongoing at the moment of arrival.',
        'has drizzled': '"Has drizzled" is present perfect; the sentence describes a past scene.',
        'is drizzling': '"Is drizzling" is present continuous; "when we arrived" sets the scene in the past.',
      }],
      ['Priya ___ in her sketchbook when the lights suddenly went out.', 'was sketching', ['sketched', 'has sketched', 'is sketching'], {
        'was sketching': '"Was sketching" is correct because the sketching was in progress when the lights went out.',
        'sketched': '"Sketched" is simple past; it does not show the action was ongoing when interrupted.',
        'has sketched': '"Has sketched" is present perfect; the sentence describes a past interruption.',
        'is sketching': '"Is sketching" is present continuous; "when the lights went out" sets the scene in the past.',
      }],
      ['The vendors ___ their stalls when the security guard made his rounds.', 'were packing up', ['packed up', 'have packed up', 'are packing up'], {
        'were packing up': '"Were packing up" is correct because the packing was in progress during the security rounds.',
        'packed up': '"Packed up" is simple past; it does not show the action was ongoing during that time.',
        'have packed up': '"Have packed up" is present perfect; the sentence describes a simultaneous past scene.',
        'are packing up': '"Are packing up" is present continuous; "when the security guard made his rounds" sets the scene in the past.',
      }],
      ['He ___ along the park connector when he spotted a monitor lizard.', 'was cycling', ['cycled', 'has cycled', 'is cycling'], {
        'was cycling': '"Was cycling" is correct because the cycling was in progress when he spotted the lizard.',
        'cycled': '"Cycled" is simple past; it does not show the action was ongoing when he spotted the lizard.',
    ...
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'past_continuous', q, choices: buildChoices(answer, ds), answer, explain: 'Past continuous (was/were + verb-ing) shows an action in progress at a past moment. It is often used with "when" (interrupted action) or "while" (simultaneous actions).', optionExplanations };
  },
  adjAdverbs(level, i) {
    const rows = [
      ['The speaker explained the rule ___.', 'clearly', ['clear', 'clearest', 'more clear'], {
        'clearly': '"Clearly" is correct because it is an adverb describing how the speaker explained — modifying the verb.',
        'clear': '"Clear" is an adjective used to describe a noun; here it must describe the verb "explained".',
        'clearest': '"Clearest" is a superlative adjective; an adverb is needed to describe how explaining was done.',
        'more clear': '"More clear" is a comparative adjective; an adverb is needed to describe the action.',
      }],
      ['After the race, the runners looked ___.', 'tired', ['tiredly', 'more tiredly', 'tiring'], {
        'tired': '"Tired" is correct because "looked" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'tiredly': '"Tiredly" is an adverb; after a linking verb like "looked", an adjective is needed.',
        'more tiredly': '"More tiredly" is an adverb; linking verbs require adjectives, not adverbs.',
        'tiring': '"Tiring" means causing tiredness in others; "tired" describes how the runners themselves felt.',
      }],
      ['Please answer the question ___.', 'politely', ['polite', 'politer', 'politeness'], {
        'politely': '"Politely" is correct because it is an adverb describing how to answer — modifying the verb.',
        'polite': '"Polite" is an adjective for describing a noun; here it must describe the verb "answer".',
        'politer': '"Politer" is a comparative adjective; an adverb is needed to describe the action.',
        'politeness': '"Politeness" is a noun, not an adverb or adjective.',
      }],
      ['The soup tastes ___.', 'delicious', ['deliciously', 'more deliciously', 'deliciousness'], {
        'delicious': '"Delicious" is correct because "tastes" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'deliciously': '"Deliciously" is an adverb; after a linking verb like "tastes", an adjective is needed.',
        'more deliciously': '"More deliciously" is an adverb; linking verbs require adjectives.',
        'deliciousness': '"Deliciousness" is a noun, not an adjective.',
      }],
      ['Aisha sings ___ in the school choir.', 'beautifully', ['beautiful', 'beautifuller', 'beautifulness'], {
        'beautifully': '"Beautifully" is correct because it is an adverb describing how Aisha sings — modifying the verb.',
        'beautiful': '"Beautiful" is an adjective for describing nouns; here it must describe the verb "sings".',
        'beautifuller': '"Beautifuller" is not a real word — "beautiful" has an irregular comparative: "more beautiful".',
        'beautifulness': '"Beautifulness" is not a standard noun; the adverb form "beautifully" is needed here.',
      }],
      ['The puppy seemed ___ after its long nap.', 'happy', ['happily', 'more happily', 'happiness'], {
        'happy': '"Happy" is correct because "seemed" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'happily': '"Happily" is an adverb; after a linking verb like "seemed", an adjective is needed.',
        'more happily': '"More happily" is an adverb; linking verbs require adjectives.',
        'happiness': '"Happiness" is a noun, not an adjective.',
      }],
      ['The chef chopped the vegetables ___ before adding them to the pot.', 'quickly', ['quick', 'quickest', 'more quick'], {
        'quickly': '"Quickly" is correct because it is an adverb describing how the chopping was done — modifying the verb.',
        'quick': '"Quick" is an adjective; here the word must describe the action of chopping.',
        'quickest': '"Quickest" is a superlative adjective; an adverb is needed to describe the action.',
        'more quick': '"More quick" is a comparative adjective; an adverb is needed to describe the verb.',
      }],
      ['The new perfume smells ___.', 'sweet', ['sweetly', 'more sweetly', 'sweetness'], {
        'sweet': '"Sweet" is correct because "smells" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'sweetly': '"Sweetly" is an adverb; after a linking verb like "smells", an adjective is needed.',
        'more sweetly': '"More sweetly" is an adverb; linking verbs require adjectives.',
        'sweetness': '"Sweetness" is a noun, not an adjective.',
      }],
      ['The driver took the corner ___ to avoid an accident.', 'carefully', ['careful', 'carefuler', 'carefulness'], {
        'carefully': '"Carefully" is correct because it is an adverb describing how the driver took the corner — modifying the verb.',
        'careful': '"Careful" is an adjective; here the word must describe the action of taking the corner.',
        'carefuler': '"Carefuler" is not a real word — the comparative of "careful" is "more careful".',
        'carefulness': '"Carefulness" is a noun, not an adverb.',
      }],
      ['The kitten felt ___ in its cosy basket.', 'safe', ['safely', 'more safely', 'safeness'], {
        'safe': '"Safe" is correct because "felt" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'safely': '"Safely" is an adverb; after a linking verb like "felt", an adjective is needed.',
        'more safely': '"More safely" is an adverb; linking verbs require adjectives.',
        'safeness': '"Safeness" is a noun, not an adjective.',
      }],
      ['Mrs Tan explained the question ___ so even the youngest pupils understood.', 'patiently', ['patient', 'patientness', 'more patient'], {
        'patiently': '"Patiently" is correct because it is an adverb describing how Mrs Tan explained — modifying the verb.',
        'patient': '"Patient" is an adjective for nouns; here the word must describe the action of explaining.',
        'patientness': '"Patientness" is not a standard word; the correct noun is "patience".',
        'more patient': '"More patient" is a comparative adjective; an adverb is needed to describe the verb.',
      }],
      ['The fresh fruit looked ___ on the breakfast tray.', 'appetising', ['appetisingly', 'more appetisingly', 'appetisement'], {
        'appetising': '"Appetising" is correct because "looked" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'appetisingly': '"Appetisingly" is an adverb; after a linking verb like "looked", an adjective is needed.',
        'more appetisingly': '"More appetisingly" is an adverb; linking verbs require adjectives.',
        'appetisement': '"Appetisement" is not a real word.',
      }],
      ['The lemonade tasted ___ on such a hot afternoon.', 'refreshing', ['refreshingly', 'refreshed', 'more refreshingly'], {
        'refreshing': '"Refreshing" is correct because "tasted" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'refreshingly': '"Refreshingly" is an adverb; after a linking verb like "tasted", an adjective is needed.',
        'refreshed': '"Refreshed" describes how people feel after drinking; "refreshing" describes the drink itself.',
        'more refreshingly': '"More refreshingly" is an adverb; linking verbs require adjectives.',
      }],
      ['The prefect spoke ___ into the microphone so the whole hall could hear.', 'clearly', ['clear', 'clearer', 'clearness'], {
        'clearly': '"Clearly" is correct because it is an adverb describing how the prefect spoke — modifying the verb.',
        'clear': '"Clear" is an adjective; here the word must describe the action of speaking.',
        'clearer': '"Clearer" is a comparative adjective; an adverb is needed to describe the verb.',
        'clearness': '"Clearness" is a noun, not an adverb.',
      }],
      ['After the long hike, every pupil felt ___.', 'exhausted', ['exhaustedly', 'more exhaustedly', 'exhaustion'], {
        'exhausted': '"Exhausted" is correct because "felt" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'exhaustedly': '"Exhaustedly" is not a standard adverb; after the linking verb "felt", an adjective is needed.',
        'more exhaustedly': '"More exhaustedly" is not standard; the linking verb requires an adjective.',
        'exhaustion': '"Exhaustion" is a noun, not an adjective.',
      }],
      ['She folded the origami crane ___ so that every crease was perfect.', 'neatly', ['neat', 'neater', 'neatness'], {
        'neatly': '"Neatly" is correct because it is an adverb describing how she folded — modifying the verb.',
        'neat': '"Neat" is an adjective; here the word must describe the action of folding.',
        'neater': '"Neater" is a comparative adjective; an adverb is needed to describe the verb.',
        'neatness': '"Neatness" is a noun, not an adverb.',
      }],
      ['The curry my aunt cooked smelled ___ when we opened the front door.', 'wonderful', ['wonderfully', 'more wonderfully', 'wonderfulness'], {
        'wonderful': '"Wonderful" is correct because "smelled" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'wonderfully': '"Wonderfully" is an adverb; after a linking verb like "smelled", an adjective is needed.',
        'more wonderfully': '"More wonderfully" is an adverb; linking verbs require adjectives.',
        'wonderfulness': '"Wonderfulness" is a noun, not an adjective.',
      }],
      ['The injured bird hopped ___ across the grass before flying away.', 'awkwardly', ['awkward', 'more awkward', 'awkwardness'], {
        'awkwardly': '"Awkwardly" is correct because it is an adverb describing how the bird hopped — modifying the verb.',
        'awkward': '"Awkward" is an adjective; here the word must describe the action of hopping.',
        'more awkward': '"More awkward" is a comparative adjective; an adverb is needed to describe the verb.',
        'awkwardness': '"Awkwardness" is a noun, not an adverb.',
      }],
      ['The water in the swimming pool felt ___ after the blazing afternoon sun.', 'cool', ['coolly', 'more coolly', 'coolness'], {
        'cool': '"Cool" is correct because "felt" is a linking verb, and adjectives follow linking verbs to describe the subject.',
        'coolly': '"Coolly" is an adverb meaning in a calm manner; after a linking verb like "felt", an adjective is needed.',
        'more coolly': '"More coolly" is an adverb; linking verbs require adjectives.',
        'coolness': '"Coolness" is a noun, not an adjective.',
      }],
      ['He answered every question on the quiz ___ and scored full marks.', 'correctly', ['correct', 'correcter', 'correctness'], {
        'correctly': '"Correctly" is correct because it is an adverb describing how he answered — modifying the verb.',
        'correct': '"Correct" is an adjective; here the word must describe the action of answering.',
        'correcter': '"Correcter" is not a standard word — the comparative of "correct" is "more correct".',
        'correctness': '"Correctness" is a noun, not an adverb.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'adjective_adverb_choice', q, choices: buildChoices(answer, ds), answer, explain: 'Adjectives describe nouns and follow linking verbs (looks/feels/smells/tastes/seems). Adverbs describe verbs and often end in -ly. After "look/feel/smell/taste/seem", use an adjective.', optionExplanations };
  },
  auxiliaries(level, i) {
    const rows = [
      ['___ you finished your corrections yet?', 'Have', ['Do', 'Did', 'Are'], {
        'Have': '"Have" is correct because "yet" signals present perfect, and "you" takes "have".',
        'Do': '"Do" forms a simple present question; "yet" signals present perfect.',
        'Did': '"Did" forms a simple past question; "yet" signals present perfect.',
        'Are': '"Are" forms a present continuous question; "yet" with "finished" signals present perfect.',
      }],
      ['Why ___ the players so quiet today?', 'are', ['is', 'was', 'has'], {
        'are': '"Are" is correct because "the players" is plural and the sentence is in the present.',
        'is': '"Is" is for singular subjects; "the players" is plural.',
        'was': '"Was" is singular past tense; "today" signals the present.',
        'has': '"Has" forms present perfect; the sentence is a simple present question about a current state.',
      }],
      ['___ she submit the file yesterday?', 'Did', ['Does', 'Do', 'Has'], {
        'Did': '"Did" is correct because "yesterday" signals simple past, and "did" is used for all subjects in simple past questions.',
        'Does': '"Does" forms a simple present question; "yesterday" signals simple past.',
        'Do': '"Do" forms a simple present question; "yesterday" signals simple past.',
        'Has': '"Has" forms a present perfect question; "yesterday" pins the action to a specific past time.',
      }],
      ['How many chapters ___ you read so far?', 'have', ['has', 'had', 'are'], {
        'have': '"Have" is correct because "so far" signals present perfect, and "you" takes "have".',
        'has': '"Has" is for he/she/it; "you" always takes "have" in present perfect.',
        'had': '"Had" forms past perfect; "so far" signals an ongoing connection to the present.',
        'are': '"Are" forms a present continuous question; "so far" signals present perfect.',
      }],
      ['Where ___ you going after the assembly?', 'are', ['is', 'do', 'have'], {
        'are': '"Are" is correct because "going" signals present continuous, and "you" takes "are".',
        'is': '"Is" is for he/she/it in present continuous; "you" takes "are".',
        'do': '"Do" forms a simple present question; "going" signals present continuous.',
        'have': '"Have" forms a present perfect question; "going" signals present continuous.',
      }],
      ['___ the teacher already explained the new topic?', 'Has', ['Have', 'Did', 'Was'], {
        'Has': '"Has" is correct because "already" signals present perfect, and "the teacher" (he/she) takes "has".',
        'Have': '"Have" is for I/you/we/they; "the teacher" is singular third person.',
        'Did': '"Did" forms a simple past question; "already" here signals present perfect.',
        'Was': '"Was" forms a past continuous or past linking question; "already" with a past participle signals present perfect.',
      }],
      ['Why ___ Jenny crying when I saw her in the canteen?', 'was', ['is', 'has', 'did'], {
        'was': '"Was" is correct because "when I saw her" sets the scene in the past, and "crying" signals past continuous.',
        'is': '"Is" forms a present continuous question; "when I saw her" signals the past.',
        'has': '"Has" forms a present perfect question; the past continuous is needed for an action in progress when another happened.',
        'did': '"Did" forms a simple past question; "crying" requires the continuous form "was crying".',
      }],
      ['When ___ the exhibition open last weekend?', 'did', ['does', 'has', 'is'], {
        'did': '"Did" is correct because "last weekend" signals simple past.',
        'does': '"Does" forms a simple present question; "last weekend" signals simple past.',
        'has': '"Has" forms a present perfect question; "last weekend" pins the action to a specific past time.',
        'is': '"Is" forms a present continuous question; "last weekend" signals simple past.',
      }],
      ['___ your father reading the newspaper at the moment?', 'Is', ['Has', 'Did', 'Do'], {
        'Is': '"Is" is correct because "at the moment" signals present continuous, and "your father" (he) takes "is".',
        'Has': '"Has" forms a present perfect question; "at the moment" signals an ongoing present action.',
        'Did': '"Did" forms a simple past question; "at the moment" signals the present.',
        'Do': '"Do" forms a simple present question; "reading at the moment" requires present continuous.',
      }],
      ['How long ___ you been waiting for the bus today?', 'have', ['has', 'are', 'did'], {
        'have': '"Have" is correct because "how long…been" signals present perfect continuous, and "you" takes "have".',
        'has': '"Has" is for he/she/it; "you" always takes "have" in perfect tenses.',
        'are': '"Are" forms a present continuous question; "how long…been" signals present perfect continuous.',
        'did': '"Did" forms a simple past question; "how long…been" signals present perfect continuous.',
      }],
      ['___ they bring their swimming kit yesterday?', 'Did', ['Do', 'Have', 'Are'], {
        'Did': '"Did" is correct because "yesterday" signals simple past, and "did" is used for all subjects.',
        'Do': '"Do" forms a simple present question; "yesterday" signals simple past.',
        'Have': '"Have" forms a present perfect question; "yesterday" pins the action to a specific past time.',
        'Are': '"Are" forms a present continuous question; "yesterday" signals simple past.',
      }],
      ['What ___ the librarian say about the missing book?', 'did', ['does', 'is', 'has'], {
        'did': '"Did" is correct because the question is about something said in the past.',
        'does': '"Does" forms a simple present question; the question is about a past statement.',
        'is': '"Is" forms a present continuous or linking question; the question is about a past statement.',
        'has': '"Has" forms a present perfect question; the simple past "did" is needed for a specific past event.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'aux_question_forms', q, choices: buildChoices(answer, ds), answer, explain: 'Match the auxiliary to the tense: Did (simple past), Do/Does (simple present), Is/Are/Was/Were (continuous), Have/Has/Had (perfect), Will (future). The auxiliary must also agree with the subject in number and person.', optionExplanations };
  },
  ...
  pastPerfect(level, i) {
    const rows = [
      ['The train had left before we ___ the station.', 'reached', ['reach', 'have reached', 'are reaching'], {
        'reached': '"Reached" is correct because it is the second past action — the train left first, then we arrived.',
        'reach': '"Reach" is base form present; the sentence describes two past events in sequence.',
      ...
      ['By 6 p.m., they ___ all the banners.', 'had hung', ['have hung', 'hung', 'were hanging'], {
        'had hung': '"Had hung" is correct because "by 6 p.m." is a past deadline — the action was completed before that point.',
        'have hung': '"Have hung" is present perfect; "by 6 p.m." refers to a past deadline.',
      ...
      ['When I switched on the television, the news ___ already.', 'had ended', ['has ended', 'ended', 'was ending'], {
        'had ended': '"Had ended" is correct because the news ending happened before the past action of switching on the TV.',
        'has ended': '"Has ended" is present perfect; both events are in the past.',
        'ended': '"Ended" is simple past; "had ended" is needed to show the ending happened before switching on the TV.',
        'was ending': '"Was ending" shows an action in progress; "already" suggests the ending was complete by then.',
      }],
      ['The audience ___ when the play finally began at 8 p.m.', 'had been waiting', ['has been waiting', 'waited', 'is waiting'], {
        'had been waiting': '"Had been waiting" is correct because it shows ongoing action before the past event of the play beginning.',
        'has been waiting': '"Has been waiting" is present perfect continuous; both events are in the past.',
        'waited': '"Waited" is simple past; it does not show the duration of waiting before the play began.',
        'is waiting': '"Is waiting" is present continuous; "when the play finally began" sets the scene in the past.',
      }],
      ['By the time the fire engines arrived, neighbours ___ the small fire.', 'had put out', ['have put out', 'put out', 'were putting out'], {
        'had put out': '"Had put out" is correct because the neighbours extinguished the fire before the fire engines arrived.',
        'have put out': '"Have put out" is present perfect; both events are in the past.',
        'put out': '"Put out" is simple past; "had put out" is needed to show the action happened before the fire engines arrived.',
        'were putting out': '"Were putting out" shows action in progress; the past perfect shows it was already done by then.',
      }],
      ['Lin felt embarrassed because she ___ the wrong jersey to the match.', 'had brought', ['has brought', 'brought', 'is bringing'], {
        'had brought': '"Had brought" is correct because the wrong jersey was brought before the past state of feeling embarrassed.',
        'has brought': '"Has brought" is present perfect; both events are in the past.',
        'brought': '"Brought" is simple past; "had brought" is needed to show the earlier past cause.',
        'is bringing': '"Is bringing" is present continuous; the sentence is set entirely in the past.',
      }],
      ['We ___ for the keys for an hour when Father finally found them in the car.', 'had searched', ['have searched', 'searched', 'are searching'], {
        'had searched': '"Had searched" is correct because the searching was ongoing for an hour before the past event of Father finding the keys.',
        'have searched': '"Have searched" is present perfect; both events are in the past.',
        'searched': '"Searched" is simple past; it does not show the one-hour duration before Father found them.',
        'are searching': '"Are searching" is present continuous; the sentence is set entirely in the past.',
      }],
      ['The dog wagged its tail because it ___ its owner from a distance.', 'had spotted', ['has spotted', 'spots', 'is spotting'], {
        'had spotted': '"Had spotted" is correct because spotting the owner happened before the past action of wagging the tail.',
        'has spotted': '"Has spotted" is present perfect; both events are in the past.',
        'spots': '"Spots" is simple present; the sentence is set in the past.',
        'is spotting': '"Is spotting" is present continuous; the sentence is set entirely in the past.',
      }],
      ['The shop assistant explained that the last set ___ minutes earlier.', 'had been sold', ['has been sold', 'was sold', 'is being sold'], {
        'had been sold': '"Had been sold" is correct because the selling happened before the past action of explaining.',
        'has been sold': '"Has been sold" is present perfect passive; both events are in the past.',
      ...
      ['By the time we got to the stall, the char kway teow ___ out.', 'had sold', ['has sold', 'sold', 'was selling'], {
        'had sold': '"Had sold out" is correct because selling out happened before the past event of us arriving.',
        'has sold': '"Has sold" is present perfect; both events are in the past.',
        'sold': '"Sold" is simple past; "had sold" is needed to show it happened before we arrived.',
        'was selling': '"Was selling" shows an action in progress; the past perfect shows the selling was already done.',
      }],
      ['She was nervous because she ___ in front of such a large audience before.', 'had never performed', ['has never performed', 'never performed', 'was never performing'], {
        'had never performed': '"Had never performed" is correct because the lack of experience is the earlier past cause of her nervousness.',
        'has never performed': '"Has never performed" is present perfect; both events are in the past.',
      ...
      ['The teacher noticed that someone ___ all the art supplies from the cupboard.', 'had taken', ['has taken', 'took', 'was taking'], {
        ...
        'has taken': '"Has taken" is present perfect; both events are in the past.',
      ...
      ['He could not board the bus because he ___ his EZ-Link card at home.', 'had left', ['has left', 'left', 'is leaving'], {
        'had left': '"Had left" is correct because forgetting the card happened before the past state of being unable to board.',
        'has left': '"Has left" is present perfect; both events are in the past.',
        'left': '"Left" is simple past; "had left" is needed to show the earlier past cause.',
        'is leaving': '"Is leaving" is present continuous; the sentence is set entirely in the past.',
      }],
      ['By the time the guests arrived, Grandma ___ enough curry puffs for everyone.', 'had prepared', ['has prepared', 'prepared', 'was preparing'], {
        'had prepared': '"Had prepared" is correct because the preparation was completed before the past event of the guests arriving.',
        'has prepared': '"Has prepared" is present perfect; both events are in the past.',
        'prepared': '"Prepared" is simple past; "had prepared" is needed to show completion before the guests arrived.',
        'was preparing': '"Was preparing" shows action in progress; the past perfect shows the preparation was already done.',
      }],
      ['The referee blew the whistle because a player ___ the boundary line.', 'had crossed', ['has crossed', 'crossed', 'is crossing'], {
        'had crossed': '"Had crossed" is correct because crossing the line is the earlier past cause of the referee blowing the whistle.',
        'has crossed': '"Has crossed" is present perfect; both events are in the past.',
        'crossed': '"Crossed" is simple past; "had crossed" is needed to show the earlier past cause.',
        'is crossing': '"Is crossing" is present continuous; the sentence is set entirely in the past.',
      }],
      ['Rina was very hungry at lunch. She realised she ___ her breakfast by mistake that morning.', 'had skipped', ['has skipped', 'skipped', 'was skipping'], {
        'had skipped': '"Had skipped" is correct because skipping breakfast happened before the past state of being hungry.',
        'has skipped': '"Has skipped" is present perfect; both events are in the past.',
        'skipped': '"Skipped" is simple past; "had skipped" is needed to show the earlier past cause of hunger.',
        'was skipping': '"Was skipping" shows action in progress; the past perfect shows a completed action.',
      }],
      ['Wei could not find his calculator during the test. He thought he ___ it at home.', 'had left', ['has left', 'left', 'is leaving'], {
        'had left': '"Had left" is correct because leaving the calculator happened before the past state of not finding it.',
        'has left': '"Has left" is present perfect; both events are in the past.',
        'left': '"Left" is simple past; "had left" is needed to show the earlier past cause.',
        'is leaving': '"Is leaving" is present continuous; the sentence is set entirely in the past.',
      }],
      ['Priya smiled when she saw her results. She ___ worked harder than ever before that term.', 'had', ['has', 'have', 'was'], {
        'had': '"Had" is correct because "had worked harder" forms the past perfect — the working happened before the past event of seeing results.',
        'has': '"Has" forms present perfect; both events are in the past.',
        'have': '"Have" forms present perfect and is for I/you/we/they; "she" takes "has" or "had".',
        'was': '"Was" forms past continuous; "worked" is a past participle needing "had" for past perfect.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'past_perfect_sequence', q, choices: buildChoices(answer, ds), answer, explain: 'Past perfect (had + past participle) shows the earlier of two past events. Look for "by the time", "before", "when", "after", and "because" as clues to sequence.', optionExplanations };
  },
  perfectContinuousTenses(level, i) {
    const rows = [
      ['By noon, we ___ for two hours.', 'had been practising', ['have practised', 'practised', 'are practising'], {
        'had been practising': '"Had been practising" is correct because "by noon" shows a past deadline, and the action was ongoing up to that point — past perfect continuous.',
        'have practised': '"Have practised" is present perfect; "by noon" with a past reference needs past perfect continuous.',
        'practised': '"Practised" is simple past; it does not show the two-hour duration leading up to noon.',
        'are practising': '"Are practising" is present continuous; the sentence describes a past scene at noon.',
      }],
      ['She looks tired because she ___ non-stop since dawn.', 'has been working', ['worked', 'had worked', 'was working'], {
        'has been working': '"Has been working" is correct because "since dawn" shows an action that started in the past and is still continuing now.',
        'worked': '"Worked" is simple past; "since dawn" shows the action is still ongoing.',
      ...
      ['They ___ in this neighbourhood for ten years.', 'have been living', ['lived', 'had lived', 'are living'], {
        ...
        'are living': '"Are living" is present continuous; "for ten years" shows ongoing duration needing perfect continuous.',
      }],
      ['By next week, he ___ at this task for a month.', 'will have been working', ['has worked', 'worked', 'is working'], {
        'will have been working': '"Will have been working" is correct because "by next week" is a future deadline, and the action spans a month — future perfect continuous.',
        'has worked': '"Has worked" is present perfect; "by next week" places the completion in the future.',
        'worked': '"Worked" is simple past; "by next week" is a future reference.',
        'is working': '"Is working" is present continuous; "by next week" signals a future perfect duration.',
      }],
      ['I ___ the same novel for three days because it is so long.', 'have been reading', ['read', 'had read', 'was reading'], {
        'have been reading': '"Have been reading" is correct because "for three days" shows an action that started in the past and is still ongoing.',
        'read': '"Read" is simple past; "for three days" shows the reading is still in progress.',
      ...
      ['By the time the concert ends tonight, the band ___ for nearly four hours.', 'will have been performing', ['has performed', 'performed', 'will perform'], {
        'will have been performing': '"Will have been performing" is correct because "by the time the concert ends" is a future point, and the performance spans four hours — future perfect continuous.',
        'has performed': '"Has performed" is present perfect; the concert is in the future.',
        'performed': '"Performed" is simple past; "by the time the concert ends tonight" is in the future.',
        'will perform': '"Will perform" is simple future; it does not show the four-hour duration.',
      }],
      ['Mei ___ piano lessons since she was six years old.', 'has been taking', ['took', 'had taken', 'will take'], {
        'has been taking': '"Has been taking" is correct because "since she was six" shows an action that started in the past and is still continuing.',
        'took': '"Took" is simple past for a completed action; "since she was six" shows she still takes lessons.',
        'had taken': '"Had taken" is past perfect; Mei still takes lessons now.',
        'will take': '"Will take" is future; "since she was six" shows the action has already been ongoing.',
      }],
      ['When Mother finally came home, the dog ___ at the door for ages.', 'had been waiting', ['has been waiting', 'waited', 'is waiting'], {
        'had been waiting': '"Had been waiting" is correct because the waiting was ongoing for a long time before the past event of Mother coming home.',
        'has been waiting': '"Has been waiting" is present perfect continuous; both events are in the past.',
        'waited': '"Waited" is simple past; it does not show the duration of waiting before Mother arrived.',
        'is waiting': '"Is waiting" is present continuous; "when Mother finally came home" sets the scene in the past.',
      }],
      ['Our class ___ for the field trip ever since the term began.', 'has been preparing', ['prepared', 'had prepared', 'is preparing'], {
        'has been preparing': '"Has been preparing" is correct because "ever since the term began" shows an action ongoing from the past to the present.',
        'prepared': '"Prepared" is simple past for a completed action; "ever since" shows the preparation is still continuing.',
        'had prepared': '"Had prepared" is past perfect; the preparation is still ongoing now.',
        'is preparing': '"Is preparing" is present continuous; "ever since the term began" shows duration needing perfect continuous.',
      }],
      ['The rain ___ steadily for two days now, and the field is flooded.', 'has been falling', ['fell', 'had fallen', 'falls'], {
        'has been falling': '"Has been falling" is correct because "for two days now" shows ongoing duration from the past to the present.',
        'fell': '"Fell" is simple past; "now" shows the rain is still falling.',
        'had fallen': '"Had fallen" is past perfect; "now" shows the rain is still falling at the present moment.',
        'falls': '"Falls" is simple present for habits; "for two days" shows duration needing perfect continuous.',
      }],
      ['By the end of this month, she ___ in the gym every weekend for half a year.', 'will have been training', ['has trained', 'is training', 'trains'], {
        'will have been training': '"Will have been training" is correct because "by the end of this month" is a future deadline, and the training spans six months — future perfect continuous.',
        'has trained': '"Has trained" is present perfect; "by the end of this month" places the completion in the future.',
        'is training': '"Is training" is present continuous; it does not show the six-month duration up to a future point.',
        'trains': '"Trains" is simple present for habits; the sentence describes a span of time up to a future deadline.',
      }],
      ['The construction workers ___ on the MRT extension for over three years.', 'have been working', ['worked', 'had worked', 'are working'], {
        'have been working': '"Have been working" is correct because "for over three years" shows an action that started in the past and is still ongoing.',
        'worked': '"Worked" is simple past for a completed action; the work is still ongoing.',
        'had worked': '"Had worked" is past perfect; the work is still in progress now.',
        'are working': '"Are working" is present continuous; "for over three years" shows duration needing perfect continuous.',
      }],
      ['By the time the match ends tonight, both teams ___ for more than ninety minutes.', 'will have been playing', ['have played', 'played', 'will play'], {
        'will have been playing': '"Will have been playing" is correct because "by the time the match ends tonight" is a future point, and the play spans ninety minutes — future perfect continuous.',
        'have played': '"Have played" is present perfect; the match ending is in the future.',
        'played': '"Played" is simple past; the match is happening in the future.',
        'will play': '"Will play" is simple future; it does not show the ninety-minute duration.',
      }],
      ['She ___ Mandarin at the community centre since Primary Three.', 'has been learning', ['learned', 'had learned', 'will learn'], {
        'has been learning': '"Has been learning" is correct because "since Primary Three" shows an action ongoing from the past to the present.',
        'learned': '"Learned" is simple past for a completed action; "since" shows she still learns Mandarin.',
        'had learned': '"Had learned" is past perfect; the learning is still continuing now.',
        'will learn': '"Will learn" is future; "since Primary Three" shows the action has already been ongoing.',
      }],
      ['When the bell finally rang, the pupils ___ the same maths problem for forty minutes.', 'had been solving', ['have been solving', 'solved', 'are solving'], {
        'had been solving': '"Had been solving" is correct because the solving was ongoing for forty minutes before the past event of the bell ringing.',
        'have been solving': '"Have been solving" is present perfect continuous; both events are in the past.',
        'solved': '"Solved" is simple past; it does not show the forty-minute duration before the bell rang.',
        'are solving': '"Are solving" is present continuous; "when the bell finally rang" sets the scene in the past.',
      }],
      ['I feel dizzy because I ___ in the sun for too long without water.', 'have been standing', ['stood', 'had stood', 'am standing'], {
        'have been standing': '"Have been standing" is correct because "for too long" shows ongoing action that explains the present dizziness.',
        'stood': '"Stood" is simple past; the standing is still ongoing and causes current dizziness.',
        'had stood': '"Had stood" is past perfect; the dizziness exists now, so present perfect continuous is needed.',
        'am standing': '"Am standing" is present continuous; "for too long" shows duration needing perfect continuous.',
      }],
      ['By his next birthday, he ___ the violin for a full decade.', 'will have been playing', ['has played', 'is playing', 'will play'], {
        'will have been playing': '"Will have been playing" is correct because "by his next birthday" is a future deadline, and playing the violin spans ten years — future perfect continuous.',
        'has played': '"Has played" is present perfect; "by his next birthday" places the completion in the future.',
        'is playing': '"Is playing" is present continuous; the sentence describes a ten-year span up to a future point.',
        'will play': '"Will play" is simple future; it does not show the ten-year duration.',
      }],
      ['The volunteers ___ meals for the elderly residents since early this morning.', 'have been preparing', ['prepared', 'had prepared', 'were preparing'], {
        'have been preparing': '"Have been preparing" is correct because "since early this morning" shows an action ongoing from the past to the present.',
        'prepared': '"Prepared" is simple past; "since this morning" shows the preparation is still in progress.',
        'had prepared': '"Had prepared" is past perfect; the preparation is still continuing now.',
        'were preparing': '"Were preparing" is past continuous for a specific past moment; "since this morning" shows ongoing duration to the present.',
      }],
      ['When Mum checked on us at midnight, we ___ the same board game for hours.', 'had been playing', ['have been playing', 'played', 'were playing'], {
        'had been playing': '"Had been playing" is correct because the game was ongoing for hours before the past event of Mum checking.',
        'have been playing': '"Have been playing" is present perfect continuous; both events are in the past.',
        'played': '"Played" is simple past; it does not show the hours of play before Mum arrived.',
        'were playing': '"Were playing" is past continuous; it does not show the extended duration before the past event.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'perfect_continuous', q, choices: buildChoices(answer, ds), answer, explain: 'Perfect continuous tenses show duration. Present: has/have been + verb-ing (for/since). Past: had been + verb-ing (before a past event). Future: will have been + verb-ing (by a future point).', optionExplanations };
  },
  ...
  passiveVoice(level, i) {
    const rows = [
      ['The science models ___ by the P5 pupils.', 'were built', ['built', 'are building', 'have built'], {
        'were built': '"Were built" is correct because the models received the action (passive voice) in the past, and "by the P5 pupils" confirms they are passive.',
        'built': '"Built" alone is an active past tense; the passive needs "were built" to show the models received the action.',
        'are building': '"Are building" is active present continuous — the P5 pupils are the subject doing the action, which reverses the meaning.',
        'have built': '"Have built" is active present perfect — the P5 pupils are still the active subject.',
      }],
      ['The report ___ by the committee tomorrow.', 'will be reviewed', ['reviews', 'reviewed', 'has reviewed'], {
        'will be reviewed': '"Will be reviewed" is correct because the report receives the action (passive) and "tomorrow" signals the future.',
        'reviews': '"Reviews" is active present simple; the passive future needs "will be + past participle".',
        'reviewed': '"Reviewed" is simple past active; "tomorrow" signals the future.',
        'has reviewed': '"Has reviewed" is active present perfect; the report receives the action, not performs it.',
      }],
      ['The hall ___ before the event started.', 'had been cleaned', ['cleaned', 'was cleaning', 'has cleaned'], {
        'had been cleaned': '"Had been cleaned" is correct because the cleaning (passive) happened before the earlier past event of the event starting.',
        'cleaned': '"Cleaned" is active simple past; the passive past perfect "had been cleaned" is needed.',
        'was cleaning': '"Was cleaning" is active past continuous — someone was doing the cleaning, which reverses the meaning.',
        'has cleaned': '"Has cleaned" is active present perfect; both events are in the past.',
      }],
      ['The safety rules ___ to all new students.', 'are explained', ['explain', 'explained', 'have explained'], {
        'are explained': '"Are explained" is correct because the rules receive the action (passive) as a regular present practice.',
        'explain': '"Explain" is active base form; the passive present needs "are explained".',
        'explained': '"Explained" is active past; the present passive is needed for an ongoing practice.',
        'have explained': '"Have explained" is active present perfect; the rules receive the explanation.',
      }],
      ['The classroom windows ___ every Friday afternoon.', 'are wiped', ['wipe', 'wiped', 'have wiped'], {
        'are wiped': '"Are wiped" is correct because the windows receive the action (passive) as a regular routine.',
        'wipe': '"Wipe" is active base form; the passive present needs "are wiped".',
        'wiped': '"Wiped" is active past; the present passive is needed for a regular routine.',
        'have wiped': '"Have wiped" is active present perfect; the windows receive the action.',
      }],
      ['The lost wallet ___ to the front office yesterday.', 'was returned', ['returned', 'has returned', 'is returning'], {
        'was returned': '"Was returned" is correct because the wallet received the action (passive) in the past.',
        'returned': '"Returned" is active past; the passive "was returned" is needed since the wallet received the action.',
        'has returned': '"Has returned" is active present perfect; "yesterday" pins the action to a specific past time.',
        'is returning': '"Is returning" is active present continuous; the wallet received the action in the past.',
      }],
      ['By tomorrow noon, all the prizes ___.', 'will have been packed', ['will pack', 'pack', 'has packed'], {
        'will have been packed': '"Will have been packed" is correct because the prizes receive the action (passive future perfect) — completed by a future deadline.',
        'will pack': '"Will pack" is active future; the prizes receive the action, not perform it.',
        'pack': '"Pack" is active base form; the passive future perfect is needed.',
        'has packed': '"Has packed" is active present perfect; "by tomorrow noon" places the action in the future.',
      }],
      ['Each year, thousands of trees ___ along the new highway.', 'are planted', ['plant', 'planted', 'have planted'], {
        'are planted': '"Are planted" is correct because the trees receive the action (passive) as a regular annual practice.',
        'plant': '"Plant" is active base form; the passive present is needed since the trees receive the action.',
        'planted': '"Planted" is active past; the present passive is needed for an annual routine.',
        'have planted': '"Have planted" is active present perfect; the trees receive the action.',
      }],
      ['The new gym ___ since January and is now ready to use.', 'has been built', ['built', 'is building', 'will build'], {
        'has been built': '"Has been built" is correct because the gym received the action (passive present perfect) starting in January.',
        'built': '"Built" alone is active past; the passive present perfect "has been built" is needed.',
        'is building': '"Is building" is active present continuous — someone is the doer, which reverses the meaning.',
        'will build': '"Will build" is active future; the gym has already been completed.',
      }],
      ['When we arrived, the food ___ already.', 'had been served', ['has been served', 'served', 'is serving'], {
        'had been served': '"Had been served" is correct because the food received the action (passive) before the past event of our arrival.',
        'has been served': '"Has been served" is passive present perfect; both events are in the past.',
        'served': '"Served" is active past; the passive past perfect "had been served" is needed.',
        'is serving': '"Is serving" is active present continuous — the doer is the subject, which reverses the meaning.',
      }],
      ['The library books ___ by the volunteers right now.', 'are being sorted', ['sort', 'sorted', 'have sorted'], {
        'are being sorted': '"Are being sorted" is correct because the books receive the ongoing action (passive present continuous) right now.',
        'sort': '"Sort" is active base form; the passive present continuous is needed.',
        'sorted': '"Sorted" is active past; "right now" signals the action is ongoing.',
        'have sorted': '"Have sorted" is active present perfect; the books receive the action right now.',
      }],
      ['The award ___ to the most improved player every year.', 'is given', ['gives', 'gave', 'has given'], {
        'is given': '"Is given" is correct because the award receives the action (passive) as a regular annual event.',
        'gives': '"Gives" is active present simple; the award is the receiver, not the giver.',
        'gave': '"Gave" is active past; the present passive is needed for an annual routine.',
        'has given': '"Has given" is active present perfect; the award receives the action.',
      }],
      ['The new community centre ___ officially opened by the Member of Parliament last Saturday.', 'was', ['is', 'has been', 'were'], {
        'was': '"Was" is correct because the community centre received the action (passive simple past: was + opened) last Saturday.',
        'is': '"Is" is present tense; "last Saturday" signals the action is in the past.',
      ...
      ['The injured stray cat ___ rescued by a group of volunteers near Toa Payoh.', 'was', ['is', 'were', 'had been'], {
        ...
        'is': '"Is" is present tense; the rescue was a completed past event.',
      ...
      ['The prize-winners ___ announced after the closing ceremony.', 'were', ['was', 'are', 'have been'], {
        ...
        'have been': '"Have been" is present perfect; the simple past passive "were announced" is needed for a completed past event.',
      }],
      ['The examination timetable ___ been posted on the school notice board.', 'has', ['have', 'had', 'was'], {
        'has': '"Has" is correct because "the examination timetable" is singular and "been posted" signals present perfect passive.',
        'have': '"Have" is for plural subjects; "the examination timetable" is singular.',
        'had': '"Had" forms past perfect; the context suggests present perfect — the timetable is likely still there.',
        'was': '"Was" forms simple past or past continuous; "been posted" needs a perfect auxiliary like "has".',
      }],
      ['The students were told that their compositions ___ be marked by Friday.', 'would be', ['will be', 'are being', 'had been'], {
        'would be': '"Would be" is correct because the sentence reports what was said in the past — reported speech shifts "will" to "would".',
        'will be': '"Will be" is direct future; in reported speech after "were told", "will" shifts to "would".',
        'are being': '"Are being" is present continuous passive; the marking is a future event in reported speech.',
        'had been': '"Had been" is past perfect passive; the marking is a future event, not a past one.',
      }],
      ['By the time the referee blew the whistle, the result ___ already been decided.', 'had', ['has', 'have', 'was'], {
        'had': '"Had" is correct because "had already been decided" is past perfect passive — the result was decided before the past event of the whistle.',
        'has': '"Has" forms present perfect; both events are in the past.',
        'have': '"Have" is for plural subjects; "the result" is singular.',
        'was': '"Was" forms simple past or past continuous; "been decided" needs "had" for past perfect passive.',
      }],
      ['Fresh flowers ___ delivered to the school office every Monday morning.', 'are', ['is', 'were', 'have been'], {
        'are': '"Are" is correct because fresh flowers receive the action (passive: are + delivered) as a regular weekly routine.',
        'is': '"Is" is singular; "fresh flowers" is plural.',
        'were': '"Were" is past; the sentence describes a current regular practice.',
        'have been': '"Have been" forms present perfect; the simple present passive "are delivered" is needed for a routine.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return { subskill: 'passive_forms', q, choices: buildChoices(answer, ds), answer, explain: 'Passive voice: the subject receives the action. Form: am/is/are/was/were/has been/had been + past participle. The doer is introduced by "by".', optionExplanations };
  },
  relativeClauses(level, i) {
    const rows = [
      ['The teacher ___ guided us is retiring this year.', 'who', ['which', 'whose', 'whom'], {
        'who': '"Who" is correct because the relative clause refers to a person (the teacher) as the subject.',
        'which': '"Which" is for things, not people.',
        'whose': '"Whose" shows possession; the clause is about the teacher as the subject, not what the teacher owns.',
        'whom': '"Whom" is for a person as the object; here the teacher is the subject of "guided".',
      }],
      ['This is the book ___ cover was torn.', 'whose', ['who', 'which', 'whom'], {
        'whose': '"Whose" is correct because it shows possession — the cover belongs to the book.',
        'who': '"Who" is for people; "whose" is needed to show ownership of a thing.',
        'which': '"Which" introduces a clause about the thing itself, not a possessive clause about its cover.',
        'whom': '"Whom" is for a person as the object; the clause needs a possessive pronoun.',
      }],
      ['The park ___ we visited has a new playground.', 'that', ['who', 'whose', 'whom'], {
        'that': '"That" is correct because it introduces a relative clause about a thing (the park).',
        'who': '"Who" is for people; the park is a place.',
        'whose': '"Whose" shows possession; the clause is about the park as the object of "visited".',
        'whom': '"Whom" is for a person as the object; the park is not a person.',
      }],
      ['The scientist to ___ we wrote replied kindly.', 'whom', ['who', 'which', 'whose'], {
        'whom': '"Whom" is correct because after the preposition "to", the object form of "who" is needed.',
        'who': '"Who" is a subject pronoun; after the preposition "to", the object form "whom" is needed.',
        'which': '"Which" is for things; the scientist is a person.',
        'whose': '"Whose" shows possession; the clause is about the scientist as the object after "to".',
      }],
      ['The dog, ___ tail kept wagging, was clearly excited to see us.', 'whose', ['who', 'which', 'whom'], {
        'whose': '"Whose" is correct because it shows possession — the tail belongs to the dog.',
        'who': '"Who" is for people as a subject or object; "whose" is needed to show ownership.',
        'which': '"Which" introduces a non-possessive clause about the thing; the clause describes the dog\'s tail.',
        'whom': '"Whom" is for a person as the object; the clause needs a possessive pronoun.',
      }],
      ['Mrs Lee, ___ teaches us mathematics, also runs the chess club.', 'who', ['which', 'whose', 'whom'], {
        'who': '"Who" is correct because Mrs Lee is a person and she is the subject of "teaches".',
        'which': '"Which" is for things, not people.',
        'whose': '"Whose" shows possession; the clause is about what Mrs Lee does, not what she owns.',
        'whom': '"Whom" is for a person as the object; Mrs Lee is the subject of "teaches".',
      }],
      ['The bicycle ___ I borrowed has a flat tyre.', 'that', ['who', 'whose', 'whom'], {
        'that': '"That" is correct because it introduces a relative clause about a thing (the bicycle).',
        'who': '"Who" is for people; the bicycle is a thing.',
        'whose': '"Whose" shows possession; the clause is about the bicycle as the object of "borrowed".',
        'whom': '"Whom" is for a person as the object; the bicycle is not a person.',
      }],
      ['The girl with ___ I shared my umbrella thanked me politely.', 'whom', ['who', 'which', 'whose'], {
        'whom': '"Whom" is correct because after the preposition "with", the object form is needed.',
        'who': '"Who" is a subject pronoun; after the preposition "with", the object form "whom" is needed.',
        'which': '"Which" is for things; the girl is a person.',
        'whose': '"Whose" shows possession; the clause is about the girl as the object after "with".',
      }],
      ['The museum ___ opened last year is very popular with families.', 'which', ['who', 'whose', 'whom'], {
        'which': '"Which" is correct because it introduces a relative clause about a thing (the museum).',
        'who': '"Who" is for people; the museum is a thing.',
        'whose': '"Whose" shows possession; the clause is about the museum as the subject of "opened".',
        'whom': '"Whom" is for a person as the object; the museum is a thing.',
      }],
      ['I met the author ___ wrote my favourite picture book.', 'who', ['which', 'whose', 'whom'], {
        'who': '"Who" is correct because the author is a person and is the subject of "wrote".',
        'which': '"Which" is for things; the author is a person.',
        'whose': '"Whose" shows possession; the clause is about what the author did, not what the author owns.',
        'whom': '"Whom" is for a person as the object; the author is the subject of "wrote".',
      }],
      ['This is the corridor ___ floor was newly polished.', 'whose', ['who', 'which', 'whom'], {
        'whose': '"Whose" is correct because it shows possession — the floor belongs to the corridor.',
        'who': '"Who" is for people; "whose" is used for things showing possession.',
        'which': '"Which" introduces a non-possessive clause; the clause needs to show the floor belongs to the corridor.',
        'whom': '"Whom" is for a person as the object; the clause needs a possessive pronoun.',
      }],
      ['The volunteers, most of ___ are seniors, run the soup kitchen on weekends.', 'whom', ['who', 'which', 'whose'], {
        'whom': '"Whom" is correct because after the preposition "of", the object form is needed for people.',
        'who': '"Who" is a subject pronoun; after "of", the object form "whom" is needed.',
        'which': '"Which" is for things; the volunteers are people.',
        'whose': '"Whose" shows possession; the clause is about the volunteers as the object after "of".',
      }],
      ['The cleaner ___ mops our classroom every morning always greets us cheerfully.', 'who', ['which', 'whose', 'whom'], {
        'who': '"Who" is correct because the cleaner is a person and is the subject of "mops".',
        'which': '"Which" is for things; the cleaner is a person.',
        'whose': '"Whose" shows possession; the clause is about what the cleaner does.',
        'whom': '"Whom" is for a person as the object; the cleaner is the subject of "mops".',
      }],
      ['The laptop ___ the school lent me has a cracked screen.', 'that', ['who', 'whose', 'whom'], {
        'that': '"That" is correct because it introduces a relative clause about a thing (the laptop).',
        'who': '"Who" is for people; the laptop is a thing.',
        'whose': '"Whose" shows possession; the clause is about the laptop as the object of "lent".',
        'whom': '"Whom" is for a person as the object; the laptop is not a person.',
      }],
      ['The prefect ___ badge was missing reported it to the teacher immediately.', 'whose', ["who's", 'that', 'which'], {
        'whose': '"Whose" is correct because it shows possession — the badge belongs to the prefect.',
        "who's": '"Who\'s" means "who is" — not a possessive pronoun.',
        'that': '"That" introduces a relative clause about the thing or person as a subject or object; the clause needs to show ownership of the badge.',
        'which': '"Which" is for things; "whose" is needed to show possession.',
      }],
      ['She is the author to ___ the school sent a letter of appreciation.', 'whom', ['who', 'which', 'whose'], {
        'whom': '"Whom" is correct because after the preposition "to", the object form is needed for a person.',
        'who': '"Who" is a subject pronoun; after "to", the object form "whom" is needed.',
        'which': '"Which" is for things; the author is a person.',
        'whose': '"Whose" shows possession; the clause is about the author as the object after "to".',
      }],
      ['The hawker stall ___ always has a long queue serves the best chicken rice in the neighbourhood.', 'that', ['who', 'whom', 'whose'], {
        'that': '"That" is correct because it introduces a relative clause about a thing (the hawker stall).',
        'who': '"Who" is for people; the hawker stall is a place.',
        'whom': '"Whom" is for a person as the object; the stall is not a person.',
        'whose': '"Whose" shows possession; the clause is about the stall as the subject of "has".',
      }],
      ['My neighbour, ___ moved in last month, works as a doctor at SGH.', 'who', ['which', 'whom', 'whose'], {
        'who': '"Who" is correct because the neighbour is a person and is the subject of "moved in".',
        'which': '"Which" is for things; the neighbour is a person.',
      ...
      ['The trophy, ___ was donated by a former student, is displayed in the school foyer.', 'which', ['that', 'who', 'whose'], {
        ...
        'whose': '"Whose" shows possession; the clause is about the trophy as the subject of "was donated".',
      }],
      ['The volunteer ___ they had been waiting for finally arrived with boxes of supplies.', 'whom', ['who', 'which', 'whose'], {
        'whom': '"Whom" is correct because the volunteer is the object of "waiting for" — a preposition at the end of the clause.',
        'who': '"Who" is a subject pronoun; the volunteer is the object after the preposition "for".',
        'which': '"Which" is for things; the volunteer is a person.',
        'whose': '"Whose" shows possession; the clause is about the volunteer as the object of "for".',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
  ...
  homophones(level, i) {
    const rows = [
      ...
      ['The boys left ___ water bottles on the field after PE.', 'their', ['there', 'they\'re', 'theirs'], {
        ...
        'there': '"There" is a place word (over there) or used with "there is/are".',
      ...
      ['Do you know ___ backpack this is? It has no name tag.', 'whose', ['who\'s', 'whos', 'who'], {
        ...
        'who\'s': '"Who\'s" means "who is" or "who has" — not asking about ownership.',
        'whos': '"Whos" is not a real word.',
        'who': '"Who" asks about the identity of a person, not ownership of an object.',
      }],
      ['"___ your favourite book so far?" the librarian asked.', 'What\'s', ['Whats', 'What\'re', 'Whatever'], {
        'What\'s': '"What\'s" is correct because it means "what is" — "what is your favourite book?"',
        'Whats': '"Whats" is not a real word — the contraction needs an apostrophe.',
        'What\'re': '"What\'re" means "what are" — "what are your favourite book" is grammatically wrong.',
        'Whatever': '"Whatever" means "anything that" — not used to ask a direct question.',
      }],
      ['___ going to be the class chairperson this term?', 'Who\'s', ['Whose', 'Whos', 'Who'], {
        'Who\'s': '"Who\'s" is correct because it means "who is" — "who is going to be the chairperson?"',
        'Whose': '"Whose" asks about ownership; the question is about who will be chairperson, not ownership.',
      ...
      ['She wore ___ new school shoes for the first time on Monday.', 'her', ['hers', 'she\'s', 'herself'], {
        ...
        'hers': '"Hers" is a possessive pronoun that stands alone; it cannot come before a noun.',
        'she\'s': '"She\'s" means "she is" or "she has" — not a possessive adjective.',
        'herself': '"Herself" is a reflexive pronoun, not a possessive adjective.',
      }],
      ['We packed ___ lunches the night before the excursion.', 'our', ['ours', 'we\'re', 'hour'], {
        'our': '"Our" is correct because it is a possessive adjective coming before the noun "lunches".',
        'ours': '"Ours" is a possessive pronoun that stands alone; it cannot come before a noun.',
      ...
      ['The guide showed us ___ to find the emergency exits.', 'where', ['were', 'wear', 'there'], {
        'where': '"Where" is correct because it means "the place at which" — the guide showed the location of the exits.',
        'were': '"Were" is a past tense of "to be"; it does not show location.',
        'wear': '"Wear" means to put on clothing — unrelated to showing a location.',
        'there': '"There" is a place marker; "where to find" is the correct phrase for showing location.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return {
  ...
  wordForms(level, i) {
    const rows = [
      ['The judges were impressed by the ___ of her piano performance.', 'brilliance', ['brilliant', 'brilliantly', 'brillianted'], {
        'brilliance': '"Brilliance" is correct because after "the" and "of", a noun is needed.',
        'brilliant': '"Brilliant" is an adjective describing a noun; after "the…of", a noun is needed.',
        'brilliantly': '"Brilliantly" is an adverb; after "the…of", a noun is needed.',
        'brillianted': '"Brillianted" is not a real word.',
      }],
      ['The school counsellor encouraged the pupils to be ___ of their own feelings.', 'aware', ['awareness', 'awared', 'unaware'], {
        'aware': '"Aware" is correct because after "to be", an adjective is needed to describe the pupils.',
        'awareness': '"Awareness" is a noun; after "to be", an adjective like "aware" is needed.',
        'awared': '"Awared" is not a real word.',
        'unaware': '"Unaware" means not knowing; the counsellor is encouraging pupils to be conscious, not unaware.',
      }],
      ['The committee made a ___ to plant more trees along the school path.', 'decision', ['decide', 'decisive', 'decisively'], {
        'decision': '"Decision" is correct because after "a" and before "to", a noun is needed.',
        'decide': '"Decide" is a verb; after "a", a noun is needed.',
        'decisive': '"Decisive" is an adjective; after "a…to", a noun is needed.',
        'decisively': '"Decisively" is an adverb; after "a…to", a noun is needed.',
      }],
      ['He spoke ___ when addressing the crowd at the assembly.', 'confidently', ['confident', 'confidence', 'confide'], {
        'confidently': '"Confidently" is correct because it is an adverb describing how he spoke — modifying the verb.',
        'confident': '"Confident" is an adjective; here the word must describe the action of speaking.',
        'confidence': '"Confidence" is a noun; an adverb is needed to describe the verb.',
        'confide': '"Confide" is a verb meaning to share a secret; it does not describe how someone speaks.',
      }],
      ['The ___ of the volunteers was evident from the start.', 'dedication', ['dedicated', 'dedicatedly', 'dedicate'], {
        'dedication': '"Dedication" is correct because after "the" and before "of", a noun is needed.',
        'dedicated': '"Dedicated" is an adjective; after "the…of", a noun is needed.',
        'dedicatedly': '"Dedicatedly" is an adverb; after "the…of", a noun is needed.',
        'dedicate': '"Dedicate" is a verb; after "the…of", a noun is needed.',
      }],
      ['Her ___ response impressed the panel of judges.', 'creative', ['creation', 'creatively', 'creativity'], {
        'creative': '"Creative" is correct because it is an adjective describing the noun "response".',
        'creation': '"Creation" is a noun; before "response", an adjective is needed.',
        'creatively': '"Creatively" is an adverb; before a noun like "response", an adjective is needed.',
        'creativity': '"Creativity" is a noun; before "response", an adjective is needed.',
      }],
      ['The ___ of the new facilities was announced at the school open day.', 'completion', ['complete', 'completely', 'completed'], {
        'completion': '"Completion" is correct because after "the" and before "of", a noun is needed.',
        'complete': '"Complete" is an adjective or verb; after "the…of", a noun is needed.',
        'completely': '"Completely" is an adverb; after "the…of", a noun is needed.',
        'completed': '"Completed" is a past tense verb or adjective; after "the…of", a noun is needed.',
      }],
      ['The athlete trained with great ___ to prepare for the national competition.', 'determination', ['determined', 'determinedly', 'determine'], {
        'determination': '"Determination" is correct because after "great", a noun is needed.',
        'determined': '"Determined" is an adjective; after "great", a noun is needed.',
        'determinedly': '"Determinedly" is an adverb; after "great", a noun is needed.',
        'determine': '"Determine" is a verb; after "great", a noun is needed.',
      }],
      ['The audience applauded ___ at the end of the performance.', 'enthusiastically', ['enthusiastic', 'enthusiasm', 'enthuse'], {
        'enthusiastically': '"Enthusiastically" is correct because it is an adverb describing how the audience applauded.',
        'enthusiastic': '"Enthusiastic" is an adjective; here the word must describe the verb "applauded".',
        'enthusiasm': '"Enthusiasm" is a noun; an adverb is needed to describe the verb.',
        'enthuse': '"Enthuse" is a verb; an adverb is needed to describe how the audience applauded.',
      }],
      ['The doctor explained that the patient\'s ___ was remarkable.', 'recovery', ['recover', 'recovered', 'recoverable'], {
        'recovery': '"Recovery" is correct because after a possessive ("patient\'s") and before "was", a noun is needed.',
        'recover': '"Recover" is a verb; after a possessive, a noun is needed.',
        'recovered': '"Recovered" is a past tense verb or adjective; after "the patient\'s", a noun is needed.',
        'recoverable': '"Recoverable" is an adjective; after the possessive, a noun is needed.',
      }],
      ['The principal reminded pupils that ___ is key to doing well.', 'perseverance', ['persevere', 'perseverant', 'persevering'], {
        'perseverance': '"Perseverance" is correct because after "that" and before "is", a noun (the subject) is needed.',
        'persevere': '"Persevere" is a verb; a noun is needed as the subject of "is key".',
        'perseverant': '"Perseverant" is not a standard adjective — "persevering" or "persistent" would be used instead.',
        'persevering': '"Persevering" is an adjective or gerund; "perseverance" is the correct noun form here.',
      }],
      ['The science teacher gave a clear ___ of how photosynthesis works.', 'explanation', ['explain', 'explainable', 'explanatory'], {
        'explanation': '"Explanation" is correct because after "a clear" and before "of", a noun is needed.',
        'explain': '"Explain" is a verb; after "a clear…of", a noun is needed.',
        'explainable': '"Explainable" is an adjective; after "a clear…of", a noun is needed.',
        'explanatory': '"Explanatory" is an adjective meaning "serving to explain"; a noun is needed after "a clear".',
      }],
      ['The committee was ___ about the new timetable changes.', 'optimistic', ['optimism', 'optimistically', 'optimist'], {
        'optimistic': '"Optimistic" is correct because after "was", an adjective is needed to describe the committee.',
        'optimism': '"Optimism" is a noun; after "was", an adjective is needed.',
        'optimistically': '"Optimistically" is an adverb; after the linking verb "was", an adjective is needed.',
        'optimist': '"Optimist" is a noun for a person; after "was", an adjective is needed.',
      }],
      ['The ___ of the event was handled by a team of senior pupils.', 'organisation', ['organise', 'organised', 'organisational'], {
        'organisation': '"Organisation" is correct because after "the" and before "of", a noun is needed.',
        'organise': '"Organise" is a verb; after "the…of", a noun is needed.',
        'organised': '"Organised" is a past tense verb or adjective; after "the…of", a noun is needed.',
        'organisational': '"Organisational" is an adjective; after "the…of", a noun is needed.',
      }],
      ['She spoke with great ___ despite being the youngest speaker.', 'maturity', ['mature', 'maturely', 'maturing'], {
        'maturity': '"Maturity" is correct because after "great", a noun is needed.',
        'mature': '"Mature" is an adjective or verb; after "great", a noun is needed.',
        'maturely': '"Maturely" is an adverb; after "great", a noun is needed.',
        'maturing': '"Maturing" is a verb form or adjective; after "great", a noun is needed.',
      }],
      ['The ___ between the two teams was intense throughout the final match.', 'competition', ['compete', 'competitive', 'competitively'], {
        'competition': '"Competition" is correct because after "the" and before "between", a noun is needed.',
        'compete': '"Compete" is a verb; after "the…between", a noun is needed.',
        'competitive': '"Competitive" is an adjective; after "the…between", a noun is needed.',
        'competitively': '"Competitively" is an adverb; after "the…between", a noun is needed.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return {
  ...
  gerundInfinitive(level, i) {
    const rows = [
      ['She enjoys ___ the piano for an hour every evening.', 'playing', ['play', 'to play', 'played'], {
        'playing': '"Playing" is correct because "enjoy" always takes a gerund (-ing form).',
        'play': '"Play" is base form; after "enjoy", the gerund "playing" is needed.',
        'to play': '"To play" is an infinitive; "enjoy" never takes an infinitive — it takes a gerund.',
        'played': '"Played" is simple past; after "enjoy", a gerund is needed.',
      }],
      ['We managed ___ the last bus just in time.', 'to catch', ['catching', 'caught', 'catch'], {
        'to catch': '"To catch" is correct because "manage" always takes an infinitive (to + verb).',
        'catching': '"Catching" is a gerund; "manage" always takes an infinitive.',
        'caught': '"Caught" is simple past; after "managed", an infinitive is needed.',
        'catch': '"Catch" is base form; "manage" takes "to + verb", not the base form alone.',
      }],
      ['He decided ___ in the school play this year.', 'to take part', ['taking part', 'took part', 'take part'], {
        'to take part': '"To take part" is correct because "decide" always takes an infinitive.',
        'taking part': '"Taking part" is a gerund; "decide" takes an infinitive, not a gerund.',
        'took part': '"Took part" is simple past; after "decided", an infinitive is needed.',
        'take part': '"Take part" is base form; "decide" takes "to + verb", not the base form alone.',
      }],
      ['Please finish ___ your worksheet before the bell rings.', 'doing', ['to do', 'done', 'did'], {
        'doing': '"Doing" is correct because "finish" always takes a gerund (-ing form).',
        'to do': '"To do" is an infinitive; "finish" never takes an infinitive — it takes a gerund.',
        'done': '"Done" is a past participle; after "finish", a gerund is needed.',
        'did': '"Did" is simple past; after "finish", a gerund is needed.',
      }],
      ['Mei hopes ___ a doctor when she grows up.', 'to become', ['becoming', 'become', 'became'], {
        'to become': '"To become" is correct because "hope" always takes an infinitive.',
        'becoming': '"Becoming" is a gerund; "hope" takes an infinitive, not a gerund.',
        'become': '"Become" is base form; "hope" takes "to + verb", not the base form alone.',
        'became': '"Became" is simple past; after "hopes", an infinitive is needed.',
      }],
      ['I remember ___ my water bottle this morning — it is safely in my bag.', 'packing', ['to pack', 'packed', 'pack'], {
        'packing': '"Packing" is correct because "remember + gerund" means recalling a past action (I remember doing it — it happened).',
        'to pack': '"To pack" would mean I remember that I need to pack it — a future obligation, but the speaker says it is already in the bag.',
        'packed': '"Packed" is simple past; "remember" here needs the gerund to show a recalled past action.',
        'pack': '"Pack" is base form; "remember" takes a gerund to recall a past action.',
      }],
      ['He stopped ___ the view before continuing the hike.', 'to admire', ['admiring', 'admired', 'admire'], {
        'to admire': '"To admire" is correct because "stop + infinitive" means he paused in order to do something else.',
        'admiring': '"Admiring" would mean he stopped the action of admiring — but here he paused the hike to look.',
        'admired': '"Admired" is simple past; "stop" here takes an infinitive to show purpose.',
        'admire': '"Admire" is base form; "stopped to admire" is the correct phrase for stopping in order to do something.',
      }],
      ['The coach suggested ___ earlier to warm up properly.', 'arriving', ['to arrive', 'arrived', 'arrive'], {
        'arriving': '"Arriving" is correct because "suggest" always takes a gerund.',
        'to arrive': '"To arrive" is an infinitive; "suggest" never takes an infinitive — it takes a gerund.',
        'arrived': '"Arrived" is simple past; after "suggested", a gerund is needed.',
        'arrive': '"Arrive" is base form; "suggest" takes a gerund, not the base form alone.',
      }],
      ['She agreed ___ the class presentation on behalf of the group.', 'to give', ['giving', 'gave', 'give'], {
        'to give': '"To give" is correct because "agree" always takes an infinitive.',
        'giving': '"Giving" is a gerund; "agree" takes an infinitive, not a gerund.',
        'gave': '"Gave" is simple past; after "agreed", an infinitive is needed.',
        'give': '"Give" is base form; "agree" takes "to + verb", not the base form alone.',
      }],
      ['They avoided ___ the busy road during the morning rush.', 'crossing', ['to cross', 'crossed', 'cross'], {
        'crossing': '"Crossing" is correct because "avoid" always takes a gerund.',
        'to cross': '"To cross" is an infinitive; "avoid" never takes an infinitive — it takes a gerund.',
        'crossed': '"Crossed" is simple past; after "avoided", a gerund is needed.',
        'cross': '"Cross" is base form; "avoid" takes a gerund, not the base form alone.',
      }],
      ['My brother plans ___ computing at the polytechnic next year.', 'to study', ['studying', 'studied', 'study'], {
        'to study': '"To study" is correct because "plan" always takes an infinitive.',
        'studying': '"Studying" is a gerund; "plan" takes an infinitive, not a gerund.',
        'studied': '"Studied" is simple past; after "plans", an infinitive is needed.',
        'study': '"Study" is base form; "plan" takes "to + verb", not the base form alone.',
      }],
      ['Instead of ___ the escalator, they climbed the stairs for exercise.', 'taking', ['take', 'to take', 'taken'], {
        'taking': '"Taking" is correct because after a preposition ("of"), a gerund is always needed.',
        'take': '"Take" is base form; after the preposition "of", a gerund is required.',
        'to take': '"To take" is an infinitive; after a preposition, a gerund (not an infinitive) is needed.',
        'taken': '"Taken" is a past participle; after the preposition "of", a gerund is needed.',
      }],
      ['The class kept ___ questions even after the lesson ended.', 'asking', ['to ask', 'asked', 'ask'], {
        'asking': '"Asking" is correct because "keep" always takes a gerund.',
        'to ask': '"To ask" is an infinitive; "keep" takes a gerund, not an infinitive.',
        'asked': '"Asked" is simple past; after "kept", a gerund is needed.',
        'ask': '"Ask" is base form; "keep" takes a gerund, not the base form alone.',
      }],
      ['He forgot ___ his PE kit at home, so he borrowed a spare set.', 'to bring', ['bringing', 'brought', 'bring'], {
        'to bring': '"To bring" is correct because "forget + infinitive" means he failed to do something — he did not remember to bring it.',
        'bringing': '"Bringing" would mean he forgot an action he had already done; here he failed to do the action.',
        'brought': '"Brought" is simple past; "forget" here takes an infinitive.',
        'bring': '"Bring" is base form; "forgot to + verb" is the correct pattern.',
      }],
      ['The volunteers offered ___ the elderly residents to the community hall.', 'to escort', ['escorting', 'escorted', 'escort'], {
        'to escort': '"To escort" is correct because "offer" always takes an infinitive.',
        'escorting': '"Escorting" is a gerund; "offer" takes an infinitive, not a gerund.',
        'escorted': '"Escorted" is simple past; after "offered", an infinitive is needed.',
        'escort': '"Escort" is base form; "offer" takes "to + verb", not the base form alone.',
      }],
      ['She practises ___ her lines for the drama every night before bed.', 'reciting', ['to recite', 'recited', 'recite'], {
        'reciting': '"Reciting" is correct because "practise" always takes a gerund.',
        'to recite': '"To recite" is an infinitive; "practise" never takes an infinitive — it takes a gerund.',
        'recited': '"Recited" is simple past; after "practises", a gerund is needed.',
        'recite': '"Recite" is base form; "practise" takes a gerund, not the base form alone.',
      }],
    ];
    const [q, answer, ds, optionExplanations] = rotate(rows, i);
    return {
 ...
 *
 * Each category is generated by rotating through a fixed list of authored
 * sentences, so asking for 101 items from a list of ~18 produces every
 * sentence about six times. Those copies used to be disguised by a
 * scene-setting wrapper; without the wrapper they are simply repeats, and a
 * child working through a category would meet the same sentence again and
 * again.
 *
 * So the bank now reports what it actually holds. The remedy for a thin
 * category is more authored sentences in its builder — not more copies of
...
function dedupeBySeed(items) {
  ...
  // Ids carry a sequence number; renumber so gaps don't appear after culling.
